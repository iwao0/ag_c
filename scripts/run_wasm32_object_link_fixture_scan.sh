...
skip_reason() {
  case "$1" in
    ...
    test/fixtures/wasm32/function_floating_rank_signature_mismatch_main.c|\
    ...
    test/fixtures/wasm32/global_callback_floating_rank_signature_mismatch_main.c|\
...
link_companion() {
  case "$1" in
    ...
    test/fixtures/probes_found_bugs/unprototyped_void_parameter_xtu_main.c)
      echo "test/fixtures/probes_found_bugs/unprototyped_void_parameter_xtu_other.c"
      ;;
    test/fixtures/probes_found_bugs/unprototyped_void_zero_xtu_main.c)
      echo "test/fixtures/probes_found_bugs/unprototyped_void_zero_xtu_other.c"
      ;;
    ...
    test/fixtures/probes_found_bugs/nested_atomic_union_complex_callback_parameter_xtu_main.c)
      echo "test/fixtures/probes_found_bugs/nested_atomic_union_complex_callback_parameter_xtu_other.c"
      ;;
    test/fixtures/probes_found_bugs/nested_atomic_union_complex_callback_result_xtu_main.c)
      echo "test/fixtures/probes_found_bugs/nested_atomic_union_complex_callback_result_xtu_other.c"
      ;;
    test/fixtures/probes_found_bugs/nested_atomic_union_complex_callback_factory_xtu_main.c)
      echo "test/fixtures/probes_found_bugs/nested_atomic_union_complex_callback_factory_xtu_other.c"
      ;;
    test/fixtures/probes_found_bugs/atomic_union_complex_callback_factory_data_xtu_main.c)
      echo "test/fixtures/probes_found_bugs/atomic_union_complex_callback_factory_data_xtu_other.c"
      ;;
    test/fixtures/probes_found_bugs/atomic_union_complex_callback_factory_container_xtu_main.c)
      echo "test/fixtures/probes_found_bugs/atomic_union_complex_callback_factory_container_xtu_other.c"
      ;;
    ...
    test/fixtures/probes_found_bugs/overaligned_callback_value_abi_xtu_main.c)
      echo "test/fixtures/probes_found_bugs/overaligned_callback_value_abi_xtu_other.c"
      ;;
