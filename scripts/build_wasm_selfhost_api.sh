...
AGC_WASM_RUNTIME_OBJECT="$runtime_obj" "$root/build/ag_wasm_link" --no-entry \
  ...
  --export=agc_wasm_adapter_analyze_source_virtual \
  --export=agc_wasm_adapter_analyze_project_source_virtual \
  --export=agc_wasm_adapter_update_language_project \
  --export=agc_wasm_adapter_analysis_error_code_ptr \
  --export=agc_wasm_adapter_analysis_error_limit_ptr \
  --export=agc_wasm_adapter_analysis_error_max \
  --export=agc_wasm_adapter_analysis_error_actual \
  --export=agc_wasm_adapter_dependency_count \
  --export=agc_wasm_adapter_dependency_name_ptr \
