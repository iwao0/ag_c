...
AGC_WASM_RUNTIME_OBJECT="$runtime_obj" "$root/build/ag_wasm_link" --no-entry \
  ...
  --export=agc_wasm_compile_wat_named \
  ...
  --export=agc_wasm_diagnostic_bytes \
  --export=agc_wasm_diagnostic_limit_kind \
  --export=agc_wasm_diagnostic_severity \
  --export=agc_wasm_diagnostic_code_ptr \
  --export=agc_wasm_diagnostic_message_ptr \
  --export=agc_wasm_diagnostic_source_name_ptr \
  --export=agc_wasm_diagnostic_start_line \
  --export=agc_wasm_diagnostic_start_column \
  --export=agc_wasm_diagnostic_start_offset \
  --export=agc_wasm_diagnostic_end_line \
  --export=agc_wasm_diagnostic_end_column \
  --export=agc_wasm_diagnostic_end_offset \
