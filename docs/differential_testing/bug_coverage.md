...
| 同梱 `<complex.h>` (I/creal/cimag/conj、算術) | 🔧 | stdheader/complex_ops | _Complex brace 初期化・複素数 compound literal で I={0,1} を構築、creal/cimag はメモリ経由マクロ (lvalue)。算術はネイティブ。値渡し/__real__ 無し |
