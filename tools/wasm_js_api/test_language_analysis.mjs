...
const sameTypedefDeclaratorHoverSource = {
  ...
  source: "struct SameTypedefRecord { int value; };\n" +
    ...
    "  { extern ExternObjectParenthesizedOuterRestrictDoublePointerType (* restrict *ExternObjectParenthesizedOuterRestrictDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerRestrictDoublePointerType (** restrict ExternObjectParenthesizedInnerRestrictDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedDoublePointerRestrictCommentType (* /* before restrict */ restrict /* between pointers */ * ExternObjectParenthesizedDoublePointerRestrictCommentType); }\n" +
    ...
    "  { extern ExternObjectParenthesizedBothConstDoublePointerType (* const * const ExternObjectParenthesizedBothConstDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedConstVolatileDoublePointerType (* const * volatile ExternObjectParenthesizedConstVolatileDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedVolatileConstDoublePointerType (* volatile * const ExternObjectParenthesizedVolatileConstDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedBothVolatileDoublePointerType (* volatile * volatile ExternObjectParenthesizedBothVolatileDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedDoublePointerDualCvCommentType (* const /* between pointers */ * /* before second qualifier */ volatile ExternObjectParenthesizedDoublePointerDualCvCommentType); }\n" +
    "  { extern ExternObjectParenthesizedDoublePointerDualCvSpliceType (* volatile * \\\nconst ExternObjectParenthesizedDoublePointerDualCvSpliceType); }\n" +
    "  { extern ExternObjectParenthesizedConstRestrictDoublePointerType (* const * restrict ExternObjectParenthesizedConstRestrictDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedRestrictConstDoublePointerType (* restrict * const ExternObjectParenthesizedRestrictConstDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedVolatileRestrictDoublePointerType (* volatile * restrict ExternObjectParenthesizedVolatileRestrictDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedRestrictVolatileDoublePointerType (* restrict * volatile ExternObjectParenthesizedRestrictVolatileDoublePointerType); }\n" +
    ...
    "  { extern ExternObjectParenthesizedOuterConstRestrictListDoublePointerType (* const restrict *ExternObjectParenthesizedOuterConstRestrictListDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerConstRestrictListDoublePointerType (** const restrict ExternObjectParenthesizedInnerConstRestrictListDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterRestrictConstListDoublePointerType (* restrict const *ExternObjectParenthesizedOuterRestrictConstListDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerRestrictConstListDoublePointerType (** restrict const ExternObjectParenthesizedInnerRestrictConstListDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType (* volatile restrict *ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType (** volatile restrict ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType (* restrict volatile *ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType (** restrict volatile ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType (* restrict /* between qualifiers */ volatile /* before pointer */ * ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType); }\n" +
    "  { extern ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType (** const \\\nrestrict ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType); }\n" +
    "  { extern ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType (* const volatile restrict *ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType (** const volatile restrict ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType (* const restrict volatile *ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType (** const restrict volatile ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType (* volatile const restrict *ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType (** volatile const restrict ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType (* volatile restrict const *ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType (** volatile restrict const ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType (* restrict const volatile *ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType (** restrict const volatile ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType (* restrict volatile const *ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerRestrictVolatileConstDoublePointerType (** restrict volatile const ExternObjectParenthesizedInnerRestrictVolatileConstDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedDoublePointerSingleLevelAllCvrCommentType (* const /* first gap */ volatile /* second gap */ restrict * ExternObjectParenthesizedDoublePointerSingleLevelAllCvrCommentType); }\n" +
    "  { extern ExternObjectParenthesizedDoublePointerSingleLevelAllCvrSpliceType (** restrict volatile \\\nconst ExternObjectParenthesizedDoublePointerSingleLevelAllCvrSpliceType); }\n" +
    "  { extern ExternObjectParenthesizedOuterCvInnerConstDoublePointerType (* const volatile * const ExternObjectParenthesizedOuterCvInnerConstDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterConstInnerVrDoublePointerType (* const * volatile restrict ExternObjectParenthesizedOuterConstInnerVrDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterAllCvrInnerVolatileDoublePointerType (* const volatile restrict * volatile ExternObjectParenthesizedOuterAllCvrInnerVolatileDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterRestrictInnerAllCvrDoublePointerType (* restrict * const volatile restrict ExternObjectParenthesizedOuterRestrictInnerAllCvrDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedBothPairCvrDoublePointerType (* const volatile * const restrict ExternObjectParenthesizedBothPairCvrDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterAllCvrInnerCvDoublePointerType (* const volatile restrict * const volatile ExternObjectParenthesizedOuterAllCvrInnerCvDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterVrInnerAllCvrDoublePointerType (* volatile restrict * const volatile restrict ExternObjectParenthesizedOuterVrInnerAllCvrDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedBothAllCvrDoublePointerType (* const volatile restrict * const volatile restrict ExternObjectParenthesizedBothAllCvrDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedDoublePointerBothCvrListCommentType (* const /* outer gap */ volatile * restrict /* inner gap */ const ExternObjectParenthesizedDoublePointerBothCvrListCommentType); }\n" +
    "  { extern ExternObjectParenthesizedDoublePointerBothCvrListSpliceType (* restrict volatile const * const \\\nvolatile restrict ExternObjectParenthesizedDoublePointerBothCvrListSpliceType); }\n" +
    "  { extern ExternObjectParenthesizedOuterRepeatedConstDoublePointerType (* const const *ExternObjectParenthesizedOuterRepeatedConstDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerRepeatedConstDoublePointerType (** const const ExternObjectParenthesizedInnerRepeatedConstDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType (* volatile volatile *ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType (** volatile volatile ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType (* restrict restrict *ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType (** restrict restrict ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType (* const volatile const *ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType (** restrict const restrict ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedBothRepeatedCvrDoublePointerType (* const const * volatile volatile ExternObjectParenthesizedBothRepeatedCvrDoublePointerType); }\n" +
    "  { extern ExternObjectParenthesizedOuterFourConstDoublePointerType (* const const const const *ExternObjectParenthesizedOuterFourConstDoublePointerType); }\n" +
...
const externTypedefShadowConflictSources = [
  ...
  "extern SameBlockParenthesizedDoublePointerExternType " +
    "(**SameBlockParenthesizedDoublePointerExternType)"],
  [{
    name: "same-block-parenthesized-const-double-pointer-extern-typedef-conflict.c",
    source:
  ...
  "extern SameBlockParenthesizedConstDoublePointerExternType " +
    "(* const *SameBlockParenthesizedConstDoublePointerExternType)"],
  [{
    name: "same-block-parenthesized-volatile-double-pointer-extern-typedef-conflict.c",
    source:
  ...
  "extern SameBlockParenthesizedVolatileDoublePointerExternType " +
    "(* volatile *SameBlockParenthesizedVolatileDoublePointerExternType)"],
  [{
    name: "same-block-parenthesized-restrict-double-pointer-extern-typedef-conflict.c",
    source:
  ...
  "extern SameBlockParenthesizedRestrictDoublePointerExternType " +
    "(* restrict *SameBlockParenthesizedRestrictDoublePointerExternType)"],
  [{
    name: "same-block-parenthesized-dual-cv-double-pointer-extern-typedef-conflict.c",
    source:
  ...
  "extern SameBlockParenthesizedDualCvDoublePointerExternType " +
    ...
    "SameBlockParenthesizedDualCvDoublePointerExternType)"],
  [{
    name: "same-block-parenthesized-dual-cvr-double-pointer-extern-typedef-conflict.c",
    source:
  ...
  "extern SameBlockParenthesizedSingleLevelCvDoublePointerExternType " +
    ...
    "SameBlockParenthesizedSingleLevelCvDoublePointerExternType)"],
  [{
    name: "same-block-parenthesized-single-level-cvr-double-pointer-extern-typedef-conflict.c",
    source:
  ...
  "extern SameBlockParenthesizedSingleLevelCvrDoublePointerExternType " +
    ...
    "SameBlockParenthesizedSingleLevelCvrDoublePointerExternType)"],
  [{
    name: "same-block-parenthesized-single-level-all-cvr-double-pointer-extern-typedef-conflict.c",
    source:
  ...
  "extern SameBlockParenthesizedSingleLevelAllCvrDoublePointerExternType " +
    ...
    "SameBlockParenthesizedSingleLevelAllCvrDoublePointerExternType)"],
  [{
    name: "same-block-parenthesized-both-level-cvr-list-double-pointer-extern-typedef-conflict.c",
    source:
  ...
  "extern SameBlockParenthesizedBothLevelCvrListDoublePointerExternType " +
    ...
    "SameBlockParenthesizedBothLevelCvrListDoublePointerExternType)"],
  [{
    name: "same-block-parenthesized-repeated-cvr-double-pointer-extern-typedef-conflict.c",
    source:
...
if (!languageAnalysisFocus || languageAnalysisFocus === "same-typedef-declarators") {
  ...
  const externObjectTypeCases = [
    ...
    ["extern ExternObjectParenthesizedOuterRestrictDoublePointerType (* restrict *ExternObjectParenthesizedOuterRestrictDoublePointerType)",
      "ExternObjectParenthesizedOuterRestrictDoublePointerType", true],
    ["extern ExternObjectParenthesizedInnerRestrictDoublePointerType (** restrict ExternObjectParenthesizedInnerRestrictDoublePointerType)",
      "ExternObjectParenthesizedInnerRestrictDoublePointerType", false],
    ["extern ExternObjectParenthesizedDoublePointerRestrictCommentType (* /* before restrict */ restrict /* between pointers */ * ExternObjectParenthesizedDoublePointerRestrictCommentType)",
      "ExternObjectParenthesizedDoublePointerRestrictCommentType", false],
    ["extern ExternObjectParenthesizedDoublePointerRestrictSpliceType (** \\\nrestrict ExternObjectParenthesizedDoublePointerRestrictSpliceType)",
      "ExternObjectParenthesizedDoublePointerRestrictSpliceType", false],
    ["extern ExternObjectParenthesizedBothConstDoublePointerType (* const * const ExternObjectParenthesizedBothConstDoublePointerType)",
      "ExternObjectParenthesizedBothConstDoublePointerType", true],
    ["extern ExternObjectParenthesizedConstVolatileDoublePointerType (* const * volatile ExternObjectParenthesizedConstVolatileDoublePointerType)",
      "ExternObjectParenthesizedConstVolatileDoublePointerType", false],
    ["extern ExternObjectParenthesizedVolatileConstDoublePointerType (* volatile * const ExternObjectParenthesizedVolatileConstDoublePointerType)",
      "ExternObjectParenthesizedVolatileConstDoublePointerType", false],
    ["extern ExternObjectParenthesizedBothVolatileDoublePointerType (* volatile * volatile ExternObjectParenthesizedBothVolatileDoublePointerType)",
      "ExternObjectParenthesizedBothVolatileDoublePointerType", false],
    ["extern ExternObjectParenthesizedDoublePointerDualCvCommentType (* const /* between pointers */ * /* before second qualifier */ volatile ExternObjectParenthesizedDoublePointerDualCvCommentType)",
      "ExternObjectParenthesizedDoublePointerDualCvCommentType", false],
    ["extern ExternObjectParenthesizedDoublePointerDualCvSpliceType (* volatile * \\\nconst ExternObjectParenthesizedDoublePointerDualCvSpliceType)",
      "ExternObjectParenthesizedDoublePointerDualCvSpliceType", false],
    ["extern ExternObjectParenthesizedConstRestrictDoublePointerType (* const * restrict ExternObjectParenthesizedConstRestrictDoublePointerType)",
      "ExternObjectParenthesizedConstRestrictDoublePointerType", true],
    ["extern ExternObjectParenthesizedRestrictConstDoublePointerType (* restrict * const ExternObjectParenthesizedRestrictConstDoublePointerType)",
      "ExternObjectParenthesizedRestrictConstDoublePointerType", false],
    ["extern ExternObjectParenthesizedVolatileRestrictDoublePointerType (* volatile * restrict ExternObjectParenthesizedVolatileRestrictDoublePointerType)",
      "ExternObjectParenthesizedVolatileRestrictDoublePointerType", false],
    ["extern ExternObjectParenthesizedRestrictVolatileDoublePointerType (* restrict * volatile ExternObjectParenthesizedRestrictVolatileDoublePointerType)",
      "ExternObjectParenthesizedRestrictVolatileDoublePointerType", false],
    ["extern ExternObjectParenthesizedBothRestrictDoublePointerType (* restrict * restrict ExternObjectParenthesizedBothRestrictDoublePointerType)",
      "ExternObjectParenthesizedBothRestrictDoublePointerType", false],
    ["extern ExternObjectParenthesizedDoublePointerDualCvrCommentType (* restrict /* between pointers */ * /* before second qualifier */ restrict ExternObjectParenthesizedDoublePointerDualCvrCommentType)",
    ...
    ["extern ExternObjectParenthesizedOuterConstRestrictListDoublePointerType (* const restrict *ExternObjectParenthesizedOuterConstRestrictListDoublePointerType)",
      "ExternObjectParenthesizedOuterConstRestrictListDoublePointerType", true],
    ["extern ExternObjectParenthesizedInnerConstRestrictListDoublePointerType (** const restrict ExternObjectParenthesizedInnerConstRestrictListDoublePointerType)",
      "ExternObjectParenthesizedInnerConstRestrictListDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterRestrictConstListDoublePointerType (* restrict const *ExternObjectParenthesizedOuterRestrictConstListDoublePointerType)",
      "ExternObjectParenthesizedOuterRestrictConstListDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerRestrictConstListDoublePointerType (** restrict const ExternObjectParenthesizedInnerRestrictConstListDoublePointerType)",
      "ExternObjectParenthesizedInnerRestrictConstListDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType (* volatile restrict *ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType)",
      "ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType (** volatile restrict ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType)",
      "ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType (* restrict volatile *ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType)",
      "ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType (** restrict volatile ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType)",
      "ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType", false],
    ["extern ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType (* restrict /* between qualifiers */ volatile /* before pointer */ * ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType)",
      "ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType", false],
    ["extern ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType (** const \\\nrestrict ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType)",
      "ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType", false],
    ["extern ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType (* const volatile restrict *ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType)",
      "ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType", true],
    ["extern ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType (** const volatile restrict ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType)",
      "ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType (* const restrict volatile *ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType)",
      "ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType (** const restrict volatile ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType)",
      "ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType (* volatile const restrict *ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType)",
      "ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType (** volatile const restrict ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType)",
      "ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType (* volatile restrict const *ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType)",
      "ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType (** volatile restrict const ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType)",
      "ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType (* restrict const volatile *ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType)",
      "ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType (** restrict const volatile ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType)",
      "ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType (* restrict volatile const *ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType)",
      "ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerRestrictVolatileConstDoublePointerType (** restrict volatile const ExternObjectParenthesizedInnerRestrictVolatileConstDoublePointerType)",
      "ExternObjectParenthesizedInnerRestrictVolatileConstDoublePointerType", false],
    ["extern ExternObjectParenthesizedDoublePointerSingleLevelAllCvrCommentType (* const /* first gap */ volatile /* second gap */ restrict * ExternObjectParenthesizedDoublePointerSingleLevelAllCvrCommentType)",
      "ExternObjectParenthesizedDoublePointerSingleLevelAllCvrCommentType", false],
    ["extern ExternObjectParenthesizedDoublePointerSingleLevelAllCvrSpliceType (** restrict volatile \\\nconst ExternObjectParenthesizedDoublePointerSingleLevelAllCvrSpliceType)",
      "ExternObjectParenthesizedDoublePointerSingleLevelAllCvrSpliceType", false],
    ["extern ExternObjectParenthesizedOuterCvInnerConstDoublePointerType (* const volatile * const ExternObjectParenthesizedOuterCvInnerConstDoublePointerType)",
      "ExternObjectParenthesizedOuterCvInnerConstDoublePointerType", true],
    ["extern ExternObjectParenthesizedOuterConstInnerVrDoublePointerType (* const * volatile restrict ExternObjectParenthesizedOuterConstInnerVrDoublePointerType)",
      "ExternObjectParenthesizedOuterConstInnerVrDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterAllCvrInnerVolatileDoublePointerType (* const volatile restrict * volatile ExternObjectParenthesizedOuterAllCvrInnerVolatileDoublePointerType)",
      "ExternObjectParenthesizedOuterAllCvrInnerVolatileDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterRestrictInnerAllCvrDoublePointerType (* restrict * const volatile restrict ExternObjectParenthesizedOuterRestrictInnerAllCvrDoublePointerType)",
      "ExternObjectParenthesizedOuterRestrictInnerAllCvrDoublePointerType", false],
    ["extern ExternObjectParenthesizedBothPairCvrDoublePointerType (* const volatile * const restrict ExternObjectParenthesizedBothPairCvrDoublePointerType)",
      "ExternObjectParenthesizedBothPairCvrDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterAllCvrInnerCvDoublePointerType (* const volatile restrict * const volatile ExternObjectParenthesizedOuterAllCvrInnerCvDoublePointerType)",
      "ExternObjectParenthesizedOuterAllCvrInnerCvDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterVrInnerAllCvrDoublePointerType (* volatile restrict * const volatile restrict ExternObjectParenthesizedOuterVrInnerAllCvrDoublePointerType)",
      "ExternObjectParenthesizedOuterVrInnerAllCvrDoublePointerType", false],
    ["extern ExternObjectParenthesizedBothAllCvrDoublePointerType (* const volatile restrict * const volatile restrict ExternObjectParenthesizedBothAllCvrDoublePointerType)",
      "ExternObjectParenthesizedBothAllCvrDoublePointerType", false],
    ["extern ExternObjectParenthesizedDoublePointerBothCvrListCommentType (* const /* outer gap */ volatile * restrict /* inner gap */ const ExternObjectParenthesizedDoublePointerBothCvrListCommentType)",
      "ExternObjectParenthesizedDoublePointerBothCvrListCommentType", false],
    ["extern ExternObjectParenthesizedDoublePointerBothCvrListSpliceType (* restrict volatile const * const \\\nvolatile restrict ExternObjectParenthesizedDoublePointerBothCvrListSpliceType)",
      "ExternObjectParenthesizedDoublePointerBothCvrListSpliceType", false],
    ["extern ExternObjectParenthesizedOuterRepeatedConstDoublePointerType (* const const *ExternObjectParenthesizedOuterRepeatedConstDoublePointerType)",
      "ExternObjectParenthesizedOuterRepeatedConstDoublePointerType", true],
    ["extern ExternObjectParenthesizedInnerRepeatedConstDoublePointerType (** const const ExternObjectParenthesizedInnerRepeatedConstDoublePointerType)",
      "ExternObjectParenthesizedInnerRepeatedConstDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType (* volatile volatile *ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType)",
      "ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType (** volatile volatile ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType)",
      "ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType (* restrict restrict *ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType)",
      "ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType (** restrict restrict ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType)",
      "ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType (* const volatile const *ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType)",
      "ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType", false],
    ["extern ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType (** restrict const restrict ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType)",
      "ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType", false],
    ["extern ExternObjectParenthesizedBothRepeatedCvrDoublePointerType (* const const * volatile volatile ExternObjectParenthesizedBothRepeatedCvrDoublePointerType)",
      "ExternObjectParenthesizedBothRepeatedCvrDoublePointerType", false],
    ["extern ExternObjectParenthesizedOuterFourConstDoublePointerType (* const const const const *ExternObjectParenthesizedOuterFourConstDoublePointerType)",
      "ExternObjectParenthesizedOuterFourConstDoublePointerType", false],
    ["extern ExternObjectParenthesizedBothAllRepeatedCvrDoublePointerType (* const volatile restrict const volatile restrict * restrict const volatile restrict const volatile ExternObjectParenthesizedBothAllRepeatedCvrDoublePointerType)",
      "ExternObjectParenthesizedBothAllRepeatedCvrDoublePointerType", false],
    ["extern ExternObjectParenthesizedDoublePointerRepeatedCvrCommentType (* const /* duplicate outer */ const * volatile /* duplicate inner */ volatile ExternObjectParenthesizedDoublePointerRepeatedCvrCommentType)",
