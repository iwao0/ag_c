...
unresolved host function imports, and a many-data-segment case that requires
more than one Wasm memory page.

Not yet supported:

- Function pointer/table relocations: `R_WASM_TABLE_INDEX_*`.
