...
static void preregister_test_locals(void) {
  ...
  for (int i = 0; i < 26; i++) {
    ps_decl_register_lvar(&names[i], 1);
  }
}
...
static int canonical_node_pointer_qual_levels(node_t *node) {
  return node ? ps_type_pointer_view_structural_qual_levels(
...
static unsigned int canonical_node_pointer_const_qual_mask(node_t *node) {
  return node ? ps_type_pointer_view_structural_qual_mask(
                    ps_node_get_type(node), 0)
              : 0;
}

static unsigned int canonical_node_pointer_volatile_qual_mask(node_t *node) {
  return node ? ps_type_pointer_view_structural_qual_mask(
                    ps_node_get_type(node), 1)
              : 0;
}
...
static int canonical_node_pointer_stride_metadata(
    node_t *node, int *inner_stride, int *next_stride,
...
static int canonical_lvar_pointer_qual_levels(lvar_t *var) {
  return var ? ps_type_pointer_view_structural_qual_levels(
                   ps_lvar_get_decl_type(var))
             : 0;
}

static psx_type_t *test_function_pointer(
    psx_type_t *return_type, psx_type_t *const *param_types,
...
static void test_local_declaration_frontend_boundary() {
  ...
  ASSERT_TRUE(ps_ctx_get_function_type((char *)"block_fn", 8) != NULL);
}
...
static void test_identifier_resolution_boundary() {
  ...
  lvar_t *local = ps_decl_register_lvar(
...
static void test_persistent_local_scope_lookup_boundary() {
  ...
  lvar_t *outer = ps_decl_register_lvar_sized(
  ...
  lvar_t *inner = ps_decl_register_lvar_sized(
      (char *)"__scope_value", 13, 4, 4, 0);
  ASSERT_TRUE(inner != NULL);
  psx_local_lookup_point_t after_inner =
      ps_local_registry_capture_lookup_point();
  ASSERT_TRUE(ps_local_registry_find_visible(
  ...
  psx_local_lookup_point_t sibling_before_decl =
      ps_local_registry_capture_lookup_point();
  lvar_t *sibling = ps_decl_register_lvar_sized(
  ...
  ASSERT_TRUE(!ps_ctx_find_enum_const_at(
...
static void test_member_access_resolution_boundary() {
  ...
  ps_decl_reset_locals();
  lvar_t *raw_object = ps_decl_register_lvar_sized(
      (char *)"object", 6, 4, 4, 0);
  ps_local_registry_set_decl_type(raw_object, object_type);
...
static void test_additive_semantic_lowering_boundary() {
  ...
  ps_decl_reset_locals();
  lvar_t *pointer = ps_decl_register_lvar_sized((char *)"p", 1, 8, 4, 0);
  ps_local_registry_set_decl_type(
      pointer,
      ps_type_new_pointer(ps_type_new_integer(TK_INT, 4, 0)));
  lvar_t *integer = ps_decl_register_lvar_sized(
      (char *)"i", 1, 4, 4, 0);
  ps_local_registry_set_decl_type(
      integer, ps_type_new_integer(TK_INT, 4, 0));
  lvar_t *floating = ps_decl_register_lvar_sized(
      (char *)"d", 1, 8, 8, 0);
  ps_local_registry_set_decl_type(
  ...
  mixed = psx_frontend_analyze_expression(mixed, NULL);
  ASSERT_TRUE(mixed->type != NULL);
  ...
  difference = psx_frontend_analyze_expression(difference, NULL);
...
static void test_unary_deref_semantic_lowering_boundary() {
  ...
  lvar_t *pointer = ps_decl_register_lvar_sized(
      (char *)"p", 1, 8, 4, 0);
  ps_local_registry_set_decl_type(pointer, pointer_type);
  lvar_t *pointer_pointer = ps_decl_register_lvar_sized(
      (char *)"q", 1, 8, 8, 0);
  ps_local_registry_set_decl_type(
  ...
  subscript_address = psx_frontend_analyze_expression(
...
static void test_unary_operator_semantic_lowering_boundary() {
  ...
  lvar_t *complex_value = ps_decl_register_lvar_sized(
      (char *)"z", 1, 16, 8, 0);
  ps_local_registry_set_decl_type(complex_value, complex_type);
  ...
  node_t *lowered_integer =
      psx_frontend_analyze_expression(raw_integer, NULL);
  ...
  node_t *lowered_floating =
      psx_frontend_analyze_expression(raw_floating, NULL);
  ...
  node_t *lowered_real = psx_frontend_analyze_expression(raw_real, NULL);
  ...
  node_t *lowered_integer_imag =
      psx_frontend_analyze_expression(raw_integer_imag, NULL);
...
static void test_generic_selection_semantic_lowering_boundary() {
  ...
  ps_decl_reset_locals();
  lvar_t *value = ps_decl_register_lvar_sized(
      (char *)"x", 1, 4, 4, 0);
  ps_local_registry_set_decl_type(
...
static void test_sizeof_semantic_lowering_boundary() {
  ...
  raw_expr = psx_bind_identifier_tree(raw_expr, NULL);
  ...
  psx_resolve_sizeof_query(negative_type_query, &direct_resolution);
  ...
  node_sizeof_query_t *zero_type_query =
      (node_sizeof_query_t *)parse_expr_input_with_existing_locals(
          "sizeof(int[0])");
  psx_resolve_sizeof_query(zero_type_query, &direct_resolution);
  ASSERT_EQ(PSX_TYPE_QUERY_RESOLUTION_OK, direct_resolution.status);
  ASSERT_TRUE((direct_resolution.zero_length_bound_mask & 1u) != 0);
  ...
  node_t *lowered_type = psx_frontend_analyze_expression(raw_type, NULL);
  ASSERT_TRUE(type_query->type_name.resolved_type != NULL);
  ...
  node_t *lowered_addr = psx_frontend_analyze_expression(raw_addr, NULL);
  ...
  psx_resolve_alignof_query(align_query);
  ASSERT_TRUE(align_query->type_name.resolved_type != NULL);
  ASSERT_EQ(4, align_query->resolved_alignment);
  node_t *lowered_align = psx_frontend_analyze_expression(raw_align, NULL);
  ASSERT_TRUE(align_query->type_name.resolved_type != NULL);
...
static void test_expression_type_materialization_boundary() {
  ...
  psx_frontend_analyze_expression(ternary, NULL);
  ASSERT_TRUE(ternary->type != NULL);
...
static void test_function_call_type_binding_boundary() {
  ...
  psx_type_t *parameters[] = {parameter};
  ...
  ASSERT_TRUE(ps_type_find_function(reference_type) != NULL);
  ...
  ps_decl_reset_locals();
  lvar_t *fp = ps_decl_register_lvar_sized(
      (char *)"fp", 2, 8, 8, 0);
  ps_local_registry_set_decl_type(
...
static void test_compound_assignment_semantic_lowering_boundary() {
  ...
  ps_decl_reset_locals();
  lvar_t *value = ps_decl_register_lvar_sized((char *)"a", 1, 4, 4, 0);
  ps_local_registry_set_decl_type(
      value, ps_type_new_integer(TK_INT, 4, 0));
...
static void test_toplevel_declaration_frontend_boundary() {
  ...
  ASSERT_TRUE(!ps_ctx_find_typedef_name(
  ...
  ASSERT_TRUE(ps_find_global_var("__phase_global", 14) == NULL);
  psx_apply_toplevel_declaration(&item.value.declaration);
  ASSERT_TRUE(ps_find_global_var("__phase_global", 14) != NULL);
  ps_dispose_toplevel_declaration_syntax(&item.value.declaration);
  ...
  ASSERT_TRUE(ps_find_global_var("__phase_initialized", 19) == NULL);
  psx_apply_toplevel_declaration(&item.value.declaration);
  ASSERT_TRUE(ps_find_global_var("__phase_initialized", 19) != NULL);
  ps_dispose_toplevel_declaration_syntax(&item.value.declaration);
...
static void test_toplevel_compound_initializer_frontend_boundary() {
  ...
  ASSERT_TRUE(ps_find_global_var("__phase_compound", 16) == NULL);
  ASSERT_TRUE(ps_find_global_var("__compound_lit_0", 16) == NULL);
...
static void test_toplevel_point_of_declaration_boundary() {
  ...
  global_var_t *self = ps_find_global_var("__point_self", 12);
  global_var_t *first = ps_find_global_var("__point_first", 13);
  global_var_t *second = ps_find_global_var("__point_second", 14);
...
static void test_frontend_stream_lifecycle_boundary() {
  ...
  psx_frontend_reset_translation_unit_state();
  node_t **program = psx_frontend_program_from(tk_tokenize(
...
static void test_complex_initializer_semantic_lowering_boundary() {
  ...
  ps_decl_reset_locals();
  lvar_t *value = ps_decl_register_lvar_sized((char *)"z", 1, 16, 16, 0);
  psx_type_t *complex_type = ps_type_new(PSX_TYPE_COMPLEX);
  complex_type->fp_kind = TK_FLOAT_KIND_DOUBLE;
  complex_type->size = 16;
  complex_type->align = 8;
  ps_local_registry_set_decl_type(value, complex_type);
  ...
  lvar_t *float_value = ps_decl_register_lvar_sized((char *)"f", 1, 8, 8, 0);
  ...
  ps_local_registry_set_decl_type(float_value, float_complex_type);
...
static void test_vla_lowering_request_boundary() {
  ...
  ps_decl_reset_locals();
  lvar_t *n = ps_decl_register_lvar_sized(
      (char *)"n", 1, 4, 4, 0);
  lvar_t *k = ps_decl_register_lvar_sized(
      (char *)"k", 1, 4, 4, 0);
  n->is_param = 1;
  k->is_param = 1;
...
static void test_parameter_declaration_storage_plan_boundary() {
  ...
  psx_type_t *returned_callable_params[] = {integer};
...
static void test_declaration_pipeline_order_boundary() {
  ...
  ASSERT_TRUE(ps_find_global_var(name, name_len) != NULL);
...
static void test_declaration_phase_boundary() {
  ...
  psx_parse_decl_specifier_syntax_ex(&syntax, NULL);
  ps_prepare_decl_specifier_alignments(&syntax);
...
static void test_type_name_phase_boundary() {
  ...
  ASSERT_TRUE(psx_parse_type_name_syntax_at(tokens, NULL, &syntax));
...
static void test_enum_constant_resolution_boundary() {
  ...
  ps_ctx_enter_block_scope();
  ps_decl_enter_scope();
  ASSERT_TRUE(ps_decl_register_lvar_sized(
...
static void test_local_initializer_parse_lowering_boundary() {
  ...
  lvar_t *object = ps_decl_register_lvar_sized(
      (char *)"object", 6, 16, 16, 0);
  ps_local_registry_set_decl_type(object, aggregate);
  token_t *tokens = tk_tokenize((char *)"{0, 7}");
  tk_set_current_token(tokens);

  node_t *raw = psx_decl_parse_initializer_for_var(object);
  ASSERT_EQ(ND_DECL_INIT, raw->kind);
  ...
  lvar_t *source = ps_decl_register_lvar_sized(
      (char *)"source", 6, 16, 16, 0);
  ps_local_registry_set_decl_type(source, aggregate);
  tokens = tk_tokenize((char *)"source");
  tk_set_current_token(tokens);
  raw = psx_decl_parse_initializer_for_var(object);
  ASSERT_EQ(ND_DECL_INIT, raw->kind);
  ASSERT_EQ(PSX_DECL_INIT_EXPR,
            ((node_decl_init_t *)raw)->init_kind);
  ...
  lvar_t *union_object = ps_decl_register_lvar_sized(
      (char *)"u", 1, 4, 4, 0);
  ps_local_registry_set_decl_type(union_object, union_type);
  tokens = tk_tokenize((char *)"9");
  tk_set_current_token(tokens);
  raw = psx_decl_parse_initializer_for_var(union_object);
  ASSERT_EQ(ND_DECL_INIT, raw->kind);
  ASSERT_EQ(PSX_DECL_INIT_EXPR,
            ((node_decl_init_t *)raw)->init_kind);
  psx_frontend_analyze_expression(raw, NULL);
  ...
  lvar_t *scalar = ps_decl_register_lvar_sized(
      (char *)"scalar", 6, 4, 4, 0);
  ps_local_registry_set_decl_type(scalar, integer);
  tokens = tk_tokenize((char *)"{7,}");
  tk_set_current_token(tokens);
  raw = psx_decl_parse_initializer_for_var(scalar);
  ASSERT_EQ(ND_DECL_INIT, raw->kind);
  ASSERT_EQ(PSX_DECL_INIT_LIST,
            ((node_decl_init_t *)raw)->init_kind);
  ...
  tk_set_current_token(tokens);
  raw = psx_decl_parse_initializer_for_var(complex_value);
  ASSERT_EQ(ND_DECL_INIT, raw->kind);
  ASSERT_EQ(PSX_DECL_INIT_LIST,
            ((node_decl_init_t *)raw)->init_kind);
  ASSERT_EQ(2, ((node_init_list_t *)raw->rhs)->entry_count);
...
static void test_static_data_initializer_boundary() {
  ...
  ps_decl_set_gvar_decl_type(&global, array);
  ...
  ps_decl_set_gvar_decl_type(&union_global, union_type);
...
static void test_expr_unary_ops() {
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(ptr_elem_2d_cast,
                                               &ptr_elem_2d_inner,
                                               &ptr_elem_2d_next,
                                               NULL, NULL));
...
static void test_expr_generic() {
  ...
  canonical_expr_funcptr = psx_frontend_analyze_expression(
  ...
  ps_local_registry_set_decl_type(synthetic_nested, synthetic_nested_type);
  ...
  lvar_t *synthetic_ret_funcptr =
      ps_decl_register_lvar_sized(synthetic_ret_funcptr_name, 1, 8, 4, 0);
  psx_type_t *synthetic_ret_funcptr_param =
      ps_type_new_integer(TK_INT, 4, 0);
  psx_type_t *synthetic_ret_funcptr_params[] = {
  ...
  ps_local_registry_set_decl_type(synthetic_ret_funcptr,
  ...
  lvar_t *synthetic_double_ret_funcptr =
      ps_decl_register_lvar_sized(synthetic_double_ret_funcptr_name, 1, 8, 8, 0);
  psx_type_t *synthetic_double_ret_funcptr_param =
      ps_type_new_integer(TK_INT, 4, 0);
  psx_type_t *synthetic_double_ret_funcptr_params[] = {
  ...
  ps_local_registry_set_decl_type(synthetic_double_ret_funcptr,
...
static void test_expr_inc_dec() {
  ...
  psx_frontend_analyze_expression(prei, NULL);
  ...
  psx_frontend_analyze_expression(pred, NULL);
  ...
  psx_frontend_analyze_expression(posti, NULL);
  ...
  psx_frontend_analyze_expression(postd, NULL);
...
static void test_type_decl() {
  ...
  body = as_block(as_func(parsed_code[0])->base.rhs);
  ASSERT_EQ(ND_ASSIGN, body->body[0]->kind);
  ASSERT_EQ(1u, canonical_node_pointer_const_qual_mask(body->body[0]->lhs));
  ASSERT_EQ(0u, canonical_node_pointer_volatile_qual_mask(body->body[0]->lhs));
  ASSERT_EQ(ND_ASSIGN, body->body[1]->kind);
  ASSERT_EQ(0u, canonical_node_pointer_const_qual_mask(body->body[1]->lhs));
  ASSERT_EQ(1u, canonical_node_pointer_volatile_qual_mask(body->body[1]->lhs));
  ASSERT_EQ(ND_RETURN, body->body[2]->kind);

  parsed_code = parse_program_input("int main() { int *const *volatile pp=0; return pp==0; }");
  body = as_block(as_func(parsed_code[0])->base.rhs);
  ASSERT_EQ(ND_ASSIGN, body->body[0]->kind);
  psx_type_t *qualified_pp_type = ps_node_get_type(body->body[0]->lhs);
  ...
  ASSERT_EQ(2u, canonical_node_pointer_const_qual_mask(body->body[0]->lhs));
  ASSERT_EQ(1u, canonical_node_pointer_volatile_qual_mask(body->body[0]->lhs));
  ASSERT_EQ(ND_RETURN, body->body[1]->kind);
...
static void test_type_metadata_bridge() {
  ...
  psx_type_t *qualified_ptr_alias_type =
  ...
  psx_type_t *qualified_array_alias_type =
  ...
  ASSERT_TRUE(!canonical_node_pointer_stride_metadata(
  ...
  ASSERT_EQ(0u, canonical_node_pointer_const_qual_mask(tmp_lvar_flat_ptr_mismatch_ref));
  ASSERT_EQ(0u, canonical_node_pointer_volatile_qual_mask(tmp_lvar_flat_ptr_mismatch_ref));
  ...
  lvar_t *funcptr_sync_lvar =
      ps_decl_register_lvar_sized(funcptr_sync_lvar_name,
                                   (int)strlen(funcptr_sync_lvar_name), 8, 4, 0);
  psx_type_t *funcptr_sync_lvar_param =
      ps_type_new_integer(TK_INT, 4, 0);
  psx_type_t *funcptr_sync_lvar_params[] = {funcptr_sync_lvar_param};
  psx_type_t *funcptr_sync_lvar_type = test_function_pointer(
      ps_type_new_integer(TK_INT, 4, 0),
      funcptr_sync_lvar_params, 1, 0);
  ps_local_registry_set_decl_type(funcptr_sync_lvar, funcptr_sync_lvar_type);
  ...
  psx_type_t *funcptr_sync_gvar_param =
      ps_type_new_float(TK_FLOAT_KIND_DOUBLE, 8);
  psx_type_t *funcptr_sync_gvar_params[] = {funcptr_sync_gvar_param};
  psx_type_t *funcptr_sync_gvar_type = test_function_pointer(
      ps_type_new_float(TK_FLOAT_KIND_DOUBLE, 8),
  ...
  int rows_inner = 0;
  int rows_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(rows_array_elem, &rows_inner,
                                               &rows_next, NULL, NULL));
  ...
  int vla_ptr_inner = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(vla_ptr_node, &vla_ptr_inner,
                                               NULL, NULL, NULL));
  ...
  ASSERT_EQ(4, ps_type_pointer_view_structural_ptr_array_pointee_bytes(
                   ptrarr_p->decl_type));
  ...
  ps_local_registry_set_decl_type(&tmp_complex_lvar, canonical_complex);
  ...
  psx_frontend_analyze_expression(typed_bool_assign, NULL);
  ...
  typed_addr_ptr_operand_mem.type =
      ps_type_new_pointer(ps_type_new_integer(TK_INT, 4, 0));
  typed_addr_ptr_operand_mem.type->is_const_qualified = 1;
  ...
  ASSERT_EQ(2u, canonical_node_pointer_const_qual_mask(typed_addr_ptr));
  ...
  ASSERT_EQ(3u, canonical_node_pointer_const_qual_mask(
                    &typed_nested_ptr_stale_quals_mem));
  ASSERT_EQ(2u, canonical_node_pointer_volatile_qual_mask(
                    &typed_nested_ptr_stale_quals_mem));
  ...
  psx_type_t *raw_nested_ptr_type = ps_type_wrap_pointer_levels(
      ps_type_new_integer(TK_INT, 4, 0), 3, 5u, 6u);
  ...
  ASSERT_EQ(1u, canonical_node_pointer_const_qual_mask(&typed_ptr_mem));
  ASSERT_EQ(1u, canonical_node_pointer_volatile_qual_mask(&typed_ptr_mem));
  ASSERT_EQ(8, canonical_node_base_deref_size(&typed_ptr_mem));
  ASSERT_EQ(16, canonical_node_ptr_array_pointee_bytes(&typed_ptr_mem));
  ASSERT_EQ(24, ps_node_vla_row_stride_frame_off(&typed_ptr_mem));
  int typed_inner_stride = 0;
  int typed_next_stride = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(&typed_ptr_mem,
                                               &typed_inner_stride,
                                               &typed_next_stride,
                                               NULL, NULL));
  ...
  int ptrarr2d_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(ptrarr2d_p_node,
                                               &ptrarr2d_inner,
                                               &ptrarr2d_next,
                                               NULL, NULL));
  ...
  int ptrarr3d_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(ptrarr3d_p_node,
                                               &ptrarr3d_inner,
                                               &ptrarr3d_next,
                                               NULL, NULL));
  ...
  ptrarr3d_inner = 0;
  ptrarr3d_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(ptrarr3d_array,
                                               &ptrarr3d_inner,
                                               &ptrarr3d_next,
                                               NULL, NULL));
  ASSERT_EQ(48, ptrarr3d_inner);
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(ptrarr2d_struct_array,
                                               &ptrarr2d_struct_inner,
                                               &ptrarr2d_struct_next,
                                               NULL, NULL));
  ASSERT_EQ(24, ptrarr2d_struct_inner);
  ASSERT_EQ(8, ptrarr2d_struct_next);
  ...
  int array3d_inner = 0;
  int array3d_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(array3d_addr,
                                               &array3d_inner,
                                               &array3d_next,
                                               NULL, NULL));
  ...
  array3d_inner = 0;
  array3d_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(array3d_row,
                                               &array3d_inner,
                                               &array3d_next,
                                               NULL, NULL));
  ASSERT_EQ(12, array3d_inner);
  ...
  int array2d_inner = 0;
  int array2d_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(array2d_node,
                                               &array2d_inner,
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(param_ptrarr3d_node,
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(param_ptrarr3d_row,
                                               &param_ptrarr3d_inner,
                                               &param_ptrarr3d_next,
                                               NULL, NULL));
  ASSERT_EQ(16, param_ptrarr3d_inner);
  ...
  param_ptrarr3d_inner = 0;
  param_ptrarr3d_next = 0;
  ASSERT_TRUE(!canonical_node_pointer_stride_metadata(param_ptrarr3d_cell_row,
                                                &param_ptrarr3d_inner,
                                                &param_ptrarr3d_next,
                                                NULL, NULL));
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(local_ptrarr3d_node,
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(local_ptrarr3d_row,
                                               &local_ptrarr3d_inner,
                                               &local_ptrarr3d_next,
                                               NULL, NULL));
  ASSERT_EQ(16, local_ptrarr3d_inner);
  ...
  int vla3d_inner = 0;
  int vla3d_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(vla3d_node,
                                               &vla3d_inner,
                                               &vla3d_next,
                                               NULL, NULL));
  ...
  vla3d_inner = 0;
  vla3d_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(vla3d_row,
                                               &vla3d_inner,
                                               &vla3d_next,
                                               NULL, NULL));
  ASSERT_EQ(4, vla3d_inner);
  int vla3d_type_inner = 0;
  int vla3d_type_next = 0;
  ASSERT_TRUE(ps_type_pointer_view_stride_metadata(
      ps_node_get_type(vla3d_row), &vla3d_type_inner,
      &vla3d_type_next, NULL, NULL));
  ...
  psx_type_t *declarator_func_params[] = {
      ps_type_new_integer(TK_INT, 4, 0)};
  psx_set_resolved_function_parameter_types(
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(vla_const_inner_node,
  ...
  ASSERT_TRUE(!canonical_node_pointer_stride_metadata(vla_const_inner_row,
                                                NULL, NULL, NULL, NULL));
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(ptrarr_ip_pia_node,
                                               &ptrarr_ip_inner,
                                               &ptrarr_ip_next,
                                               NULL, NULL));
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(param_ptrarr_ip_p_node,
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(param_ptrarr_ip2_p_node,
  ...
  ASSERT_TRUE(!canonical_node_pointer_stride_metadata(param_ptrarr_ip2_row1,
                                                &param_ptrarr_ip2_inner,
                                                &param_ptrarr_ip2_next,
                                                NULL, NULL));
  ASSERT_EQ(0, param_ptrarr_ip2_inner);
  ...
  int nested2_inner = 0;
  int nested2_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(nested2_rows_array,
                                               &nested2_inner,
                                               &nested2_next,
                                               NULL, NULL));
  ...
  nested2_inner = 0;
  nested2_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(nested2_rowptr,
                                               &nested2_inner,
                                               &nested2_next,
                                               NULL, NULL));
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(local_nested_rows_array,
                                               &local_nested_inner,
                                               &local_nested_next,
                                               NULL, NULL));
  ...
  canonical_node_pointer_stride_metadata(local_typedef_rowptr,
  ...
  canonical_node_pointer_stride_metadata(flat_rows_rowptr,
                                   &flat_rows_inner,
                                   &flat_rows_next,
                                   NULL, NULL);
  ...
  psx_type_t *typed_tag_array_deref_type =
  ...
  ASSERT_EQ(16, ps_type_sizeof(typed_tag_array_deref_type));
  ASSERT_EQ(4, ps_type_deref_size(typed_tag_array_deref_type));
  ...
  ASSERT_EQ(0u, canonical_node_pointer_const_qual_mask(&typed_const_view_mem));
  ASSERT_EQ(0u, canonical_node_pointer_volatile_qual_mask(&typed_const_view_mem));
  ...
  typed_ptr_canonical_self_const_mem.type =
      ps_type_new_pointer(ps_type_new_integer(TK_INT, 4, 0));
  typed_ptr_canonical_self_const_mem.type->is_const_qualified = 1;
  expect_const_assign_fail_for_node(
  ...
  psx_type_t *typed_funcptr_view_params[] = {typed_funcptr_view_param};
  ...
  const psx_type_t *typed_funcptr_view_function =
      ps_type_find_function(ps_node_get_type(&typed_funcptr_view_mem));
  ...
  psx_type_t *typed_funcptr_array_param =
      ps_type_new_float(TK_FLOAT_KIND_FLOAT, 4);
  psx_type_t *typed_funcptr_array_params[] = {typed_funcptr_array_param};
  ...
  node_t *typed_funcptr_array_elem_node = ps_node_new_subscript_deref_for(
      ...
      ps_node_new_num(0));
  psx_type_t *typed_funcptr_array_result_type =
  ...
  const psx_type_t *typed_funcptr_array_function =
      ps_type_find_function(typed_funcptr_array_result_type);
  ...
  ASSERT_EQ(0, ps_node_is_pointer(&typed_stmt_tag_ptr));
  ASSERT_EQ(0, ps_node_deref_size(&typed_stmt_tag_ptr));
  psx_frontend_analyze_expression(&typed_stmt_tag_ptr, NULL);
  ...
  ASSERT_EQ(16, canonical_node_base_deref_size(&typed_stmt_tag_ptr));
  psx_type_t *typed_stmt_tag_ptr_type =
  ...
  psx_frontend_analyze_expression(&typed_stmt_fp_ptr, NULL);
  ASSERT_EQ(TK_FLOAT_KIND_DOUBLE,
            canonical_node_pointee_fp_kind(&typed_stmt_fp_ptr));
  ...
  cached_add_ptr.type =
      ps_type_new_pointer(ps_type_new_integer(TK_INT, 4, 0));
  cached_add_ptr.type->is_const_qualified = 1;
  ASSERT_EQ(1, canonical_node_pointer_qual_levels(&cached_add_ptr));
  ASSERT_EQ(4, canonical_node_base_deref_size(&cached_add_ptr));
  ASSERT_EQ(1u, canonical_node_pointer_const_qual_mask(&cached_add_ptr));
  ASSERT_EQ(0u, canonical_node_pointer_volatile_qual_mask(&cached_add_ptr));
  ...
  cached_nested_ptr.type = ps_type_new_pointer(cached_nested_inner);
  cached_nested_ptr.type->is_const_qualified = 1;
  ASSERT_EQ(2, canonical_node_pointer_qual_levels(&cached_nested_ptr));
  ASSERT_EQ(3u, canonical_node_pointer_const_qual_mask(&cached_nested_ptr));
  ASSERT_EQ(2u, canonical_node_pointer_volatile_qual_mask(&cached_nested_ptr));
  ...
  psx_type_t *cached_tag_type = ps_node_get_type(&cached_tag_add);
  ...
  psx_type_t *typed_tag_ptr_type = ps_node_get_type(&typed_tag_mem);
  ...
  psx_type_t *typed_tag_ptr_cast_result_type =
  ...
  ASSERT_TRUE(ps_tag_member_at_flat_slot(TK_STRUCT, "FlatOut", 7, 3,
                                          &flat_slot_member, &flat_slot_ordinal));
  token_kind_t flat_slot_tag_kind = TK_EOF;
  ps_tag_member_decl_tag_identity(&flat_slot_member, &flat_slot_tag_kind,
                                   NULL, NULL, NULL);
  ASSERT_EQ(TK_UNION, flat_slot_tag_kind);
  ...
  ASSERT_TRUE(ps_type_complete_array(ps_gvar_get_decl_type(&tmp_arr_gv), 3));
  ...
  ASSERT_EQ(0u, canonical_node_pointer_const_qual_mask(tmp_gv_flat_ptr_mismatch_ref));
  ASSERT_EQ(0u, canonical_node_pointer_volatile_qual_mask(tmp_gv_flat_ptr_mismatch_ref));
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(tmp_gv_stale_array_addr,
  ...
  ASSERT_TRUE(ps_tag_member_is_unnamed_union(&tmp_member));
  ASSERT_TRUE(ps_tag_member_is_unnamed_aggregate(&tmp_member));
  tmp_member.decl_type = ps_type_new_pointer(tmp_member.decl_type);
  ASSERT_TRUE(!ps_tag_member_is_tag_aggregate(&tmp_member));
  ASSERT_TRUE(!ps_tag_member_is_unnamed_union(&tmp_member));
  ASSERT_TRUE(!ps_tag_member_is_unnamed_aggregate(&tmp_member));
  ...
  token_kind_t member_sync_kind = TK_EOF;
  char *member_sync_name = NULL;
  int member_sync_name_len = 0;
  int member_sync_is_pointer = 0;
  ps_tag_member_decl_tag_identity(
      &member_sync_out, &member_sync_kind, &member_sync_name,
      &member_sync_name_len, &member_sync_is_pointer);
  ASSERT_EQ(TK_EOF, member_sync_kind);
  ASSERT_TRUE(member_sync_name == NULL);
  ASSERT_EQ(0, member_sync_name_len);
  ASSERT_EQ(0, member_sync_is_pointer);
  ASSERT_EQ(0, ps_type_pointer_view_structural_qual_levels(
  ...
  const psx_type_t *ptrptr_ret_type =
      psx_ctx_get_function_ret_type("__tm_pp", 7);
  ...
  const psx_type_t *manual_ret_stored =
      psx_ctx_get_function_ret_type("__tm_manual_type", 16);
  ...
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(lvar_view_array_shape_addr,
  ...
  const psx_type_t *void_ptr_ret_type =
      psx_ctx_get_function_ret_type("get", 3);
  ...
  ASSERT_TRUE(ps_type_find_function(dp_info.decl_type) == NULL);
  ...
  const psx_type_t *partial_sig_node_function =
      ps_type_find_function(ps_node_get_type(partial_sig_node));
  ...
  ASSERT_TRUE(!ps_type_pointer_view_stride_metadata(
      member_plain_ptr_type, NULL, NULL, NULL, NULL));
  ...
  ASSERT_EQ(0, ps_type_pointer_view_structural_qual_levels(
                   member_plain_ptr_missing_base));
  ASSERT_TRUE(!ps_type_pointer_view_stride_metadata(
      member_plain_ptr_missing_base, NULL, NULL, NULL, NULL));
  ...
  ASSERT_TRUE(ps_type_find_function(dp_type) == NULL);
  ...
  ASSERT_TRUE(ps_type_find_function(gdp_type) == NULL);
  ...
  int gpia_inner = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(gpia_node, &gpia_inner,
                                               NULL, NULL, NULL));
  ...
  ASSERT_EQ(24, canonical_node_ptr_array_pointee_bytes(gap_node));
  ...
  node_t *gap_elem = ps_node_new_subscript_deref_for(
      ...
      ps_node_new_num(0));
  psx_type_t *gap_elem_type = ps_node_get_type(gap_elem);
  ...
  int gpi_next = 0;
  int gpi_extra[5] = {0};
  int gpi_extra_count = 0;
  ASSERT_TRUE(ps_type_pointer_view_stride_metadata(
      gpi_type, &gpi_inner, &gpi_next, gpi_extra, &gpi_extra_count));
  ...
  gpi_inner = 0;
  gpi_next = 0;
  ASSERT_TRUE(canonical_node_pointer_stride_metadata(gpi_outer_row, &gpi_inner,
                                               &gpi_next, NULL, NULL));
  ASSERT_EQ(16, gpi_inner);
  ASSERT_EQ(4, gpi_next);
...
static void test_translation_unit_reset_decl_locals_state() {
  ...
  char name[] = "x";
  ps_decl_reset_locals();
  ASSERT_TRUE(ps_decl_register_lvar(name, 1) != NULL);
...
static void test_multiple_funcdefs() {
  ...
  ASSERT_TRUE(parsed_code[0] != NULL);
  ASSERT_EQ(2, ps_type_pointer_depth(
                   psx_ctx_get_function_ret_type("sig_proto_pp", 12)));

  parsed_code = parse_program_input("int **sig_def_pp(void) { return 0; }");
  ASSERT_TRUE(parsed_code[0] != NULL);
  ASSERT_EQ(2, ps_type_pointer_depth(
                   psx_ctx_get_function_ret_type("sig_def_pp", 10)));

  parsed_code = parse_program_input(
      "int (*(*(*sig_deep(void))(int))(double))[3] { return 0; }");
  ASSERT_TRUE(parsed_code[0] != NULL);
  const psx_type_t *deep_return =
      psx_ctx_get_function_ret_type("sig_deep", 8);
  const psx_type_t *deep_int_function =
      ps_type_find_function(deep_return);
  ...
  const psx_type_t *deep_double_function =
      ps_type_find_function(deep_int_function->base);
