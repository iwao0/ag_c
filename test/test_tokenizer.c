...
static void test_tokenize() {
  ...
  tk_set_current_token(tk_tokenize(" 12 + 34 - 5 "));
  ...
  // 四則演算と括弧のテスト
  tk_set_current_token(tk_tokenize("1 * (2 / 3)"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ...
  // 比較演算子のテスト
  tk_set_current_token(tk_tokenize("1 == 2 != 3 <= 4 >= 5 < 6 > 7"));
  // 1
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ASSERT_EQ(1, as_num_i(tk_get_current_token())->val);
  tk_set_current_token(tk_get_current_token()->next);
...
static void test_tokenize_int_literals() {
  ...
  tk_set_current_token(tk_tokenize("0x2a 0X10 0b101 0B11 077 010 0 123 1u 2UL 3llu 0x1ffffffff"));
...
static void test_tokenize_len_guard_boundaries() {
  ...
  tk_set_max_token_len_for_test(8);
  tk_set_current_token(tk_tokenize("abcdefgh"));
...
static void test_tokenize_ident() {
  ...
  tk_set_current_token(tk_tokenize("a = 3; b = a;"));
  ...
  // 複数文字識別子
  tk_set_current_token(tk_tokenize("foo my_var x1"));
  ...
  // アンダースコアで始まる識別子
  tk_set_current_token(tk_tokenize("_start _a1"));
  ASSERT_EQ(TK_IDENT, tk_get_current_token()->kind); ASSERT_EQ(6, as_ident(tk_get_current_token())->len);
...
static void test_tokenize_keywords() {
  ...
  // 制御構文キーワード
  tk_set_current_token(tk_tokenize("if else while for return"));
  ...
  // 型キーワード
  tk_set_current_token(tk_tokenize("int char void short long float double signed unsigned"));
  ...
  // その他のキーワード
  tk_set_current_token(tk_tokenize(
  ...
  tk_set_current_token(tk_tokenize("iff int1 returns"));
  ASSERT_EQ(TK_IDENT, tk_get_current_token()->kind);
...
static void test_tokenize_punctuators() {
  ...
  tk_set_current_token(tk_tokenize("#include \"x.h\"\nint main() { return 0; }"));
...
static void test_tokenize_comments() {
  ...
  tk_set_current_token(tk_tokenize("1//comment\n2"));
  ...
  tk_set_current_token(tk_tokenize("1/* comment */2"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ASSERT_TRUE(!tk_get_current_token()->at_bol);
  tk_set_current_token(tk_get_current_token()->next);
  ...
  tk_set_current_token(tk_tokenize("1/*\n*/2"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ASSERT_TRUE(tk_get_current_token()->at_bol);
  tk_set_current_token(tk_get_current_token()->next);
...
static void test_tokenize_string() {
  ...
  tk_set_current_token(tk_tokenize("\"hello\""));
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind);
  ASSERT_EQ(5, as_string(tk_get_current_token())->len);
  ASSERT_TRUE(strncmp(as_string(tk_get_current_token())->str, "hello", 5) == 0);
  tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);
  ...
  tk_set_current_token(tk_tokenize("\"\""));
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind);
  ASSERT_EQ(0, as_string(tk_get_current_token())->len);
  tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);

  // 文字列と他のトークンの混在
  tk_set_current_token(tk_tokenize("char *s = \"AB\";"));
  ASSERT_EQ(TK_CHAR, tk_get_current_token()->kind);     tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_MUL, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_IDENT, tk_get_current_token()->kind);    tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_ASSIGN, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind);
  ASSERT_EQ(2, as_string(tk_get_current_token())->len);
  ASSERT_TRUE(strncmp(as_string(tk_get_current_token())->str, "AB", 2) == 0);
  tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_SEMI, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);

  // エスケープを含む文字列
  tk_set_current_token(tk_tokenize("\"a\\\"b\""));
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind);
  ASSERT_EQ(4, as_string(tk_get_current_token())->len);
  tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);
}
...
static void test_tokenize_float_literal() {
  ...
  tk_set_current_token(tk_tokenize("3.14 1.5f 2.0E-3 0x1.8p1 0x1p2f 4.0L 0x1p2L"));
...
static void test_consume() {
  printf("test_consume...\n");
  tk_set_current_token(tk_tokenize(" + 42 "));
...
static void test_consume_ident() {
  ...
  tk_set_current_token(tk_tokenize("foo 42"));
...
static void test_expect_number() {
  ...
  tk_set_current_token(tk_tokenize(" 999 "));
...
static void test_tokenize_char_literal() {
  ...
  tk_set_current_token(tk_tokenize("'A'"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ...
  tk_set_current_token(tk_tokenize("'\\0'"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ASSERT_EQ(0, as_num_i(tk_get_current_token())->val);
  tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);
  ...
  // マルチ文字文字定数（実装定義）
  tk_set_current_token(tk_tokenize("'ab'"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ...
  // 接頭辞付き文字定数
  tk_set_current_token(tk_tokenize("L'A' u'B' U'\\u00A9'"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ...
  tk_set_current_token(tk_tokenize("L'AB' u'CD' U'EF'"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ASSERT_EQ(((unsigned char)'A' << 8) | (unsigned char)'B', as_num_i(tk_get_current_token())->val);
  ASSERT_EQ(TK_CHAR_WIDTH_CHAR32, as_num_i(tk_get_current_token())->char_width);
  tk_set_current_token(tk_get_current_token()->next);
...
static void test_tokenize_string_prefixes_and_ucn() {
  ...
  tk_set_current_token(tk_tokenize("L\"wide\" u\"u16\" U\"u32\" u8\"utf8\" \"\\u00A9\""));
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind); ASSERT_EQ(4, as_string(tk_get_current_token())->len); ASSERT_EQ(TK_CHAR_WIDTH_CHAR32, as_string(tk_get_current_token())->char_width); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind); ASSERT_EQ(3, as_string(tk_get_current_token())->len); ASSERT_EQ(TK_CHAR_WIDTH_CHAR16, as_string(tk_get_current_token())->char_width); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind); ASSERT_EQ(3, as_string(tk_get_current_token())->len); ASSERT_EQ(TK_CHAR_WIDTH_CHAR32, as_string(tk_get_current_token())->char_width); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind); ASSERT_EQ(4, as_string(tk_get_current_token())->len); ASSERT_EQ(TK_CHAR_WIDTH_CHAR, as_string(tk_get_current_token())->char_width); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind); ASSERT_EQ(6, as_string(tk_get_current_token())->len); ASSERT_EQ(TK_CHAR_WIDTH_CHAR, as_string(tk_get_current_token())->char_width); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);
}

static void test_tokenize_ucn_ident_and_trigraph() {
  printf("test_tokenize_ucn_ident_and_trigraph...\n");
  tk_set_current_token(tk_tokenize("foo\\u00A9 = 1;"));
  ASSERT_EQ(TK_IDENT, tk_get_current_token()->kind);
  ...
  tk_set_current_token(tk_tokenize("?" "?=define X 1"));
  ASSERT_EQ(TK_HASH, tk_get_current_token()->kind);
  tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_IDENT, tk_get_current_token()->kind);
...
static void test_tokenize_evil_edge_cases() {
  ...
  // x+++y → x ++ + y
  tk_set_current_token(tk_tokenize("x+++y"));
  ASSERT_EQ(TK_IDENT, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_INC, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ...
  // 16進の境界値
  tk_set_current_token(tk_tokenize("0x0"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ASSERT_EQ(0, as_num_i(tk_get_current_token())->val);
  tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);

  tk_set_current_token(tk_tokenize("0xFFFFFFFF"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ...
  // 空白なしの連続演算
  tk_set_current_token(tk_tokenize("1+2*3-4/5%6"));
  ...
  // 文字列中の特殊文字の後にすぐトークン
  tk_set_current_token(tk_tokenize("\"abc\"+1"));
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_PLUS, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);
  ...
  // コメントの直後に演算子（空白なし）
  tk_set_current_token(tk_tokenize("1/**/+2"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind); ASSERT_EQ(1, as_num_i(tk_get_current_token())->val); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_PLUS, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind); ASSERT_EQ(2, as_num_i(tk_get_current_token())->val); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);
  ...
  // 文字リテラル直後に演算子
  tk_set_current_token(tk_tokenize("'a'+1"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_PLUS, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);
  ...
  // 文字列直後にセミコロン
  tk_set_current_token(tk_tokenize("\"abc\";"));
  ASSERT_EQ(TK_STRING, tk_get_current_token()->kind);
  ASSERT_EQ(3, as_string(tk_get_current_token())->len);
  tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_SEMI, tk_get_current_token()->kind); tk_set_current_token(tk_get_current_token()->next);
  ASSERT_EQ(TK_EOF, tk_get_current_token()->kind);
...
static void test_strict_c11_mode() {
  ...
  tk_set_current_token(tk_tokenize("0b101"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ASSERT_EQ(5, as_num_i(tk_get_current_token())->val);
...
static void test_runtime_mode_switch_boundaries() {
  ...
  tk_set_current_token(tk_tokenize("0b11"));
  ASSERT_EQ(TK_NUM, tk_get_current_token()->kind);
  ASSERT_EQ(3, as_num_i(tk_get_current_token())->val);
