...
static const char local_record_static_assert_hover_source[] =
    "typedef int FileRecordAssertType;\n"
...
static const char same_typedef_declarator_hover_source[] =
    ...
    "FirstFileAtomicPointerAlias;\n"
    "typedef _Atomic(const FirstFileAtomicBase *) "
    "FirstFileAtomicConstPointerAlias;\n"
    "typedef _Atomic(FirstFileAtomicBase **) "
    "FirstFileAtomicDoublePointerAlias;\n"
    "typedef _Atomic(FirstFileAtomicBase * /* pointer gap */) "
    "FirstFileAtomicPointerCommentAlias;\n"
    "typedef _Atomic(FirstFileAtomicBase *\\\n"
    ") FirstFileAtomicPointerSpliceAlias;\n"
    "typedef _Atomic(FirstFileAtomicBase * const *) "
    "FirstFileAtomicInnerConstAlias;\n"
    "typedef _Atomic(const FirstFileAtomicBase * volatile *) "
    "FirstFileAtomicQualifiedChainAlias;\n"
    "typedef _Atomic(FirstFileAtomicBase * restrict * "
    "/* qualified gap */) FirstFileAtomicRestrictChainAlias;\n"
    "typedef _Atomic(FirstFileAtomicBase * const *\\\n"
    ...
    "typedef int ExternObjectParenthesizedOuterConstDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerConstDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedDoublePointerConstCommentType;\n"
    "typedef int ExternObjectParenthesizedDoublePointerConstSpliceType;\n"
    "typedef int ExternObjectParenthesizedOuterVolatileDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerVolatileDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedDoublePointerVolatileCommentType;\n"
    "typedef int ExternObjectParenthesizedDoublePointerVolatileSpliceType;\n"
    "typedef int ExternObjectParenthesizedOuterRestrictDoublePointerType;\n"
    ...
    "typedef int ExternObjectParenthesizedConstRestrictDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedRestrictConstDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedVolatileRestrictDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedRestrictVolatileDoublePointerType;\n"
    ...
    "typedef int ExternObjectParenthesizedOuterConstRestrictListDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerConstRestrictListDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterRestrictConstListDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerRestrictConstListDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType;\n"
    "typedef int ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType;\n"
    "typedef int ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType;\n"
    ...
    "typedef int ExternObjectParenthesizedOuterRepeatedConstDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerRepeatedConstDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedBothRepeatedCvrDoublePointerType;\n"
    "typedef int ExternObjectParenthesizedOuterFourConstDoublePointerType;\n"
    ...
    "  typedef _Atomic(FirstBlockAtomicBase *) "
    "FirstBlockAtomicPointerAlias;\n"
    "  typedef _Atomic(FirstBlockAtomicBase * const *) "
    "FirstBlockAtomicQualifiedAlias;\n"
    ...
    "  { extern ExternObjectParenthesizedAtomicPointerType "
    "(* _Atomic ExternObjectParenthesizedAtomicPointerType); }\n"
    "  { extern ExternObjectParenthesizedAtomicCommentType "
    "(* /* before atomic */ _Atomic /* after atomic */ "
    "ExternObjectParenthesizedAtomicCommentType); }\n"
    "  { extern ExternObjectParenthesizedAtomicSpliceType "
    "(* _Atomic \\\n"
    "ExternObjectParenthesizedAtomicSpliceType); }\n"
    "  { extern ExternObjectParenthesizedConstAtomicPointerType "
    "(* const _Atomic ExternObjectParenthesizedConstAtomicPointerType); }\n"
    "  { extern ExternObjectParenthesizedAtomicConstPointerType "
    "(* _Atomic const ExternObjectParenthesizedAtomicConstPointerType); }\n"
    "  { extern ExternObjectParenthesizedAtomicQualifierChainType "
    "(* volatile _Atomic const "
    "ExternObjectParenthesizedAtomicQualifierChainType); }\n"
    "  { extern ExternObjectParenthesizedAtomicQualifierCommentType "
    "(* const /* before atomic */ _Atomic /* after atomic */ volatile "
    "ExternObjectParenthesizedAtomicQualifierCommentType); }\n"
    "  { extern ExternObjectParenthesizedAtomicQualifierSpliceType "
    "(* const \\\n"
    "_Atomic volatile "
    "ExternObjectParenthesizedAtomicQualifierSpliceType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerType "
    "(**ExternObjectParenthesizedDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerCommentType "
    "(* /* between pointers */ * "
    "ExternObjectParenthesizedDoublePointerCommentType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerSpliceType "
    "(*\\\n"
    "*ExternObjectParenthesizedDoublePointerSpliceType); }\n"
    "  { extern ExternObjectParenthesizedOuterConstDoublePointerType "
    "(* const *ExternObjectParenthesizedOuterConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerConstDoublePointerType "
    "(** const ExternObjectParenthesizedInnerConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerConstCommentType "
    "(* /* before const */ const /* between pointers */ * "
    "ExternObjectParenthesizedDoublePointerConstCommentType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerConstSpliceType "
    "(** \\\n"
    "const ExternObjectParenthesizedDoublePointerConstSpliceType); }\n"
    "  { extern ExternObjectParenthesizedOuterVolatileDoublePointerType "
    "(* volatile *ExternObjectParenthesizedOuterVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerVolatileDoublePointerType "
    "(** volatile ExternObjectParenthesizedInnerVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerVolatileCommentType "
    "(* /* before volatile */ volatile /* between pointers */ * "
    "ExternObjectParenthesizedDoublePointerVolatileCommentType); }\n"
    ...
    "  { extern ExternObjectParenthesizedOuterRestrictDoublePointerType "
    "(* restrict *ExternObjectParenthesizedOuterRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerRestrictDoublePointerType "
    "(** restrict ExternObjectParenthesizedInnerRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerRestrictCommentType "
    "(* /* before restrict */ restrict /* between pointers */ * "
    "ExternObjectParenthesizedDoublePointerRestrictCommentType); }\n"
    ...
    "  { extern ExternObjectParenthesizedConstRestrictDoublePointerType "
    "(* const * restrict "
    "ExternObjectParenthesizedConstRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedRestrictConstDoublePointerType "
    "(* restrict * const "
    "ExternObjectParenthesizedRestrictConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedVolatileRestrictDoublePointerType "
    "(* volatile * restrict "
    "ExternObjectParenthesizedVolatileRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedRestrictVolatileDoublePointerType "
    "(* restrict * volatile "
    "ExternObjectParenthesizedRestrictVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedBothRestrictDoublePointerType "
    "(* restrict * restrict "
    "ExternObjectParenthesizedBothRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerDualCvrCommentType "
    "(* restrict /* between pointers */ * /* before second qualifier */ "
    "restrict ExternObjectParenthesizedDoublePointerDualCvrCommentType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerDualCvrSpliceType "
    "(* volatile * \\\n"
    "restrict ExternObjectParenthesizedDoublePointerDualCvrSpliceType); }\n"
    "  { extern ExternObjectParenthesizedOuterConstVolatileDoublePointerType "
    "(* const volatile *"
    "ExternObjectParenthesizedOuterConstVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerConstVolatileDoublePointerType "
    "(** const volatile "
    "ExternObjectParenthesizedInnerConstVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterVolatileConstDoublePointerType "
    "(* volatile const *"
    "ExternObjectParenthesizedOuterVolatileConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerVolatileConstDoublePointerType "
    "(** volatile const "
    "ExternObjectParenthesizedInnerVolatileConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerSingleLevelCvCommentType "
    "(* const /* between qualifiers */ volatile /* before pointer */ * "
    "ExternObjectParenthesizedDoublePointerSingleLevelCvCommentType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerSingleLevelCvSpliceType "
    "(** volatile \\\n"
    "const ExternObjectParenthesizedDoublePointerSingleLevelCvSpliceType); }\n"
    "  { extern ExternObjectParenthesizedOuterConstRestrictListDoublePointerType "
    "(* const restrict *"
    "ExternObjectParenthesizedOuterConstRestrictListDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerConstRestrictListDoublePointerType "
    "(** const restrict "
    "ExternObjectParenthesizedInnerConstRestrictListDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterRestrictConstListDoublePointerType "
    "(* restrict const *"
    "ExternObjectParenthesizedOuterRestrictConstListDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerRestrictConstListDoublePointerType "
    "(** restrict const "
    "ExternObjectParenthesizedInnerRestrictConstListDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType "
    "(* volatile restrict *"
    "ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType "
    "(** volatile restrict "
    "ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType "
    "(* restrict volatile *"
    "ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType "
    "(** restrict volatile "
    "ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType "
    "(* restrict /* between qualifiers */ volatile /* before pointer */ * "
    "ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType "
    "(** const \\\n"
    "restrict ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType); }\n"
    "  { extern ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType "
    "(* const volatile restrict *"
    "ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType "
    "(** const volatile restrict "
    "ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType "
    "(* const restrict volatile *"
    "ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType "
    "(** const restrict volatile "
    "ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType "
    "(* volatile const restrict *"
    "ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType "
    "(** volatile const restrict "
    "ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType "
    "(* volatile restrict const *"
    "ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType "
    "(** volatile restrict const "
    "ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType "
    "(* restrict const volatile *"
    "ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType "
    "(** restrict const volatile "
    "ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType "
    "(* restrict volatile const *"
    "ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerRestrictVolatileConstDoublePointerType "
    "(** restrict volatile const "
    "ExternObjectParenthesizedInnerRestrictVolatileConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerSingleLevelAllCvrCommentType "
    "(* const /* first gap */ volatile /* second gap */ restrict * "
    "ExternObjectParenthesizedDoublePointerSingleLevelAllCvrCommentType); }\n"
    ...
    "  { extern ExternObjectParenthesizedOuterRepeatedConstDoublePointerType "
    "(* const const *ExternObjectParenthesizedOuterRepeatedConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerRepeatedConstDoublePointerType "
    "(** const const ExternObjectParenthesizedInnerRepeatedConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType "
    "(* volatile volatile *ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType "
    "(** volatile volatile ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType "
    "(* restrict restrict *ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType "
    "(** restrict restrict ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType "
    "(* const volatile const *ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType "
    "(** restrict const restrict ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedBothRepeatedCvrDoublePointerType "
    "(* const const * volatile volatile ExternObjectParenthesizedBothRepeatedCvrDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterFourConstDoublePointerType "
    "(* const const const const *ExternObjectParenthesizedOuterFourConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedBothAllRepeatedCvrDoublePointerType "
    "(* const volatile restrict const volatile restrict * restrict const volatile restrict const volatile "
    "ExternObjectParenthesizedBothAllRepeatedCvrDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerRepeatedCvrCommentType "
    "(* const /* duplicate outer */ const * volatile /* duplicate inner */ volatile "
    "ExternObjectParenthesizedDoublePointerRepeatedCvrCommentType); }\n"
    "  { extern ExternObjectParenthesizedDoublePointerRepeatedCvrSpliceType "
    "(* restrict \\\nrestrict * const \\\nconst "
    "ExternObjectParenthesizedDoublePointerRepeatedCvrSpliceType); }\n"
    "  { extern ExternObjectParenthesizedRepeatedAtomicPointerType "
    "(* _Atomic _Atomic ExternObjectParenthesizedRepeatedAtomicPointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterAtomicDoublePointerType "
    "(* _Atomic *ExternObjectParenthesizedOuterAtomicDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerAtomicDoublePointerType "
    "(** _Atomic ExternObjectParenthesizedInnerAtomicDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedBothAtomicDoublePointerType "
    "(* _Atomic * _Atomic ExternObjectParenthesizedBothAtomicDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterConstAtomicDoublePointerType "
    "(* const _Atomic *ExternObjectParenthesizedOuterConstAtomicDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterAtomicConstDoublePointerType "
    "(* _Atomic const *ExternObjectParenthesizedOuterAtomicConstDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerVolatileAtomicDoublePointerType "
    "(** volatile _Atomic ExternObjectParenthesizedInnerVolatileAtomicDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerAtomicVolatileDoublePointerType "
    "(** _Atomic volatile ExternObjectParenthesizedInnerAtomicVolatileDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterAtomicInnerCvrDoublePointerType "
    "(* _Atomic * const volatile restrict "
    "ExternObjectParenthesizedOuterAtomicInnerCvrDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterCvrInnerAtomicDoublePointerType "
    "(* const volatile restrict * _Atomic "
    "ExternObjectParenthesizedOuterCvrInnerAtomicDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedBothAtomicCvDoublePointerType "
    "(* const _Atomic volatile * volatile _Atomic const "
    "ExternObjectParenthesizedBothAtomicCvDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedOuterRepeatedAtomicDoublePointerType "
    "(* _Atomic _Atomic *ExternObjectParenthesizedOuterRepeatedAtomicDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedInnerRepeatedAtomicDoublePointerType "
    "(** _Atomic _Atomic ExternObjectParenthesizedInnerRepeatedAtomicDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedBothRepeatedAtomicDoublePointerType "
    "(* _Atomic _Atomic * _Atomic _Atomic "
    "ExternObjectParenthesizedBothRepeatedAtomicDoublePointerType); }\n"
    "  { extern ExternObjectParenthesizedAtomicDoublePointerCommentType "
    "(* /* outer */ _Atomic * const /* inner */ _Atomic "
    "ExternObjectParenthesizedAtomicDoublePointerCommentType); }\n"
    "  { extern ExternObjectParenthesizedAtomicDoublePointerSpliceType "
    "(* _Atomic \\\n* volatile \\\n_Atomic "
    "ExternObjectParenthesizedAtomicDoublePointerSpliceType); }\n"
    ...
    "typedef _Atomic(FirstBlockAtomicPointerShadow *) "
    "FirstBlockAtomicPointerShadow; "
    "typedef _Atomic(FirstBlockAtomicQualifiedShadow * const *) "
...
static const char
    same_block_parenthesized_atomic_extern_typedef_conflict_source[] =
...
static const char
    same_block_parenthesized_atomic_qualified_extern_typedef_conflict_source[] =
...
static const char
    same_block_parenthesized_double_pointer_extern_typedef_conflict_source[] =
...
static const char
    ...
    "int same_block_parenthesized_const_double_pointer_extern_typedef_conflict(void) {\n"
    "  typedef int SameBlockParenthesizedConstDoublePointerExternType;\n"
    "  extern SameBlockParenthesizedConstDoublePointerExternType "
    "(* const *SameBlockParenthesizedConstDoublePointerExternType);\n"
    "  return 0;\n"
    "}\n";

static const char
    same_block_parenthesized_volatile_double_pointer_extern_typedef_conflict_source[] =
    "int same_block_parenthesized_volatile_double_pointer_extern_typedef_conflict(void) {\n"
    "  typedef int SameBlockParenthesizedVolatileDoublePointerExternType;\n"
    "  extern SameBlockParenthesizedVolatileDoublePointerExternType "
    "(* volatile *SameBlockParenthesizedVolatileDoublePointerExternType);\n"
    "  return 0;\n"
    "}\n";

static const char
    same_block_parenthesized_restrict_double_pointer_extern_typedef_conflict_source[] =
    "int same_block_parenthesized_restrict_double_pointer_extern_typedef_conflict(void) {\n"
...
static const char
    same_block_parenthesized_dual_cvr_double_pointer_extern_typedef_conflict_source[] =
    "int same_block_parenthesized_dual_cvr_double_pointer_extern_typedef_conflict(void) {\n"
    "  typedef int SameBlockParenthesizedDualCvrDoublePointerExternType;\n"
    "  extern SameBlockParenthesizedDualCvrDoublePointerExternType "
    "(* const * restrict SameBlockParenthesizedDualCvrDoublePointerExternType);\n"
    "  return 0;\n"
    "}\n";
...
static const char
    ...
    "int same_block_parenthesized_single_level_cvr_double_pointer_extern_typedef_conflict(void) {\n"
    "  typedef int SameBlockParenthesizedSingleLevelCvrDoublePointerExternType;\n"
    "  extern SameBlockParenthesizedSingleLevelCvrDoublePointerExternType "
    "(* const restrict *SameBlockParenthesizedSingleLevelCvrDoublePointerExternType);\n"
    "  return 0;\n"
    "}\n";

static const char
    same_block_parenthesized_single_level_all_cvr_double_pointer_extern_typedef_conflict_source[] =
    "int same_block_parenthesized_single_level_all_cvr_double_pointer_extern_typedef_conflict(void) {\n"
...
static const char
    same_block_parenthesized_repeated_cvr_double_pointer_extern_typedef_conflict_source[] =
    "int same_block_parenthesized_repeated_cvr_double_pointer_extern_typedef_conflict(void) {\n"
    "  typedef int SameBlockParenthesizedRepeatedCvrDoublePointerExternType;\n"
    "  extern SameBlockParenthesizedRepeatedCvrDoublePointerExternType "
    "(* const const * volatile volatile SameBlockParenthesizedRepeatedCvrDoublePointerExternType);\n"
    "  return 0;\n"
    "}\n";

static const char
    same_block_parenthesized_atomic_double_pointer_extern_typedef_conflict_source[] =
...
static const char atomic_restrict_parenthesized_extern_typedef_source[] =
    "typedef int AtomicRestrictParenthesizedType;\n"
    "int probe(void) {\n"
...
static const char
    outer_atomic_restrict_double_pointer_extern_typedef_source[] =
    "typedef int OuterAtomicRestrictDoublePointerType;\n"
    "int probe(void) {\n"
...
static const char
    inner_atomic_restrict_double_pointer_extern_typedef_source[] =
    "typedef int InnerAtomicRestrictDoublePointerType;\n"
    "int probe(void) {\n"
...
static int print_local_record_static_assert_hover_parity_snapshot(
    const char *cursor_text) {
  char *end = NULL;
  unsigned long long parsed_cursor = strtoull(cursor_text, &end, 10);
  size_t source_length = strlen(local_record_static_assert_hover_source);
  if (!cursor_text[0] || !end || *end != '\0' ||
      parsed_cursor > (unsigned long long)source_length)
    return 1;
  return print_macro_definition_source_snapshot(
      "local-record-static-assert-hover.c",
      local_record_static_assert_hover_source,
      (size_t)parsed_cursor, (header_bundle_t){0});
}
...
static int print_extern_typedef_shadow_conflict_parity_snapshot(
  ...
  static const char *source_names[] = {
      ...
      "same-block-parenthesized-atomic-extern-typedef-conflict.c",
      "same-block-parenthesized-atomic-qualified-extern-typedef-conflict.c",
      "same-block-parenthesized-double-pointer-extern-typedef-conflict.c",
      ...
      "same-block-parenthesized-dual-cvr-double-pointer-extern-typedef-conflict.c",
      ...
      "same-block-parenthesized-repeated-cvr-double-pointer-extern-typedef-conflict.c",
      "same-block-parenthesized-atomic-double-pointer-extern-typedef-conflict.c",
  };
  char *variant_end = NULL;
...
static int print_extern_typedef_semantic_type_parity_snapshot(
  ...
  static const char *sources[] = {
      ...
      atomic_restrict_parenthesized_extern_typedef_source,
      outer_atomic_restrict_double_pointer_extern_typedef_source,
      inner_atomic_restrict_double_pointer_extern_typedef_source,
  };
  static const char *source_names[] = {
      ...
      "atomic-restrict-parenthesized-extern-typedef.c",
      "outer-atomic-restrict-double-pointer-extern-typedef.c",
      "inner-atomic-restrict-double-pointer-extern-typedef.c",
  };
  char *variant_end = NULL;
  unsigned long variant = strtoul(variant_text, &variant_end, 10);
  char *end = NULL;
...
static int test_same_typedef_declarator_hover(ag_target_info_t target) {
  static const struct {
    ...
    int check_boundaries;
      ...
      {"typedef _Atomic(FirstFileAtomicBase *) "
       "FirstFileAtomicPointerAlias",
       "FirstFileAtomicBase", "FirstFileAtomicPointerAlias", NULL, 0, 1},
      {"typedef _Atomic(const FirstFileAtomicBase *) "
       "FirstFileAtomicConstPointerAlias",
       "FirstFileAtomicBase", "FirstFileAtomicConstPointerAlias", NULL, 0,
       0},
      {"typedef _Atomic(FirstFileAtomicBase **) "
       "FirstFileAtomicDoublePointerAlias",
       "FirstFileAtomicBase", "FirstFileAtomicDoublePointerAlias", NULL, 0,
       0},
      {"typedef _Atomic(FirstFileAtomicBase * /* pointer gap */) "
       "FirstFileAtomicPointerCommentAlias",
       "FirstFileAtomicBase", "FirstFileAtomicPointerCommentAlias", NULL,
       0, 0},
      {"typedef _Atomic(FirstFileAtomicBase *\\\n) "
       "FirstFileAtomicPointerSpliceAlias",
       "FirstFileAtomicBase", "FirstFileAtomicPointerSpliceAlias", NULL, 0,
       0},
      {"typedef _Atomic(FirstBlockAtomicBase *) "
       "FirstBlockAtomicPointerAlias",
       "FirstBlockAtomicBase", "FirstBlockAtomicPointerAlias", NULL, 1, 0},
      {"typedef _Atomic(FirstFileAtomicBase * const *) "
       "FirstFileAtomicInnerConstAlias",
       "FirstFileAtomicBase", "FirstFileAtomicInnerConstAlias", NULL, 0, 1},
      {"typedef _Atomic(const FirstFileAtomicBase * volatile *) "
       "FirstFileAtomicQualifiedChainAlias",
       "FirstFileAtomicBase", "FirstFileAtomicQualifiedChainAlias", NULL, 0,
       0},
      {"typedef _Atomic(FirstFileAtomicBase * restrict * "
       "/* qualified gap */) FirstFileAtomicRestrictChainAlias",
       "FirstFileAtomicBase", "FirstFileAtomicRestrictChainAlias", NULL, 0,
       0},
      {"typedef _Atomic(FirstFileAtomicBase * const *\\\n) "
       "FirstFileAtomicQualifiedSpliceAlias",
       "FirstFileAtomicBase", "FirstFileAtomicQualifiedSpliceAlias", NULL,
       0, 0},
      {"typedef _Atomic(FirstBlockAtomicBase * const *) "
       "FirstBlockAtomicQualifiedAlias",
       "FirstBlockAtomicBase", "FirstBlockAtomicQualifiedAlias", NULL, 1,
       0},
  };
  ag_compilation_session_t *session = ag_compilation_session_create(&target);
  ...
  static const struct {
    ...
    int use_first_occurrence;
      ...
      {"typedef _Atomic(FirstBlockAtomicPointerShadow *) "
       "FirstBlockAtomicPointerShadow",
       "FirstBlockAtomicPointerShadow", 0},
      {"typedef _Atomic(FirstBlockAtomicQualifiedShadow * const *) "
       "FirstBlockAtomicQualifiedShadow",
       "FirstBlockAtomicQualifiedShadow", 0},
  };
  ...
  static const struct {
    ...
    int check_boundaries;
      ...
      {"extern ExternObjectParenthesizedAtomicPointerType "
       "(* _Atomic ExternObjectParenthesizedAtomicPointerType)",
       "ExternObjectParenthesizedAtomicPointerType", 1},
      {"extern ExternObjectParenthesizedAtomicCommentType "
       "(* /* before atomic */ _Atomic /* after atomic */ "
       "ExternObjectParenthesizedAtomicCommentType)",
       "ExternObjectParenthesizedAtomicCommentType", 0},
      {"extern ExternObjectParenthesizedAtomicSpliceType "
       "(* _Atomic \\\nExternObjectParenthesizedAtomicSpliceType)",
       "ExternObjectParenthesizedAtomicSpliceType", 1},
      {"extern ExternObjectParenthesizedConstAtomicPointerType "
       "(* const _Atomic ExternObjectParenthesizedConstAtomicPointerType)",
       "ExternObjectParenthesizedConstAtomicPointerType", 1},
      {"extern ExternObjectParenthesizedAtomicConstPointerType "
       "(* _Atomic const ExternObjectParenthesizedAtomicConstPointerType)",
       "ExternObjectParenthesizedAtomicConstPointerType", 1},
      {"extern ExternObjectParenthesizedAtomicQualifierChainType "
       "(* volatile _Atomic const "
       "ExternObjectParenthesizedAtomicQualifierChainType)",
       "ExternObjectParenthesizedAtomicQualifierChainType", 0},
      {"extern ExternObjectParenthesizedAtomicQualifierCommentType "
       "(* const /* before atomic */ _Atomic /* after atomic */ volatile "
       "ExternObjectParenthesizedAtomicQualifierCommentType)",
       "ExternObjectParenthesizedAtomicQualifierCommentType", 0},
      {"extern ExternObjectParenthesizedAtomicQualifierSpliceType "
       "(* const \\\n_Atomic volatile "
       "ExternObjectParenthesizedAtomicQualifierSpliceType)",
       "ExternObjectParenthesizedAtomicQualifierSpliceType", 1},
      {"extern ExternObjectParenthesizedDoublePointerType "
       "(**ExternObjectParenthesizedDoublePointerType)",
       "ExternObjectParenthesizedDoublePointerType", 1},
      {"extern ExternObjectParenthesizedDoublePointerCommentType "
       "(* /* between pointers */ * "
       "ExternObjectParenthesizedDoublePointerCommentType)",
       "ExternObjectParenthesizedDoublePointerCommentType", 0},
      {"extern ExternObjectParenthesizedDoublePointerSpliceType "
       "(*\\\n*ExternObjectParenthesizedDoublePointerSpliceType)",
       "ExternObjectParenthesizedDoublePointerSpliceType", 1},
      {"extern ExternObjectParenthesizedOuterConstDoublePointerType "
       "(* const *ExternObjectParenthesizedOuterConstDoublePointerType)",
       "ExternObjectParenthesizedOuterConstDoublePointerType", 1},
      {"extern ExternObjectParenthesizedInnerConstDoublePointerType "
       "(** const ExternObjectParenthesizedInnerConstDoublePointerType)",
       "ExternObjectParenthesizedInnerConstDoublePointerType", 1},
      {"extern ExternObjectParenthesizedDoublePointerConstCommentType "
       "(* /* before const */ const /* between pointers */ * "
       "ExternObjectParenthesizedDoublePointerConstCommentType)",
       "ExternObjectParenthesizedDoublePointerConstCommentType", 0},
      {"extern ExternObjectParenthesizedDoublePointerConstSpliceType "
       "(** \\\nconst ExternObjectParenthesizedDoublePointerConstSpliceType)",
       "ExternObjectParenthesizedDoublePointerConstSpliceType", 1},
      {"extern ExternObjectParenthesizedOuterVolatileDoublePointerType "
       "(* volatile *"
       "ExternObjectParenthesizedOuterVolatileDoublePointerType)",
       "ExternObjectParenthesizedOuterVolatileDoublePointerType", 1},
      {"extern ExternObjectParenthesizedInnerVolatileDoublePointerType "
       "(** volatile "
       "ExternObjectParenthesizedInnerVolatileDoublePointerType)",
       "ExternObjectParenthesizedInnerVolatileDoublePointerType", 1},
      {"extern ExternObjectParenthesizedDoublePointerVolatileCommentType "
       "(* /* before volatile */ volatile /* between pointers */ * "
       "ExternObjectParenthesizedDoublePointerVolatileCommentType)",
       "ExternObjectParenthesizedDoublePointerVolatileCommentType", 0},
      {"extern ExternObjectParenthesizedDoublePointerVolatileSpliceType "
       "(** \\\nvolatile "
       "ExternObjectParenthesizedDoublePointerVolatileSpliceType)",
       "ExternObjectParenthesizedDoublePointerVolatileSpliceType", 1},
      {"extern ExternObjectParenthesizedOuterRestrictDoublePointerType "
       "(* restrict *"
       "ExternObjectParenthesizedOuterRestrictDoublePointerType)",
       "ExternObjectParenthesizedOuterRestrictDoublePointerType", 1},
      {"extern ExternObjectParenthesizedInnerRestrictDoublePointerType "
       "(** restrict "
       "ExternObjectParenthesizedInnerRestrictDoublePointerType)",
       "ExternObjectParenthesizedInnerRestrictDoublePointerType", 1},
      {"extern ExternObjectParenthesizedDoublePointerRestrictCommentType "
       "(* /* before restrict */ restrict /* between pointers */ * "
       "ExternObjectParenthesizedDoublePointerRestrictCommentType)",
       "ExternObjectParenthesizedDoublePointerRestrictCommentType", 0},
      {"extern ExternObjectParenthesizedDoublePointerRestrictSpliceType "
       "(** \\\nrestrict "
      ...
      {"extern ExternObjectParenthesizedConstRestrictDoublePointerType "
       "(* const * restrict "
       "ExternObjectParenthesizedConstRestrictDoublePointerType)",
       "ExternObjectParenthesizedConstRestrictDoublePointerType", 1},
      {"extern ExternObjectParenthesizedRestrictConstDoublePointerType "
       "(* restrict * const "
       "ExternObjectParenthesizedRestrictConstDoublePointerType)",
       "ExternObjectParenthesizedRestrictConstDoublePointerType", 0},
      {"extern ExternObjectParenthesizedVolatileRestrictDoublePointerType "
       "(* volatile * restrict "
       "ExternObjectParenthesizedVolatileRestrictDoublePointerType)",
       "ExternObjectParenthesizedVolatileRestrictDoublePointerType", 0},
      {"extern ExternObjectParenthesizedRestrictVolatileDoublePointerType "
       "(* restrict * volatile "
       "ExternObjectParenthesizedRestrictVolatileDoublePointerType)",
       "ExternObjectParenthesizedRestrictVolatileDoublePointerType", 0},
      {"extern ExternObjectParenthesizedBothRestrictDoublePointerType "
       "(* restrict * restrict "
       "ExternObjectParenthesizedBothRestrictDoublePointerType)",
       "ExternObjectParenthesizedBothRestrictDoublePointerType", 0},
      {"extern ExternObjectParenthesizedDoublePointerDualCvrCommentType "
       "(* restrict /* between pointers */ * "
       "/* before second qualifier */ restrict "
       "ExternObjectParenthesizedDoublePointerDualCvrCommentType)",
       "ExternObjectParenthesizedDoublePointerDualCvrCommentType", 0},
      {"extern ExternObjectParenthesizedDoublePointerDualCvrSpliceType "
       "(* volatile * \\\nrestrict "
       "ExternObjectParenthesizedDoublePointerDualCvrSpliceType)",
       "ExternObjectParenthesizedDoublePointerDualCvrSpliceType", 1},
      {"extern ExternObjectParenthesizedOuterConstVolatileDoublePointerType "
       "(* const volatile *"
       "ExternObjectParenthesizedOuterConstVolatileDoublePointerType)",
       "ExternObjectParenthesizedOuterConstVolatileDoublePointerType", 1},
      {"extern ExternObjectParenthesizedInnerConstVolatileDoublePointerType "
       "(** const volatile "
       "ExternObjectParenthesizedInnerConstVolatileDoublePointerType)",
       "ExternObjectParenthesizedInnerConstVolatileDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterVolatileConstDoublePointerType "
       "(* volatile const *"
       "ExternObjectParenthesizedOuterVolatileConstDoublePointerType)",
       "ExternObjectParenthesizedOuterVolatileConstDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerVolatileConstDoublePointerType "
       "(** volatile const "
       "ExternObjectParenthesizedInnerVolatileConstDoublePointerType)",
       "ExternObjectParenthesizedInnerVolatileConstDoublePointerType", 0},
      {"extern ExternObjectParenthesizedDoublePointerSingleLevelCvCommentType "
       "(* const /* between qualifiers */ volatile "
       "/* before pointer */ * "
       "ExternObjectParenthesizedDoublePointerSingleLevelCvCommentType)",
       "ExternObjectParenthesizedDoublePointerSingleLevelCvCommentType", 0},
      {"extern ExternObjectParenthesizedDoublePointerSingleLevelCvSpliceType "
       "(** volatile \\\nconst "
       "ExternObjectParenthesizedDoublePointerSingleLevelCvSpliceType)",
       "ExternObjectParenthesizedDoublePointerSingleLevelCvSpliceType", 1},
      {"extern ExternObjectParenthesizedOuterConstRestrictListDoublePointerType "
       "(* const restrict *"
       "ExternObjectParenthesizedOuterConstRestrictListDoublePointerType)",
       "ExternObjectParenthesizedOuterConstRestrictListDoublePointerType", 1},
      {"extern ExternObjectParenthesizedInnerConstRestrictListDoublePointerType "
       "(** const restrict "
       "ExternObjectParenthesizedInnerConstRestrictListDoublePointerType)",
       "ExternObjectParenthesizedInnerConstRestrictListDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterRestrictConstListDoublePointerType "
       "(* restrict const *"
       "ExternObjectParenthesizedOuterRestrictConstListDoublePointerType)",
       "ExternObjectParenthesizedOuterRestrictConstListDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerRestrictConstListDoublePointerType "
       "(** restrict const "
       "ExternObjectParenthesizedInnerRestrictConstListDoublePointerType)",
       "ExternObjectParenthesizedInnerRestrictConstListDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType "
       "(* volatile restrict *"
       "ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType)",
       "ExternObjectParenthesizedOuterVolatileRestrictListDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType "
       "(** volatile restrict "
       "ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType)",
       "ExternObjectParenthesizedInnerVolatileRestrictListDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType "
       "(* restrict volatile *"
       "ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType)",
       "ExternObjectParenthesizedOuterRestrictVolatileListDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType "
       "(** restrict volatile "
       "ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType)",
       "ExternObjectParenthesizedInnerRestrictVolatileListDoublePointerType", 0},
      {"extern ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType "
       "(* restrict /* between qualifiers */ volatile "
       "/* before pointer */ * "
       "ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType)",
       "ExternObjectParenthesizedDoublePointerSingleLevelCvrCommentType", 0},
      {"extern ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType "
       "(** const \\\nrestrict "
       "ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType)",
       "ExternObjectParenthesizedDoublePointerSingleLevelCvrSpliceType", 1},
      {"extern ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType "
       "(* const volatile restrict *"
       "ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType)",
       "ExternObjectParenthesizedOuterConstVolatileRestrictDoublePointerType", 1},
      {"extern ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType "
       "(** const volatile restrict "
       "ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType)",
       "ExternObjectParenthesizedInnerConstVolatileRestrictDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType "
       "(* const restrict volatile *"
       "ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType)",
       "ExternObjectParenthesizedOuterConstRestrictVolatileDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType "
       "(** const restrict volatile "
       "ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType)",
       "ExternObjectParenthesizedInnerConstRestrictVolatileDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType "
       "(* volatile const restrict *"
       "ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType)",
       "ExternObjectParenthesizedOuterVolatileConstRestrictDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType "
       "(** volatile const restrict "
       "ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType)",
       "ExternObjectParenthesizedInnerVolatileConstRestrictDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType "
       "(* volatile restrict const *"
       "ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType)",
       "ExternObjectParenthesizedOuterVolatileRestrictConstDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType "
       "(** volatile restrict const "
       "ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType)",
       "ExternObjectParenthesizedInnerVolatileRestrictConstDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType "
       "(* restrict const volatile *"
       "ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType)",
       "ExternObjectParenthesizedOuterRestrictConstVolatileDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType "
       "(** restrict const volatile "
       "ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType)",
       "ExternObjectParenthesizedInnerRestrictConstVolatileDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType "
       "(* restrict volatile const *"
       "ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType)",
       "ExternObjectParenthesizedOuterRestrictVolatileConstDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerRestrictVolatileConstDoublePointerType "
       "(** restrict volatile const "
       "ExternObjectParenthesizedInnerRestrictVolatileConstDoublePointerType)",
       "ExternObjectParenthesizedInnerRestrictVolatileConstDoublePointerType", 0},
      {"extern ExternObjectParenthesizedDoublePointerSingleLevelAllCvrCommentType "
       "(* const /* first gap */ volatile /* second gap */ restrict * "
       "ExternObjectParenthesizedDoublePointerSingleLevelAllCvrCommentType)",
       "ExternObjectParenthesizedDoublePointerSingleLevelAllCvrCommentType", 0},
      {"extern ExternObjectParenthesizedDoublePointerSingleLevelAllCvrSpliceType "
       "(** restrict volatile \\\nconst "
      ...
      {"extern ExternObjectParenthesizedOuterRepeatedConstDoublePointerType "
       "(* const const *"
       "ExternObjectParenthesizedOuterRepeatedConstDoublePointerType)",
       "ExternObjectParenthesizedOuterRepeatedConstDoublePointerType", 1},
      {"extern ExternObjectParenthesizedInnerRepeatedConstDoublePointerType "
       "(** const const "
       "ExternObjectParenthesizedInnerRepeatedConstDoublePointerType)",
       "ExternObjectParenthesizedInnerRepeatedConstDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType "
       "(* volatile volatile *"
       "ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType)",
       "ExternObjectParenthesizedOuterRepeatedVolatileDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType "
       "(** volatile volatile "
       "ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType)",
       "ExternObjectParenthesizedInnerRepeatedVolatileDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType "
       "(* restrict restrict *"
       "ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType)",
       "ExternObjectParenthesizedOuterRepeatedRestrictDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType "
       "(** restrict restrict "
       "ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType)",
       "ExternObjectParenthesizedInnerRepeatedRestrictDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType "
       "(* const volatile const *"
       "ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType)",
       "ExternObjectParenthesizedOuterMixedRepeatedCvrDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType "
       "(** restrict const restrict "
       "ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType)",
       "ExternObjectParenthesizedInnerMixedRepeatedCvrDoublePointerType", 0},
      {"extern ExternObjectParenthesizedBothRepeatedCvrDoublePointerType "
       "(* const const * volatile volatile "
       "ExternObjectParenthesizedBothRepeatedCvrDoublePointerType)",
       "ExternObjectParenthesizedBothRepeatedCvrDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterFourConstDoublePointerType "
       "(* const const const const *"
       "ExternObjectParenthesizedOuterFourConstDoublePointerType)",
       "ExternObjectParenthesizedOuterFourConstDoublePointerType", 0},
      {"extern ExternObjectParenthesizedBothAllRepeatedCvrDoublePointerType "
       "(* const volatile restrict const volatile restrict * restrict const "
       "volatile restrict const volatile "
       "ExternObjectParenthesizedBothAllRepeatedCvrDoublePointerType)",
       "ExternObjectParenthesizedBothAllRepeatedCvrDoublePointerType", 0},
      {"extern ExternObjectParenthesizedDoublePointerRepeatedCvrCommentType "
       "(* const /* duplicate outer */ const * volatile "
       "/* duplicate inner */ volatile "
       "ExternObjectParenthesizedDoublePointerRepeatedCvrCommentType)",
       "ExternObjectParenthesizedDoublePointerRepeatedCvrCommentType", 0},
      {"extern ExternObjectParenthesizedDoublePointerRepeatedCvrSpliceType "
       "(* restrict \\\nrestrict * const \\\nconst "
       "ExternObjectParenthesizedDoublePointerRepeatedCvrSpliceType)",
       "ExternObjectParenthesizedDoublePointerRepeatedCvrSpliceType", 1},
      {"extern ExternObjectParenthesizedRepeatedAtomicPointerType "
       "(* _Atomic _Atomic "
       "ExternObjectParenthesizedRepeatedAtomicPointerType)",
       "ExternObjectParenthesizedRepeatedAtomicPointerType", 1},
      {"extern ExternObjectParenthesizedOuterAtomicDoublePointerType "
       "(* _Atomic *"
       "ExternObjectParenthesizedOuterAtomicDoublePointerType)",
       "ExternObjectParenthesizedOuterAtomicDoublePointerType", 1},
      {"extern ExternObjectParenthesizedInnerAtomicDoublePointerType "
       "(** _Atomic "
       "ExternObjectParenthesizedInnerAtomicDoublePointerType)",
       "ExternObjectParenthesizedInnerAtomicDoublePointerType", 0},
      {"extern ExternObjectParenthesizedBothAtomicDoublePointerType "
       "(* _Atomic * _Atomic "
       "ExternObjectParenthesizedBothAtomicDoublePointerType)",
       "ExternObjectParenthesizedBothAtomicDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterConstAtomicDoublePointerType "
       "(* const _Atomic *"
       "ExternObjectParenthesizedOuterConstAtomicDoublePointerType)",
       "ExternObjectParenthesizedOuterConstAtomicDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterAtomicConstDoublePointerType "
       "(* _Atomic const *"
       "ExternObjectParenthesizedOuterAtomicConstDoublePointerType)",
       "ExternObjectParenthesizedOuterAtomicConstDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerVolatileAtomicDoublePointerType "
       "(** volatile _Atomic "
       "ExternObjectParenthesizedInnerVolatileAtomicDoublePointerType)",
       "ExternObjectParenthesizedInnerVolatileAtomicDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerAtomicVolatileDoublePointerType "
       "(** _Atomic volatile "
       "ExternObjectParenthesizedInnerAtomicVolatileDoublePointerType)",
       "ExternObjectParenthesizedInnerAtomicVolatileDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterAtomicInnerCvrDoublePointerType "
       "(* _Atomic * const volatile restrict "
       "ExternObjectParenthesizedOuterAtomicInnerCvrDoublePointerType)",
       "ExternObjectParenthesizedOuterAtomicInnerCvrDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterCvrInnerAtomicDoublePointerType "
       "(* const volatile restrict * _Atomic "
       "ExternObjectParenthesizedOuterCvrInnerAtomicDoublePointerType)",
       "ExternObjectParenthesizedOuterCvrInnerAtomicDoublePointerType", 0},
      {"extern ExternObjectParenthesizedBothAtomicCvDoublePointerType "
       "(* const _Atomic volatile * volatile _Atomic const "
       "ExternObjectParenthesizedBothAtomicCvDoublePointerType)",
       "ExternObjectParenthesizedBothAtomicCvDoublePointerType", 0},
      {"extern ExternObjectParenthesizedOuterRepeatedAtomicDoublePointerType "
       "(* _Atomic _Atomic *"
       "ExternObjectParenthesizedOuterRepeatedAtomicDoublePointerType)",
       "ExternObjectParenthesizedOuterRepeatedAtomicDoublePointerType", 0},
      {"extern ExternObjectParenthesizedInnerRepeatedAtomicDoublePointerType "
       "(** _Atomic _Atomic "
       "ExternObjectParenthesizedInnerRepeatedAtomicDoublePointerType)",
       "ExternObjectParenthesizedInnerRepeatedAtomicDoublePointerType", 0},
      {"extern ExternObjectParenthesizedBothRepeatedAtomicDoublePointerType "
       "(* _Atomic _Atomic * _Atomic _Atomic "
       "ExternObjectParenthesizedBothRepeatedAtomicDoublePointerType)",
       "ExternObjectParenthesizedBothRepeatedAtomicDoublePointerType", 0},
      {"extern ExternObjectParenthesizedAtomicDoublePointerCommentType "
       "(* /* outer */ _Atomic * const /* inner */ _Atomic "
       "ExternObjectParenthesizedAtomicDoublePointerCommentType)",
       "ExternObjectParenthesizedAtomicDoublePointerCommentType", 0},
      {"extern ExternObjectParenthesizedAtomicDoublePointerSpliceType "
       "(* _Atomic \\\n* volatile \\\n_Atomic "
       "ExternObjectParenthesizedAtomicDoublePointerSpliceType)",
       "ExternObjectParenthesizedAtomicDoublePointerSpliceType", 1},
  };
  for (int fresh_session = 0; fresh_session < 2; fresh_session++) {
    for (size_t case_index = 0;
  ...
  static const struct {
    ...
    const char *name;
      ...
      {"same-block-parenthesized-const-double-pointer-extern-typedef-conflict.c",
       ...
       "extern SameBlockParenthesizedConstDoublePointerExternType "
       "(* const *SameBlockParenthesizedConstDoublePointerExternType)",
       "SameBlockParenthesizedConstDoublePointerExternType"},
      {"same-block-parenthesized-volatile-double-pointer-extern-typedef-conflict.c",
       same_block_parenthesized_volatile_double_pointer_extern_typedef_conflict_source,
       "extern SameBlockParenthesizedVolatileDoublePointerExternType "
       "(* volatile *SameBlockParenthesizedVolatileDoublePointerExternType)",
       "SameBlockParenthesizedVolatileDoublePointerExternType"},
      {"same-block-parenthesized-restrict-double-pointer-extern-typedef-conflict.c",
       same_block_parenthesized_restrict_double_pointer_extern_typedef_conflict_source,
       "extern SameBlockParenthesizedRestrictDoublePointerExternType "
       "(* restrict *SameBlockParenthesizedRestrictDoublePointerExternType)",
      ...
      {"same-block-parenthesized-single-level-cvr-double-pointer-extern-typedef-conflict.c",
       ...
       "extern SameBlockParenthesizedSingleLevelCvrDoublePointerExternType "
       "(* const restrict *"
       "SameBlockParenthesizedSingleLevelCvrDoublePointerExternType)",
       "SameBlockParenthesizedSingleLevelCvrDoublePointerExternType"},
      {"same-block-parenthesized-single-level-all-cvr-double-pointer-extern-typedef-conflict.c",
       same_block_parenthesized_single_level_all_cvr_double_pointer_extern_typedef_conflict_source,
       "extern SameBlockParenthesizedSingleLevelAllCvrDoublePointerExternType "
  ...
  static const struct {
    ...
    int valid;
      ...
      {"atomic-restrict-parenthesized-extern-typedef.c",
       ...
       "extern AtomicRestrictParenthesizedType "
       "(* _Atomic restrict AtomicRestrictParenthesizedType)",
       "AtomicRestrictParenthesizedType", 0},
      {"outer-atomic-restrict-double-pointer-extern-typedef.c",
       outer_atomic_restrict_double_pointer_extern_typedef_source,
       "extern OuterAtomicRestrictDoublePointerType "
       "(* _Atomic restrict *OuterAtomicRestrictDoublePointerType)",
       "OuterAtomicRestrictDoublePointerType", 0},
      {"inner-atomic-restrict-double-pointer-extern-typedef.c",
       inner_atomic_restrict_double_pointer_extern_typedef_source,
       "extern InnerAtomicRestrictDoublePointerType "
       "(** _Atomic restrict InnerAtomicRestrictDoublePointerType)",
       "InnerAtomicRestrictDoublePointerType", 0},
  };
...
static int test_local_record_static_assert_hover(ag_target_info_t target) {
  static const struct {
    const char *fragment;
    const char *name;
    ag_language_symbol_kind_t kind;
    ...
    const char *macro_replacement;
      ...
      {"LocalRecordAssertNamed { _Static_assert(LOCAL_RECORD_ASSERT",
       "LOCAL_RECORD_ASSERT", AG_LANGUAGE_SYMBOL_ENUM_CONSTANT, NULL, "1",
       NULL},
      {"LocalRecordAssertUnion { _Static_assert(LOCAL_RECORD_ASSERT",
       "LOCAL_RECORD_ASSERT", AG_LANGUAGE_SYMBOL_ENUM_CONSTANT, NULL, "1",
       NULL},
      {"struct { _Static_assert(LOCAL_RECORD_ASSERT",
       "LOCAL_RECORD_ASSERT", AG_LANGUAGE_SYMBOL_ENUM_CONSTANT, NULL, "1",
       NULL},
      {"LocalRecordAssertNested { _Static_assert(LOCAL_RECORD_ASSERT",
       "LOCAL_RECORD_ASSERT", AG_LANGUAGE_SYMBOL_ENUM_CONSTANT, NULL, "1",
       NULL},
      {"LocalRecordAssertFile { _Static_assert(FILE_RECORD_ASSERT",
       "FILE_RECORD_ASSERT", AG_LANGUAGE_SYMBOL_ENUM_CONSTANT, NULL, "1",
       NULL},
      {"LocalRecordAssertMacro { _Static_assert(RECORD_ASSERT_MACRO",
       "RECORD_ASSERT_MACRO", AG_LANGUAGE_SYMBOL_MACRO, NULL, NULL, "1"},
      {"_Static_assert(/* operand */ LOCAL_RECORD_ASSERT",
       "LOCAL_RECORD_ASSERT", AG_LANGUAGE_SYMBOL_ENUM_CONSTANT, NULL, "1",
       NULL},
      {"_Static_assert /* gap */ (LOCAL_RECORD_ASSERT",
       "LOCAL_RECORD_ASSERT", AG_LANGUAGE_SYMBOL_ENUM_CONSTANT, NULL, "1",
       NULL},
      {"LocalRecordAssertLf { _Static_assert(\\\nLOCAL_RECORD_ASSERT",
       "LOCAL_RECORD_ASSERT", AG_LANGUAGE_SYMBOL_ENUM_CONSTANT, NULL, "1",
       NULL},
      {"LocalRecordAssertCrlf { _Static_assert(\\\r\nLOCAL_RECORD_ASSERT",
       "LOCAL_RECORD_ASSERT", AG_LANGUAGE_SYMBOL_ENUM_CONSTANT, NULL, "1",
       NULL},
      {"LocalRecordAssertShadow { _Static_assert(SHADOW_RECORD_ASSERT",
       "SHADOW_RECORD_ASSERT", AG_LANGUAGE_SYMBOL_ENUM_CONSTANT,
       "enum LocalRecordAssertConstants", "3", NULL},
      {"sizeof(LocalRecordAssertType", "LocalRecordAssertType",
       AG_LANGUAGE_SYMBOL_TYPEDEF, NULL, NULL, NULL},
  };
  ag_compilation_session_t *session =
      ag_compilation_session_create(&target);
  CHECK(session != NULL, "local record static assert hover session");
  ag_language_analysis_limits_t defaults =
      ag_language_analysis_default_limits();
  ag_language_analysis_snapshot_t snapshot = {0};
  ag_language_analysis_error_t error = {0};
  for (int fresh_session = 0; fresh_session < 2; fresh_session++) {
    for (size_t case_index = 0;
      ...
      const char *use = fragment ? strstr(fragment, cases[case_index].name)
                                 : NULL;
      const char *declaration_root = cases[case_index].declaration_fragment
          ? strstr(local_record_static_assert_hover_source,
                   cases[case_index].declaration_fragment)
          : local_record_static_assert_hover_source;
      const char *declaration = declaration_root
          ? strstr(declaration_root, cases[case_index].name)
          : NULL;
      CHECK(use && declaration, "local record static assert hover anchors");
      size_t name_length = strlen(cases[case_index].name);
      size_t deltas[] = {0, name_length / 2, name_length};
      for (size_t delta_index = 0;
           delta_index < sizeof(deltas) / sizeof(deltas[0]);
        ...
        if (fresh_session) {
          analysis_session = ag_compilation_session_create(&target);
          CHECK(analysis_session != NULL,
                "local record static assert hover fresh session");
        }
        CHECK(analyze_named(
                  analysis_session, "local-record-static-assert-hover.c",
                  local_record_static_assert_hover_source,
                  (size_t)(use - local_record_static_assert_hover_source) +
                      deltas[delta_index],
                  (header_bundle_t){0}, defaults, &snapshot, &error),
              "local record static assert hover analysis");
        const ag_language_symbol_t *hover = hover_symbol(&snapshot);
        const ag_language_symbol_t *completion = find_symbol(
            &snapshot, cases[case_index].name, cases[case_index].kind);
        CHECK(!snapshot.partial && snapshot.diagnostic_count == 0 &&
                  ...
                  hover->declaration.source_name &&
                  strcmp(hover->declaration.source_name,
                         "local-record-static-assert-hover.c") == 0 &&
                  hover->declaration.start.offset ==
                      (int)(declaration -
                            local_record_static_assert_hover_source) &&
                  hover->declaration.end.offset ==
                  ...
                  same_range(&hover->declaration,
                             &completion->declaration) &&
                  !find_symbol(&snapshot, "RECORD_ASSERT_AFTER",
                               AG_LANGUAGE_SYMBOL_ENUM_CONSTANT) &&
                  !find_symbol(&snapshot, "record_assert_after_local",
                               AG_LANGUAGE_SYMBOL_OBJECT) &&
                  !find_symbol(&snapshot, "record_assert_after_file",
                               AG_LANGUAGE_SYMBOL_OBJECT),
              "local record static assert hover snapshot");
        if (cases[case_index].constant_value)
          CHECK(hover->constant_value && completion->constant_value &&
                    strcmp(hover->constant_value,
                           cases[case_index].constant_value) == 0 &&
                    strcmp(completion->constant_value,
                           cases[case_index].constant_value) == 0,
                "local record static assert constant value");
        if (cases[case_index].macro_replacement)
          CHECK(hover->macro_replacement &&
                    completion->macro_replacement &&
                    strcmp(hover->macro_replacement,
                    ...
                    strcmp(completion->macro_replacement,
                           cases[case_index].macro_replacement) == 0,
                "local record static assert macro replacement");
        ag_language_analysis_snapshot_dispose(&snapshot);
        if (fresh_session)
          ag_compilation_session_destroy(analysis_session);
      }
...
int main(int argc, char **argv) {
  ...
  if (argc == 3 &&
      strcmp(argv[1], "--local-record-static-assert-hover-parity-json") == 0)
    return print_local_record_static_assert_hover_parity_snapshot(argv[2]);
  if (argc == 3 &&
  ...
  CHECK(test_local_record_static_assert_hover(target) == 0,
        "local record static assert hover scenarios");
  ...
  ag_compilation_session_destroy(session);
  puts("language analysis tests passed (70 scenarios)");
  return 0;
}
