...
static const compile_fail_case_t compile_fail_cases[] = {
    ...
    {"block_static_vla_object_rejected",
     "int main(int argc, char **argv) { static int values[argc]; return values[0] + (argv != 0); }",
     "E3064"},
    {"block_extern_vla_object_rejected",
     "int main(int argc, char **argv) { extern int values[argc]; return values[0] + (argv != 0); }",
     "E3064"},
    ...
    {"bitfield_derived_switch_duplicate_case_rejected",
     "struct bits { unsigned long value : 3; }; int main(void) { struct bits b = {0}; switch (b.value = 1ul) { case -1: return 1; case 4294967295u: return 2; default: return 0; } }",
     "E3060"},
    ...
    {"restrict_function_pointer_rejected",
     "int answer(void) { return 42; } int main(void) { int (*restrict callback)(void)=answer; return callback(); }",
     "E3064"},
    {"restrict_typedef_function_pointer_rejected",
     "typedef int function_type(void); int main(void) { function_type *restrict callback=0; return callback != 0; }",
     "E3064"},
    {"restrict_typedef_function_pointer_prefix_rejected",
     "typedef int (*function_pointer)(void); int main(void) { restrict function_pointer callback=0; return callback != 0; }",
     "E3064"},
    ...
    {"restrict_typedef_function_pointer_type_name_rejected",
     "typedef int (*function_pointer)(void); int main(void) { return (restrict function_pointer)0 != 0; }",
     "E3064"},
    {"restrict_typedef_scalar_type_name_rejected",
     "typedef int scalar_type; int main(void) { return sizeof(restrict scalar_type); }",
     "E3117"},
    ...
    {"restrict_function_pointer_parameter_rejected",
     "int apply(int (*restrict callback)(void)); int main(void) { return 0; }",
     "E3064"},
    {"restrict_function_pointer_member_rejected",
     "struct callbacks { int (*restrict read)(void); }; int main(void) { return 0; }",
     "E3064"},
    {"restrict_function_pointer_typedef_declaration_rejected",
     "typedef int function_type(void); typedef function_type *restrict callback_type; int main(void) { return 0; }",
     "E3064"},
    ...
    {"array_parameter_duplicate_static_rejected",
     "int f(int values[static static 3]); int main(void) { return 0; }",
     "E3064"},
    {"array_parameter_nested_static_rejected",
     "int f(int (*values)[static 3]); int main(void) { return 0; }",
     "E3064"},
    {"array_parameter_nested_const_rejected",
     "int f(int (*values)[const 3]); int main(void) { return 0; }",
     "E3064"},
    {"array_parameter_nested_volatile_rejected",
     "int f(int (*values)[volatile 3]); int main(void) { return 0; }",
     "E3064"},
    {"array_parameter_nested_restrict_rejected",
     "int f(int (*values)[restrict 3]); int main(void) { return 0; }",
     "E3064"},
    ...
    {"array_parameter_star_definition_rejected",
     "int f(int values[*]) { return values[0]; } int main(void) { return 0; }",
     "E3064"},
    {"array_of_void_rejected",
     "typedef void element_type; element_type values[2]; int main(void) { return 0; }",
     "E3064"},
    {"array_of_function_rejected",
     "typedef int function_type(void); function_type values[2]; int main(void) { return 0; }",
     "E3064"},
    {"void_variable",
     "int main(void) { void value; return 0; }",
     "E3087"},
    {"pointer_to_array_incomplete_element_rejected",
     "struct incomplete; struct incomplete (*values)[2]; int main(void) { return values != 0; }",
     "E3064"},
    {"pointer_to_vla_incomplete_element_rejected",
     "struct incomplete; int f(int count, struct incomplete (*values)[count]); int main(void) { return 0; }",
     "E3064"},
    {"named_void_parameter_rejected",
     "int f(void value); int main(void) { return 0; }",
     "E3064"},
    {"nested_named_void_parameter_rejected",
     "int f(int (*callback)(void value)); int main(void) { return 0; }",
     "E3064"},
    ...
    {"typedef_void_variadic_parameter_rejected",
     "typedef void no_parameters; int f(no_parameters, ...); int main(void) { return 0; }",
     "E3064"},
    {"incomplete_record_parameter_definition_rejected",
     "struct record; int f(struct record value) { return 0; } int main(void) { return 0; }",
     "E3064"},
    {"incomplete_record_return_definition_rejected",
     "struct record; struct record f(void) { for (;;) {} } int main(void) { return 0; }",
     "E3064"},
    {"call_incomplete_return_rejected",
     "struct record; struct record make(void); int main(void) { make(); return 0; }",
     "E3064"},
    {"pointer_to_array_incomplete_element_type_name_rejected",
     "struct incomplete; int main(void) { return sizeof(struct incomplete (*)[2]); }",
     "E3117"},
    ...
    {"atomic_const_type_rejected",
     "_Atomic(const int) value; int main(void) { return 0; }",
     "E3064"},
    {"atomic_volatile_type_rejected",
     "_Atomic(volatile int) value; int main(void) { return 0; }",
     "E3064"},
    {"nested_atomic_type_rejected",
     "_Atomic(_Atomic(int)) value; int main(void) { return 0; }",
     "E3064"},
    {"atomic_void_type_rejected",
     "_Atomic(void) value; int main(void) { return 0; }",
     "E3064"},
    {"atomic_array_type_rejected",
     "_Atomic(int[2]) value; int main(void) { return 0; }",
     "E3064"},
    {"atomic_function_type_rejected",
     "_Atomic(int(void)) value; int main(void) { return 0; }",
     "E3064"},
    {"atomic_incomplete_record_rejected",
     "struct incomplete; _Atomic(struct incomplete) value; int main(void) { return 0; }",
     "E3064"},
    {"atomic_const_pointer_type_rejected",
     "int value; _Atomic(int * const) pointer = &value; int main(void) { return 0; }",
     "E3064"},
    {"nested_atomic_pointer_type_rejected",
     "int value; _Atomic(int * _Atomic) pointer = &value; int main(void) { return 0; }",
     "E3064"},
    {"atomic_typedef_function_qualifier_rejected",
     "typedef int function_type(void); _Atomic function_type function; int main(void) { return 0; }",
     "E3064"},
    {"atomic_typedef_function_local_rejected",
     "typedef int function_type(void); int main(void) { _Atomic function_type function; return 0; }",
     "E3064"},
    {"atomic_typedef_function_member_rejected",
     "typedef int function_type(void); struct callbacks { _Atomic function_type callback; }; int main(void) { return 0; }",
     "E3064"},
    {"atomic_typedef_function_parameter_rejected",
     "typedef int function_type(void); int apply(_Atomic function_type callback); int main(void) { return 0; }",
     "E3064"},
    {"atomic_typedef_function_typedef_rejected",
     "typedef int function_type(void); typedef _Atomic function_type atomic_function_type; int main(void) { return 0; }",
     "E3064"},
    {"atomic_typedef_function_pointer_outer_rejected",
     "typedef int function_type(void); _Atomic function_type *pointer; int main(void) { return 0; }",
     "E3064"},
    {"atomic_typedef_array_qualifier_rejected",
     "typedef int array_type[2]; _Atomic array_type values; int main(void) { return 0; }",
     "E3064"},
    {"atomic_typedef_array_pointer_outer_rejected",
     "typedef int array_type[2]; _Atomic array_type *pointer; int main(void) { return 0; }",
     "E3064"},
    {"atomic_typedef_array_type_name_rejected",
     "typedef int array_type[2]; int main(void) { return sizeof(_Atomic array_type); }",
     "E3117"},
    {"atomic_incomplete_record_pointer_outer_rejected",
     "struct item; _Atomic struct item *pointer; int main(void) { return 0; }",
     "E3064"},
    {"atomic_bitfield_qualifier_rejected",
     "struct flags { _Atomic unsigned int value : 3; }; int main(void) { return 0; }",
     "E3064"},
    {"atomic_bitfield_specifier_rejected",
     "struct flags { _Atomic(unsigned int) value : 3; }; int main(void) { return 0; }",
     "E3064"},
    {"atomic_bitfield_typedef_rejected",
     "typedef _Atomic unsigned int atomic_uint; struct flags { atomic_uint value : 3; }; int main(void) { return 0; }",
     "E3064"},
    {"atomic_bitfield_unnamed_rejected",
     "struct flags { _Atomic unsigned int : 0; }; int main(void) { return 0; }",
     "E3064"},
    {"atomic_rvalue_return_to_plain_type_rejected",
     "_Atomic int source(void) { return 1; } int sink(void) { return source(); } int main(void) { return 0; }",
     "E3108"},
    {"stdatomic_load_result_assignment_rejected",
     "#include <stdatomic.h>\nint main(void) { atomic_int value = 1; atomic_load(&value) = 2; return value; }\n",
     "E3062"},
    {"stdatomic_plain_object_argument_rejected",
     "#include <stdatomic.h>\nint main(void) { int value = 1; return atomic_load(&value); }\n",
     "E3120"},
    {"stdatomic_const_expected_argument_rejected",
     "#include <stdatomic.h>\nint main(void) { atomic_int value = 1; const int expected = 1; return atomic_compare_exchange_strong(&value, &expected, 2); }\n",
     "E3120"},
    {"stdatomic_compare_exchange_distinct_enum_expected_rejected",
     "#include <stdatomic.h>\nenum first_state { FIRST_STATE = 1 }; enum second_state { SECOND_STATE = 1 }; int main(void) { _Atomic(enum first_state) value = FIRST_STATE; enum second_state expected = SECOND_STATE; return atomic_compare_exchange_strong(&value, &expected, FIRST_STATE); }\n",
     "E3120"},
    {"stdatomic_compare_exchange_incompatible_integer_expected_rejected",
     "#include <stdatomic.h>\nenum positive_state { POSITIVE_STATE_ZERO = 0, POSITIVE_STATE_ONE = 1 }; int main(void) { _Atomic(enum positive_state) value = POSITIVE_STATE_ONE; int expected = 1; return atomic_compare_exchange_strong(&value, &expected, POSITIVE_STATE_ZERO); }\n",
     "E3120"},
    {"stdatomic_compare_exchange_volatile_expected_rejected",
     "#include <stdatomic.h>\nenum positive_state { POSITIVE_STATE_ZERO = 0, POSITIVE_STATE_ONE = 1 }; int main(void) { _Atomic(enum positive_state) value = POSITIVE_STATE_ONE; volatile unsigned int expected = 1; return atomic_compare_exchange_strong(&value, &expected, POSITIVE_STATE_ZERO); }\n",
     "E3120"},
    {"stdatomic_compare_exchange_atomic_expected_rejected",
     "#include <stdatomic.h>\nenum positive_state { POSITIVE_STATE_ZERO = 0, POSITIVE_STATE_ONE = 1 }; int main(void) { _Atomic(enum positive_state) value = POSITIVE_STATE_ONE; _Atomic(unsigned int) expected = 1; return atomic_compare_exchange_strong(&value, &expected, POSITIVE_STATE_ZERO); }\n",
     "E3120"},
    {"stdatomic_const_object_store_rejected",
     "#include <stdatomic.h>\nint main(void) { const atomic_int value = 1; atomic_store(&value, 2); return 0; }\n",
     "E3120"},
    {"stdatomic_const_object_exchange_rejected",
     "#include <stdatomic.h>\nint main(void) { const atomic_int value = 1; return atomic_exchange(&value, 2); }\n",
     "E3120"},
    {"stdatomic_const_object_compare_exchange_rejected",
     "#include <stdatomic.h>\nint main(void) { const atomic_int value = 1; int expected = 1; return atomic_compare_exchange_strong(&value, &expected, 2); }\n",
     "E3120"},
    {"stdatomic_const_object_fetch_rejected",
     "#include <stdatomic.h>\nint main(void) { const atomic_int value = 1; return atomic_fetch_add(&value, 2); }\n",
     "E3120"},
    {"stdatomic_const_object_init_rejected",
     "#include <stdatomic.h>\nint main(void) { const atomic_int value = 1; atomic_init(&value, 2); return 0; }\n",
     "E3120"},
    {"stdatomic_const_aggregate_store_rejected",
     "#include <stdatomic.h>\nstruct pair { int x; int y; }; int main(void) { const _Atomic(struct pair) value = (struct pair){1, 2}; atomic_store(&value, ((struct pair){3, 4})); return 0; }\n",
     "E3120"},
    {"stdatomic_const_flag_clear_rejected",
     "#include <stdatomic.h>\nint main(void) { const atomic_flag flag = ATOMIC_FLAG_INIT; atomic_flag_clear(&flag); return 0; }\n",
     "E3120"},
    {"stdatomic_fetch_aggregate_operand_rejected",
     "#include <stdatomic.h>\nstruct pair { int x; int y; }; int main(void) { atomic_int value = 1; return atomic_fetch_add(&value, ((struct pair){2, 3})); }\n",
     "E3120"},
    ...
    {"stdatomic_fetch_pointer_bitwise_rejected",
     "#include <stdatomic.h>\nint main(void) { int values[2]; _Atomic(int *) value = values; return atomic_fetch_or(&value, 1) != 0; }\n",
     "E3120"},
    {"stdatomic_store_struct_order_rejected",
     "#include <stdatomic.h>\nstruct order_value { int value; }; int main(void) { atomic_int value = 1; struct order_value order = {0}; atomic_store_explicit(&value, 2, order); return 0; }\n",
     "E3099"},
    {"stdatomic_load_pointer_order_rejected",
     "#include <stdatomic.h>\nint main(void) { atomic_int value = 1; int order = 0; return atomic_load_explicit(&value, &order); }\n",
     "E3099"},
    {"stdatomic_compare_exchange_struct_success_order_rejected",
     "#include <stdatomic.h>\nstruct order_value { int value; }; int main(void) { atomic_int value = 1; int expected = 1; struct order_value order = {0}; return atomic_compare_exchange_strong_explicit(&value, &expected, 2, order, memory_order_relaxed); }\n",
     "E3099"},
    {"stdatomic_compare_exchange_pointer_failure_order_rejected",
     "#include <stdatomic.h>\nint main(void) { atomic_int value = 1; int expected = 1; int order = 0; return atomic_compare_exchange_strong_explicit(&value, &expected, 2, memory_order_relaxed, &order); }\n",
     "E3099"},
    {"stdatomic_thread_fence_struct_order_rejected",
     "#include <stdatomic.h>\nstruct order_value { int value; }; int main(void) { struct order_value order = {0}; atomic_thread_fence(order); return 0; }\n",
     "E3099"},
    {"stdatomic_flag_pointer_order_rejected",
     "#include <stdatomic.h>\nint main(void) { atomic_flag flag = ATOMIC_FLAG_INIT; int order = 0; return atomic_flag_test_and_set_explicit(&flag, &order); }\n",
     "E3099"},
    ...
    {"stdatomic_lock_free_void_pointer_rejected",
     "#include <stdatomic.h>\nint main(void) { void *value = 0; return atomic_is_lock_free(value); }\n",
     "E3120"},
    {"stdatomic_lock_free_nonpointer_rejected",
     "#include <stdatomic.h>\nint main(void) { atomic_int value = 1; return atomic_is_lock_free(value); }\n",
     "E3120"},
    {"stdatomic_thread_fence_value_rejected",
     "#include <stdatomic.h>\nint main(void) { int value = atomic_thread_fence(memory_order_seq_cst); return value; }\n",
     "E3099"},
    {"stdatomic_signal_fence_value_rejected",
     "#include <stdatomic.h>\nint main(void) { int value = atomic_signal_fence(memory_order_seq_cst); return value; }\n",
     "E3099"},
    {"stdarg_va_start_value_rejected",
     "#include <stdarg.h>\nint variadic(int last, ...) { va_list args; int result = va_start(args, last); va_end(args); return result; } int main(void) { return variadic(0); }\n",
     "E3099"},
    {"stdarg_va_copy_value_rejected",
     "#include <stdarg.h>\nint variadic(int last, ...) { va_list args; va_list copy; va_start(args, last); int result = va_copy(copy, args); va_end(copy); va_end(args); return result; } int main(void) { return variadic(0); }\n",
     "E3099"},
    {"stddef_offsetof_nonaggregate_rejected",
     "#include <stddef.h>\nint main(void) { return (int)offsetof(int, member); }\n",
     "E3117"},
    {"stddef_offsetof_missing_member_rejected",
     "#include <stddef.h>\nstruct value { int member; }; int main(void) { return (int)offsetof(struct value, missing); }\n",
     "E3064"},
    {"stddef_offsetof_bitfield_rejected",
     "#include <stddef.h>\nstruct value { unsigned member : 1; }; int main(void) { return (int)offsetof(struct value, member); }\n",
     "E3113"},
    ...
    {"static_assert_missing_message_rejected",
     "_Static_assert(1); int main(void) { return 0; }",
     "E2006"},
    {"static_assert_identifier_message_rejected",
     "const char message[] = \"message\"; _Static_assert(1, message); int main(void) { return 0; }",
     "E3011"},
    {"static_assert_float_condition_rejected",
     "_Static_assert(1.0, \"floating condition\"); int main(void) { return 0; }",
     "E3010"},
    {"static_assert_comma_condition_rejected",
     "_Static_assert((1, 1), \"comma condition\"); int main(void) { return 0; }",
     "E3010"},
    {"static_assert_variable_condition_rejected",
     "int value = 1; _Static_assert(value, \"variable condition\"); int main(void) { return 0; }",
     "E3010"},
    {"static_assert_floating_expression_cast_rejected",
     "_Static_assert((int)(1.0 + 2.0) == 3, \"not immediate operands\"); int main(void) { return 0; }",
     "E3010"},
    {"static_assert_sizeof_vla",
     "void reject_sizeof_vla_in_static_assert(int count) { int values[count]; _Static_assert(sizeof(values) > 0, \"VLA size is not constant\"); } int main(void) { return 0; }",
     "E3010"},
    {"conditional_unselected_call_enum",
     "static int runtime_value(void) { return 9; } enum values { VALUE = 1 ? 7 : runtime_value() }; int main(void) { return 0; }",
     "E3064"},
    {"logical_unselected_call_static_assert",
     "static int runtime_value(void) { return 9; } _Static_assert(0 && runtime_value(), \"unselected call\"); int main(void) { return 0; }",
     "E3010"},
    {"conditional_selected_comma_enum",
     "enum values { VALUE = 1 ? (2, 3) : 4 }; int main(void) { return 0; }",
     "E3064"},
    {"logical_selected_comma_static_assert",
     "_Static_assert(1 && (2, 3), \"selected comma\"); int main(void) { return 0; }",
     "E3010"},
    ...
    {"static_assert_for_initializer_false_rejected",
     "int main(void) { for (_Static_assert(0, \"failure\"); ; ) "
     "return 0; }",
     "E3012"},
    ...
    {"declaration_immediately_after_label_rejected",
     "int main(void) { label: _Static_assert(1, \"declaration\"); return 0; }",
     "E3064"},
    {"declaration_immediately_after_case_rejected",
     "int main(void) { switch (1) { case 1: int value = 0; return value; } }",
     "E3064"},
    {"declaration_immediately_after_default_rejected",
     "int main(void) { switch (1) { default: int value = 0; return value; } }",
     "E3064"},
    ...
    {"enum_floating_expression_cast_rejected",
     "enum values { VALUE = (int)(1.0 + 2.0) }; int main(void) { return 0; }",
     "E3064"},
    {"case_comma_constant_rejected",
     "int main(void) { switch (1) { case (1, 1): return 0; } return 1; }",
     "E3064"},
    {"case_float_constant_rejected",
     "int main(void) { switch (1) { case 1.0: return 0; } return 1; }",
     "E3064"},
    {"bitfield_comma_width_rejected",
     "struct bits { unsigned value : (1, 3); }; int main(void) { return 0; }",
     "E3064"},
    {"sizeof_generic_selected_bitfield_rejected",
     "struct bits { unsigned value : 3; }; int main(void) { struct bits b = {0}; return (int)sizeof(_Generic(0, int: b.value, default: 0u)); }",
     "E3118"},
    {"sizeof_generic_selected_function_rejected",
     "static int f(void) { return 0; } int main(void) { return (int)sizeof(_Generic(0, int: f, default: 0)); }",
     "E3117"},
    {"assign_generic_selected_const_rejected",
     "int main(void) { const int constant = 1; int mutable = 2; _Generic(0, int: constant, default: mutable) = 3; return 0; }",
     "E3077"},
    {"function_pointer_from_nonzero_void_pointer_rejected",
     "typedef int callback_type(void); int main(void) { callback_type *callback = (void *)1; return callback != 0; }",
     "E3099"},
    {"function_pointer_from_object_pointer_cast_rejected",
     "typedef int callback_type(void); int main(void) { callback_type *callback = (int *)0; return callback != 0; }",
     "E3099"},
    {"bitfield_pointer_type_rejected",
     "struct bits { unsigned int *value : 3; }; int main(void) { return 0; }",
     "E3064"},
    {"bitfield_array_type_rejected",
     "struct bits { unsigned int value[2] : 3; }; int main(void) { return 0; }",
     "E3064"},
    {"bitfield_function_type_rejected",
     "struct bits { unsigned int value(void) : 3; }; int main(void) { return 0; }",
     "E3064"},
    {"bitfield_negative_width_rejected",
     "struct bits { unsigned value : -1; }; int main(void) { return 0; }",
     "E3064"},
    {"bitfield_named_zero_width_rejected",
     "struct bits { unsigned value : 0; }; int main(void) { return 0; }",
     "E3064"},
    {"bool_bitfield_width_exceeds_one_rejected",
     "struct bits { _Bool value : 2; }; int main(void) { return 0; }",
     "E3064"},
    {"flexible_array_in_union_rejected",
     "union value { int prefix; int data[]; }; int main(void) { return 0; }",
     "E3064"},
    {"flexible_array_without_prior_named_member_rejected",
     "struct value { int data[]; }; int main(void) { return 0; }",
     "E3064"},
    {"flexible_array_not_last_rejected",
     "struct value { int prefix; int data[]; int tail; }; int main(void) { return 0; }",
     "E3064"},
    {"flexible_array_nested_struct_member_rejected",
     "struct inner { int prefix; int data[]; }; struct outer { struct inner value; }; int main(void) { return 0; }",
     "E3064"},
    {"flexible_array_nested_union_member_rejected",
     "struct inner { int prefix; int data[]; }; union holder { struct inner value; int fallback; }; struct outer { union holder value; }; int main(void) { return 0; }",
     "E3064"},
    {"flexible_array_element_rejected",
     "struct value { int prefix; int data[]; }; struct value values[2]; int main(void) { return 0; }",
     "E3064"},
    {"flexible_array_pointer_to_array_rejected",
     "struct value { int prefix; int data[]; }; struct value (*pointer)[2]; int main(void) { return 0; }",
     "E3064"},
    {"flexible_array_parameter_array_rejected",
     "struct value { int prefix; int data[]; }; int consume(struct value values[2]) { return values != 0; } int main(void) { return 0; }",
     "E3064"},
    {"flexible_array_compound_literal_array_rejected",
     "struct value { int prefix; int data[]; }; int main(void) { return ((struct value[2]){{1}, {2}})[0].prefix; }",
     "E3064"},
    {"alignas_comma_constant_rejected",
     "_Alignas((1, 16)) int value; int main(void) { return 0; }",
     "E3064"},
    {"static_array_comma_bound_rejected",
     "static int values[(1, 2)]; int main(void) { return 0; }",
     "E3064"},
    {"declaration_as_if_body_rejected",
     "int main(void) { if (1) int value = 0; return 0; }",
     "E3064"},
    {"declaration_as_else_body_rejected",
     "int main(void) { if (1) return 0; else int value = 0; return 1; }",
     "E3064"},
    {"declaration_as_while_body_rejected",
     "int main(void) { while (0) int value = 0; return 0; }",
     "E3064"},
    {"declaration_as_do_body_rejected",
     "int main(void) { do int value = 0; while (0); return 0; }",
     "E3064"},
    {"declaration_as_for_body_rejected",
     "int main(void) { for (;;) int value = 0; return 0; }",
     "E3064"},
    {"declaration_as_switch_body_rejected",
     "int main(void) { switch (1) int value = 0; return 0; }",
     "E3064"},
    ...
    {"generic_incomplete_record_association_rejected",
     "struct incomplete; int main(void) { return _Generic(1, struct incomplete: 1, default: 0); }",
     "E3043"},
    {"generic_implicit_incomplete_tag_association_rejected",
     "int main(void) { return _Generic(1, struct missing: 1, default: 0); }",
     "E3043"},
    {"generic_vla_association_rejected",
     "int main(int argc, char **argv) { int n = argc; return _Generic(argv, int[n]: 1, default: 0); }",
     "E3064"},
    {"generic_duplicate_typedef_association_rejected",
     "typedef int integer; int main(void) { return _Generic(1, int: 0, integer: 1); }",
     "E3105"},
    {"generic_duplicate_positive_enum_compatible_type",
     "enum positive_value { POSITIVE_ZERO = 0, POSITIVE_ONE = 1 }; int main(void) { enum positive_value value = POSITIVE_ONE; return _Generic(value, enum positive_value: 1, unsigned int: 2); }",
     "E3105"},
    {"generic_duplicate_negative_enum_compatible_type",
     "enum negative_value { NEGATIVE_ONE = -1, NEGATIVE_ZERO = 0 }; int main(void) { enum negative_value value = NEGATIVE_ONE; return _Generic(value, enum negative_value: 1, int: 2); }",
     "E3105"},
    {"generic_duplicate_qualified_parameter_function_pointer",
     "typedef int (*plain_callback)(int); typedef int (*qualified_parameter_callback)(const int); int main(void) { return _Generic((plain_callback)0, plain_callback: 1, qualified_parameter_callback: 2, default: 0); }",
     "E3105"},
    {"generic_duplicate_array_adjusted_function_pointer",
     "typedef int array_parameter_function(int values[const static 1]); typedef int pointer_parameter_function(int *values); int main(void) { return _Generic((array_parameter_function *)0, array_parameter_function *: 1, pointer_parameter_function *: 2, default: 0); }",
     "E3105"},
    {"generic_duplicate_function_adjusted_parameter_pointer",
     "typedef int unary_function(int); typedef int function_parameter_function(unary_function callback); typedef int pointer_parameter_function(unary_function *callback); int main(void) { return _Generic((function_parameter_function *)0, function_parameter_function *: 1, pointer_parameter_function *: 2, default: 0); }",
     "E3105"},
    {"generic_duplicate_nested_callback_parameter_pointer_qualifier",
     "typedef int callback(void); typedef int plain_consumer(callback *function); typedef int qualified_consumer(callback *const function); int main(void) { return _Generic((plain_consumer *)0, plain_consumer *: 1, qualified_consumer *: 2, default: 0); }",
     "E3105"},
    {"generic_duplicate_nested_callback_array_adjustment",
     "typedef int array_callback(int values[const static 2]); typedef int pointer_callback(int *values); typedef int array_consumer(array_callback *callback); typedef int pointer_consumer(pointer_callback *callback); int main(void) { return _Generic((array_consumer *)0, array_consumer *: 1, pointer_consumer *: 2, default: 0); }",
     "E3105"},
    {"generic_duplicate_nested_callback_function_adjustment",
     "typedef int unary(int); typedef int function_callback(unary transform); typedef int pointer_callback(unary *transform); typedef int function_consumer(function_callback *callback); typedef int pointer_consumer(pointer_callback *callback); int main(void) { return _Generic((function_consumer *)0, function_consumer *: 1, pointer_consumer *: 2, default: 0); }",
     "E3105"},
    {"generic_duplicate_nested_callback_unprototyped_int",
     "typedef int unprototyped_callback(); typedef int prototyped_callback(int); typedef int unprototyped_consumer(unprototyped_callback *callback); typedef int prototyped_consumer(prototyped_callback *callback); int main(void) { return _Generic((unprototyped_consumer *)0, unprototyped_consumer *: 1, prototyped_consumer *: 2, default: 0); }",
     "E3105"},
    {"generic_duplicate_nested_callback_return_function_unprototyped_int",
     "typedef int unprototyped_target(); typedef int prototyped_target(int); typedef unprototyped_target *unprototyped_factory(void); typedef prototyped_target *prototyped_factory(void); typedef int unprototyped_consumer(unprototyped_factory *factory); typedef int prototyped_consumer(prototyped_factory *factory); int main(void) { return _Generic((unprototyped_consumer *)0, unprototyped_consumer *: 1, prototyped_consumer *: 2, default: 0); }",
     "E3105"},
    {"generic_duplicate_nested_callback_restrict_array_adjustment",
     "typedef int restrict_callback(int values[static const restrict 1]); typedef int pointer_callback(int *values); typedef int restrict_consumer(restrict_callback *callback); typedef int pointer_consumer(pointer_callback *callback); int main(void) { return _Generic((restrict_consumer *)0, restrict_consumer *: 1, pointer_consumer *: 2, default: 0); }",
     "E3105"},
    {"generic_duplicate_nested_callback_atomic_array_adjustment",
     "typedef int atomic_callback(int values[_Atomic 1]); typedef int pointer_callback(int *values); typedef int atomic_consumer(atomic_callback *callback); typedef int pointer_consumer(pointer_callback *callback); int main(void) { return _Generic((atomic_consumer *)0, atomic_consumer *: 1, pointer_consumer *: 2, default: 0); }",
     "E3105"},
    {"generic_duplicate_nested_callback_function_pointer_parameter_qualifier",
     "typedef int target(int); typedef int plain_callback(target *function); typedef int qualified_callback(target *const function); typedef int plain_consumer(plain_callback *callback); typedef int qualified_consumer(qualified_callback *callback); int main(void) { return _Generic((plain_consumer *)0, plain_consumer *: 1, qualified_consumer *: 2, default: 0); }",
     "E3105"},
    {"generic_unselected_undefined_identifier_rejected",
     "int main(void) { return _Generic(1, int: 0, default: undefined_value); }",
     "E3066"},
    {"generic_unselected_incomplete_compound_literal_rejected",
     "int main(void) { return _Generic(1, int: 0, default: (struct missing){0}); }",
     "E3114"},
    {"compound_literal_void_type",
     "int main(void) { (void){0}; return 0; }",
     "E3114"},
    {"compound_literal_function_type",
     "int main(void) { (int (void)){0}; return 0; }",
     "E3114"},
    {"compound_literal_incomplete_record",
     "struct incomplete; int main(void) { (struct incomplete){0}; return 0; }",
     "E3114"},
    {"compound_literal_vla",
     "int main(int count, char **values) { (int[count]){1}; return values != 0; }",
     "E3064"},
    {"array_designator_negative",
     "int values[3] = {[-1] = 7}; int main(void) { return values[0]; }",
     "E3085"},
    {"array_designator_nonconstant",
     "static const int index_value = 1; int values[3] = {[index_value] = 7}; int main(void) { return values[1]; }",
     "E3085"},
    {"array_designator_out_of_bounds",
     "int values[3] = {[3] = 7}; int main(void) { return values[0]; }",
     "E3085"},
    {"struct_designator_unknown_member",
     "struct pair { int first; int second; }; struct pair value = {.missing = 7}; int main(void) { return value.first; }",
     "E3084"},
    {"scalar_array_designator",
     "int value = {[0] = 7}; int main(void) { return value; }",
     "E3064"},
    ...
    {"sizeof_incomplete_type_rejected",
     "struct incomplete; int main(void) { return (int)sizeof(struct incomplete); }",
     "E3117"},
    {"sizeof_incomplete_expression_rejected",
     "struct incomplete; int main(void) { return (int)sizeof(*(struct incomplete *)0); }",
     "E3117"},
    {"sizeof_incomplete_array_type_rejected",
     "int main(void) { return (int)sizeof(int[]); }",
     "E3117"},
    {"sizeof_incomplete_array_expression_rejected",
     "extern int values[]; int main(void) { return (int)sizeof(values); }",
     "E3117"},
    {"sizeof_flexible_array_member_rejected",
     "struct packet { int length; unsigned char payload[]; }; "
     "int main(void) { struct packet *packet = 0; "
     "return (int)sizeof(packet->payload); }",
     "E3117"},
    {"sizeof_function_expression_rejected",
     "int function(void); int main(void) { return (int)sizeof(function); }",
     "E3117"},
    {"sizeof_function_type_rejected",
     "int main(void) { return (int)sizeof(int(void)); }",
     "E3117"},
    {"alignof_incomplete_type_rejected",
     "struct incomplete; int main(void) { return (int)_Alignof(struct incomplete); }",
     "E3117"},
    ...
    {"sizeof_bitfield_rejected",
     "struct bits { unsigned value : 3; }; int main(void) { struct bits value = {1}; return (int)sizeof(value.value); }",
     "E3118"},
    {"address_of_register_object_rejected",
     "int main(void) { register int value = 1; return &value != 0; }",
     "E3119"},
    {"address_generic_selected_register_object_rejected",
     "int main(void) { register int value = 1; return &_Generic(0, int: value, default: value) != 0; }",
     "E3119"},
    {"address_generic_selected_register_member_rejected",
     "struct pair { int first; int second; }; int main(void) { register struct pair value = {1, 2}; return &_Generic(0, int: value.first, default: value.second) != 0; }",
     "E3119"},
    {"address_generic_selected_register_array_rejected",
     "int main(void) { register int values[3] = {1, 2, 3}; return &_Generic(0, int: values, default: values) != 0; }",
     "E3119"},
    ...
    {"address_of_register_member_rejected",
     ...
     "E3119"},
    {"subscript_nonpointer_operands_rejected",
     "int main(void) { return 1[2]; }",
     "E3064"},
    {"call_nonfunction_object_rejected",
     "int main(void) { int value = 1; return value(); }",
     "E3102"},
    {"call_argument_discards_const_rejected",
     "static int read(int *value) { return *value; } int main(void) { const int value = 1; return read(&value); }",
     "E3121"},
    {"call_argument_incompatible_pointer_rejected",
     "static int read(int *value) { return *value; } int main(void) { double value = 1.0; return read(&value); }",
     "E3120"},
    {"stdio_file_pointer_argument_rejected",
     "#include <stdio.h>\nint main(void) { int value = 0; return fclose(&value); }",
     "E3120"},
    ...
    {"call_argument_nonzero_integer_to_pointer_rejected",
     "static int read(int *value) { return value != 0; } int main(void) { return read(1); }",
     "E3120"},
    {"call_argument_pointer_to_integer_rejected",
     "static int read(int value) { return value; } int main(void) { int value = 1; return read(&value); }",
     "E3120"},
    {"call_argument_incompatible_struct_rejected",
     "struct first { int value; }; struct second { int value; }; static int read(struct first value) { return value.value; } int main(void) { struct second value = {1}; return read(value); }",
     "E3120"},
    {"call_argument_struct_to_integer_rejected",
     "struct value { int member; }; static int read(int value) { return value; } int main(void) { struct value value = {1}; return read(value); }",
     "E3120"},
    {"call_argument_integer_to_struct_rejected",
     "struct value { int member; }; static int read(struct value value) { return value.member; } int main(void) { return read(1); }",
     "E3120"},
    {"call_argument_adds_nested_const_rejected",
     "static int read(const int **value) { return **value; } int main(void) { int value = 1; int *pointer = &value; return read(&pointer); }",
     "E3120"},
    {"call_argument_discards_nested_const_rejected",
     "static int read(int **value) { return **value; } int main(void) { const int value = 1; const int *pointer = &value; return read(&pointer); }",
     "E3120"},
    {"call_argument_nested_const_pointer_rejected",
     "static int read(const int * const *value) { return **value; } int main(void) { int value = 1; int *pointer = &value; return read(&pointer); }",
     "E3120"},
    {"call_argument_incompatible_function_pointer_rejected",
     "static int unary(int value) { return value; } static int call(int (*callback)(double)) { return callback(1.0); } int main(void) { return call(unary); }",
     "E3120"},
    {"variadic_fixed_argument_incompatible_rejected",
     "static int read(int *value, ...) { return *value; } int main(void) { double value = 1.0; return read(&value, 2); }",
     "E3120"},
    {"variadic_fixed_argument_discards_const_rejected",
     "static int read(int *value, ...) { return *value; } int main(void) { const int value = 1; return read(&value, 2); }",
     "E3121"},
    {"return_discards_const_rejected",
     "static int *get(const int *value) { return value; } int main(void) { return get(0) != 0; }",
     "E3109"},
    {"return_incompatible_pointer_rejected",
     "static int *get(double *value) { return value; } int main(void) { return get(0) != 0; }",
     "E3108"},
    {"return_nonzero_integer_to_pointer_rejected",
     "static int *get(void) { return 1; } int main(void) { return get() != 0; }",
     "E3108"},
    {"return_pointer_to_integer_rejected",
     "static int get(int *value) { return value; } int main(void) { int value = 1; return get(&value); }",
     "E3108"},
    {"return_incompatible_struct_rejected",
     "struct first { int value; }; struct second { int value; }; static struct first get(void) { struct second value = {1}; return value; } int main(void) { return get().value; }",
     "E3108"},
    {"return_integer_to_struct_rejected",
     "struct value { int member; }; static struct value get(void) { return 1; } int main(void) { return get().member; }",
     "E3108"},
    {"return_struct_to_integer_rejected",
     "struct value { int member; }; static int get(void) { struct value value = {1}; return value; } int main(void) { return get(); }",
     "E3108"},
    {"binary_struct_equality_rejected",
     "struct value { int member; }; int main(void) { struct value left = {1}, right = {1}; return left == right; }",
     "E3122"},
    {"binary_pointer_nonzero_integer_equality_rejected",
     "int main(void) { int value = 1; return &value == 1; }",
     "E3122"},
    {"binary_pointer_float_equality_rejected",
     "int main(void) { int value = 1; return &value == 1.0; }",
     "E3122"},
    {"binary_incompatible_pointer_equality_rejected",
     "int main(void) { int integer = 1; double floating = 1.0; return &integer == &floating; }",
     "E3122"},
    {"binary_function_void_pointer_equality_rejected",
     "static int function(void) { return 1; } int main(void) { void *pointer = 0; return function == pointer; }",
     "E3122"},
    {"binary_complex_relational_rejected",
     "int main(void) { double _Complex left = 1.0, right = 2.0; return left < right; }",
     "E3122"},
    {"binary_complex_modulo_rejected",
     "int main(void) { double _Complex value = 5.0; return (int)(value % 2); }",
     "E3122"},
    ...
    {"binary_struct_relational_rejected",
     "struct value { int member; }; int main(void) { struct value left = {1}, right = {2}; return left < right; }",
     "E3122"},
    {"binary_pointer_integer_relational_rejected",
     "int main(void) { int value = 1; return &value < 1; }",
     "E3122"},
    {"binary_pointer_void_relational_rejected",
     "int main(void) { int value = 1; void *pointer = &value; return &value < pointer; }",
     "E3122"},
    {"binary_function_pointer_relational_rejected",
     "static int first(void) { return 1; } static int second(void) { return 2; } int main(void) { return first < second; }",
     "E3122"},
    {"binary_incompatible_pointer_relational_rejected",
     "int main(void) { int integer = 1; double floating = 1.0; return &integer < &floating; }",
     "E3122"},
    {"binary_struct_logical_and_rejected",
     "struct value { int member; }; int main(void) { struct value value = {1}; return value && 1; }",
     "E3122"},
    {"binary_struct_logical_or_rejected",
     "struct value { int member; }; int main(void) { struct value value = {1}; return 0 || value; }",
     "E3122"},
    {"binary_floating_modulo_rejected",
     "int main(void) { return (int)(5.0 % 2.0); }",
     "E3122"},
    {"binary_floating_bitwise_and_rejected",
     "int main(void) { return (int)(5.0 & 2.0); }",
     "E3122"},
    {"binary_integer_shift_pointer_rejected",
     "int main(void) { int value = 1; return 1 << &value; }",
     "E3122"},
    {"binary_pointer_add_floating_rejected",
     "int main(void) { int value = 1; return (&value + 1.0) != 0; }",
     "E3122"},
    {"binary_pointer_sub_floating_rejected",
     "int main(void) { int value = 1; return (&value - 1.0) != 0; }",
     "E3122"},
    {"binary_incompatible_pointer_subtraction_rejected",
     "int main(void) { int integer = 1; double floating = 1.0; return (int)(&integer - &floating); }",
     "E3122"},
    {"binary_incomplete_pointer_addition_rejected",
     "struct incomplete; int main(void) { struct incomplete *pointer = 0; return (pointer + 1) != 0; }",
     "E3122"},
    {"increment_void_pointer_rejected",
     "int main(void) { void *pointer = 0; pointer++; return pointer != 0; }",
     "E3123"},
    {"decrement_incomplete_pointer_rejected",
     "struct incomplete; int main(void) { struct incomplete *pointer = 0; --pointer; return pointer != 0; }",
     "E3123"},
    {"compound_void_pointer_add_rejected",
     "int main(void) { void *pointer = 0; pointer += 1; return pointer != 0; }",
     "E3099"},
    {"compound_incomplete_pointer_add_rejected",
     "struct incomplete; int main(void) { struct incomplete *pointer = 0; pointer += 1; return pointer != 0; }",
     "E3099"},
    {"compound_function_pointer_add_rejected",
     "static int function(void) { return 1; } int main(void) { int (*pointer)(void) = function; pointer += 1; return pointer != 0; }",
     "E3099"},
    {"compound_incomplete_array_pointer_add_rejected",
     "typedef int incomplete_array[]; int main(void) { incomplete_array *pointer = 0; pointer += 1; return pointer != 0; }",
     "E3099"},
    {"compound_complex_modulo_rejected",
     "int main(void) { double _Complex value = 5.0; value %= 2; return 0; }",
     "E3099"},
    ...
    {"conditional_pointer_nonzero_integer_rejected",
     "int main(void) { int value = 1; return *(1 ? &value : 1); }",
     "E3101"},
    {"conditional_incompatible_object_pointers_rejected",
     "int main(void) { int integer = 1; double floating = 2.0; return (1 ? &integer : &floating) != 0; }",
     "E3101"},
    {"conditional_function_void_pointer_rejected",
     "static int function(void) { return 1; } int main(void) { void *pointer = 0; return (1 ? function : pointer) != 0; }",
     "E3101"},
    {"conditional_different_structs_rejected",
     "struct first { int member; }; struct second { int member; }; int main(void) { struct first left = {1}; struct second right = {2}; (void)(1 ? left : right); return 0; }",
     "E3101"},
    {"conditional_incompatible_function_pointers_rejected",
     "static int first(int value) { return value; } static int second(double value) { return (int)value; } int main(void) { return (1 ? first : second) != 0; }",
     "E3101"},
    {"conditional_incompatible_nested_callback_pointers",
     "typedef int plain_callback(void); typedef const int qualified_callback(void); static int consume_plain(plain_callback *callback) { return callback(); } static int consume_qualified(qualified_callback *callback) { return callback(); } int main(void) { return (1 ? consume_plain : consume_qualified) != 0; }",
     "E3101"},
    {"conditional_incompatible_positive_enum_function_pointer",
     "enum positive_value { POSITIVE_ZERO = 0, POSITIVE_ONE = 1 }; static enum positive_value first(void) { return POSITIVE_ONE; } static int second(void) { return 1; } int main(void) { return (1 ? first : second) != 0; }",
     "E3101"},
    {"conditional_incompatible_negative_enum_function_pointer",
     "enum negative_value { NEGATIVE_ONE = -1, NEGATIVE_ZERO = 0 }; static enum negative_value first(void) { return NEGATIVE_ONE; } static unsigned int second(void) { return 1; } int main(void) { return (1 ? first : second) != 0; }",
     "E3101"},
    {"conditional_object_function_pointer_rejected",
     "static int function(void) { return 1; } int main(void) { int value = 1; return (1 ? &value : function) != 0; }",
     "E3101"},
    {"conditional_differently_qualified_array_pointers_rejected",
     "int main(void) { int (*left)[3] = 0; const int (*right)[3] = 0; return (1 ? left : right) != 0; }",
     "E3101"},
    {"conditional_atomic_nonatomic_pointers_rejected",
     "int main(void) { _Atomic int *left = 0; int *right = 0; return (1 ? left : right) != 0; }",
     "E3101"},
    {"enum_incompatible_integer_pointer",
     "enum positive_value { POSITIVE_ZERO = 0, POSITIVE_ONE = 1 }; int main(void) { enum positive_value value = POSITIVE_ONE; int *pointer = &value; return *pointer; }",
     "E3099"},
    {"enum_incompatible_nested_integer_pointer",
     "enum positive_value { POSITIVE_ZERO = 0, POSITIVE_ONE = 1 }; int main(void) { enum positive_value value = POSITIVE_ONE; enum positive_value *pointer = &value; int **nested = &pointer; return **nested; }",
     "E3099"},
    {"enum_negative_incompatible_nested_unsigned_pointer",
     "enum negative_value { NEGATIVE_ONE = -1, NEGATIVE_ZERO = 0 }; int main(void) { enum negative_value value = NEGATIVE_ONE; enum negative_value *pointer = &value; unsigned int **nested = &pointer; return **nested; }",
     "E3099"},
    {"distinct_enum_pointer_compatibility",
     "enum first_value { FIRST_ZERO = 0, FIRST_ONE = 1 }; enum second_value { SECOND_ZERO = 0, SECOND_ONE = 1 }; int main(void) { enum second_value value = SECOND_ONE; enum first_value *pointer = &value; return *pointer; }",
     "E3099"},
    {"assign_discards_const_pointer",
     "int main(void) { const int value = 7; const int *qualified = &value; int *invalid = qualified; return *invalid; }",
     "E3078"},
    {"argument_discards_const_pointer",
     "static int read_mutable(int *value) { return *value; } int main(void) { const int value = 7; return read_mutable(&value); }",
     "E3121"},
    {"return_discards_const_pointer",
     "static const int value = 7; static int *invalid_return(void) { return &value; } int main(void) { return *invalid_return(); }",
     "E3109"},
    {"add_const_through_double_pointer",
     "int main(void) { int value = 7; int *mutable = &value; const int **invalid = &mutable; return **invalid; }",
     "E3099"},
    {"discard_const_through_double_pointer",
     "int main(void) { const int value = 7; const int *qualified = &value; int **invalid = &qualified; return **invalid; }",
     "E3099"},
    {"object_double_pointer_to_void_double_pointer",
     "int main(void) { int value = 7; int *pointer = &value; void **invalid = &pointer; return invalid == 0; }",
     "E3099"},
    {"function_pointer_to_void_pointer",
     "static int answer(void) { return 42; } int main(void) { void *invalid = answer; return invalid == 0; }",
     "E3099"},
    {"void_pointer_to_function_pointer",
     "int main(void) { void *object_pointer = 0; int (*invalid)(void) = object_pointer; return invalid == 0; }",
     "E3099"},
    {"compare_function_and_void_pointers",
     "static int answer(void) { return 42; } int main(void) { void *object_pointer = 0; return answer == object_pointer; }",
     "E3122"},
    {"conditional_function_and_void_pointers",
     "static int answer(void) { return 42; } int main(void) { int choose = 1; void *invalid = choose ? answer : (void *)0; return invalid == 0; }",
     "E3099"},
    {"assign_incompatible_function_pointer",
     "static int increment(int value) { return value + 1; } int main(void) { double (*invalid)(double) = increment; return invalid(1.0) != 2.0; }",
     "E3099"},
    {"compare_incompatible_function_pointers",
     "static int increment(int value) { return value + 1; } static double half(double value) { return value / 2.0; } int main(void) { return increment == half; }",
     "E3122"},
    {"argument_incompatible_function_pointer",
     "static int increment(int value) { return value + 1; } static double apply(double (*callback)(double), double value) { return callback(value); } int main(void) { return apply(increment, 1.0) != 2.0; }",
     "E3120"},
    {"return_incompatible_function_pointer",
     "static int increment(int value) { return value + 1; } static double (*invalid_return(void))(double) { return increment; } int main(void) { return invalid_return()(1.0) != 2.0; }",
     "E3108"},
    {"assign_incompatible_nested_callback_pointer",
     "typedef int plain_callback(void); typedef const int qualified_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(qualified_callback *callback) { return callback(); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"compare_incompatible_nested_callback_pointers",
     "typedef int plain_callback(void); typedef const int qualified_callback(void); static int consume_plain(plain_callback *callback) { return callback(); } static int consume_qualified(qualified_callback *callback) { return callback(); } int main(void) { return consume_plain == consume_qualified; }",
     "E3122"},
    {"argument_incompatible_nested_callback_pointer",
     "typedef int plain_callback(void); typedef const int qualified_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(qualified_callback *callback) { return callback(); } static int apply(plain_consumer *consumer, plain_callback *callback) { return consumer(callback); } static int value(void) { return 42; } int main(void) { return apply(consume, value) != 42; }",
     "E3120"},
    {"return_incompatible_nested_callback_pointer",
     "typedef int plain_callback(void); typedef const int qualified_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(qualified_callback *callback) { return callback(); } static plain_consumer *invalid_return(void) { return consume; } int main(void) { return invalid_return() == 0; }",
     "E3108"},
    {"function_return_qualifier_redeclaration_mismatch",
     "int qualified_result(void); const int qualified_result(void) { return 42; } int main(void) { return qualified_result() != 42; }",
     "E3064"},
    {"function_pointer_return_qualifier_redeclaration_mismatch",
     "int *pointer_result(void); int *const pointer_result(void) { static int value = 42; return &value; } int main(void) { return *pointer_result() != 42; }",
     "E3064"},
    {"nested_array_inner_bound_function_redeclaration_mismatch",
     "int sum_cube(int (*cube)[][3]); int sum_cube(int (*cube)[][4]) { return (*cube)[0][0]; } int main(void) { int values[1][3] = {{42, 0, 0}}; return sum_cube(&values) != 42; }",
     "E3064"},
    {"nested_array_inner_bound_function_pointer_mismatch",
     "static int sum_cube(int (*cube)[][3]) { return (*cube)[0][0]; } int main(void) { int (*invalid)(int (*)[][4]) = sum_cube; return invalid == 0; }",
     "E3099"},
    {"nested_callback_return_array_bound_redeclaration_mismatch",
     "typedef int cube_three[][3]; typedef int cube_four[][4]; typedef cube_three *factory_three(void); typedef cube_four *factory_four(void); int consume_factory(factory_three *factory); int consume_factory(factory_four *factory) { return (*factory())[0][0]; } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_return_array_bound_pointer_mismatch",
     "typedef int cube_three[][3]; typedef int cube_four[][4]; typedef cube_three *factory_three(void); typedef cube_four *factory_four(void); static int consume_factory(factory_three *factory) { return (*factory())[0][0]; } int main(void) { int (*invalid)(factory_four *) = consume_factory; return invalid == 0; }",
     "E3099"},
    {"function_return_qualifier_pointer_mismatch",
     "static const int qualified_result(void) { return 42; } int main(void) { int (*invalid)(void) = qualified_result; return invalid() != 42; }",
     "E3099"},
    {"nested_callback_return_qualifier_redeclaration_mismatch",
     "typedef int plain_callback(void); typedef const int qualified_callback(void); int consume(plain_callback *callback); int consume(qualified_callback *callback) { return callback(); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_return_qualifier_pointer_mismatch",
     "typedef int plain_callback(void); typedef const int qualified_callback(void); static int consume(qualified_callback *callback) { return callback(); } int main(void) { int (*invalid)(plain_callback *) = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_pointer_return_qualifier_redeclaration_mismatch",
     "typedef int *plain_callback(void); typedef int *const qualified_callback(void); int consume(plain_callback *callback); int consume(qualified_callback *callback) { return *callback(); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_pointer_return_qualifier_pointer_mismatch",
     "typedef int *plain_callback(void); typedef int *const qualified_callback(void); static int consume(qualified_callback *callback) { return *callback(); } int main(void) { int (*invalid)(plain_callback *) = consume; return invalid == 0; }",
     "E3099"},
    ...
    {"nested_callback_array_element_qualifier_redeclaration_mismatch",
     "typedef int plain_callback(int values[2]); typedef int qualified_callback(const int values[2]); int consume(plain_callback *callback); int consume(qualified_callback *callback) { int values[2] = {19, 23}; return callback(values); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_array_element_qualifier_pointer_mismatch",
     "typedef int plain_callback(int values[2]); typedef int qualified_callback(const int values[2]); static int consume(qualified_callback *callback) { int values[2] = {19, 23}; return callback(values); } int main(void) { int (*invalid)(plain_callback *) = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_unprototyped_narrow_redeclaration_mismatch",
     "typedef int unprototyped_callback(); typedef int narrow_callback(signed char); int consume(unprototyped_callback *callback); int consume(narrow_callback *callback) { return callback(42); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_unprototyped_narrow_pointer_mismatch",
     "typedef int unprototyped_callback(); typedef int narrow_callback(signed char); static int consume(narrow_callback *callback) { return callback(42); } int main(void) { int (*invalid)(unprototyped_callback *) = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_variadic_redeclaration_mismatch",
     "typedef int fixed_callback(int); typedef int variadic_callback(int, ...); int consume(fixed_callback *callback); int consume(variadic_callback *callback) { return callback(42, 0); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_variadic_pointer_mismatch",
     "typedef int fixed_callback(int); typedef int variadic_callback(int, ...); static int consume(variadic_callback *callback) { return callback(42, 0); } int main(void) { int (*invalid)(fixed_callback *) = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_return_function_narrow_redeclaration_mismatch",
     "typedef int unprototyped_target(); typedef int narrow_target(signed char); typedef unprototyped_target *unprototyped_factory(void); typedef narrow_target *narrow_factory(void); int consume(unprototyped_factory *factory); int consume(narrow_factory *factory) { return factory()(42); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_return_function_narrow_pointer_mismatch",
     "typedef int unprototyped_target(); typedef int narrow_target(signed char); typedef unprototyped_target *unprototyped_factory(void); typedef narrow_target *narrow_factory(void); static int consume(narrow_factory *factory) { return factory()(42); } int main(void) { int (*invalid)(unprototyped_factory *) = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_array_element_redeclaration_mismatch",
     "typedef int plain_callback(int values[1]); typedef int atomic_callback(_Atomic(int) values[1]); int consume(plain_callback *callback); int consume(atomic_callback *callback) { _Atomic(int) values[1] = {42}; return callback(values); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_array_element_pointer_mismatch",
     "typedef int plain_callback(int values[1]); typedef int atomic_callback(_Atomic(int) values[1]); static int consume(atomic_callback *callback) { _Atomic(int) values[1] = {42}; return callback(values); } int main(void) { int (*invalid)(plain_callback *) = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_return_volatile_pointer_pointer_mismatch",
     "typedef int *plain_callback(void); typedef int *volatile qualified_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(qualified_callback *callback) { return *callback(); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_return_restrict_pointer_pointer_mismatch",
     "typedef int *plain_callback(void); typedef int *restrict qualified_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(qualified_callback *callback) { return *callback(); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_return_atomic_pointer_pointer_mismatch",
     "typedef int *plain_callback(void); typedef _Atomic(int *) atomic_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(int *) pointer = callback(); return *pointer; } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_return_atomic_pointee_pointer_mismatch",
     "typedef int *plain_callback(void); typedef _Atomic(int) *atomic_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { return *callback(); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_return_function_const_pointer_mismatch",
     "typedef int target(int); typedef target *plain_factory(void); typedef target *const qualified_factory(void); typedef int plain_consumer(plain_factory *factory); static int consume(qualified_factory *factory) { return factory()(42); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_return_function_volatile_pointer_mismatch",
     "typedef int target(int); typedef target *plain_factory(void); typedef target *volatile qualified_factory(void); typedef int plain_consumer(plain_factory *factory); static int consume(qualified_factory *factory) { return factory()(42); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_return_function_atomic_pointer_mismatch",
     "typedef int target(int); typedef target *plain_factory(void); typedef _Atomic(target *) atomic_factory(void); typedef int plain_consumer(plain_factory *factory); static int consume(atomic_factory *factory) { _Atomic(target *) callback = factory(); return callback(42); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_function_pointer_parameter_redeclaration_mismatch",
     "typedef int target(int); typedef int plain_callback(target *function); typedef int atomic_callback(_Atomic(target *) function); int consume(plain_callback *callback); int consume(atomic_callback *callback) { _Atomic(target *) function = 0; return callback(function); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_function_pointer_parameter_pointer_mismatch",
     "typedef int target(int); typedef int plain_callback(target *function); typedef int atomic_callback(_Atomic(target *) function); static int consume(atomic_callback *callback) { _Atomic(target *) function = 0; return callback(function); } int main(void) { int (*invalid)(plain_callback *) = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_const_small_aggregate_return_pointer_mismatch",
     "struct pair { int left; int right; }; typedef struct pair plain_callback(void); typedef const struct pair qualified_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(qualified_callback *callback) { struct pair value = callback(); return value.left + value.right; } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_volatile_large_aggregate_return_pointer_mismatch",
     "struct packet { int values[6]; }; typedef struct packet plain_callback(void); typedef volatile struct packet qualified_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(qualified_callback *callback) { struct packet value = callback(); return value.values[0]; } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_const_aggregate_return_redeclaration_mismatch",
     "struct pair { int left; int right; }; typedef struct pair plain_callback(void); typedef const struct pair qualified_callback(void); int consume(plain_callback *callback); int consume(qualified_callback *callback) { struct pair value = callback(); return value.left + value.right; } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_aggregate_return_pointer_mismatch",
     "struct pair { int left; int right; }; typedef struct pair plain_callback(void); typedef _Atomic(struct pair) atomic_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(struct pair) value = callback(); return sizeof value; } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_aggregate_return_redeclaration_mismatch",
     "struct pair { int left; int right; }; typedef struct pair plain_callback(void); typedef _Atomic(struct pair) atomic_callback(void); int consume(plain_callback *callback); int consume(atomic_callback *callback) { _Atomic(struct pair) value = callback(); return sizeof value; } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_large_atomic_aggregate_return_pointer_mismatch",
     "struct words3 { unsigned int first; unsigned int second; unsigned int third; }; typedef struct words3 plain_callback(void); typedef _Atomic(struct words3) atomic_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(struct words3) value = callback(); return sizeof value; } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_large_atomic_aggregate_return_redeclaration_mismatch",
     "struct words3 { unsigned int first; unsigned int second; unsigned int third; }; typedef struct words3 plain_callback(void); typedef _Atomic(struct words3) atomic_callback(void); int consume(plain_callback *callback); int consume(atomic_callback *callback) { _Atomic(struct words3) value = callback(); return sizeof value; } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_large_atomic_aggregate_parameter_pointer_mismatch",
     "struct words3 { unsigned int first; unsigned int second; unsigned int third; }; typedef int plain_callback(struct words3 value); typedef int atomic_callback(_Atomic(struct words3) value); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(struct words3) value = (struct words3){19, 11, 12}; return callback(value); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_large_atomic_aggregate_parameter_redeclaration_mismatch",
     "struct words3 { unsigned int first; unsigned int second; unsigned int third; }; typedef int plain_callback(struct words3 value); typedef int atomic_callback(_Atomic(struct words3) value); int consume(plain_callback *callback); int consume(atomic_callback *callback) { _Atomic(struct words3) value = (struct words3){19, 11, 12}; return callback(value); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_large_atomic_union_parameter_pointer_mismatch",
     "union words3 { unsigned int words[3]; unsigned char bytes[12]; }; typedef int plain_callback(union words3 value); typedef int atomic_callback(_Atomic(union words3) value); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(union words3) value = (union words3){.words = {19, 11, 12}}; return callback(value); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_large_atomic_union_parameter_redeclaration_mismatch",
     "union words3 { unsigned int words[3]; unsigned char bytes[12]; }; typedef int plain_callback(union words3 value); typedef int atomic_callback(_Atomic(union words3) value); int consume(plain_callback *callback); int consume(atomic_callback *callback) { _Atomic(union words3) value = (union words3){.words = {19, 11, 12}}; return callback(value); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_complex_parameter_pointer_mismatch",
     "typedef int plain_callback(float _Complex value); typedef int atomic_callback(_Atomic(float _Complex) value); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(float _Complex) value = 0; return callback(value); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_complex_parameter_redeclaration_mismatch",
     "typedef int plain_callback(double _Complex value); typedef int atomic_callback(_Atomic(double _Complex) value); int consume(plain_callback *callback); int consume(atomic_callback *callback) { _Atomic(double _Complex) value = 0; return callback(value); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_distinct_enum_parameter_pointer_mismatch",
     "enum left_state { LEFT_NEGATIVE = -1, LEFT_VALUE = 42 }; enum right_state { RIGHT_NEGATIVE = -1, RIGHT_VALUE = 42 }; typedef int left_callback(_Atomic(enum left_state) value); typedef int right_callback(_Atomic(enum right_state) value); typedef int left_consumer(left_callback *callback); static int consume(right_callback *callback) { _Atomic(enum right_state) value = RIGHT_VALUE; return callback(value); } int main(void) { left_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_enum_signedness_parameter_redeclaration_mismatch",
     "enum unsigned_state { STATE_ZERO = 0, STATE_VALUE = 42 }; typedef int enum_callback(_Atomic(enum unsigned_state) value); typedef int signed_callback(_Atomic(int) value); int consume(enum_callback *callback); int consume(signed_callback *callback) { _Atomic(int) value = 42; return callback(value); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_subinteger_parameter_pointer_mismatch",
     "typedef int plain_callback(_Bool value); typedef int atomic_callback(_Atomic(_Bool) value); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(_Bool) value = 1; return callback(value); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_subinteger_signedness_parameter_redeclaration_mismatch",
     "typedef int unsigned_callback(_Atomic(unsigned short) value); typedef int signed_callback(_Atomic(short) value); int consume(unsigned_callback *callback); int consume(signed_callback *callback) { _Atomic(short) value = -17; return callback(value); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_floating_parameter_pointer_mismatch",
     "typedef int plain_callback(double value); typedef int atomic_callback(_Atomic(double) value); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(double) value = 17.5; return callback(value); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_floating_rank_parameter_redeclaration_mismatch",
     "typedef int double_callback(_Atomic(double) value); typedef int long_double_callback(_Atomic(long double) value); int consume(double_callback *callback); int consume(long_double_callback *callback) { _Atomic(long double) value = 17.5L; return callback(value); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_long_parameter_pointer_mismatch",
     "typedef int plain_callback(long value); typedef int atomic_callback(_Atomic(long) value); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(long) value = -5000000000L; return callback(value); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_long_rank_parameter_redeclaration_mismatch",
     "typedef int long_callback(_Atomic(long) value); typedef int long_long_callback(_Atomic(long long) value); int consume(long_callback *callback); int consume(long_long_callback *callback) { _Atomic(long long) value = -5000000000LL; return callback(value); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_long_signedness_parameter_pointer_mismatch",
     "typedef int signed_callback(_Atomic(long) value); typedef int unsigned_callback(_Atomic(unsigned long) value); typedef int signed_consumer(signed_callback *callback); static int consume(unsigned_callback *callback) { _Atomic(unsigned long) value = 4000000000UL; return callback(value); } int main(void) { signed_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_pointer_parameter_pointer_mismatch",
     "typedef int plain_callback(int *value); typedef int atomic_callback(_Atomic(int *) value); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { int pointee = 42; _Atomic(int *) value = &pointee; return callback(value); } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_pointer_pointee_parameter_redeclaration_mismatch",
     "typedef int atomic_pointer_callback(_Atomic(int *) value); typedef int atomic_pointee_callback(_Atomic(int) *value); int consume(atomic_pointer_callback *callback); int consume(atomic_pointee_callback *callback) { _Atomic(int) value = 42; return callback(&value); } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_complex_return_pointer_mismatch",
     "typedef double _Complex plain_callback(void); typedef _Atomic(double _Complex) atomic_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(double _Complex) value = callback(); return sizeof value; } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_complex_return_redeclaration_mismatch",
     "typedef float _Complex plain_callback(void); typedef _Atomic(float _Complex) atomic_callback(void); int consume(plain_callback *callback); int consume(atomic_callback *callback) { _Atomic(float _Complex) value = callback(); return sizeof value; } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_union_return_pointer_mismatch",
     "union wide { unsigned long long words[2]; unsigned char bytes[16]; }; typedef union wide plain_callback(void); typedef _Atomic(union wide) atomic_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(union wide) value = callback(); return sizeof value; } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_union_return_redeclaration_mismatch",
     "union word { unsigned int bits; float value; }; typedef union word plain_callback(void); typedef _Atomic(union word) atomic_callback(void); int consume(plain_callback *callback); int consume(atomic_callback *callback) { _Atomic(union word) value = callback(); return sizeof value; } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_distinct_enum_return_pointer_mismatch",
     "enum left_state { LEFT_NEGATIVE = -1, LEFT_VALUE = 42 }; enum right_state { RIGHT_NEGATIVE = -1, RIGHT_VALUE = 42 }; typedef _Atomic(enum left_state) left_callback(void); typedef _Atomic(enum right_state) right_callback(void); typedef int left_consumer(left_callback *callback); static int consume(right_callback *callback) { _Atomic(enum right_state) value = callback(); return value; } int main(void) { left_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_enum_signedness_return_redeclaration_mismatch",
     "enum unsigned_state { STATE_ZERO = 0, STATE_VALUE = 42 }; typedef _Atomic(enum unsigned_state) enum_callback(void); typedef _Atomic(int) signed_callback(void); int consume(enum_callback *callback); int consume(signed_callback *callback) { _Atomic(int) value = callback(); return value; } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_subinteger_return_pointer_mismatch",
     "typedef _Bool plain_callback(void); typedef _Atomic(_Bool) atomic_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(_Bool) value = callback(); return value; } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_subinteger_signedness_return_redeclaration_mismatch",
     "typedef _Atomic(unsigned short) unsigned_callback(void); typedef _Atomic(short) signed_callback(void); int consume(unsigned_callback *callback); int consume(signed_callback *callback) { _Atomic(short) value = callback(); return value; } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_floating_return_pointer_mismatch",
     "typedef double plain_callback(void); typedef _Atomic(double) atomic_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(double) value = callback(); return value == 0.0; } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_floating_rank_return_redeclaration_mismatch",
     "typedef _Atomic(double) double_callback(void); typedef _Atomic(long double) long_double_callback(void); int consume(double_callback *callback); int consume(long_double_callback *callback) { _Atomic(long double) value = callback(); return value == 0.0L; } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_long_return_pointer_mismatch",
     "typedef long plain_callback(void); typedef _Atomic(long) atomic_callback(void); typedef int plain_consumer(plain_callback *callback); static int consume(atomic_callback *callback) { _Atomic(long) value = callback(); return value == 0; } int main(void) { plain_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"nested_callback_atomic_long_rank_return_redeclaration_mismatch",
     "typedef _Atomic(long) long_callback(void); typedef _Atomic(long long) long_long_callback(void); int consume(long_callback *callback); int consume(long_long_callback *callback) { _Atomic(long long) value = callback(); return value == 0; } int main(void) { return 0; }",
     "E3064"},
    {"nested_callback_atomic_long_signedness_return_pointer_mismatch",
     "typedef _Atomic(long) signed_callback(void); typedef _Atomic(unsigned long) unsigned_callback(void); typedef int signed_consumer(signed_callback *callback); static int consume(unsigned_callback *callback) { _Atomic(unsigned long) value = callback(); return value == 0; } int main(void) { signed_consumer *invalid = consume; return invalid == 0; }",
     "E3099"},
    {"initializer_plain_to_atomic_pointer_rejected",
     "int main(void) { int value = 1; _Atomic int *pointer = &value; return *pointer; }",
     "E3099"},
    {"initializer_atomic_to_plain_pointer_rejected",
     "int main(void) { _Atomic int value = 1; int *pointer = &value; return *pointer; }",
     "E3099"},
    {"assignment_plain_to_atomic_pointer_rejected",
     "int main(void) { int value = 1; _Atomic int *pointer = 0; pointer = &value; return *pointer; }",
     "E3099"},
    {"call_plain_to_atomic_pointer_rejected",
     "static int read(_Atomic int *pointer) { return *pointer; } int main(void) { int value = 1; return read(&value); }",
     "E3120"},
    {"call_atomic_to_plain_pointer_rejected",
     "static int read(int *pointer) { return *pointer; } int main(void) { _Atomic int value = 1; return read(&value); }",
     "E3120"},
    {"return_plain_to_atomic_pointer_rejected",
     "static _Atomic int *get(int *pointer) { return pointer; } int main(void) { int value = 1; return *get(&value); }",
     "E3108"},
    {"return_atomic_to_plain_pointer_rejected",
     "static int *get(_Atomic int *pointer) { return pointer; } int main(void) { _Atomic int value = 1; return *get(&value); }",
     "E3108"},
    {"binary_atomic_plain_pointer_equality_rejected",
     "int main(void) { int left = 1; _Atomic int right = 1; return &left == &right; }",
     "E3122"},
    {"binary_atomic_plain_pointer_relational_rejected",
     "int main(void) { int left = 1; _Atomic int right = 1; return &left < &right; }",
     "E3122"},
    {"binary_atomic_plain_pointer_subtraction_rejected",
     "int main(void) { int left = 1; _Atomic int right = 1; return (int)(&left - &right); }",
     "E3122"},
    {"initializer_const_array_pointer_to_plain_rejected",
     "int main(void) { const int values[3] = {0}; int (*pointer)[3] = &values; return (*pointer)[0]; }",
     "E3078"},
    {"call_const_array_pointer_to_plain_rejected",
     "static int read(int (*pointer)[3]) { return (*pointer)[0]; } int main(void) { const int values[3] = {0}; return read(&values); }",
     "E3121"},
    {"return_const_array_pointer_to_plain_rejected",
     "static int (*get(const int (*pointer)[3]))[3] { return pointer; } int main(void) { const int values[3] = {0}; return (*get(&values))[0]; }",
     "E3109"},
    {"dot_nonaggregate_operand_rejected",
     "int main(void) { int value = 1; return value.member; }",
     "E3005"},
    {"arrow_nonpointer_operand_rejected",
     "struct value { int member; }; int main(void) { struct value value = {1}; return value->member; }",
     "E3005"},
    {"address_of_rvalue_rejected",
     "int main(void) { return &(1) != 0; }",
     "E3112"},
    {"address_generic_selected_bitfield_rejected",
     "struct bits { unsigned value : 3; }; int main(void) { struct bits b = {0}; return &_Generic(0, int: b.value, default: b) != 0; }",
     "E3113"},
    {"dereference_nonpointer_rejected",
     "int main(void) { return *1; }",
     "E3064"},
    {"unary_plus_pointer_rejected",
     "int main(void) { int value = 1; int *pointer = &value; return +pointer != 0; }",
     "E3064"},
    {"bitwise_not_pointer_rejected",
     "int main(void) { int value = 1; int *pointer = &value; return ~pointer != 0; }",
     "E3064"},
    {"bitwise_not_complex_rejected",
     "int main(void) { double _Complex value = 5.0; return (int)~value; }",
     "E3064"},
    ...
    {"default_outside_switch",
     ...
     "E3068"},
    {"duplicate_label",
     "int main(void) { label: goto label; label: return 0; }",
     "E3067"},
    {"duplicate_default",
     "int main(int value, char **args) { (void)args; switch (value) { default: return 1; default: return 2; } }",
     "E3061"},
    {"duplicate_case_simple",
     "int main(int value, char **args) { (void)args; switch (value) { case 1: return 1; case 1: return 2; } return 0; }",
     "E3060"},
    {"goto_undefined_label",
     "int main(void) { goto missing; return 0; }",
     "E3064"},
    {"case_nonconstant_expression",
     "static int runtime_value(void) { return 1; } int main(int value, char **args) { (void)args; switch (value) { case runtime_value(): return 1; } return 0; }",
     "E3064"},
    {"switch_complex_control_rejected",
     "int main(void) { double _Complex value = 5.0; switch (value) { default: return 0; } }",
     "E3107"},
    ...
    {"alignas_redeclaration_missing_definition_rejected",
     "_Alignas(16) extern int value; int value; int main(void) { return value; }",
     "E3064"},
    {"alignas_redeclaration_conflict_rejected",
     "_Alignas(8) extern int value; _Alignas(16) int value; int main(void) { return value; }",
     "E3064"},
    {"alignas_zero_missing_definition_rejected",
     "_Alignas(0) extern int value; int value; int main(void) { return value; }",
     "E3064"},
    {"alignas_zero_conflicts_strict_rejected",
     "_Alignas(0) extern int value; _Alignas(16) int value; int main(void) { return value; }",
     "E3064"},
    {"alignas_aligned_then_plain_tentative_rejected",
     "_Alignas(16) int value; int value; int main(void) { return value; }",
     "E3064"},
    {"alignas_definition_then_aligned_extern_rejected",
     "int value = 1; _Alignas(16) extern int value; int main(void) { return value; }",
     "E3064"},
    ...
    {"inline_function_pointer_object_rejected",
     "inline int (*function_pointer)(void); int main(void) { return 0; }",
     "E3064"},
    {"noreturn_function_pointer_object_rejected",
     "_Noreturn int (*function_pointer)(void); int main(void) { return 0; }",
     "E3064"},
    {"inline_mixed_function_object_declarators_rejected",
     "inline int function(void), object; int main(void) { return 0; }",
     "E3064"},
    {"noreturn_mixed_function_object_declarators_rejected",
     "_Noreturn int function(void), object; int main(void) { return 0; }",
     "E3064"},
    {"inline_function_pointer_parameter_rejected",
     "int caller(inline int (*callback)(void)); int main(void) { return 0; }",
     "E3064"},
    {"noreturn_function_pointer_parameter_rejected",
     "int caller(_Noreturn int (*callback)(void)); int main(void) { return 0; }",
     "E3064"},
    {"inline_function_pointer_member_rejected",
     "struct holder { inline int (*callback)(void); }; int main(void) { return 0; }",
     "E3064"},
    {"noreturn_function_pointer_member_rejected",
     "struct holder { _Noreturn int (*callback)(void); }; int main(void) { return 0; }",
     "E3064"},
    {"inline_function_type_name_rejected",
     "int main(void) { return sizeof(inline int (void)); }",
     "E3064"},
    {"noreturn_function_type_name_rejected",
     "int main(void) { return sizeof(_Noreturn int (void)); }",
     "E3064"},
    {"file_scope_auto_rejected",
     "auto int value; int main(void) { return 0; }",
     "E3064"},
    {"file_scope_register_rejected",
     "register int value; int main(void) { return 0; }",
     "E3064"},
    {"block_thread_local_without_static_or_extern_rejected",
     "int main(void) { _Thread_local int value; return value; }",
     "E3064"},
    {"thread_local_function_declaration_rejected",
     "_Thread_local int function(void); int main(void) { return 0; }",
     "E3064"},
    {"auto_function_definition_rejected",
     "auto int function(void) { return 0; } int main(void) { return function(); }",
     "E3064"},
    {"block_static_function_declaration_rejected",
     "int main(void) { static int function(void); return 0; }",
     "E3064"},
    {"static_parameter_rejected",
     "int function(static int value) { return value; } int main(void) { return 0; }",
     "E3064"},
    {"extern_parameter_rejected",
     "int function(extern int value) { return value; } int main(void) { return 0; }",
     "E3064"},
    {"static_aggregate_member_rejected",
     "struct value { static int member; }; int main(void) { return 0; }",
     "E3064"},
    {"thread_local_aggregate_member_rejected",
     "struct value { _Thread_local int member; }; int main(void) { return 0; }",
     "E3064"},
    {"typedef_with_static_rejected",
     "typedef static int value_type; int main(void) { return 0; }",
     "E3064"},
    {"duplicate_thread_local_rejected",
     "_Thread_local int _Thread_local value; int main(void) { return 0; }",
     "E3064"},
    {"thread_local_redeclaration_missing_specifier_rejected",
     "_Thread_local int value; extern int value; int main(void) { return 0; }",
     "E3064"},
    {"thread_local_redeclaration_added_specifier_rejected",
     "extern int value; extern _Thread_local int value; int main(void) { return 0; }",
     "E3064"},
    {"storage_class_on_standalone_tag_rejected",
     "static struct value; int main(void) { return 0; }",
     "E3064"},
    {"post_type_storage_class_in_type_name_rejected",
     "int main(void) { return sizeof(int static); }",
     "E3064"},
    {"object_extern_then_static_linkage_rejected",
     "extern int value; static int value; int main(void) { return 0; }",
     "E3064"},
    {"object_static_then_plain_linkage_rejected",
     "static int value; int value; int main(void) { return 0; }",
     "E3064"},
    {"object_plain_then_static_linkage_rejected",
     "int value; static int value; int main(void) { return 0; }",
     "E3064"},
    {"function_extern_then_static_linkage_rejected",
     "extern int function(void); static int function(void); int main(void) { return 0; }",
     "E3064"},
    {"function_plain_then_static_linkage_rejected",
     "int function(void); static int function(void); int main(void) { return 0; }",
     "E3064"},
    {"block_extern_then_file_static_linkage_rejected",
     "int main(void) { extern int value; return 0; } static int value;",
     "E3064"},
    {"thread_local_extern_then_static_linkage_rejected",
     "extern _Thread_local int value; static _Thread_local int value; int main(void) { return 0; }",
     "E3064"},
    ...
    {"atomic_aggregate_callback_return_rejected",
     ...
     "struct bytes3 atomic_identity(_Atomic(struct bytes3) value) "
     "{ return value; } "
     "plain_callback *pick_plain(void) "
     "{ return atomic_identity; } "
     "int main(void) { return pick_plain() != 0; }",
     "E3108"},
