...
static const compile_fail_case_t compile_fail_cases[] = {
    ...
    {"array_of_flexible_record_rejected",
     ...
     "E3064"},
    {"array_parameter_nested_qualifier_rejected",
     "fixture:test/fixtures/should_reject/"
     "array_parameter_nested_qualifier.c",
     "E3064"},
    {"array_static_bound_outside_parameter_rejected",
     "fixture:test/fixtures/should_reject/"
     "array_static_bound_outside_parameter.c",
     "E3064"},
    {"file_scope_vla_rejected",
     "fixture:test/fixtures/should_reject/file_scope_vla.c",
     "E3064"},
    {"static_local_vla_rejected",
