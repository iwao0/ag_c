...
const expectedWasmProbeRegistrationExclusions = [
  ...
  "anonymous_flexible_function_signature_xtu_other.c",
...
const wasmMultiTuProbeFixtures = [
  ...
  "overaligned_callback_value_abi_xtu_main.c",
  "overaligned_callback_value_abi_xtu_other.c",
  "overaligned_variadic_value_abi_xtu_main.c",
  "overaligned_variadic_value_abi_xtu_other.c",
  "overaligned_named_parameter_variadic_abi_xtu_main.c",
  "overaligned_named_parameter_variadic_abi_xtu_other.c",
  "overaligned_va_list_forwarding_xtu_main.c",
  "overaligned_va_list_forwarding_xtu_other.c",
  "overaligned_variadic_return_abi_xtu_main.c",
  "overaligned_variadic_return_abi_xtu_other.c",
  "overaligned_vla_parameter_qualifier_xtu_main.c",
  "overaligned_vla_parameter_qualifier_xtu_other.c",
  "overaligned_vla_global_callback_xtu_main.c",
  "overaligned_vla_global_callback_xtu_other.c",
  "overaligned_vla_callback_factory_xtu_main.c",
  ...
  "atomic_enum_aligned_record_signature_xtu_main.c",
  "atomic_enum_aligned_record_signature_xtu_other.c",
  "atomic_enum_anonymous_union_data_signature_xtu_main.c",
  "atomic_enum_anonymous_union_data_signature_xtu_other.c",
  "atomic_enum_array_data_signature_xtu_main.c",
  "atomic_enum_array_data_signature_xtu_other.c",
  "atomic_enum_callback_data_signature_xtu_main.c",
  "atomic_enum_callback_data_signature_xtu_other.c",
  "atomic_enum_callback_signature_xtu_main.c",
  "atomic_enum_callback_signature_xtu_other.c",
  "atomic_enum_container_signature_xtu_main.c",
  "atomic_enum_container_signature_xtu_other.c",
  "atomic_enum_flexible_record_signature_xtu_main.c",
  "atomic_enum_flexible_record_signature_xtu_other.c",
  "atomic_enum_function_signature_xtu_main.c",
  "atomic_enum_function_signature_xtu_other.c",
  "atomic_enum_incomplete_record_signature_xtu_main.c",
  "atomic_enum_incomplete_record_signature_xtu_other.c",
  "atomic_enum_mutual_record_signature_xtu_main.c",
  "atomic_enum_mutual_record_signature_xtu_other.c",
  "atomic_enum_packed_record_signature_xtu_main.c",
  "atomic_enum_packed_record_signature_xtu_other.c",
  "atomic_enum_pointer_to_array_signature_xtu_main.c",
  "atomic_enum_pointer_to_array_signature_xtu_other.c",
  "atomic_enum_record_data_signature_xtu_main.c",
  "atomic_enum_record_data_signature_xtu_other.c",
  "atomic_enum_record_function_signature_xtu_main.c",
  "atomic_enum_record_function_signature_xtu_other.c",
  "atomic_enum_self_record_signature_xtu_main.c",
  "atomic_enum_self_record_signature_xtu_other.c",
  "atomic_enum_union_function_signature_xtu_main.c",
  "atomic_enum_union_function_signature_xtu_other.c",
  "atomic_function_pointer_data_signature_xtu_main.c",
  "atomic_function_pointer_data_signature_xtu_other.c",
  "atomic_function_pointer_signature_xtu_main.c",
  "atomic_function_pointer_signature_xtu_other.c",
  "atomic_incomplete_record_pointer_signature_xtu_main.c",
  "atomic_incomplete_record_pointer_signature_xtu_other.c",
  "atomic_incomplete_record_wrapper_signature_xtu_main.c",
  "atomic_incomplete_record_wrapper_signature_xtu_other.c",
  "atomic_mutual_record_signature_xtu_main.c",
  "atomic_mutual_record_signature_xtu_other.c",
  "atomic_self_referential_record_signature_xtu_main.c",
  "atomic_self_referential_record_signature_xtu_other.c",
  ...
  "atomic_pointer_return_signature_xtu_main.c",
  "atomic_pointer_return_signature_xtu_other.c",
  "atomic_pointer_to_array_signature_xtu_main.c",
  "atomic_pointer_to_array_signature_xtu_other.c",
  "atomic_pointer_to_record_signature_xtu_main.c",
  "atomic_pointer_to_record_signature_xtu_other.c",
  "atomic_pointer_array_signature_xtu_main.c",
  "atomic_pointer_array_signature_xtu_other.c",
  "atomic_pointer_multidimensional_array_signature_xtu_main.c",
  "atomic_pointer_multidimensional_array_signature_xtu_other.c",
  "atomic_pointer_global_signature_xtu_main.c",
  "atomic_pointer_global_signature_xtu_other.c",
  "atomic_record_member_signature_xtu_main.c",
  "atomic_record_member_signature_xtu_other.c",
  ...
  "function_return_pointee_qualifier_xtu_main.c",
  "function_return_pointee_qualifier_xtu_other.c",
  "function_parameter_qualifier_adjustment_xtu_main.c",
  "function_parameter_qualifier_adjustment_xtu_other.c",
  "function_parameter_multidimensional_qualifier_xtu_main.c",
  "function_parameter_multidimensional_qualifier_xtu_other.c",
  "function_parameter_function_adjustment_xtu_main.c",
  "function_parameter_function_adjustment_xtu_other.c",
  "function_parameter_callback_return_qualifier_xtu_main.c",
  "function_parameter_callback_return_qualifier_xtu_other.c",
  "function_parameter_callback_return_array_qualifier_xtu_main.c",
  ...
  "unprototyped_address_then_direct_call_xtu_main.c",
  "unprototyped_address_then_direct_call_xtu_other.c",
  "unprototyped_direct_call_then_address_xtu_main.c",
  ...
  "qualified_external_objects_xtu_main.c",
  "qualified_external_objects_xtu_other.c",
];
...
if (!/typedef\s+struct\s*\{[^]*?node_t\s*\*value;[^]*?token_t\s*\*value_tok;[^]*?\}\s*psx_initializer_entry_t;/.test(
      astHeader,
    ) ||
    !/token_t\s*\*value_tok\s*=\s*curtok\(runtime_context\)[^]*?\.value_tok\s*=\s*value_tok/.test(
      initializerSyntaxSource,
    )) {
  throw new Error(
    "initializer syntax entries must capture the value-start token after any designators",
  );
}
...
if (!typeNameRef ||
    ...
    !/\btoken_t\s*\*\s*invalid_type_token\s*;/.test(sizeofQueryNode[1]) ||
...
if (!/query->operand_token\s*=\s*lparen_tok->next\s*;\s*query->invalid_type_token\s*=\s*lparen_tok\s*;\s*set_curtok\(ctx,\s*query->operand_token\s*\)[^]*?query->operand_token\s*=\s*curtok\(ctx\)\s*;\s*query->invalid_type_token\s*=\s*query->operand_token\s*;\s*query->operand\s*=\s*unary_ctx\(ctx\)/.test(
      parserExprSource,
    ) ||
...
if (!flatInitializerApplyValue ||
    ...
    !/value_token\s*=\s*entry->value_tok\s*\?\s*entry->value_tok\s*:\s*entry->designator_count\s*==\s*0\s*\?\s*entry->tok\s*:\s*NULL[^]*?flat_initializer_apply_value\(\s*context,\s*&target,\s*entry->value,\s*value_token/.test(
      explicitDiagnosticInitializerResolutionSource,
    ) ||
    !/flat_initializer_apply_value\(\s*context,\s*last_target,\s*entry->value,\s*entry->value_tok,\s*1\)/.test(
      explicitDiagnosticInitializerResolutionSource,
    ) ||
    ...
    !/direct_character_array_string_initializer_token\([^]*?list->entries\[0\]\.value\s*==\s*\(const node_t \*\)string[^]*?return list->entries\[0\]\.value_tok[^]*?list->entries\[0\]\.tok/.test(
      syntaxTypedHirResolutionSource,
    ) ||
    ...
    !/string_initializer_token\s*=\s*direct_character_array_string_initializer_token\(\s*&initializer,\s*string_initializer\)[^]*?reject_direct_character_array_initializer\([^]*?string_initializer_token\s*\?\s*string_initializer_token\s*:\s*initializer\.value_tok/.test(
      syntaxTypedHirResolutionSource,
    )) {
  throw new Error(
    "braced character-array string failures must preserve each initializer value token through flat and compound-literal diagnostics",
  );
}
...
if (!/token_t\s*\*psx_declaration_specifier_token_for_kinds\s*\([^]*?specifier->diagnostic_token[^]*?token\s*!=\s*fallback[^]*?token->next[^]*?return\s+fallback/.test(
    ...
    !/TK_CONST,\s*TK_VOLATILE/.test(
      declarationSpecifierConstraintValidator,
    ) ||
    !/\(const token_kind_t\[\]\)\{TK_RESTRICT\}/.test(
      declarationSpecifierConstraintValidator,
    ) ||
    !/\(const token_kind_t\[\]\)\{TK_ATOMIC\}/.test(
      declarationSpecifierConstraintValidator,
    ) ||
...
if (!/psx_semantic_type_table_pointer_can_be_restrict_qualified\s*\([^]*?pointer_shape\.kind\s*!=\s*PSX_TYPE_POINTER[^]*?pointee_shape\.kind\s*!=\s*PSX_TYPE_FUNCTION/.test(
    ...
    !/token_t\s*\*psx_atomic_restrict_pointer_token\s*\([^]*?token->kind\s*==\s*TK_MUL[^]*?token->kind\s*==\s*TK_ATOMIC[^]*?token\s*==\s*restrict_token\s*&&\s*token->kind\s*==\s*TK_RESTRICT[^]*?return\s+pointer_token/.test(
      declarationApplicationSource,
    ) ||
    !/psx_validate_parsed_decl_specifier_constraints_in_context\s*\([^]*?psx_semantic_type_table_has_invalid_restrict_qualification[^]*?psx_atomic_restrict_pointer_token\s*\(\s*specifier->diagnostic_token,\s*diagnostic_token,\s*source_token\s*\)[^]*?if\s*\(pointer_token\)\s*source_token\s*=\s*pointer_token/.test(
      declarationApplicationSource,
    ) ||
    !/psx_type_name_restrict_qualifier_token\s*\([^]*?psx_atomic_restrict_pointer_token\s*\(\s*syntax->diagnostic_token,\s*syntax->end,\s*source_token\s*\)[^]*?if\s*\(pointer_token\)\s*return\s+pointer_token/.test(
      typeNameResolutionSource,
    ) ||
  ...
  throw new Error(
    "restrict qualifiers must preserve canonical metadata through declaration and type-query validation, using the pointer token for same-level atomic/restrict declarators and type names and the qualifier token otherwise",
  );
}
...
if (!/base_shape\.kind\s*==\s*PSX_TYPE_VOID\s*&&[^]*?parameter_application\.shape\.count\s*==\s*0[^]*?parameters->count\s*==\s*1\s*&&[^]*?!parameters->is_variadic\s*&&[^]*?!parameter->declarator\.identifier\s*&&[^]*?base_qual_type\.qualifiers\s*==\s*PSX_TYPE_QUALIFIER_NONE[^]*?resolved_count\s*=\s*0[^]*?source_token\s*=\s*parameter->specifier\.diagnostic_token[^]*?parameter->declarator\.identifier[^]*?source_token\s*=\s*\(token_t\s*\*\)parameter->declarator\.identifier[^]*?base_qual_type\.qualifiers\s*==\s*PSX_TYPE_QUALIFIER_NONE[^]*?parameters->count\s*!=\s*1[^]*?parameters->is_variadic[^]*?source_token\s*=\s*parameter->declarator\.diagnostic_token[^]*?void parameter must be the only parameter, unnamed/.test(
      declarationApplicationSource,
    )) {
  throw new Error(
    "void parameter diagnostics must distinguish the sole marker, named parameters, unqualified delimiter failures, and qualified specifiers",
  );
}
...
const missingCrossTuSignatureMismatchRegistrations =
  crossTuSignatureMismatchFixtures.filter(
    (name) =>
      ...
      !wasm32WatFixtureScan.includes(name),
  );
