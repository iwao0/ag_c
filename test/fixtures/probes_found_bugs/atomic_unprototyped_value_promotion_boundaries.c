// Atomic value conversion across an unprototyped old-style call.
// Expected: exit=0
#include <complex.h>
...
static int check_atomic_unprototyped();
...
int main(void) {
  int status = check_atomic_unprototyped(
...
static int check_atomic_unprototyped(
    marker, boolean_value, byte_value, short_value,
    float_value, double_value, pointer_value,
    float_complex_value, double_complex_value,
    small_value, wide_value, choice_value)
int marker;
int boolean_value;
int byte_value;
int short_value;
