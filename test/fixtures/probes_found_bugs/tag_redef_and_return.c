...
//     後段でメンバが混在 / shadow されていた。ps_ctx_define_tag_type_with_layout で
...
// "タグ完全定義済み" / "関数 is_defined" 状態が漏れないよう、ps_ctx_reset_tag_diag_state
// と ps_ctx_reset_function_diag_state を ps_program_from の冒頭で呼び出すように。
