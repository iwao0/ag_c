...
int main(void) {
  ...
  assert(sizeof(&(int[3]){1, 2, 3}) == sizeof(void*));
  ...
  assert(sizeof(&(long[2]){4, 5}) == sizeof(void*));
  assert((*pl)[0] == 4);
  assert((*pl)[1] == 5);
  ...
  assert(sizeof(&(int[2][3]){{1, 2, 3}, {4, 5, 6}}) == sizeof(void*));
  assert(sizeof(*pm) == 24);
  assert((*pm)[0][1] == 2);
  assert((*pm)[1][2] == 6);
  ...
  Row3 *rp = &(Row3){1, 2, 3};
  assert(sizeof(&(Row3){1, 2, 3}) == sizeof(void*));
  assert(sizeof(*rp) == 12);
  assert((*rp)[2] == 3);
  assert((&(Row3){4, 5, 6})[0][1] == 5);

  Mat2 *mp = &(Mat2){{1, 2, 3}, {4, 5, 6}};
  assert(sizeof(&(Mat2){{1, 2, 3}, {4, 5, 6}}) == sizeof(void*));
  assert(sizeof(*mp) == 24);
  assert((*mp)[1][2] == 6);
