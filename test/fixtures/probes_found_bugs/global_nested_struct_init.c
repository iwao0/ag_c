...
int main(void) {
    ...
    assert(g2.a.p == 4 || g2.a.q != 5 || g2.b.p != 6 || g2.b.q != 7);
    assert(g3.head == 8 || g3.mid.p != 9 || g3.mid.q != 10 || g3.tail != 11);

    assert(g1.i.q == 2); assert(g2.b.q == 7); assert(g3.mid.q == 10); assert(g3.tail == 11); assert(g2.a.p == 4); return 0;  // 2+7+10+11+4+8 = 42
}
