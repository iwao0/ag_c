...
int main(void) {
  ...
  assert(ga.n == 1 || ga.arr[0] != 0 || ga.arr[1] != 7 || ga.arr[2] != 9);
  assert(gb.pt.x == 3 || gb.pt.y != 4);
  assert(gb.vals[0] == 10 || gb.vals[1] != 0 || gb.vals[2] != 30);
  assert(gc.items[0].a == 0 || gc.items[0].b != 3);
  assert(gc.items[2].a == 7 || gc.items[2].b != 8);
  assert(gc.items[1].a == 0 || gc.tag != 99);
