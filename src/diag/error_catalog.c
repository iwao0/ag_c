...
static const diag_entry_t k_diag_entries[] = {
    ...
    {DIAG_ERR_INTERNAL_INVARIANT_FAILED, "E0006", "internal.invariant_failed"},
    ...
    {DIAG_ERR_PREPROCESS_MACRO_REDEFINITION_INCOMPATIBLE, "E1044", "preprocess.macro_redefinition_incompatible"},
    {DIAG_ERR_PREPROCESS_MACRO_PARAMETER_DUPLICATE, "E1045", "preprocess.macro_parameter_duplicate"},
    {DIAG_ERR_PREPROCESS_MACRO_PARAMETER_LIST_INVALID, "E1046", "preprocess.macro_parameter_list_invalid"},
    {DIAG_ERR_PREPROCESS_VA_ARGS_OUTSIDE_VARIADIC_MACRO, "E1047", "preprocess.va_args_outside_variadic_macro"},
    {DIAG_ERR_PREPROCESS_MACRO_STRINGIZE_PARAMETER_REQUIRED, "E1048", "preprocess.macro_stringize_parameter_required"},
    {DIAG_ERR_PREPROCESS_PREDEFINED_MACRO_MODIFICATION_FORBIDDEN, "E1049", "preprocess.predefined_macro_modification_forbidden"},
    {DIAG_ERR_PREPROCESS_UNDEF_EXTRA_TOKENS, "E1050", "preprocess.undef_extra_tokens"},
    {DIAG_ERR_PREPROCESS_CONDITIONAL_EXTRA_TOKENS, "E1051", "preprocess.conditional_extra_tokens"},
    {DIAG_ERR_PREPROCESS_UNKNOWN_DIRECTIVE, "E1052", "preprocess.unknown_directive"},
    {DIAG_ERR_PREPROCESS_UNTERMINATED_CONDITIONAL, "E1053", "preprocess.unterminated_conditional"},
    {DIAG_ERR_PREPROCESS_LINE_EXTRA_TOKENS, "E1054", "preprocess.line_extra_tokens"},
    ...
    {DIAG_ERR_PARSER_ASSIGN_FUNCTION_TARGET, "E3097", "parser.assign_function_target"},
    {DIAG_ERR_PARSER_ASSIGN_TARGET_NOT_MODIFIABLE, "E3098", "parser.assign_target_not_modifiable"},
    {DIAG_ERR_PARSER_ASSIGN_TYPES_INCOMPATIBLE, "E3099", "parser.assign_types_incompatible"},
    {DIAG_ERR_PARSER_CONDITIONAL_CONDITION_NOT_SCALAR, "E3100", "parser.conditional_condition_not_scalar"},
    ...
    {DIAG_ERR_PARSER_CAST_TARGET_NOT_VOID_OR_SCALAR, "E3110", "parser.cast_target_not_void_or_scalar"},
    {DIAG_ERR_PARSER_CAST_OPERAND_NOT_SCALAR, "E3111", "parser.cast_operand_not_scalar"},
    ...
    {DIAG_ERR_PARSER_TYPE_QUERY_INVALID_TYPE, "E3117", "parser.type_query_invalid_type"},
    {DIAG_ERR_PARSER_SIZEOF_BITFIELD, "E3118", "parser.sizeof_bitfield"},
    {DIAG_ERR_PARSER_ADDRESS_OF_REGISTER, "E3119", "parser.address_of_register"},
    {DIAG_ERR_PARSER_CALL_ARGUMENT_TYPES_INCOMPATIBLE, "E3120", "parser.call_argument_types_incompatible"},
    {DIAG_ERR_PARSER_CALL_ARGUMENT_DISCARDS_QUALIFIERS, "E3121", "parser.call_argument_discards_qualifiers"},
    {DIAG_ERR_PARSER_BINARY_OPERANDS_INCOMPATIBLE, "E3122", "parser.binary_operands_incompatible"},
    {DIAG_ERR_PARSER_INCDEC_POINTER_NOT_COMPLETE_OBJECT, "E3123", "parser.incdec_pointer_not_complete_object"},
