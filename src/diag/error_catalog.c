...
static const diag_entry_t k_diag_entries[] = {
    ...
    {DIAG_ERR_PREPROCESS_LINE_FILENAME_INVALID, "E1028", "preprocess.line_filename_invalid"},
    ...
    {DIAG_ERR_PREPROCESS_VIRTUAL_HEADER_COUNT_LIMIT_EXCEEDED, "E1039", "preprocess.virtual_header_count_limit_exceeded"},
    ...
    {DIAG_ERR_TOKENIZER_CHAR_LITERAL_UNTERMINATED, "E2029", "tokenizer.char_literal_unterminated"},
    ...
    {DIAG_ERR_PARSER_CAST_STRUCT_SCALAR_POINTER_DISABLED, "E3072", "parser.cast_struct_scalar_pointer_disabled"},
    ...
    {DIAG_ERR_PARSER_CONST_ASSIGNMENT, "E3077", "parser.const_assignment"},
    {DIAG_ERR_PARSER_CONST_QUAL_DISCARD, "E3078", "parser.const_qual_discard"},
    {DIAG_ERR_PARSER_VLA_PARAM_DIM_NOT_PRECEDING_PARAM, "E3079", "parser.vla_param_dim_not_preceding_param"},
    {DIAG_ERR_PARSER_EXPR_NEST_TOO_DEEP, "E3080", "parser.expr_nest_too_deep"},
    {DIAG_ERR_PARSER_PAREN_NEST_TOO_DEEP, "E3081", "parser.paren_nest_too_deep"},
    {DIAG_ERR_PARSER_DECLARATOR_LIST_TOO_LONG, "E3082", "parser.declarator_list_too_long"},
    {DIAG_ERR_PARSER_MEMBER_DESIGNATOR_INVALID, "E3083", "parser.member_designator_invalid"},
    {DIAG_ERR_PARSER_MEMBER_DESIGNATOR_NOT_FOUND, "E3084", "parser.member_designator_not_found"},
