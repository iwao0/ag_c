...
int wasm32_wat_runtime_plan_call(
  ...
  for (int index = 0; index < argument_count; index++) {
    ...
    if (special_runtime && index >= call->argument_count) {
      if ((minimal_sscanf || minimal_swscanf) && index >= 2) {
        argument->kind = WASM32_WAT_RUNTIME_ARGUMENT_ZERO_I32;
        argument->value_type = IR_TY_PTR;
      } else {
...
static void emit_wasm_swprintf_stub(wasm32_ir_context_t *context) {
    int slots_addr =
        intern_data_symbol("__ag_swprintf_va_slots",
                           (int)(sizeof("__ag_swprintf_va_slots") - 1), 16, 8)->addr;
    int float_scratch_addr =
        intern_data_symbol("__ag_swprintf_float_scratch",
                           (int)(sizeof("__ag_swprintf_float_scratch") - 1),
                           512 * 4, 8)->addr;
    ...
    wasm_emitf(4, "(local.set $div (i64.const 10000000000000000000))\n");
    ...
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwudec_len (param $n i64) (result i32)\n");
    wasm_emitf(4, "(local $digits i32)\n");
    wasm_emitf(4, "(local.set $digits (i32.const 1))\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i64.lt_u (local.get $n) (i64.const 10)) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $n (i64.div_u (local.get $n) (i64.const 10)))\n");
    wasm_emitf(6, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $digits)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwuint_base_len (param $n i64) (param $base i32) (result i32)\n");
    wasm_emitf(4, "(local $digits i32)\n");
    wasm_emitf(4, "(local.set $digits (i32.const 1))\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i64.lt_u (local.get $n) (i64.extend_i32_u (local.get $base))) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $n (i64.div_u (local.get $n) (i64.extend_i32_u (local.get $base))))\n");
    wasm_emitf(6, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $digits)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwwrite_u64_base (param $buf i32) (param $size i64) (param $pos i32) (param $n i64) (param $base i32) (param $upper i32) (result i32)\n");
    wasm_emitf(4, "(local $digits i32)\n");
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(local $div i64)\n");
    wasm_emitf(4, "(local $digit i64)\n");
    wasm_emitf(4, "(local $ch i32)\n");
    wasm_emitf(4, "(local.set $digits (call $__ag_snwuint_base_len (local.get $n) (local.get $base)))\n");
    wasm_emitf(4, "(local.set $div (i64.const 1))\n");
    wasm_emitf(4, "(local.set $index (i32.const 1))\n");
    wasm_emitf(4, "(block $div_done (loop $div_loop\n");
    wasm_emitf(6, "(if (i32.ge_u (local.get $index) (local.get $digits)) (then (br $div_done)))\n");
    wasm_emitf(6, "(local.set $div (i64.mul (local.get $div) (i64.extend_i32_u (local.get $base))))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $div_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(local.set $digit (i64.div_u (local.get $n) (local.get $div)))\n");
    wasm_emitf(6, "(local.set $ch (if (result i32) (i64.lt_u (local.get $digit) (i64.const 10))\n");
    wasm_emitf(8, "(then (i32.wrap_i64 (i64.add (local.get $digit) (i64.const 48))))\n");
    wasm_emitf(8, "(else (i32.add (i32.wrap_i64 (local.get $digit)) (if (result i32) (local.get $upper) (then (i32.const 55)) (else (i32.const 87)))))))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (local.get $ch)))\n");
    wasm_emitf(6, "(local.set $n (i64.rem_u (local.get $n) (local.get $div)))\n");
    wasm_emitf(6, "(if (i64.eq (local.get $div) (i64.const 1)) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $div (i64.div_u (local.get $div) (i64.extend_i32_u (local.get $base))))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $pos)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwascii_len (param $string i32) (param $precision i32) (result i32)\n");
    wasm_emitf(4, "(local $len i32)\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.and (i32.ge_s (local.get $precision) (i32.const 0)) (i32.ge_u (local.get $len) (local.get $precision))) (then (br $done)))\n");
    wasm_emitf(6, "(if (i32.eqz (i32.load8_u (i32.add (local.get $string) (local.get $len)))) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $len (i32.add (local.get $len) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $len)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwwide_len (param $string i32) (param $precision i32) (result i32)\n");
    wasm_emitf(4, "(local $len i32)\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.and (i32.ge_s (local.get $precision) (i32.const 0)) (i32.ge_u (local.get $len) (local.get $precision))) (then (br $done)))\n");
    wasm_emitf(6, "(if (i32.eqz (i32.load (i32.add (local.get $string) (i32.mul (local.get $len) (i32.const 4))))) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $len (i32.add (local.get $len) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $len)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwwrite_ascii (param $buf i32) (param $size i64) (param $pos i32) (param $string i32) (param $len i32) (result i32)\n");
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.ge_u (local.get $index) (local.get $len)) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.load8_u (i32.add (local.get $string) (local.get $index)))))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $pos)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwwrite_wide (param $buf i32) (param $size i64) (param $pos i32) (param $string i32) (param $len i32) (result i32)\n");
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.ge_u (local.get $index) (local.get $len)) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.load (i32.add (local.get $string) (i32.mul (local.get $index) (i32.const 4))))))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $pos)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwpad (param $buf i32) (param $size i64) (param $pos i32) (param $ch i32) (param $count i32) (result i32)\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.le_s (local.get $count) (i32.const 0)) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (local.get $ch)))\n");
    wasm_emitf(6, "(local.set $count (i32.sub (local.get $count) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $pos)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwround_decimal (param $v f64) (param $scale f64) (result f64)\n");
    wasm_emitf(4, "(local $scaled f64)\n");
    wasm_emitf(4, "(local $error f64)\n");
    wasm_emitf(4, "(local $integral f64)\n");
    wasm_emitf(4, "(local $remainder f64)\n");
    wasm_emitf(4, "(local $left_split f64)\n");
    wasm_emitf(4, "(local $left_high f64)\n");
    wasm_emitf(4, "(local $left_low f64)\n");
    wasm_emitf(4, "(local $right_split f64)\n");
    wasm_emitf(4, "(local $right_high f64)\n");
    wasm_emitf(4, "(local $right_low f64)\n");
    wasm_emitf(4, "(if (f64.gt (local.get $v) (f64.div (f64.const 9007199254740991) (local.get $scale))) (then (return (local.get $v))))\n");
    wasm_emitf(4, "(local.set $scaled (f64.mul (local.get $v) (local.get $scale)))\n");
    wasm_emitf(4, "(local.set $left_split (f64.mul (f64.const 134217729) (local.get $v)))\n");
    wasm_emitf(4, "(local.set $left_high (f64.sub (local.get $left_split) (f64.sub (local.get $left_split) (local.get $v))))\n");
    wasm_emitf(4, "(local.set $left_low (f64.sub (local.get $v) (local.get $left_high)))\n");
    wasm_emitf(4, "(local.set $right_split (f64.mul (f64.const 134217729) (local.get $scale)))\n");
    wasm_emitf(4, "(local.set $right_high (f64.sub (local.get $right_split) (f64.sub (local.get $right_split) (local.get $scale))))\n");
    wasm_emitf(4, "(local.set $right_low (f64.sub (local.get $scale) (local.get $right_high)))\n");
    wasm_emitf(4, "(local.set $error (f64.add (f64.add (f64.add (f64.sub (f64.mul (local.get $left_high) (local.get $right_high)) (local.get $scaled)) (f64.mul (local.get $left_high) (local.get $right_low))) (f64.mul (local.get $left_low) (local.get $right_high))) (f64.mul (local.get $left_low) (local.get $right_low))))\n");
    wasm_emitf(4, "(local.set $integral (f64.floor (local.get $scaled)))\n");
    wasm_emitf(4, "(local.set $remainder (f64.sub (local.get $scaled) (local.get $integral)))\n");
    wasm_emitf(4, "(if (i32.or (f64.gt (local.get $remainder) (f64.const 0.5)) (i32.and (f64.eq (local.get $remainder) (f64.const 0.5)) (i32.or (f64.gt (local.get $error) (f64.const 0)) (i32.and (f64.eq (local.get $error) (f64.const 0)) (i64.eq (i64.and (i64.trunc_f64_u (local.get $integral)) (i64.const 1)) (i64.const 1)))))) (then\n");
    wasm_emitf(6, "(local.set $integral (f64.add (local.get $integral) (f64.const 1)))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(f64.div (local.get $integral) (local.get $scale))\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwround_decimal_places (param $v f64) (param $decimal_places i32) (result f64)\n");
    wasm_emitf(4, "(local $scale f64)\n");
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(local $quotient i64)\n");
    wasm_emitf(4, "(local $lower f64)\n");
    wasm_emitf(4, "(local $remainder f64)\n");
    wasm_emitf(4, "(local $halfway f64)\n");
    wasm_emitf(4, "(if (i32.ge_s (local.get $decimal_places) (i32.const 0)) (then\n");
    wasm_emitf(6, "(if (i32.gt_s (local.get $decimal_places) (i32.const 18)) (then (return (f64.const -1))))\n");
    wasm_emitf(6, "(local.set $scale (f64.const 1))\n");
    wasm_emitf(6, "(block $positive_done (loop $positive_loop\n");
    wasm_emitf(8, "(if (i32.ge_s (local.get $index) (local.get $decimal_places)) (then (br $positive_done)))\n");
    wasm_emitf(8, "(local.set $scale (f64.mul (local.get $scale) (f64.const 10)))\n");
    wasm_emitf(8, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(8, "(br $positive_loop)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(return (call $__ag_snwround_decimal (local.get $v) (local.get $scale)))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(if (i32.or (i32.lt_s (local.get $decimal_places) (i32.const -18)) (f64.gt (local.get $v) (f64.const 9007199254740991))) (then (return (f64.const -1))))\n");
    wasm_emitf(4, "(local.set $scale (f64.const 1))\n");
    wasm_emitf(4, "(local.set $index (i32.const 0))\n");
    wasm_emitf(4, "(block $negative_done (loop $negative_loop\n");
    wasm_emitf(6, "(if (i32.ge_s (local.get $index) (i32.sub (i32.const 0) (local.get $decimal_places))) (then (br $negative_done)))\n");
    wasm_emitf(6, "(local.set $scale (f64.mul (local.get $scale) (f64.const 10)))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $negative_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $quotient (i64.trunc_f64_u (f64.floor (f64.div (local.get $v) (local.get $scale)))))\n");
    wasm_emitf(4, "(local.set $lower (f64.mul (f64.convert_i64_u (local.get $quotient)) (local.get $scale)))\n");
    wasm_emitf(4, "(local.set $remainder (f64.sub (local.get $v) (local.get $lower)))\n");
    wasm_emitf(4, "(local.set $halfway (f64.div (local.get $scale) (f64.const 2)))\n");
    wasm_emitf(4, "(if (i32.or (f64.gt (local.get $remainder) (local.get $halfway)) (i32.and (f64.eq (local.get $remainder) (local.get $halfway)) (i64.eq (i64.and (local.get $quotient) (i64.const 1)) (i64.const 1)))) (then\n");
    wasm_emitf(6, "(local.set $quotient (i64.add (local.get $quotient) (i64.const 1)))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(f64.mul (f64.convert_i64_u (local.get $quotient)) (local.get $scale))\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwfloat_fixed (param $buf i32) (param $size i64) (param $v f64) (param $precision i32) (param $upper i32) (param $alternate i32) (param $sign_ch i32) (result i32)\n");
    wasm_emitf(4, "(local $pos i32)\n");
    wasm_emitf(4, "(local $negative i32)\n");
    wasm_emitf(4, "(local $scale f64)\n");
    wasm_emitf(4, "(local $rounded f64)\n");
    wasm_emitf(4, "(local $norm f64)\n");
    wasm_emitf(4, "(local $exp i32)\n");
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(local $digit i32)\n");
    wasm_emitf(4, "(if (f64.ne (local.get $v) (local.get $v)) (then\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $upper) (then (i32.const 78)) (else (i32.const 110)))))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $upper) (then (i32.const 65)) (else (i32.const 97)))))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $upper) (then (i32.const 78)) (else (i32.const 110)))))\n");
    wasm_emitf(6, "(return (local.get $pos))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $negative (i64.lt_s (i64.reinterpret_f64 (local.get $v)) (i64.const 0)))\n");
    wasm_emitf(4, "(if (f64.eq (f64.abs (local.get $v)) (f64.const inf)) (then\n");
    wasm_emitf(6, "(if (local.get $negative) (then (local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 45)))))\n");
    wasm_emitf(6, "(if (i32.and (i32.eqz (local.get $negative)) (i32.ne (local.get $sign_ch) (i32.const 0))) (then (local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (local.get $sign_ch)))))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $upper) (then (i32.const 73)) (else (i32.const 105)))))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $upper) (then (i32.const 78)) (else (i32.const 110)))))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $upper) (then (i32.const 70)) (else (i32.const 102)))))\n");
    wasm_emitf(6, "(return (local.get $pos))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(if (i32.lt_s (local.get $precision) (i32.const 0)) (then (local.set $precision (i32.const 6))))\n");
    wasm_emitf(4, "(if (i32.gt_s (local.get $precision) (i32.const 18)) (then (local.set $precision (i32.const 18))))\n");
    wasm_emitf(4, "(if (local.get $negative) (then (local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 45)))))\n");
    wasm_emitf(4, "(if (i32.and (i32.eqz (local.get $negative)) (i32.ne (local.get $sign_ch) (i32.const 0))) (then (local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (local.get $sign_ch)))))\n");
    wasm_emitf(4, "(local.set $v (f64.abs (local.get $v)))\n");
    wasm_emitf(4, "(local.set $scale (f64.const 1))\n");
    wasm_emitf(4, "(local.set $index (i32.const 0))\n");
    wasm_emitf(4, "(block $scale_done (loop $scale_loop\n");
    wasm_emitf(6, "(if (i32.ge_s (local.get $index) (local.get $precision)) (then (br $scale_done)))\n");
    wasm_emitf(6, "(local.set $scale (f64.mul (local.get $scale) (f64.const 10)))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $scale_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $rounded (call $__ag_snwround_decimal (local.get $v) (local.get $scale)))\n");
    wasm_emitf(4, "(if (f64.ge (local.get $rounded) (f64.const 1))\n");
    wasm_emitf(6, "(then\n");
    wasm_emitf(8, "(if (f64.lt (local.get $rounded) (f64.const 18446744073709551616))\n");
    wasm_emitf(10, "(then\n");
    wasm_emitf(12, "(local.set $pos (call $__ag_snwwrite_u64_dec (local.get $buf) (local.get $size) (local.get $pos) (i64.trunc_f64_u (f64.floor (local.get $rounded)))))\n");
    wasm_emitf(10, ")\n");
    wasm_emitf(10, "(else\n");
    wasm_emitf(12, "(local.set $norm (local.get $rounded))\n");
    wasm_emitf(12, "(local.set $exp (i32.const 0))\n");
    wasm_emitf(12, "(block $norm_done (loop $norm_loop\n");
    wasm_emitf(14, "(if (f64.lt (local.get $norm) (f64.const 10)) (then (br $norm_done)))\n");
    wasm_emitf(14, "(local.set $norm (f64.div (local.get $norm) (f64.const 10)))\n");
    wasm_emitf(14, "(local.set $exp (i32.add (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(14, "(br $norm_loop)\n");
    wasm_emitf(12, "))\n");
    wasm_emitf(12, "(local.set $index (local.get $exp))\n");
    wasm_emitf(12, "(block $integer_done (loop $integer_loop\n");
    wasm_emitf(14, "(local.set $digit (i32.trunc_f64_u (f64.floor (local.get $norm))))\n");
    wasm_emitf(14, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.add (local.get $digit) (i32.const 48))))\n");
    wasm_emitf(14, "(local.set $norm (f64.mul (f64.sub (local.get $norm) (f64.convert_i32_u (local.get $digit))) (f64.const 10)))\n");
    wasm_emitf(14, "(if (i32.eqz (local.get $index)) (then (br $integer_done)))\n");
    wasm_emitf(14, "(local.set $index (i32.sub (local.get $index) (i32.const 1)))\n");
    wasm_emitf(14, "(br $integer_loop)\n");
    wasm_emitf(12, "))\n");
    wasm_emitf(10, ")\n");
    wasm_emitf(8, ")\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(6, "(else\n");
    wasm_emitf(8, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48)))\n");
    wasm_emitf(8, "(local.set $norm (f64.mul (local.get $rounded) (f64.const 10)))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(4, ")\n");
    wasm_emitf(4, "(if (i32.or (i32.ne (local.get $precision) (i32.const 0)) (local.get $alternate)) (then\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 46)))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $norm (f64.nearest (f64.mul (f64.sub (local.get $rounded) (f64.floor (local.get $rounded))) (local.get $scale))))\n");
    wasm_emitf(4, "(local.set $scale (f64.div (local.get $scale) (f64.const 10)))\n");
    wasm_emitf(4, "(local.set $index (i32.const 0))\n");
    wasm_emitf(4, "(block $fraction_done (loop $fraction_loop\n");
    wasm_emitf(6, "(if (i32.ge_s (local.get $index) (local.get $precision)) (then (br $fraction_done)))\n");
    wasm_emitf(6, "(local.set $digit (i32.trunc_f64_u (f64.floor (f64.div (local.get $norm) (local.get $scale)))))\n");
    wasm_emitf(6, "(if (i32.gt_u (local.get $digit) (i32.const 9)) (then (local.set $digit (i32.const 9))))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.add (local.get $digit) (i32.const 48))))\n");
    wasm_emitf(6, "(local.set $norm (f64.sub (local.get $norm) (f64.mul (f64.convert_i32_u (local.get $digit)) (local.get $scale))))\n");
    wasm_emitf(6, "(local.set $scale (f64.div (local.get $scale) (f64.const 10)))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $fraction_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $pos)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwfloat_exp_suffix (param $buf i32) (param $size i64) (param $pos i32) (param $exp i32) (param $upper i32) (param $hex i32) (result i32)\n");
    wasm_emitf(4, "(local $magnitude i64)\n");
    wasm_emitf(4, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $hex) (then (if (result i32) (local.get $upper) (then (i32.const 80)) (else (i32.const 112)))) (else (if (result i32) (local.get $upper) (then (i32.const 69)) (else (i32.const 101)))))))\n");
    wasm_emitf(4, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (i32.lt_s (local.get $exp) (i32.const 0)) (then (i32.const 45)) (else (i32.const 43)))))\n");
    wasm_emitf(4, "(local.set $magnitude (i64.extend_i32_u (if (result i32) (i32.lt_s (local.get $exp) (i32.const 0)) (then (i32.sub (i32.const 0) (local.get $exp))) (else (local.get $exp)))))\n");
    wasm_emitf(4, "(if (i32.and (i32.eqz (local.get $hex)) (i64.lt_u (local.get $magnitude) (i64.const 10))) (then\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48)))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(call $__ag_snwwrite_u64_dec (local.get $buf) (local.get $size) (local.get $pos) (local.get $magnitude))\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwfloat_scientific (param $buf i32) (param $size i64) (param $v f64) (param $precision i32) (param $upper i32) (param $alternate i32) (param $sign_ch i32) (result i32)\n");
    wasm_emitf(4, "(local $pos i32)\n");
    wasm_emitf(4, "(local $negative i32)\n");
    wasm_emitf(4, "(local $magnitude f64)\n");
    wasm_emitf(4, "(local $rounded_magnitude f64)\n");
    wasm_emitf(4, "(local $norm f64)\n");
    wasm_emitf(4, "(local $scale f64)\n");
    wasm_emitf(4, "(local $exp i32)\n");
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(local $digit i32)\n");
    wasm_emitf(4, "(if (i32.or (f64.ne (local.get $v) (local.get $v)) (f64.eq (f64.abs (local.get $v)) (f64.const inf))) (then\n");
    wasm_emitf(6, "(return (call $__ag_snwfloat_fixed (local.get $buf) (local.get $size) (local.get $v) (local.get $precision) (local.get $upper) (local.get $alternate) (local.get $sign_ch)))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(if (i32.lt_s (local.get $precision) (i32.const 0)) (then (local.set $precision (i32.const 6))))\n");
    wasm_emitf(4, "(if (i32.gt_s (local.get $precision) (i32.const 18)) (then (local.set $precision (i32.const 18))))\n");
    wasm_emitf(4, "(local.set $negative (i64.lt_s (i64.reinterpret_f64 (local.get $v)) (i64.const 0)))\n");
    wasm_emitf(4, "(if (local.get $negative) (then (local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 45)))))\n");
    wasm_emitf(4, "(if (i32.and (i32.eqz (local.get $negative)) (i32.ne (local.get $sign_ch) (i32.const 0))) (then (local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (local.get $sign_ch)))))\n");
    wasm_emitf(4, "(local.set $magnitude (f64.abs (local.get $v)))\n");
    wasm_emitf(4, "(local.set $norm (local.get $magnitude))\n");
    wasm_emitf(4, "(if (f64.ne (local.get $norm) (f64.const 0)) (then\n");
    wasm_emitf(6, "(block $large_done (loop $large_loop\n");
    wasm_emitf(8, "(if (f64.lt (local.get $norm) (f64.const 10)) (then (br $large_done)))\n");
    wasm_emitf(8, "(local.set $norm (f64.div (local.get $norm) (f64.const 10)))\n");
    wasm_emitf(8, "(local.set $exp (i32.add (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(8, "(br $large_loop)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(block $small_done (loop $small_loop\n");
    wasm_emitf(8, "(if (f64.ge (local.get $norm) (f64.const 1)) (then (br $small_done)))\n");
    wasm_emitf(8, "(local.set $norm (f64.mul (local.get $norm) (f64.const 10)))\n");
    wasm_emitf(8, "(local.set $exp (i32.sub (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(8, "(br $small_loop)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $scale (f64.const 1))\n");
    wasm_emitf(4, "(local.set $index (i32.const 0))\n");
    ...
    wasm_emitf(6, "(br $scale_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $rounded_magnitude (call $__ag_snwround_decimal_places (local.get $magnitude) (i32.sub (local.get $precision) (local.get $exp))))\n");
    wasm_emitf(4, "(if (f64.ge (local.get $rounded_magnitude) (f64.const 0))\n");
    wasm_emitf(6, "(then\n");
    wasm_emitf(8, "(local.set $exp (i32.const 0))\n");
    wasm_emitf(8, "(local.set $norm (local.get $rounded_magnitude))\n");
    wasm_emitf(8, "(if (f64.ne (local.get $norm) (f64.const 0)) (then\n");
    wasm_emitf(10, "(block $rounded_large_done (loop $rounded_large_loop\n");
    wasm_emitf(12, "(if (f64.lt (local.get $norm) (f64.const 10)) (then (br $rounded_large_done)))\n");
    wasm_emitf(12, "(local.set $norm (f64.div (local.get $norm) (f64.const 10)))\n");
    wasm_emitf(12, "(local.set $exp (i32.add (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(12, "(br $rounded_large_loop)\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(10, "(block $rounded_small_done (loop $rounded_small_loop\n");
    wasm_emitf(12, "(if (f64.ge (local.get $norm) (f64.const 1)) (then (br $rounded_small_done)))\n");
    wasm_emitf(12, "(local.set $norm (f64.mul (local.get $norm) (f64.const 10)))\n");
    wasm_emitf(12, "(local.set $exp (i32.sub (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(12, "(br $rounded_small_loop)\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(6, "(else\n");
    wasm_emitf(8, "(local.set $norm (call $__ag_snwround_decimal (local.get $norm) (local.get $scale)))\n");
    wasm_emitf(8, "(if (f64.ge (local.get $norm) (f64.const 10)) (then\n");
    wasm_emitf(10, "(local.set $norm (f64.div (local.get $norm) (f64.const 10)))\n");
    wasm_emitf(10, "(local.set $exp (i32.add (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(4, ")\n");
    wasm_emitf(4, "(local.set $digit (i32.trunc_f64_u (f64.floor (local.get $norm))))\n");
    wasm_emitf(4, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.add (local.get $digit) (i32.const 48))))\n");
    wasm_emitf(4, "(local.set $norm (f64.nearest (f64.mul (f64.sub (local.get $norm) (f64.convert_i32_u (local.get $digit))) (local.get $scale))))\n");
    wasm_emitf(4, "(local.set $scale (f64.div (local.get $scale) (f64.const 10)))\n");
    wasm_emitf(4, "(if (i32.or (i32.ne (local.get $precision) (i32.const 0)) (local.get $alternate)) (then\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 46)))\n");
    wasm_emitf(4, "))\n");
    ...
    wasm_emitf(6, "(br $fraction_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(call $__ag_snwfloat_exp_suffix (local.get $buf) (local.get $size) (local.get $pos) (local.get $exp) (local.get $upper) (i32.const 0))\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwfloat_hex (param $buf i32) (param $size i64) (param $v f64) (param $precision i32) (param $upper i32) (param $alternate i32) (param $sign_ch i32) (result i32)\n");
    wasm_emitf(4, "(local $pos i32)\n");
    wasm_emitf(4, "(local $negative i32)\n");
    wasm_emitf(4, "(local $norm f64)\n");
    wasm_emitf(4, "(local $scale f64)\n");
    ...
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(local $digit i32)\n");
    wasm_emitf(4, "(local $default_precision i32)\n");
    wasm_emitf(4, "(local $extra_zeros i32)\n");
    wasm_emitf(4, "(local $fraction_units i64)\n");
    wasm_emitf(4, "(if (i32.or (f64.ne (local.get $v) (local.get $v)) (f64.eq (f64.abs (local.get $v)) (f64.const inf))) (then\n");
    wasm_emitf(6, "(return (call $__ag_snwfloat_fixed (local.get $buf) (local.get $size) (local.get $v) (local.get $precision) (local.get $upper) (local.get $alternate) (local.get $sign_ch)))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $default_precision (i32.lt_s (local.get $precision) (i32.const 0)))\n");
    wasm_emitf(4, "(if (local.get $default_precision)\n");
    wasm_emitf(6, "(then (local.set $precision (i32.const 13)))\n");
    wasm_emitf(6, "(else\n");
    wasm_emitf(8, "(if (i32.gt_s (local.get $precision) (i32.const 18)) (then (local.set $precision (i32.const 18))))\n");
    wasm_emitf(8, "(if (i32.gt_s (local.get $precision) (i32.const 13)) (then\n");
    wasm_emitf(10, "(local.set $extra_zeros (i32.sub (local.get $precision) (i32.const 13)))\n");
    wasm_emitf(10, "(local.set $precision (i32.const 13))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(4, ")\n");
    wasm_emitf(4, "(local.set $negative (i64.lt_s (i64.reinterpret_f64 (local.get $v)) (i64.const 0)))\n");
    ...
    wasm_emitf(4, "(if (i32.and (i32.eqz (local.get $negative)) (i32.ne (local.get $sign_ch) (i32.const 0))) (then (local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (local.get $sign_ch)))))\n");
    wasm_emitf(4, "(local.set $v (f64.abs (local.get $v)))\n");
    wasm_emitf(4, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48)))\n");
    wasm_emitf(4, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $upper) (then (i32.const 88)) (else (i32.const 120)))))\n");
    wasm_emitf(4, "(if (f64.eq (local.get $v) (f64.const 0)) (then\n");
    wasm_emitf(6, "(if (local.get $default_precision) (then (local.set $precision (i32.const 0))))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48)))\n");
    wasm_emitf(6, "(if (i32.or (i32.or (i32.ne (local.get $precision) (i32.const 0)) (i32.ne (local.get $extra_zeros) (i32.const 0))) (local.get $alternate)) (then (local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 46)))))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (i32.add (local.get $precision) (local.get $extra_zeros))))\n");
    wasm_emitf(6, "(return (call $__ag_snwfloat_exp_suffix (local.get $buf) (local.get $size) (local.get $pos) (i32.const 0) (local.get $upper) (i32.const 1)))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $norm (local.get $v))\n");
    wasm_emitf(4, "(block $large_done (loop $large_loop\n");
    wasm_emitf(6, "(if (f64.lt (local.get $norm) (f64.const 2)) (then (br $large_done)))\n");
    wasm_emitf(6, "(local.set $norm (f64.div (local.get $norm) (f64.const 2)))\n");
    wasm_emitf(6, "(local.set $exp (i32.add (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(6, "(br $large_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(block $small_done (loop $small_loop\n");
    wasm_emitf(6, "(if (f64.ge (local.get $norm) (f64.const 1)) (then (br $small_done)))\n");
    wasm_emitf(6, "(local.set $norm (f64.mul (local.get $norm) (f64.const 2)))\n");
    wasm_emitf(6, "(local.set $exp (i32.sub (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(6, "(br $small_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $scale (f64.const 1))\n");
    wasm_emitf(4, "(local.set $index (i32.const 0))\n");
    wasm_emitf(4, "(block $scale_done (loop $scale_loop\n");
    wasm_emitf(6, "(if (i32.ge_s (local.get $index) (local.get $precision)) (then (br $scale_done)))\n");
    wasm_emitf(6, "(local.set $scale (f64.mul (local.get $scale) (f64.const 16)))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $scale_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(if (local.get $default_precision)\n");
    wasm_emitf(6, "(then\n");
    wasm_emitf(8, "(local.set $fraction_units (i64.trunc_f64_u (f64.mul (f64.sub (local.get $norm) (f64.const 1)) (local.get $scale))))\n");
    wasm_emitf(8, "(block $trim_default_done (loop $trim_default_loop\n");
    wasm_emitf(10, "(if (i32.or (i32.le_s (local.get $precision) (i32.const 0)) (i64.ne (i64.and (local.get $fraction_units) (i64.const 15)) (i64.const 0))) (then (br $trim_default_done)))\n");
    wasm_emitf(10, "(local.set $fraction_units (i64.shr_u (local.get $fraction_units) (i64.const 4)))\n");
    wasm_emitf(10, "(local.set $precision (i32.sub (local.get $precision) (i32.const 1)))\n");
    wasm_emitf(10, "(br $trim_default_loop)\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(6, "(else\n");
    wasm_emitf(8, "(if (i32.eqz (local.get $extra_zeros)) (then\n");
    wasm_emitf(10, "(local.set $norm (f64.add (local.get $norm) (f64.div (f64.const 0.5) (local.get $scale))))\n");
    wasm_emitf(10, "(if (f64.ge (local.get $norm) (f64.const 2)) (then\n");
    wasm_emitf(12, "(local.set $norm (f64.div (local.get $norm) (f64.const 2)))\n");
    wasm_emitf(12, "(local.set $exp (i32.add (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(4, ")\n");
    wasm_emitf(4, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 49)))\n");
    wasm_emitf(4, "(if (i32.or (i32.or (i32.ne (local.get $precision) (i32.const 0)) (i32.ne (local.get $extra_zeros) (i32.const 0))) (local.get $alternate)) (then\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 46)))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $norm (f64.mul (f64.sub (local.get $norm) (f64.const 1)) (f64.const 16)))\n");
    wasm_emitf(4, "(local.set $index (i32.const 0))\n");
    wasm_emitf(4, "(block $fraction_done (loop $fraction_loop\n");
    wasm_emitf(6, "(if (i32.ge_s (local.get $index) (local.get $precision)) (then (br $fraction_done)))\n");
    wasm_emitf(6, "(local.set $digit (i32.trunc_f64_u (f64.floor (local.get $norm))))\n");
    wasm_emitf(6, "(if (i32.gt_u (local.get $digit) (i32.const 15)) (then (local.set $digit (i32.const 15))))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (i32.lt_u (local.get $digit) (i32.const 10)) (then (i32.add (local.get $digit) (i32.const 48))) (else (i32.add (local.get $digit) (if (result i32) (local.get $upper) (then (i32.const 55)) (else (i32.const 87))))))))\n");
    wasm_emitf(6, "(local.set $norm (f64.mul (f64.sub (local.get $norm) (f64.convert_i32_u (local.get $digit))) (f64.const 16)))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $fraction_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $extra_zeros)))\n");
    wasm_emitf(4, "(call $__ag_snwfloat_exp_suffix (local.get $buf) (local.get $size) (local.get $pos) (local.get $exp) (local.get $upper) (i32.const 1))\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwfloat_trim (param $buf i32) (param $len i32) (result i32)\n");
    wasm_emitf(4, "(local $exp_start i32)\n");
    wasm_emitf(4, "(local $dot i32)\n");
    wasm_emitf(4, "(local $end i32)\n");
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(local $out i32)\n");
    wasm_emitf(4, "(local $ch i32)\n");
    wasm_emitf(4, "(local.set $exp_start (i32.const -1))\n");
    wasm_emitf(4, "(local.set $dot (i32.const -1))\n");
    wasm_emitf(4, "(local.set $index (i32.const 0))\n");
    wasm_emitf(4, "(block $scan_done (loop $scan_loop\n");
    wasm_emitf(6, "(if (i32.ge_s (local.get $index) (local.get $len)) (then (br $scan_done)))\n");
    wasm_emitf(6, "(local.set $ch (i32.load (i32.add (local.get $buf) (i32.mul (local.get $index) (i32.const 4)))))\n");
    wasm_emitf(6, "(if (i32.and (i32.lt_s (local.get $dot) (i32.const 0)) (i32.eq (local.get $ch) (i32.const 46))) (then (local.set $dot (local.get $index))))\n");
    wasm_emitf(6, "(if (i32.or (i32.eq (local.get $ch) (i32.const 101)) (i32.eq (local.get $ch) (i32.const 69))) (then\n");
    wasm_emitf(8, "(local.set $exp_start (local.get $index))\n");
    wasm_emitf(8, "(br $scan_done)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $scan_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $end (if (result i32) (i32.ge_s (local.get $exp_start) (i32.const 0)) (then (local.get $exp_start)) (else (local.get $len))))\n");
    wasm_emitf(4, "(if (i32.ge_s (local.get $dot) (i32.const 0)) (then\n");
    wasm_emitf(6, "(block $trim_done (loop $trim_loop\n");
    wasm_emitf(8, "(if (i32.le_s (local.get $end) (i32.add (local.get $dot) (i32.const 1))) (then (br $trim_done)))\n");
    wasm_emitf(8, "(if (i32.ne (i32.load (i32.add (local.get $buf) (i32.mul (i32.sub (local.get $end) (i32.const 1)) (i32.const 4)))) (i32.const 48)) (then (br $trim_done)))\n");
    wasm_emitf(8, "(local.set $end (i32.sub (local.get $end) (i32.const 1)))\n");
    wasm_emitf(8, "(br $trim_loop)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $end) (i32.add (local.get $dot) (i32.const 1))) (then (local.set $end (local.get $dot))))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(if (i32.ge_s (local.get $exp_start) (i32.const 0)) (then\n");
    wasm_emitf(6, "(local.set $out (local.get $end))\n");
    wasm_emitf(6, "(local.set $index (local.get $exp_start))\n");
    wasm_emitf(6, "(block $copy_done (loop $copy_loop\n");
    wasm_emitf(8, "(if (i32.ge_s (local.get $index) (local.get $len)) (then (br $copy_done)))\n");
    wasm_emitf(8, "(i32.store (i32.add (local.get $buf) (i32.mul (local.get $out) (i32.const 4))) (i32.load (i32.add (local.get $buf) (i32.mul (local.get $index) (i32.const 4)))))\n");
    wasm_emitf(8, "(local.set $out (i32.add (local.get $out) (i32.const 1)))\n");
    wasm_emitf(8, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(8, "(br $copy_loop)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(return (local.get $out))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $end)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_snwfloat_general (param $buf i32) (param $size i64) (param $v f64) (param $precision i32) (param $upper i32) (param $alternate i32) (param $sign_ch i32) (result i32)\n");
    wasm_emitf(4, "(local $norm f64)\n");
    wasm_emitf(4, "(local $rounded_magnitude f64)\n");
    wasm_emitf(4, "(local $scale f64)\n");
    wasm_emitf(4, "(local $exp i32)\n");
    ...
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(if (i32.lt_s (local.get $precision) (i32.const 0)) (then (local.set $precision (i32.const 6))))\n");
    wasm_emitf(4, "(if (i32.eqz (local.get $precision)) (then (local.set $precision (i32.const 1))))\n");
    wasm_emitf(4, "(if (i32.gt_s (local.get $precision) (i32.const 18)) (then (local.set $precision (i32.const 18))))\n");
    wasm_emitf(4, "(local.set $norm (f64.abs (local.get $v)))\n");
    wasm_emitf(4, "(if (f64.ne (local.get $norm) (f64.const 0)) (then\n");
    wasm_emitf(6, "(block $large_done (loop $large_loop\n");
    wasm_emitf(8, "(if (f64.lt (local.get $norm) (f64.const 10)) (then (br $large_done)))\n");
    wasm_emitf(8, "(local.set $norm (f64.div (local.get $norm) (f64.const 10)))\n");
    ...
    wasm_emitf(6, "))\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $rounded_magnitude (call $__ag_snwround_decimal_places (f64.abs (local.get $v)) (i32.sub (i32.sub (local.get $precision) (local.get $exp)) (i32.const 1))))\n");
    wasm_emitf(4, "(if (f64.ge (local.get $rounded_magnitude) (f64.const 0))\n");
    wasm_emitf(6, "(then\n");
    wasm_emitf(8, "(local.set $exp (i32.const 0))\n");
    wasm_emitf(8, "(local.set $norm (local.get $rounded_magnitude))\n");
    ...
    wasm_emitf(6, ")\n");
    wasm_emitf(6, "(else\n");
    wasm_emitf(8, "(local.set $scale (f64.const 1))\n");
    wasm_emitf(8, "(local.set $index (i32.const 1))\n");
    wasm_emitf(8, "(block $scale_done (loop $scale_loop\n");
    wasm_emitf(10, "(if (i32.ge_s (local.get $index) (local.get $precision)) (then (br $scale_done)))\n");
    wasm_emitf(10, "(local.set $scale (f64.mul (local.get $scale) (f64.const 10)))\n");
    wasm_emitf(10, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(10, "(br $scale_loop)\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (f64.ge (call $__ag_snwround_decimal (local.get $norm) (local.get $scale)) (f64.const 10)) (then\n");
    wasm_emitf(10, "(local.set $exp (i32.add (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(4, ")\n");
    wasm_emitf(4, "(if (i32.or (i32.lt_s (local.get $exp) (i32.const -4)) (i32.ge_s (local.get $exp) (local.get $precision)))\n");
    wasm_emitf(6, "(then (local.set $len (call $__ag_snwfloat_scientific (local.get $buf) (local.get $size) (local.get $v) (i32.sub (local.get $precision) (i32.const 1)) (local.get $upper) (local.get $alternate) (local.get $sign_ch))))\n");
    wasm_emitf(6, "(else (local.set $len (call $__ag_snwfloat_fixed (local.get $buf) (local.get $size) (local.get $v) (i32.sub (i32.sub (local.get $precision) (local.get $exp)) (i32.const 1)) (local.get $upper) (local.get $alternate) (local.get $sign_ch))))\n");
    wasm_emitf(4, ")\n");
    wasm_emitf(4, "(if (result i32) (local.get $alternate) (then (local.get $len)) (else (call $__ag_snwfloat_trim (local.get $buf) (local.get $len))))\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_vswprintf_impl (param $buf i32) (param $size i64) (param $fmt i32) (param $ap i64) (result i32)\n");
    wasm_emitf(4, "(local $pos i32)\n");
    ...
    wasm_emitf(4, "(local $width i32)\n");
    wasm_emitf(4, "(local $zero_pad i32)\n");
    wasm_emitf(4, "(local $int_zero_pad i32)\n");
    wasm_emitf(4, "(local $left_align i32)\n");
    wasm_emitf(4, "(local $alternate i32)\n");
    wasm_emitf(4, "(local $sign_ch i32)\n");
    wasm_emitf(4, "(local $precision i32)\n");
    wasm_emitf(4, "(local $negative i32)\n");
    wasm_emitf(4, "(local $digits i32)\n");
    wasm_emitf(4, "(local $zero_count i32)\n");
    wasm_emitf(4, "(local $prefix_len i32)\n");
    wasm_emitf(4, "(local $base i32)\n");
    wasm_emitf(4, "(local $upper i32)\n");
    wasm_emitf(4, "(local $emit_digits i32)\n");
    wasm_emitf(4, "(local $string i32)\n");
    wasm_emitf(4, "(local $string_len i32)\n");
    wasm_emitf(4, "(local $pad i32)\n");
    wasm_emitf(4, "(local $length_h i32)\n");
    wasm_emitf(4, "(local $length_hh i32)\n");
    wasm_emitf(4, "(local $length_l i32)\n");
    wasm_emitf(4, "(local $length_L i32)\n");
    wasm_emitf(4, "(local $store_size i32)\n");
    wasm_emitf(4, "(local $float_value f64)\n");
    wasm_emitf(4, "(local $float_len i32)\n");
    wasm_emitf(4, "(local $float_start i32)\n");
    wasm_emitf(4, "(local $float_finite i32)\n");
    ...
    wasm_emitf(8, "(br $loop)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(local.set $width (i32.const 0))\n");
    wasm_emitf(6, "(local.set $zero_pad (i32.const 0))\n");
    wasm_emitf(6, "(local.set $left_align (i32.const 0))\n");
    wasm_emitf(6, "(local.set $alternate (i32.const 0))\n");
    wasm_emitf(6, "(local.set $sign_ch (i32.const 0))\n");
    wasm_emitf(6, "(local.set $precision (i32.const -1))\n");
    wasm_emitf(6, "(block $flags_done (loop $flags\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 45)) (then\n");
    wasm_emitf(10, "(local.set $left_align (i32.const 1))\n");
    wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(10, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(10, "(br $flags)\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 48)) (then\n");
    wasm_emitf(10, "(local.set $zero_pad (i32.const 1))\n");
    wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(10, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(10, "(br $flags)\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 35)) (then\n");
    wasm_emitf(10, "(local.set $alternate (i32.const 1))\n");
    wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(10, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(10, "(br $flags)\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 43)) (then\n");
    wasm_emitf(10, "(local.set $sign_ch (i32.const 43))\n");
    wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(10, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(10, "(br $flags)\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 32)) (then\n");
    wasm_emitf(10, "(if (i32.eqz (local.get $sign_ch)) (then (local.set $sign_ch (i32.const 32))))\n");
    wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(10, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(10, "(br $flags)\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(br $flags_done)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(block $width_done (loop $width_loop\n");
    wasm_emitf(8, "(if (i32.or (i32.lt_u (local.get $ch) (i32.const 48)) (i32.gt_u (local.get $ch) (i32.const 57))) (then (br $width_done)))\n");
    wasm_emitf(8, "(local.set $width (i32.add (i32.mul (local.get $width) (i32.const 10)) (i32.sub (local.get $ch) (i32.const 48))))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(8, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(8, "(br $width_loop)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 42)) (then\n");
    wasm_emitf(8, "(local.set $width (i32.wrap_i64 (i64.load (local.get $vap))))\n");
    wasm_emitf(8, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $width) (i32.const 0)) (then\n");
    wasm_emitf(10, "(local.set $left_align (i32.const 1))\n");
    wasm_emitf(10, "(local.set $width (i32.sub (i32.const 0) (local.get $width)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(8, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(if (local.get $left_align) (then (local.set $zero_pad (i32.const 0))))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 46)) (then\n");
    wasm_emitf(8, "(local.set $precision (i32.const 0))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(8, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 42))\n");
    wasm_emitf(10, "(then\n");
    wasm_emitf(12, "(local.set $precision (i32.wrap_i64 (i64.load (local.get $vap))))\n");
    wasm_emitf(12, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
    wasm_emitf(12, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(12, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(10, ")\n");
    wasm_emitf(10, "(else\n");
    wasm_emitf(12, "(block $precision_done (loop $precision_loop\n");
    wasm_emitf(14, "(if (i32.or (i32.lt_u (local.get $ch) (i32.const 48)) (i32.gt_u (local.get $ch) (i32.const 57))) (then (br $precision_done)))\n");
    wasm_emitf(14, "(local.set $precision (i32.add (i32.mul (local.get $precision) (i32.const 10)) (i32.sub (local.get $ch) (i32.const 48))))\n");
    wasm_emitf(14, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(14, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(14, "(br $precision_loop)\n");
    wasm_emitf(12, "))\n");
    wasm_emitf(10, ")\n");
    wasm_emitf(8, ")\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $precision) (i32.const 0)) (then (local.set $precision (i32.const -1))))\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(local.set $int_zero_pad (local.get $zero_pad))\n");
    wasm_emitf(6, "(if (i32.ge_s (local.get $precision) (i32.const 0)) (then (local.set $int_zero_pad (i32.const 0))))\n");
    wasm_emitf(6, "(local.set $length_h (i32.const 0))\n");
    wasm_emitf(6, "(local.set $length_hh (i32.const 0))\n");
    wasm_emitf(6, "(local.set $length_l (i32.const 0))\n");
    wasm_emitf(6, "(local.set $length_L (i32.const 0))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 104)) (then\n");
    wasm_emitf(8, "(local.set $length_h (i32.const 1))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(8, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 104)) (then\n");
    wasm_emitf(10, "(local.set $length_h (i32.const 0))\n");
    wasm_emitf(10, "(local.set $length_hh (i32.const 1))\n");
    wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(10, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 108)) (then\n");
    wasm_emitf(8, "(local.set $length_l (i32.const 1))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(8, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 108)) (then\n");
    wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(10, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(if (i32.or (i32.eq (local.get $ch) (i32.const 106)) (i32.or (i32.eq (local.get $ch) (i32.const 122)) (i32.eq (local.get $ch) (i32.const 116)))) (then\n");
    wasm_emitf(8, "(local.set $length_l (i32.const 1))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(8, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 76)) (then\n");
    wasm_emitf(8, "(local.set $length_L (i32.const 1))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(8, "(local.set $ch (i32.load (local.get $p)))\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(local.set $store_size (i32.const 4))\n");
    wasm_emitf(6, "(if (local.get $length_h) (then (local.set $store_size (i32.const 2))))\n");
    wasm_emitf(6, "(if (local.get $length_hh) (then (local.set $store_size (i32.const 1))))\n");
    wasm_emitf(6, "(if (local.get $length_l) (then (local.set $store_size (i32.const 8))))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 110)) (then\n");
    wasm_emitf(8, "(local.set $arg (i64.load (local.get $vap)))\n");
    wasm_emitf(8, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $store_size) (i32.const 8))\n");
    wasm_emitf(10, "(then (i64.store (i32.wrap_i64 (local.get $arg)) (i64.extend_i32_u (local.get $pos))))\n");
    wasm_emitf(10, "(else (if (i32.eq (local.get $store_size) (i32.const 2))\n");
    wasm_emitf(12, "(then (i32.store16 (i32.wrap_i64 (local.get $arg)) (local.get $pos)))\n");
    wasm_emitf(12, "(else (if (i32.eq (local.get $store_size) (i32.const 1))\n");
    wasm_emitf(14, "(then (i32.store8 (i32.wrap_i64 (local.get $arg)) (local.get $pos)))\n");
    wasm_emitf(14, "(else (i32.store (i32.wrap_i64 (local.get $arg)) (local.get $pos)))\n");
    wasm_emitf(12, "))\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(8, ")\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(8, "(br $loop)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(if (i32.or (i32.eq (local.get $ch) (i32.const 100)) (i32.or (i32.eq (local.get $ch) (i32.const 105)) (i32.eq (local.get $ch) (i32.const 117)))) (then\n");
    wasm_emitf(8, "(local.set $arg (i64.load (local.get $vap)))\n");
    wasm_emitf(8, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
    wasm_emitf(8, "(local.set $negative (i32.const 0))\n");
    wasm_emitf(8, "(if (i32.ne (local.get $ch) (i32.const 117)) (then\n");
    wasm_emitf(10, "(if (local.get $length_hh) (then (local.set $arg (i64.extend_i32_s (i32.extend8_s (i32.wrap_i64 (local.get $arg)))))))\n");
    wasm_emitf(10, "(if (local.get $length_h) (then (local.set $arg (i64.extend_i32_s (i32.extend16_s (i32.wrap_i64 (local.get $arg)))))))\n");
    wasm_emitf(10, "(if (i64.lt_s (local.get $arg) (i64.const 0)) (then\n");
    wasm_emitf(12, "(local.set $negative (i32.const 1))\n");
    wasm_emitf(12, "(local.set $arg (i64.sub (i64.const 0) (local.get $arg)))\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 117)) (then\n");
    wasm_emitf(10, "(if (local.get $length_hh) (then (local.set $arg (i64.and (local.get $arg) (i64.const 255)))))\n");
    wasm_emitf(10, "(if (local.get $length_h) (then (local.set $arg (i64.and (local.get $arg) (i64.const 65535)))))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $emit_digits (i32.const 1))\n");
    wasm_emitf(8, "(if (i32.and (i32.eq (local.get $precision) (i32.const 0)) (i64.eqz (local.get $arg))) (then\n");
    wasm_emitf(10, "(local.set $emit_digits (i32.const 0))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $digits (if (result i32) (local.get $emit_digits) (then (call $__ag_snwudec_len (local.get $arg))) (else (i32.const 0))))\n");
    wasm_emitf(8, "(local.set $zero_count (i32.sub (local.get $precision) (local.get $digits)))\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $zero_count) (i32.const 0)) (then (local.set $zero_count (i32.const 0))))\n");
    wasm_emitf(8, "(local.set $prefix_len (i32.const 0))\n");
    wasm_emitf(8, "(if (i32.ne (local.get $ch) (i32.const 117)) (then\n");
    wasm_emitf(10, "(if (i32.or (local.get $negative) (local.get $sign_ch)) (then (local.set $prefix_len (i32.const 1))))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $pad (i32.sub (local.get $width) (i32.add (local.get $prefix_len) (i32.add (local.get $zero_count) (local.get $digits)))))\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $pad) (i32.const 0)) (then (local.set $pad (i32.const 0))))\n");
    wasm_emitf(8, "(if (i32.and (i32.eqz (local.get $left_align)) (i32.eqz (local.get $int_zero_pad))) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (local.get $prefix_len) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $negative) (then (i32.const 45)) (else (local.get $sign_ch)))))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.and (i32.eqz (local.get $left_align)) (local.get $int_zero_pad)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $zero_count)))\n");
    wasm_emitf(8, "(if (local.get $emit_digits) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwwrite_u64_dec (local.get $buf) (local.get $size) (local.get $pos) (local.get $arg)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (local.get $left_align) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(8, "(br $loop)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(if (i32.or (i32.eq (local.get $ch) (i32.const 120)) (i32.or (i32.eq (local.get $ch) (i32.const 88)) (i32.or (i32.eq (local.get $ch) (i32.const 111)) (i32.eq (local.get $ch) (i32.const 112))))) (then\n");
    wasm_emitf(8, "(local.set $arg (i64.load (local.get $vap)))\n");
    wasm_emitf(8, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
    wasm_emitf(8, "(local.set $base (if (result i32) (i32.eq (local.get $ch) (i32.const 111)) (then (i32.const 8)) (else (i32.const 16))))\n");
    wasm_emitf(8, "(local.set $upper (i32.eq (local.get $ch) (i32.const 88)))\n");
    wasm_emitf(8, "(if (i32.ne (local.get $ch) (i32.const 112)) (then\n");
    wasm_emitf(10, "(if (local.get $length_hh) (then (local.set $arg (i64.and (local.get $arg) (i64.const 255)))))\n");
    wasm_emitf(10, "(if (local.get $length_h) (then (local.set $arg (i64.and (local.get $arg) (i64.const 65535)))))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $emit_digits (i32.const 1))\n");
    wasm_emitf(8, "(if (i32.and (i32.ne (local.get $ch) (i32.const 112)) (i32.and (i32.eq (local.get $precision) (i32.const 0)) (i64.eqz (local.get $arg)))) (then\n");
    wasm_emitf(10, "(local.set $emit_digits (i32.const 0))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $digits (if (result i32) (local.get $emit_digits) (then (call $__ag_snwuint_base_len (local.get $arg) (local.get $base))) (else (i32.const 0))))\n");
    wasm_emitf(8, "(local.set $zero_count (i32.sub (local.get $precision) (local.get $digits)))\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $zero_count) (i32.const 0)) (then (local.set $zero_count (i32.const 0))))\n");
    wasm_emitf(8, "(local.set $prefix_len (i32.const 0))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 112))\n");
    wasm_emitf(10, "(then (local.set $prefix_len (i32.const 2)))\n");
    wasm_emitf(10, "(else\n");
    wasm_emitf(12, "(if (i32.and (local.get $alternate) (i32.and (i32.eq (local.get $base) (i32.const 16)) (i64.ne (local.get $arg) (i64.const 0)))) (then\n");
    wasm_emitf(14, "(local.set $prefix_len (i32.const 2))\n");
    wasm_emitf(12, "))\n");
    wasm_emitf(12, "(if (i32.and (local.get $alternate) (i32.and (i32.eq (local.get $base) (i32.const 8)) (i32.or (i32.and (i64.eqz (local.get $arg)) (i32.eq (local.get $precision) (i32.const 0))) (i32.and (i64.ne (local.get $arg) (i64.const 0)) (i32.le_s (local.get $precision) (local.get $digits)))))) (then\n");
    wasm_emitf(14, "(local.set $prefix_len (i32.const 1))\n");
    wasm_emitf(12, "))\n");
    wasm_emitf(10, ")\n");
    wasm_emitf(8, ")\n");
    wasm_emitf(8, "(local.set $pad (i32.sub (local.get $width) (i32.add (local.get $prefix_len) (i32.add (local.get $zero_count) (local.get $digits)))))\n");
    ...
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.ge_u (local.get $prefix_len) (i32.const 1)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $prefix_len) (i32.const 2)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $upper) (then (i32.const 88)) (else (i32.const 120)))))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.and (i32.eqz (local.get $left_align)) (local.get $int_zero_pad)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $zero_count)))\n");
    wasm_emitf(8, "(if (local.get $emit_digits) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwwrite_u64_base (local.get $buf) (local.get $size) (local.get $pos) (local.get $arg) (local.get $base) (local.get $upper)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (local.get $left_align) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    ...
    wasm_emitf(8, "(br $loop)\n");
    wasm_emitf(6, "))\n");
    wasm_emitf(6, "(if (i32.or (i32.eq (local.get $ch) (i32.const 102)) (i32.or (i32.eq (local.get $ch) (i32.const 70)) (i32.or (i32.eq (local.get $ch) (i32.const 101)) (i32.or (i32.eq (local.get $ch) (i32.const 69)) (i32.or (i32.eq (local.get $ch) (i32.const 103)) (i32.or (i32.eq (local.get $ch) (i32.const 71)) (i32.or (i32.eq (local.get $ch) (i32.const 97)) (i32.eq (local.get $ch) (i32.const 65))))))))) (then\n");
    wasm_emitf(8, "(local.set $arg (i64.load (local.get $vap)))\n");
    wasm_emitf(8, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
    wasm_emitf(8, "(local.set $float_value (f64.reinterpret_i64 (local.get $arg)))\n");
    wasm_emitf(8, "(local.set $upper (i32.or (i32.eq (local.get $ch) (i32.const 70)) (i32.or (i32.eq (local.get $ch) (i32.const 69)) (i32.or (i32.eq (local.get $ch) (i32.const 71)) (i32.eq (local.get $ch) (i32.const 65))))))\n");
    wasm_emitf(8, "(if (i32.or (i32.eq (local.get $ch) (i32.const 97)) (i32.eq (local.get $ch) (i32.const 65)))\n");
    wasm_emitf(10, "(then (local.set $float_len (call $__ag_snwfloat_hex (i32.const %d) (i64.const 512) (local.get $float_value) (local.get $precision) (local.get $upper) (local.get $alternate) (local.get $sign_ch))))\n", float_scratch_addr);
    wasm_emitf(10, "(else (if (i32.or (i32.eq (local.get $ch) (i32.const 103)) (i32.eq (local.get $ch) (i32.const 71)))\n");
    wasm_emitf(12, "(then (local.set $float_len (call $__ag_snwfloat_general (i32.const %d) (i64.const 512) (local.get $float_value) (local.get $precision) (local.get $upper) (local.get $alternate) (local.get $sign_ch))))\n", float_scratch_addr);
    wasm_emitf(12, "(else (if (i32.or (i32.eq (local.get $ch) (i32.const 101)) (i32.eq (local.get $ch) (i32.const 69)))\n");
    wasm_emitf(14, "(then (local.set $float_len (call $__ag_snwfloat_scientific (i32.const %d) (i64.const 512) (local.get $float_value) (local.get $precision) (local.get $upper) (local.get $alternate) (local.get $sign_ch))))\n", float_scratch_addr);
    wasm_emitf(14, "(else (local.set $float_len (call $__ag_snwfloat_fixed (i32.const %d) (i64.const 512) (local.get $float_value) (local.get $precision) (local.get $upper) (local.get $alternate) (local.get $sign_ch))))\n", float_scratch_addr);
    wasm_emitf(12, "))\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(8, ")\n");
    wasm_emitf(8, "(local.set $float_finite (i32.and (f64.eq (local.get $float_value) (local.get $float_value)) (f64.ne (f64.abs (local.get $float_value)) (f64.const inf))))\n");
    wasm_emitf(8, "(local.set $pad (i32.sub (local.get $width) (local.get $float_len)))\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $pad) (i32.const 0)) (then (local.set $pad (i32.const 0))))\n");
    wasm_emitf(8, "(if (i32.and (i32.eqz (local.get $left_align)) (i32.or (i32.eqz (local.get $zero_pad)) (i32.eqz (local.get $float_finite)))) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $float_start (i32.const 0))\n");
    wasm_emitf(8, "(if (i32.and (i32.eqz (local.get $left_align)) (i32.and (local.get $zero_pad) (local.get $float_finite))) (then\n");
    wasm_emitf(10, "(local.set $ch (i32.load (i32.const %d)))\n", float_scratch_addr);
    wasm_emitf(10, "(if (i32.or (i32.eq (local.get $ch) (i32.const 45)) (i32.or (i32.eq (local.get $ch) (i32.const 43)) (i32.eq (local.get $ch) (i32.const 32)))) (then\n");
    wasm_emitf(12, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (local.get $ch)))\n");
    wasm_emitf(12, "(local.set $float_start (i32.const 1))\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(10, "(if (i32.and (i32.eq (i32.load (i32.add (i32.const %d) (i32.mul (local.get $float_start) (i32.const 4)))) (i32.const 48)) (i32.or (i32.eq (i32.load (i32.add (i32.const %d) (i32.mul (i32.add (local.get $float_start) (i32.const 1)) (i32.const 4)))) (i32.const 120)) (i32.eq (i32.load (i32.add (i32.const %d) (i32.mul (i32.add (local.get $float_start) (i32.const 1)) (i32.const 4)))) (i32.const 88)))) (then\n", float_scratch_addr, float_scratch_addr, float_scratch_addr);
    wasm_emitf(12, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48)))\n");
    wasm_emitf(12, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.load (i32.add (i32.const %d) (i32.mul (i32.add (local.get $float_start) (i32.const 1)) (i32.const 4))))))\n", float_scratch_addr);
    wasm_emitf(12, "(local.set $float_start (i32.add (local.get $float_start) (i32.const 2)))\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $pos (call $__ag_snwwrite_wide (local.get $buf) (local.get $size) (local.get $pos) (i32.add (i32.const %d) (i32.mul (local.get $float_start) (i32.const 4))) (i32.sub (local.get $float_len) (local.get $float_start))))\n", float_scratch_addr);
    wasm_emitf(8, "(if (local.get $left_align) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    ...
    wasm_emitf(8, "(local.set $arg (i64.load (local.get $vap)))\n");
    wasm_emitf(8, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
    wasm_emitf(8, "(local.set $string (i32.wrap_i64 (local.get $arg)))\n");
    wasm_emitf(8, "(local.set $string_len (if (result i32) (local.get $length_l)\n");
    wasm_emitf(10, "(then (call $__ag_snwwide_len (local.get $string) (local.get $precision)))\n");
    wasm_emitf(10, "(else (call $__ag_snwascii_len (local.get $string) (local.get $precision)))))\n");
    wasm_emitf(8, "(local.set $pad (i32.sub (local.get $width) (local.get $string_len)))\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $pad) (i32.const 0)) (then (local.set $pad (i32.const 0))))\n");
    wasm_emitf(8, "(if (i32.eqz (local.get $left_align)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $pos (if (result i32) (local.get $length_l)\n");
    wasm_emitf(10, "(then (call $__ag_snwwrite_wide (local.get $buf) (local.get $size) (local.get $pos) (local.get $string) (local.get $string_len)))\n");
    wasm_emitf(10, "(else (call $__ag_snwwrite_ascii (local.get $buf) (local.get $size) (local.get $pos) (local.get $string) (local.get $string_len)))))\n");
    wasm_emitf(8, "(if (local.get $left_align) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    ...
    wasm_emitf(8, "(local.set $arg (i64.load (local.get $vap)))\n");
    wasm_emitf(8, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
    wasm_emitf(8, "(local.set $pad (i32.sub (local.get $width) (i32.const 1)))\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $pad) (i32.const 0)) (then (local.set $pad (i32.const 0))))\n");
    wasm_emitf(8, "(if (i32.eqz (local.get $left_align)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $pos (call $__ag_snwputc (local.get $buf) (local.get $size) (local.get $pos) (i32.wrap_i64 (local.get $arg))))\n");
    wasm_emitf(8, "(if (local.get $left_align) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_snwpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    ...
    wasm_emitf(4, "(local.get $pos)\n");
    wasm_emitf(2, ")\n");
    if (has_undefined_function("vswprintf", 9)) {
      wasm_emitf(2, "(func $vswprintf (param $buf i32) (param $size i64) (param $fmt i32) (param $ap i64) (result i32)\n");
      wasm_emitf(4, "(local $result i32)\n");
      wasm_emitf(4, "(local.set $result (call $__ag_vswprintf_impl (local.get $buf) (local.get $size) (local.get $fmt) (local.get $ap)))\n");
    ...
    if (has_undefined_function("swprintf", 8)) {
      ...
      wasm_emitf(4, "(i64.store (i32.const %d) (local.get $b))\n", slots_addr + 8);
      wasm_emitf(4, "(local.set $args (if (result i64) (i32.ne (global.get $__ag_va_arg_area) (i32.const 0)) (then (i64.extend_i32_u (global.get $__ag_va_arg_area))) (else (i64.const %d))))\n", slots_addr);
      wasm_emitf(4, "(local.set $result (call $__ag_vswprintf_impl (local.get $buf) (local.get $size) (local.get $fmt) (local.get $args)))\n");
      wasm_emitf(4, "(if (i32.or (i64.eqz (local.get $size)) (i64.le_u (local.get $size) (i64.extend_i32_u (local.get $result)))) (then (return (i32.const -1))))\n");
      wasm_emitf(4, "(local.get $result)\n");
      wasm_emitf(2, ")\n");
    }
    if (has_undefined_function("vwprintf", 8)) {
      ...
      wasm_emitf(4, "(call $__ag_vswprintf_impl (i32.const 0) (i64.const 0) (local.get $fmt) (local.get $ap))\n");
      wasm_emitf(2, ")\n");
    }
    if (has_undefined_function("vfwprintf", 9)) {
      wasm_emitf(2, "(func $vfwprintf (param $stream i32) (param $fmt i32) (param $ap i64) (result i32)\n");
      wasm_emitf(4, "(if (i32.eqz (local.get $stream)) (then (return (i32.const -1))))\n");
      wasm_emitf(4, "(call $__ag_vswprintf_impl (i32.const 0) (i64.const 0) (local.get $fmt) (local.get $ap))\n");
      wasm_emitf(2, ")\n");
    }
    if (has_undefined_function("wprintf", 7)) {
      wasm_emitf(2, "(func $wprintf (param $fmt i32) (result i32)\n");
      wasm_emitf(4, "(call $__ag_vswprintf_impl (i32.const 0) (i64.const 0) (local.get $fmt) (i64.extend_i32_u (global.get $__ag_va_arg_area)))\n");
      wasm_emitf(2, ")\n");
    }
    if (has_undefined_function("fwprintf", 8)) {
      wasm_emitf(2, "(func $fwprintf (param $stream i32) (param $fmt i32) (result i32)\n");
      wasm_emitf(4, "(if (i32.eqz (local.get $stream)) (then (return (i32.const -1))))\n");
      wasm_emitf(4, "(call $__ag_vswprintf_impl (i32.const 0) (i64.const 0) (local.get $fmt) (i64.extend_i32_u (global.get $__ag_va_arg_area)))\n");
      wasm_emitf(2, ")\n");
    }
...
static void emit_wasm_vsnprintf_stubs(wasm32_ir_context_t *context) {
    ...
    wasm_emitf(4, "(local.get $pos)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_vsnudec_len (param $n i64) (result i32)\n");
    wasm_emitf(4, "(local $digits i32)\n");
    wasm_emitf(4, "(local.set $digits (i32.const 1))\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i64.lt_u (local.get $n) (i64.const 10)) (then (br $done)))\n");
    ...
    wasm_emitf(4, "(local.get $digits)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_vsnuint_base_len (param $n i64) (param $base i32) (result i32)\n");
    wasm_emitf(4, "(local $digits i32)\n");
    wasm_emitf(4, "(local.set $digits (i32.const 1))\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i64.lt_u (local.get $n) (i64.extend_i32_u (local.get $base))) (then (br $done)))\n");
    ...
    wasm_emitf(4, "(local.get $digits)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_vsnwrite_u64_base (param $buf i32) (param $size i64) (param $pos i32) (param $n i64) (param $base i32) (param $upper i32) (result i32)\n");
    wasm_emitf(4, "(local $digits i32)\n");
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(local $div i64)\n");
    wasm_emitf(4, "(local $digit i64)\n");
    wasm_emitf(4, "(local $ch i32)\n");
    wasm_emitf(4, "(local.set $digits (call $__ag_vsnuint_base_len (local.get $n) (local.get $base)))\n");
    wasm_emitf(4, "(local.set $div (i64.const 1))\n");
    wasm_emitf(4, "(local.set $index (i32.const 1))\n");
    wasm_emitf(4, "(block $div_done (loop $div_loop\n");
    wasm_emitf(6, "(if (i32.ge_u (local.get $index) (local.get $digits)) (then (br $div_done)))\n");
    ...
    wasm_emitf(4, "(local.get $pos)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_vsnstrlen (param $string i32) (param $precision i32) (result i32)\n");
    wasm_emitf(4, "(local $len i32)\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.and (i32.ge_s (local.get $precision) (i32.const 0)) (i32.ge_u (local.get $len) (local.get $precision))) (then (br $done)))\n");
    wasm_emitf(6, "(if (i32.eqz (i32.load8_u (i32.add (local.get $string) (local.get $len)))) (then (br $done)))\n");
    ...
    wasm_emitf(4, "(local.get $len)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_vsnwstrlen (param $string i32) (param $precision i32) (result i32)\n");
    wasm_emitf(4, "(local $len i32)\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.and (i32.ge_s (local.get $precision) (i32.const 0)) (i32.ge_u (local.get $len) (local.get $precision))) (then (br $done)))\n");
    wasm_emitf(6, "(if (i32.eqz (i32.load (i32.add (local.get $string) (i32.mul (local.get $len) (i32.const 4))))) (then (br $done)))\n");
    ...
    wasm_emitf(4, "(local.get $len)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_vsnwrite_string (param $buf i32) (param $size i64) (param $pos i32) (param $string i32) (param $len i32) (result i32)\n");
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.ge_u (local.get $index) (local.get $len)) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_vsnputc (local.get $buf) (local.get $size) (local.get $pos) (i32.load8_u (i32.add (local.get $string) (local.get $index)))))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $pos)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_vsnwrite_wide_ascii (param $buf i32) (param $size i64) (param $pos i32) (param $string i32) (param $len i32) (result i32)\n");
    wasm_emitf(4, "(local $index i32)\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.ge_u (local.get $index) (local.get $len)) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_vsnputc (local.get $buf) (local.get $size) (local.get $pos) (i32.load (i32.add (local.get $string) (i32.mul (local.get $index) (i32.const 4))))))\n");
    wasm_emitf(6, "(local.set $index (i32.add (local.get $index) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $pos)\n");
    wasm_emitf(2, ")\n");
    wasm_emitf(2, "(func $__ag_vsnpad (param $buf i32) (param $size i64) (param $pos i32) (param $ch i32) (param $count i32) (result i32)\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.le_s (local.get $count) (i32.const 0)) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $pos (call $__ag_vsnputc (local.get $buf) (local.get $size) (local.get $pos) (local.get $ch)))\n");
    wasm_emitf(6, "(local.set $count (i32.sub (local.get $count) (i32.const 1)))\n");
    ...
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 45)) (then\n");
    wasm_emitf(10, "(local.set $left_align (i32.const 1))\n");
    wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
    wasm_emitf(10, "(local.set $ch (i32.load8_u (local.get $p)))\n");
    wasm_emitf(10, "(br $flags)\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 48)) (then\n");
    wasm_emitf(10, "(local.set $zero_pad (i32.const 1))\n");
    ...
    wasm_emitf(12, "(local.set $ch (i32.load8_u (local.get $p)))\n");
    wasm_emitf(10, ")\n");
    wasm_emitf(10, "(else\n");
    wasm_emitf(12, "(block $precision_done (loop $precision_loop\n");
    wasm_emitf(14, "(if (i32.or (i32.lt_u (local.get $ch) (i32.const 48)) (i32.gt_u (local.get $ch) (i32.const 57))) (then (br $precision_done)))\n");
    wasm_emitf(14, "(local.set $precision (i32.add (i32.mul (local.get $precision) (i32.const 10)) (i32.sub (local.get $ch) (i32.const 48))))\n");
    wasm_emitf(14, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
    wasm_emitf(14, "(local.set $ch (i32.load8_u (local.get $p)))\n");
    wasm_emitf(14, "(br $precision_loop)\n");
    wasm_emitf(12, "))\n");
    wasm_emitf(10, ")\n");
    wasm_emitf(8, ")\n");
    ...
    wasm_emitf(10, "(local.set $emit_digits (i32.const 0))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $digits (if (result i32) (local.get $emit_digits) (then (call $__ag_vsnudec_len (local.get $arg))) (else (i32.const 0))))\n");
    wasm_emitf(8, "(local.set $zero_count (i32.sub (local.get $precision) (local.get $digits)))\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $zero_count) (i32.const 0)) (then (local.set $zero_count (i32.const 0))))\n");
    wasm_emitf(8, "(local.set $prefix_len (i32.const 0))\n");
    wasm_emitf(8, "(if (i32.ne (local.get $ch) (i32.const 117)) (then\n");
    ...
    wasm_emitf(8, "(if (i32.lt_s (local.get $pad) (i32.const 0)) (then (local.set $pad (i32.const 0))))\n");
    wasm_emitf(8, "(if (i32.and (i32.eqz (local.get $left_align)) (i32.eqz (local.get $int_zero_pad))) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (local.get $prefix_len) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $negative) (then (i32.const 45)) (else (local.get $sign_ch)))))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.and (i32.eqz (local.get $left_align)) (local.get $int_zero_pad)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $zero_count)))\n");
    wasm_emitf(8, "(if (local.get $emit_digits) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnwrite_u64_dec (local.get $buf) (local.get $size) (local.get $pos) (local.get $arg)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (local.get $left_align) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    ...
    wasm_emitf(10, "(local.set $emit_digits (i32.const 0))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $digits (if (result i32) (local.get $emit_digits) (then (call $__ag_vsnuint_base_len (local.get $arg) (local.get $base))) (else (i32.const 0))))\n");
    wasm_emitf(8, "(local.set $zero_count (i32.sub (local.get $precision) (local.get $digits)))\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $zero_count) (i32.const 0)) (then (local.set $zero_count (i32.const 0))))\n");
    wasm_emitf(8, "(local.set $prefix_len (i32.const 0))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 112))\n");
    ...
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.ge_u (local.get $prefix_len) (i32.const 1)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $prefix_len) (i32.const 2)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnputc (local.get $buf) (local.get $size) (local.get $pos) (if (result i32) (local.get $upper) (then (i32.const 88)) (else (i32.const 120)))))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (i32.and (i32.eqz (local.get $left_align)) (local.get $int_zero_pad)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $zero_count)))\n");
    wasm_emitf(8, "(if (local.get $emit_digits) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnwrite_u64_base (local.get $buf) (local.get $size) (local.get $pos) (local.get $arg) (local.get $base) (local.get $upper)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(if (local.get $left_align) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    ...
    wasm_emitf(8, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
    wasm_emitf(8, "(if (i32.eq (local.get $store_size) (i32.const 8))\n");
    wasm_emitf(10, "(then (i64.store (local.get $s) (i64.extend_i32_s (local.get $pos))))\n");
    wasm_emitf(10, "(else (if (i32.eq (local.get $store_size) (i32.const 2))\n");
    wasm_emitf(12, "(then (i32.store16 (local.get $s) (local.get $pos)))\n");
    wasm_emitf(12, "(else (if (i32.eq (local.get $store_size) (i32.const 1))\n");
    wasm_emitf(14, "(then (i32.store8 (local.get $s) (local.get $pos)))\n");
    wasm_emitf(14, "(else (i32.store (local.get $s) (local.get $pos)))\n");
    wasm_emitf(12, "))\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(8, ")\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
    ...
    wasm_emitf(10, "(local.set $ch (i32.load (i32.const %d)))\n", float_scratch_addr);
    wasm_emitf(10, "(if (i32.or (i32.eq (local.get $ch) (i32.const 45)) (i32.or (i32.eq (local.get $ch) (i32.const 43)) (i32.eq (local.get $ch) (i32.const 32)))) (then\n");
    wasm_emitf(12, "(local.set $pos (call $__ag_vsnputc (local.get $buf) (local.get $size) (local.get $pos) (local.get $ch)))\n");
    wasm_emitf(12, "(local.set $float_start (i32.const 1))\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(10, "(if (i32.and (i32.eq (i32.load (i32.add (i32.const %d) (i32.mul (local.get $float_start) (i32.const 4)))) (i32.const 48)) (i32.or (i32.eq (i32.load (i32.add (i32.const %d) (i32.mul (i32.add (local.get $float_start) (i32.const 1)) (i32.const 4)))) (i32.const 120)) (i32.eq (i32.load (i32.add (i32.const %d) (i32.mul (i32.add (local.get $float_start) (i32.const 1)) (i32.const 4)))) (i32.const 88)))) (then\n", float_scratch_addr, float_scratch_addr, float_scratch_addr);
    wasm_emitf(12, "(local.set $pos (call $__ag_vsnputc (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48)))\n");
    wasm_emitf(12, "(local.set $pos (call $__ag_vsnputc (local.get $buf) (local.get $size) (local.get $pos) (i32.load (i32.add (i32.const %d) (i32.mul (i32.add (local.get $float_start) (i32.const 1)) (i32.const 4))))))\n", float_scratch_addr);
    wasm_emitf(12, "(local.set $float_start (i32.add (local.get $float_start) (i32.const 2)))\n");
    wasm_emitf(10, "))\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 48) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $pos (call $__ag_vsnwrite_wide_ascii (local.get $buf) (local.get $size) (local.get $pos) (i32.add (i32.const %d) (i32.mul (local.get $float_start) (i32.const 4))) (i32.sub (local.get $float_len) (local.get $float_start))))\n", float_scratch_addr);
    wasm_emitf(8, "(if (local.get $left_align) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
    ...
    wasm_emitf(8, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
    wasm_emitf(8, "(local.set $string_len (if (result i32) (local.get $length_l)\n");
    wasm_emitf(10, "(then (call $__ag_vsnwstrlen (local.get $s) (local.get $precision)))\n");
    wasm_emitf(10, "(else (call $__ag_vsnstrlen (local.get $s) (local.get $precision)))))\n");
    wasm_emitf(8, "(local.set $pad (i32.sub (local.get $width) (local.get $string_len)))\n");
    wasm_emitf(8, "(if (i32.lt_s (local.get $pad) (i32.const 0)) (then (local.set $pad (i32.const 0))))\n");
    wasm_emitf(8, "(if (i32.eqz (local.get $left_align)) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $pos (if (result i32) (local.get $length_l)\n");
    wasm_emitf(10, "(then (call $__ag_vsnwrite_wide_ascii (local.get $buf) (local.get $size) (local.get $pos) (local.get $s) (local.get $string_len)))\n");
    wasm_emitf(10, "(else (call $__ag_vsnwrite_string (local.get $buf) (local.get $size) (local.get $pos) (local.get $s) (local.get $string_len)))))\n");
    wasm_emitf(8, "(if (local.get $left_align) (then\n");
    wasm_emitf(10, "(local.set $pos (call $__ag_vsnpad (local.get $buf) (local.get $size) (local.get $pos) (i32.const 32) (local.get $pad)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
...
static void emit_wasm_vsscanf_stubs(wasm32_ir_context_t *context) {
  ...
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_scan_digit_value (param $ch i32) (result i32)\n");
  wasm_emitf(4, "(if (result i32) (i32.and (i32.ge_u (local.get $ch) (i32.const 48)) (i32.le_u (local.get $ch) (i32.const 57)))\n");
  wasm_emitf(6, "(then (i32.sub (local.get $ch) (i32.const 48)))\n");
  wasm_emitf(6, "(else (if (result i32) (i32.and (i32.ge_u (local.get $ch) (i32.const 65)) (i32.le_u (local.get $ch) (i32.const 70)))\n");
  wasm_emitf(8, "(then (i32.add (i32.sub (local.get $ch) (i32.const 65)) (i32.const 10)))\n");
  wasm_emitf(8, "(else (if (result i32) (i32.and (i32.ge_u (local.get $ch) (i32.const 97)) (i32.le_u (local.get $ch) (i32.const 102)))\n");
  wasm_emitf(10, "(then (i32.add (i32.sub (local.get $ch) (i32.const 97)) (i32.const 10)))\n");
  wasm_emitf(10, "(else (i32.const -1))))))\n");
  wasm_emitf(4, ")\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_scan_int (param $p i32) (param $dst i32) (param $is_signed i32) (param $store_size i32) (param $width i32) (param $base i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $digits i32)\n");
  wasm_emitf(4, "(local $digit i32)\n");
  wasm_emitf(4, "(local $neg i32)\n");
  wasm_emitf(4, "(local $auto_base i32)\n");
  wasm_emitf(4, "(local $prefix_ok i32)\n");
  ...
  wasm_emitf(4, "(if (i32.eqz (local.get $ch)) (then (return (i32.const -1))))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 45)) (then\n");
  wasm_emitf(8, "(local.set $neg (i32.const 1))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(6, ") (else (if (i32.eq (local.get $ch) (i32.const 43)) (then\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(6, "))))\n");
  wasm_emitf(4, "(local.set $auto_base (i32.eqz (local.get $base)))\n");
  wasm_emitf(4, "(local.set $prefix_ok (i32.or (i32.lt_s (local.get $width) (i32.const 0)) (i32.ge_s (local.get $width) (i32.const 3))))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $base)) (then\n");
  wasm_emitf(6, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 48))\n");
  wasm_emitf(8, "(then (local.set $base (i32.const 8)))\n");
  wasm_emitf(8, "(else (local.set $base (i32.const 10)))\n");
  wasm_emitf(6, ")\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.and (local.get $auto_base) (i32.and (i32.eq (local.get $base) (i32.const 8)) (local.get $prefix_ok))) (then\n");
  wasm_emitf(6, "(if (i32.and (i32.or (i32.eq (i32.load8_u (i32.add (local.get $p) (i32.const 1))) (i32.const 120)) (i32.eq (i32.load8_u (i32.add (local.get $p) (i32.const 1))) (i32.const 88))) (i32.ge_s (call $__ag_scan_digit_value (i32.load8_u (i32.add (local.get $p) (i32.const 2)))) (i32.const 0))) (then\n");
  wasm_emitf(8, "(local.set $base (i32.const 16))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 2)))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 2)))))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.and (i32.eq (local.get $base) (i32.const 16)) (local.get $prefix_ok)) (then\n");
  wasm_emitf(6, "(if (i32.and (i32.and (i32.eq (i32.load8_u (local.get $p)) (i32.const 48)) (i32.or (i32.eq (i32.load8_u (i32.add (local.get $p) (i32.const 1))) (i32.const 120)) (i32.eq (i32.load8_u (i32.add (local.get $p) (i32.const 1))) (i32.const 88)))) (i32.ge_s (call $__ag_scan_digit_value (i32.load8_u (i32.add (local.get $p) (i32.const 2)))) (i32.const 0))) (then\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 2)))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 2)))))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(block $done (loop $loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(6, "(local.set $digit (call $__ag_scan_digit_value (local.get $ch)))\n");
  wasm_emitf(6, "(if (i32.or (i32.lt_s (local.get $digit) (i32.const 0)) (i32.ge_u (local.get $digit) (local.get $base))) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $val (i64.add (i64.mul (local.get $val) (i64.extend_i32_u (local.get $base))) (i64.extend_i32_u (local.get $digit))))\n");
  wasm_emitf(6, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(6, "(br $loop)\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $digits)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(if (local.get $dst) (then\n");
  wasm_emitf(6, "(if (local.get $neg) (then (local.set $val (i64.sub (i64.const 0) (local.get $val)))))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $store_size) (i32.const 8))\n");
  wasm_emitf(8, "(then (i64.store (local.get $dst) (local.get $val)))\n");
  wasm_emitf(8, "(else (if (i32.eq (local.get $store_size) (i32.const 2))\n");
  wasm_emitf(10, "(then (i32.store16 (local.get $dst) (i32.wrap_i64 (local.get $val))))\n");
  wasm_emitf(10, "(else (if (i32.eq (local.get $store_size) (i32.const 1))\n");
  wasm_emitf(12, "(then (i32.store8 (local.get $dst) (i32.wrap_i64 (local.get $val))))\n");
  wasm_emitf(12, "(else (i32.store (local.get $dst) (i32.wrap_i64 (local.get $val))))\n");
  wasm_emitf(10, "))\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(6, ")\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_scan_ascii_lower (param $ch i32) (result i32)\n");
  wasm_emitf(4, "(if (result i32) (i32.and (i32.ge_u (local.get $ch) (i32.const 65)) (i32.le_u (local.get $ch) (i32.const 90))) (then (i32.add (local.get $ch) (i32.const 32))) (else (local.get $ch)))\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_scan_hex_float (param $p i32) (param $dst i32) (param $bits64 i32) (param $width i32) (param $neg i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $digit i32)\n");
  wasm_emitf(4, "(local $digits i32)\n");
  wasm_emitf(4, "(local $value f64)\n");
  wasm_emitf(4, "(local $place f64)\n");
  wasm_emitf(4, "(local $exp_value i32)\n");
  wasm_emitf(4, "(local $exp_neg i32)\n");
  wasm_emitf(4, "(local $exp_digits i32)\n");
  wasm_emitf(4, "(if (i32.or (i32.and (i32.ge_s (local.get $width) (i32.const 0)) (i32.lt_s (local.get $width) (i32.const 2))) (i32.ne (i32.load8_u (local.get $p)) (i32.const 48))) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(if (i32.ne (call $__ag_scan_ascii_lower (i32.load8_u (i32.add (local.get $p) (i32.const 1)))) (i32.const 120)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(local.set $p (i32.add (local.get $p) (i32.const 2)))\n");
  wasm_emitf(4, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 2)))))\n");
  wasm_emitf(4, "(block $int_done (loop $int_loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $int_done)))\n");
  wasm_emitf(6, "(local.set $digit (call $__ag_scan_digit_value (i32.load8_u (local.get $p))))\n");
  wasm_emitf(6, "(if (i32.or (i32.lt_s (local.get $digit) (i32.const 0)) (i32.ge_s (local.get $digit) (i32.const 16))) (then (br $int_done)))\n");
  wasm_emitf(6, "(local.set $value (f64.add (f64.mul (local.get $value) (f64.const 16.0)) (f64.convert_i32_u (local.get $digit))))\n");
  wasm_emitf(6, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(6, "(br $int_loop)\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.and (i32.ne (local.get $width) (i32.const 0)) (i32.eq (i32.load8_u (local.get $p)) (i32.const 46))) (then\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(6, "(local.set $place (f64.const 0.0625))\n");
  wasm_emitf(6, "(block $frac_done (loop $frac_loop\n");
  wasm_emitf(8, "(if (i32.eqz (local.get $width)) (then (br $frac_done)))\n");
  wasm_emitf(8, "(local.set $digit (call $__ag_scan_digit_value (i32.load8_u (local.get $p))))\n");
  wasm_emitf(8, "(if (i32.or (i32.lt_s (local.get $digit) (i32.const 0)) (i32.ge_s (local.get $digit) (i32.const 16))) (then (br $frac_done)))\n");
  wasm_emitf(8, "(local.set $value (f64.add (local.get $value) (f64.mul (f64.convert_i32_u (local.get $digit)) (local.get $place))))\n");
  wasm_emitf(8, "(local.set $place (f64.div (local.get $place) (f64.const 16.0)))\n");
  wasm_emitf(8, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  ...
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $digits)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(if (i32.or (i32.eqz (local.get $width)) (i32.ne (call $__ag_scan_ascii_lower (i32.load8_u (local.get $p))) (i32.const 112))) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(4, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(4, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(4, "(if (i32.eq (local.get $ch) (i32.const 45)) (then (local.set $exp_neg (i32.const 1)) (local.set $p (i32.add (local.get $p) (i32.const 1))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(4, "(if (i32.eq (local.get $ch) (i32.const 43)) (then (local.set $p (i32.add (local.get $p) (i32.const 1))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(4, "(block $exp_done (loop $exp_loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $exp_done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.eqz (call $__ag_scan_isdigit (local.get $ch))) (then (br $exp_done)))\n");
  wasm_emitf(6, "(local.set $exp_digits (i32.const 1))\n");
  wasm_emitf(6, "(if (i32.lt_u (local.get $exp_value) (i32.const 1200)) (then\n");
  wasm_emitf(8, "(local.set $exp_value (i32.add (i32.mul (local.get $exp_value) (i32.const 10)) (i32.sub (local.get $ch) (i32.const 48))))\n");
  wasm_emitf(8, "(if (i32.gt_u (local.get $exp_value) (i32.const 1200)) (then (local.set $exp_value (i32.const 1200))))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(6, "(br $exp_loop)\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $exp_digits)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(block $scale_done (loop $scale_loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $exp_value)) (then (br $scale_done)))\n");
  wasm_emitf(6, "(if (local.get $exp_neg) (then (local.set $value (f64.div (local.get $value) (f64.const 2.0)))) (else (local.set $value (f64.mul (local.get $value) (f64.const 2.0)))))\n");
  wasm_emitf(6, "(local.set $exp_value (i32.sub (local.get $exp_value) (i32.const 1)))\n");
  wasm_emitf(6, "(br $scale_loop)\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (local.get $neg) (then (local.set $value (f64.neg (local.get $value)))))\n");
  wasm_emitf(4, "(if (local.get $dst) (then (if (local.get $bits64) (then (f64.store (local.get $dst) (local.get $value))) (else (f32.store (local.get $dst) (f32.demote_f64 (local.get $value)))))))\n");
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_scan_float (param $p i32) (param $dst i32) (param $bits64 i32) (param $width i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $digits i32)\n");
  wasm_emitf(4, "(local $neg i32)\n");
  wasm_emitf(4, "(local $value f64)\n");
  wasm_emitf(4, "(local $place f64)\n");
  wasm_emitf(4, "(local $exp_start i32)\n");
  wasm_emitf(4, "(local $exp_width i32)\n");
  wasm_emitf(4, "(local $exp_value i32)\n");
  wasm_emitf(4, "(local $exp_neg i32)\n");
  wasm_emitf(4, "(local $exp_digits i32)\n");
  wasm_emitf(4, "(local $payload_cursor i32)\n");
  wasm_emitf(4, "(local $payload_width i32)\n");
  wasm_emitf(4, "(local $hex_next i32)\n");
  wasm_emitf(4, "(local.set $p (call $__ag_scan_skip_spaces (local.get $p)))\n");
  wasm_emitf(4, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $ch)) (then (return (i32.const -1))))\n");
  wasm_emitf(4, "(if (i32.eq (local.get $ch) (i32.const 45)) (then (local.set $neg (i32.const 1)) (local.set $p (i32.add (local.get $p) (i32.const 1))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(4, "(if (i32.eq (local.get $ch) (i32.const 43)) (then (local.set $p (i32.add (local.get $p) (i32.const 1))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(4, "(if (i32.and (i32.or (i32.lt_s (local.get $width) (i32.const 0)) (i32.ge_s (local.get $width) (i32.const 3))) (i32.and (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (local.get $p))) (i32.const 105)) (i32.and (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (i32.add (local.get $p) (i32.const 1)))) (i32.const 110)) (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (i32.add (local.get $p) (i32.const 2)))) (i32.const 102))))) (then\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 3)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 3)))))\n");
  wasm_emitf(6, "(if (i32.and (i32.or (i32.lt_s (local.get $width) (i32.const 0)) (i32.ge_s (local.get $width) (i32.const 5))) (i32.and (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (local.get $p))) (i32.const 105)) (i32.and (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (i32.add (local.get $p) (i32.const 1)))) (i32.const 110)) (i32.and (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (i32.add (local.get $p) (i32.const 2)))) (i32.const 105)) (i32.and (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (i32.add (local.get $p) (i32.const 3)))) (i32.const 116)) (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (i32.add (local.get $p) (i32.const 4)))) (i32.const 121))))))) (then\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 5)))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 5)))))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(local.set $value (f64.const inf))\n");
  wasm_emitf(6, "(if (local.get $neg) (then (local.set $value (f64.neg (local.get $value)))))\n");
  wasm_emitf(6, "(if (local.get $dst) (then (if (local.get $bits64) (then (f64.store (local.get $dst) (local.get $value))) (else (f32.store (local.get $dst) (f32.demote_f64 (local.get $value)))))))\n");
  wasm_emitf(6, "(return (local.get $p))\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.and (i32.or (i32.lt_s (local.get $width) (i32.const 0)) (i32.ge_s (local.get $width) (i32.const 3))) (i32.and (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (local.get $p))) (i32.const 110)) (i32.and (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (i32.add (local.get $p) (i32.const 1)))) (i32.const 97)) (i32.eq (call $__ag_scan_ascii_lower (i32.load8_u (i32.add (local.get $p) (i32.const 2)))) (i32.const 110))))) (then\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 3)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 3)))))\n");
  wasm_emitf(6, "(if (i32.and (i32.ne (local.get $width) (i32.const 0)) (i32.eq (i32.load8_u (local.get $p)) (i32.const 40))) (then\n");
  wasm_emitf(8, "(local.set $payload_cursor (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(8, "(local.set $payload_width (local.get $width))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $payload_width) (i32.const 0)) (then (local.set $payload_width (i32.sub (local.get $payload_width) (i32.const 1)))))\n");
  wasm_emitf(8, "(block $payload_done (loop $payload_loop\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $payload_width)) (then (br $payload_done)))\n");
  wasm_emitf(10, "(local.set $ch (i32.load8_u (local.get $payload_cursor)))\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $ch)) (then (br $payload_done)))\n");
  wasm_emitf(10, "(if (i32.eq (local.get $ch) (i32.const 41)) (then\n");
  wasm_emitf(12, "(local.set $p (i32.add (local.get $payload_cursor) (i32.const 1)))\n");
  wasm_emitf(12, "(local.set $width (local.get $payload_width))\n");
  wasm_emitf(12, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(12, "(br $payload_done)\n");
  wasm_emitf(10, "))\n");
  wasm_emitf(10, "(local.set $payload_cursor (i32.add (local.get $payload_cursor) (i32.const 1)))\n");
  wasm_emitf(10, "(if (i32.gt_s (local.get $payload_width) (i32.const 0)) (then (local.set $payload_width (i32.sub (local.get $payload_width) (i32.const 1)))))\n");
  wasm_emitf(10, "(br $payload_loop)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(local.set $value (f64.const nan))\n");
  wasm_emitf(6, "(if (local.get $dst) (then (if (local.get $bits64) (then (f64.store (local.get $dst) (local.get $value))) (else (f32.store (local.get $dst) (f32.demote_f64 (local.get $value)))))))\n");
  wasm_emitf(6, "(return (local.get $p))\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(local.set $hex_next (call $__ag_scan_hex_float (local.get $p) (local.get $dst) (local.get $bits64) (local.get $width) (local.get $neg)))\n");
  wasm_emitf(4, "(if (local.get $hex_next) (then (return (local.get $hex_next))))\n");
  wasm_emitf(4, "(block $int_done (loop $int_loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $int_done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.eqz (call $__ag_scan_isdigit (local.get $ch))) (then (br $int_done)))\n");
  wasm_emitf(6, "(local.set $value (f64.add (f64.mul (local.get $value) (f64.const 10.0)) (f64.convert_i32_u (i32.sub (local.get $ch) (i32.const 48)))))\n");
  wasm_emitf(6, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(6, "(br $int_loop)\n");
  ...
  wasm_emitf(8, "(if (i32.eqz (local.get $width)) (then (br $frac_done)))\n");
  wasm_emitf(8, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(8, "(if (i32.eqz (call $__ag_scan_isdigit (local.get $ch))) (then (br $frac_done)))\n");
  wasm_emitf(8, "(local.set $value (f64.add (local.get $value) (f64.mul (f64.convert_i32_u (i32.sub (local.get $ch) (i32.const 48))) (local.get $place))))\n");
  ...
  wasm_emitf(4, "(if (i32.eqz (local.get $digits)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(4, "(if (i32.and (i32.ne (local.get $width) (i32.const 0)) (i32.or (i32.eq (local.get $ch) (i32.const 101)) (i32.eq (local.get $ch) (i32.const 69)))) (then\n");
  wasm_emitf(6, "(local.set $exp_start (local.get $p))\n");
  wasm_emitf(6, "(local.set $exp_width (local.get $width))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(6, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 45)) (then (local.set $exp_neg (i32.const 1)) (local.set $p (i32.add (local.get $p) (i32.const 1))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 43)) (then (local.set $p (i32.add (local.get $p) (i32.const 1))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(6, "(block $exp_done (loop $exp_loop\n");
  wasm_emitf(8, "(if (i32.eqz (local.get $width)) (then (br $exp_done)))\n");
  wasm_emitf(8, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(8, "(if (i32.eqz (call $__ag_scan_isdigit (local.get $ch))) (then (br $exp_done)))\n");
  wasm_emitf(8, "(local.set $exp_digits (i32.const 1))\n");
  wasm_emitf(8, "(if (i32.lt_u (local.get $exp_value) (i32.const 400)) (then\n");
  wasm_emitf(10, "(local.set $exp_value (i32.add (i32.mul (local.get $exp_value) (i32.const 10)) (i32.sub (local.get $ch) (i32.const 48))))\n");
  wasm_emitf(10, "(if (i32.gt_u (local.get $exp_value) (i32.const 400)) (then (local.set $exp_value (i32.const 400))))\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(8, "(br $exp_loop)\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (local.get $exp_digits)\n");
  wasm_emitf(8, "(then (block $scale_done (loop $scale_loop\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $exp_value)) (then (br $scale_done)))\n");
  wasm_emitf(10, "(if (local.get $exp_neg) (then (local.set $value (f64.div (local.get $value) (f64.const 10.0)))) (else (local.set $value (f64.mul (local.get $value) (f64.const 10.0)))))\n");
  wasm_emitf(10, "(local.set $exp_value (i32.sub (local.get $exp_value) (i32.const 1)))\n");
  wasm_emitf(10, "(br $scale_loop)\n");
  wasm_emitf(8, ")))\n");
  wasm_emitf(8, "(else (local.set $p (local.get $exp_start)) (local.set $width (local.get $exp_width)))\n");
  wasm_emitf(6, ")\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (local.get $neg) (then (local.set $value (f64.neg (local.get $value)))))\n");
  wasm_emitf(4, "(if (local.get $dst) (then (if (local.get $bits64) (then (f64.store (local.get $dst) (local.get $value))) (else (f32.store (local.get $dst) (f32.demote_f64 (local.get $value)))))))\n");
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_scan_word (param $p i32) (param $dst i32) (param $wide i32) (param $width i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $out i32)\n");
  ...
  wasm_emitf(4, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $ch)) (then (return (i32.const -1))))\n");
  wasm_emitf(4, "(if (call $__ag_scan_isspace (local.get $ch)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(block $done (loop $loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.or (i32.eqz (local.get $ch)) (call $__ag_scan_isspace (local.get $ch))) (then (br $done)))\n");
  wasm_emitf(6, "(if (local.get $out) (then\n");
  wasm_emitf(8, "(if (local.get $wide)\n");
  wasm_emitf(10, "(then (i32.store (local.get $out) (local.get $ch)) (local.set $out (i32.add (local.get $out) (i32.const 4))))\n");
  wasm_emitf(10, "(else (i32.store8 (local.get $out) (local.get $ch)) (local.set $out (i32.add (local.get $out) (i32.const 1))))\n");
  wasm_emitf(8, ")\n");
  wasm_emitf(6, "))\n");
  ...
  wasm_emitf(6, "(br $loop)\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (local.get $out) (then\n");
  wasm_emitf(6, "(if (local.get $wide) (then (i32.store (local.get $out) (i32.const 0))) (else (i32.store8 (local.get $out) (i32.const 0))))\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $count)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_scan_char (param $p i32) (param $dst i32) (param $wide i32) (param $width i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $out i32)\n");
  wasm_emitf(4, "(local $count i32)\n");
  wasm_emitf(4, "(if (i32.lt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.const 1))))\n");
  wasm_emitf(4, "(local.set $out (local.get $dst))\n");
  wasm_emitf(4, "(if (i32.eqz (i32.load8_u (local.get $p))) (then (return (i32.const -1))))\n");
  wasm_emitf(4, "(block $done (loop $loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $ch)) (then (br $done)))\n");
  ...
  wasm_emitf(6, "(local.set $count (i32.add (local.get $count) (i32.const 1)))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  wasm_emitf(6, "(local.set $width (i32.sub (local.get $width) (i32.const 1)))\n");
  wasm_emitf(6, "(br $loop)\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $count)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_scan_set_contains (param $set i32) (param $end i32) (param $invert i32) (param $ch i32) (result i32)\n");
  wasm_emitf(4, "(local $q i32)\n");
  wasm_emitf(4, "(local $first i32)\n");
  wasm_emitf(4, "(local $last i32)\n");
  wasm_emitf(4, "(local $found i32)\n");
  wasm_emitf(4, "(local.set $q (local.get $set))\n");
  wasm_emitf(4, "(block $done (loop $loop\n");
  wasm_emitf(6, "(if (i32.ge_u (local.get $q) (local.get $end)) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $first (i32.load8_u (local.get $q)))\n");
  wasm_emitf(6, "(if (i32.and (i32.lt_u (i32.add (local.get $q) (i32.const 2)) (local.get $end)) (i32.eq (i32.load8_u (i32.add (local.get $q) (i32.const 1))) (i32.const 45)))\n");
  wasm_emitf(8, "(then\n");
  wasm_emitf(10, "(local.set $last (i32.load8_u (i32.add (local.get $q) (i32.const 2))))\n");
  wasm_emitf(10, "(if (i32.or (i32.and (i32.le_u (local.get $first) (local.get $last)) (i32.and (i32.ge_u (local.get $ch) (local.get $first)) (i32.le_u (local.get $ch) (local.get $last)))) (i32.and (i32.gt_u (local.get $first) (local.get $last)) (i32.and (i32.le_u (local.get $ch) (local.get $first)) (i32.ge_u (local.get $ch) (local.get $last))))) (then (local.set $found (i32.const 1))))\n");
  wasm_emitf(10, "(local.set $q (i32.add (local.get $q) (i32.const 3)))\n");
  wasm_emitf(8, ")\n");
  wasm_emitf(8, "(else\n");
  wasm_emitf(10, "(if (i32.eq (local.get $ch) (local.get $first)) (then (local.set $found (i32.const 1))))\n");
  wasm_emitf(10, "(local.set $q (i32.add (local.get $q) (i32.const 1)))\n");
  wasm_emitf(8, ")\n");
  wasm_emitf(6, ")\n");
  wasm_emitf(6, "(br $loop)\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (result i32) (local.get $invert) (then (i32.eqz (local.get $found))) (else (local.get $found)))\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_scan_set (param $p i32) (param $dst i32) (param $wide i32) (param $width i32) (param $set i32) (param $end i32) (param $invert i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $out i32)\n");
  wasm_emitf(4, "(local $count i32)\n");
  wasm_emitf(4, "(local.set $out (local.get $dst))\n");
  ...
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load8_u (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.or (i32.eqz (local.get $ch)) (i32.eqz (call $__ag_scan_set_contains (local.get $set) (local.get $end) (local.get $invert) (local.get $ch)))) (then (br $done)))\n");
  wasm_emitf(6, "(if (local.get $out) (then\n");
  wasm_emitf(8, "(if (local.get $wide)\n");
  wasm_emitf(10, "(then (i32.store (local.get $out) (local.get $ch)) (local.set $out (i32.add (local.get $out) (i32.const 4))))\n");
  wasm_emitf(10, "(else (i32.store8 (local.get $out) (local.get $ch)) (local.set $out (i32.add (local.get $out) (i32.const 1))))\n");
  ...
  wasm_emitf(4, "(local $length_l i32)\n");
  wasm_emitf(4, "(local $length_L i32)\n");
  wasm_emitf(4, "(local $suppress i32)\n");
  wasm_emitf(4, "(local $width i32)\n");
  wasm_emitf(4, "(local $base i32)\n");
  wasm_emitf(4, "(local $store_size i32)\n");
  wasm_emitf(4, "(local $set_start i32)\n");
  wasm_emitf(4, "(local $set_end i32)\n");
  wasm_emitf(4, "(local $set_cursor i32)\n");
  wasm_emitf(4, "(local $invert i32)\n");
  ...
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.ne (local.get $ch) (i32.const 37)) (then\n");
  wasm_emitf(8, "(if (i32.ne (i32.load8_u (local.get $p)) (local.get $ch)) (then\n");
  wasm_emitf(10, "(if (i32.and (i32.eqz (i32.load8_u (local.get $p))) (i32.eqz (local.get $assigns))) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  ...
  wasm_emitf(8, "(if (i32.ne (i32.load8_u (local.get $p)) (i32.const 37)) (then\n");
  wasm_emitf(10, "(if (i32.and (i32.eqz (i32.load8_u (local.get $p))) (i32.eqz (local.get $assigns))) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
  ...
  wasm_emitf(8, "(br $loop)\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(local.set $suppress (i32.const 0))\n");
  wasm_emitf(6, "(local.set $width (i32.const -1))\n");
  wasm_emitf(6, "(local.set $length_h (i32.const 0))\n");
  wasm_emitf(6, "(local.set $length_hh (i32.const 0))\n");
  wasm_emitf(6, "(local.set $length_l (i32.const 0))\n");
  wasm_emitf(6, "(local.set $length_L (i32.const 0))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 42)) (then\n");
  wasm_emitf(8, "(local.set $suppress (i32.const 1))\n");
  wasm_emitf(8, "(local.set $f (i32.add (local.get $f) (i32.const 1)))\n");
  wasm_emitf(8, "(local.set $spec (i32.load8_u (local.get $f)))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (call $__ag_scan_isdigit (local.get $spec)) (then\n");
  wasm_emitf(8, "(local.set $width (i32.const 0))\n");
  wasm_emitf(8, "(block $width_done (loop $width_loop\n");
  wasm_emitf(10, "(if (i32.eqz (call $__ag_scan_isdigit (local.get $spec))) (then (br $width_done)))\n");
  wasm_emitf(10, "(local.set $width (i32.add (i32.mul (local.get $width) (i32.const 10)) (i32.sub (local.get $spec) (i32.const 48))))\n");
  wasm_emitf(10, "(local.set $f (i32.add (local.get $f) (i32.const 1)))\n");
  wasm_emitf(10, "(local.set $spec (i32.load8_u (local.get $f)))\n");
  wasm_emitf(10, "(br $width_loop)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 104)) (then\n");
  wasm_emitf(8, "(local.set $length_h (i32.const 1))\n");
  wasm_emitf(8, "(local.set $f (i32.add (local.get $f) (i32.const 1)))\n");
  wasm_emitf(8, "(local.set $spec (i32.load8_u (local.get $f)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $spec) (i32.const 104)) (then\n");
  wasm_emitf(10, "(local.set $length_h (i32.const 0))\n");
  wasm_emitf(10, "(local.set $length_hh (i32.const 1))\n");
  wasm_emitf(10, "(local.set $f (i32.add (local.get $f) (i32.const 1)))\n");
  wasm_emitf(10, "(local.set $spec (i32.load8_u (local.get $f)))\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.or (i32.eq (local.get $spec) (i32.const 106)) (i32.or (i32.eq (local.get $spec) (i32.const 122)) (i32.eq (local.get $spec) (i32.const 116)))) (then\n");
  wasm_emitf(8, "(local.set $length_l (i32.const 1))\n");
  wasm_emitf(8, "(local.set $f (i32.add (local.get $f) (i32.const 1)))\n");
  wasm_emitf(8, "(local.set $spec (i32.load8_u (local.get $f)))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 76)) (then\n");
  wasm_emitf(8, "(local.set $length_L (i32.const 1))\n");
  wasm_emitf(8, "(local.set $f (i32.add (local.get $f) (i32.const 1)))\n");
  wasm_emitf(8, "(local.set $spec (i32.load8_u (local.get $f)))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 108)) (then\n");
  wasm_emitf(8, "(local.set $length_l (i32.const 1))\n");
  wasm_emitf(8, "(local.set $f (i32.add (local.get $f) (i32.const 1)))\n");
  wasm_emitf(8, "(local.set $spec (i32.load8_u (local.get $f)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $spec) (i32.const 108)) (then\n");
  wasm_emitf(10, "(local.set $f (i32.add (local.get $f) (i32.const 1)))\n");
  wasm_emitf(10, "(local.set $spec (i32.load8_u (local.get $f)))\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(6, "))\n");
  ...
  wasm_emitf(6, "(if (local.get $length_hh) (then (local.set $store_size (i32.const 1))))\n");
  wasm_emitf(6, "(if (local.get $length_l) (then (local.set $store_size (i32.const 8))))\n");
  wasm_emitf(6, "(local.set $dst (i32.const 0))\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $suppress)) (then\n");
  wasm_emitf(8, "(local.set $dst (i32.wrap_i64 (i64.load (local.get $vap))))\n");
  wasm_emitf(8, "(local.set $vap (i32.add (local.get $vap) (i32.const 8)))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.or (i32.eq (local.get $spec) (i32.const 112)) (i32.or (i32.or (i32.eq (local.get $spec) (i32.const 100)) (i32.eq (local.get $spec) (i32.const 117))) (i32.or (i32.or (i32.eq (local.get $spec) (i32.const 105)) (i32.eq (local.get $spec) (i32.const 120))) (i32.or (i32.eq (local.get $spec) (i32.const 88)) (i32.eq (local.get $spec) (i32.const 111)))))) (then\n");
  wasm_emitf(8, "(local.set $base (i32.const 10))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $spec) (i32.const 105)) (then (local.set $base (i32.const 0))))\n");
  wasm_emitf(8, "(if (i32.or (i32.eq (local.get $spec) (i32.const 112)) (i32.or (i32.eq (local.get $spec) (i32.const 120)) (i32.eq (local.get $spec) (i32.const 88)))) (then (local.set $base (i32.const 16))))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $spec) (i32.const 111)) (then (local.set $base (i32.const 8))))\n");
  wasm_emitf(8, "(local.set $next (call $__ag_scan_int (local.get $p) (local.get $dst) (i32.or (i32.eq (local.get $spec) (i32.const 100)) (i32.eq (local.get $spec) (i32.const 105))) (local.get $store_size) (local.get $width) (local.get $base)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $next) (i32.const -1)) (then\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $assigns)) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(if (i32.eqz (local.get $next)) (then (br $done)))\n");
  wasm_emitf(8, "(local.set $p (local.get $next))\n");
  wasm_emitf(8, "(if (i32.eqz (local.get $suppress)) (then (local.set $assigns (i32.add (local.get $assigns) (i32.const 1)))))\n");
  wasm_emitf(8, "(local.set $f (i32.add (local.get $f) (i32.const 1)))\n");
  wasm_emitf(8, "(br $loop)\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.or (i32.or (i32.eq (local.get $spec) (i32.const 97)) (i32.eq (local.get $spec) (i32.const 65))) (i32.or (i32.or (i32.eq (local.get $spec) (i32.const 102)) (i32.eq (local.get $spec) (i32.const 70))) (i32.or (i32.or (i32.eq (local.get $spec) (i32.const 101)) (i32.eq (local.get $spec) (i32.const 69))) (i32.or (i32.eq (local.get $spec) (i32.const 103)) (i32.eq (local.get $spec) (i32.const 71)))))) (then\n");
  wasm_emitf(8, "(local.set $next (call $__ag_scan_float (local.get $p) (local.get $dst) (i32.or (local.get $length_l) (local.get $length_L)) (local.get $width)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $next) (i32.const -1)) (then\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $assigns)) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  ...
  wasm_emitf(8, "(local.set $next (call $__ag_scan_word (local.get $p) (local.get $dst) (local.get $length_l) (local.get $width)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $next) (i32.const -1)) (then\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $assigns)) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  ...
  wasm_emitf(8, "(local.set $next (call $__ag_scan_char (local.get $p) (local.get $dst) (local.get $length_l) (local.get $width)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $next) (i32.const -1)) (then\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $assigns)) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  ...
  wasm_emitf(8, "(br $loop)\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 91)) (then\n");
  wasm_emitf(8, "(local.set $set_cursor (i32.add (local.get $f) (i32.const 1)))\n");
  wasm_emitf(8, "(local.set $invert (i32.const 0))\n");
  wasm_emitf(8, "(if (i32.eq (i32.load8_u (local.get $set_cursor)) (i32.const 94)) (then\n");
  wasm_emitf(10, "(local.set $invert (i32.const 1))\n");
  wasm_emitf(10, "(local.set $set_cursor (i32.add (local.get $set_cursor) (i32.const 1)))\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(local.set $set_start (local.get $set_cursor))\n");
  wasm_emitf(8, "(if (i32.eq (i32.load8_u (local.get $set_cursor)) (i32.const 93)) (then (local.set $set_cursor (i32.add (local.get $set_cursor) (i32.const 1)))))\n");
  wasm_emitf(8, "(local.set $set_end (i32.const 0))\n");
  wasm_emitf(8, "(block $set_end_done (loop $set_end_loop\n");
  wasm_emitf(10, "(local.set $ch (i32.load8_u (local.get $set_cursor)))\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $ch)) (then (br $set_end_done)))\n");
  wasm_emitf(10, "(if (i32.eq (local.get $ch) (i32.const 93)) (then (local.set $set_end (local.get $set_cursor)) (br $set_end_done)))\n");
  wasm_emitf(10, "(local.set $set_cursor (i32.add (local.get $set_cursor) (i32.const 1)))\n");
  wasm_emitf(10, "(br $set_end_loop)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(if (i32.eqz (local.get $set_end)) (then (br $done)))\n");
  wasm_emitf(8, "(local.set $next (call $__ag_scan_set (local.get $p) (local.get $dst) (local.get $length_l) (local.get $width) (local.get $set_start) (local.get $set_end) (local.get $invert)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $next) (i32.const -1)) (then\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $assigns)) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  ...
  wasm_emitf(8, "(local.set $p (local.get $next))\n");
  wasm_emitf(8, "(if (i32.eqz (local.get $suppress)) (then (local.set $assigns (i32.add (local.get $assigns) (i32.const 1)))))\n");
  wasm_emitf(8, "(local.set $f (i32.add (local.get $set_end) (i32.const 1)))\n");
  wasm_emitf(8, "(br $loop)\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 110)) (then\n");
  wasm_emitf(8, "(if (local.get $dst) (then\n");
  wasm_emitf(10, "(if (i32.eq (local.get $store_size) (i32.const 8))\n");
  wasm_emitf(12, "(then (i64.store (local.get $dst) (i64.extend_i32_s (i32.sub (local.get $p) (local.get $s)))))\n");
  wasm_emitf(12, "(else (if (i32.eq (local.get $store_size) (i32.const 2))\n");
  wasm_emitf(14, "(then (i32.store16 (local.get $dst) (i32.sub (local.get $p) (local.get $s))))\n");
  wasm_emitf(14, "(else (if (i32.eq (local.get $store_size) (i32.const 1))\n");
  wasm_emitf(16, "(then (i32.store8 (local.get $dst) (i32.sub (local.get $p) (local.get $s))))\n");
  wasm_emitf(16, "(else (i32.store (local.get $dst) (i32.sub (local.get $p) (local.get $s))))\n");
  wasm_emitf(14, "))\n");
  wasm_emitf(12, "))\n");
  wasm_emitf(10, ")\n");
  wasm_emitf(8, "))\n");
...
static void emit_wasm_swscanf_stub(wasm32_ir_context_t *context) {
  int slots_addr =
      intern_data_symbol("__ag_swscanf_va_slots",
                         (int)(sizeof("__ag_swscanf_va_slots") - 1), 16, 8)->addr;
  ...
  wasm_emitf(4, "(i32.and (i32.ge_u (local.get $ch) (i32.const 48)) (i32.le_u (local.get $ch) (i32.const 57)))\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_wscan_digit_value (param $ch i32) (result i32)\n");
  wasm_emitf(4, "(if (result i32) (i32.and (i32.ge_u (local.get $ch) (i32.const 48)) (i32.le_u (local.get $ch) (i32.const 57)))\n");
  wasm_emitf(6, "(then (i32.sub (local.get $ch) (i32.const 48)))\n");
  wasm_emitf(6, "(else (if (result i32) (i32.and (i32.ge_u (local.get $ch) (i32.const 65)) (i32.le_u (local.get $ch) (i32.const 70)))\n");
  wasm_emitf(8, "(then (i32.add (i32.sub (local.get $ch) (i32.const 65)) (i32.const 10)))\n");
  ...
  wasm_emitf(4, ")\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_wscan_int (param $p i32) (param $dst i32) (param $is_signed i32) (param $store_size i32) (param $width i32) (param $base i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $digits i32)\n");
  wasm_emitf(4, "(local $digit i32)\n");
  wasm_emitf(4, "(local $neg i32)\n");
  ...
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.and (local.get $auto_base) (i32.and (i32.eq (local.get $base) (i32.const 8)) (local.get $prefix_ok))) (then\n");
  wasm_emitf(6, "(if (i32.and (i32.or (i32.eq (i32.load (i32.add (local.get $p) (i32.const 4))) (i32.const 120)) (i32.eq (i32.load (i32.add (local.get $p) (i32.const 4))) (i32.const 88))) (i32.ge_s (call $__ag_wscan_digit_value (i32.load (i32.add (local.get $p) (i32.const 8)))) (i32.const 0))) (then\n");
  wasm_emitf(8, "(local.set $base (i32.const 16))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 8)))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 2)))))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.and (i32.eq (local.get $base) (i32.const 16)) (local.get $prefix_ok)) (then\n");
  wasm_emitf(6, "(if (i32.and (i32.and (i32.eq (i32.load (local.get $p)) (i32.const 48)) (i32.or (i32.eq (i32.load (i32.add (local.get $p) (i32.const 4))) (i32.const 120)) (i32.eq (i32.load (i32.add (local.get $p) (i32.const 4))) (i32.const 88)))) (i32.ge_s (call $__ag_wscan_digit_value (i32.load (i32.add (local.get $p) (i32.const 8)))) (i32.const 0))) (then\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 8)))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 2)))))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(4, "))\n");
  ...
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(6, "(local.set $digit (call $__ag_wscan_digit_value (local.get $ch)))\n");
  wasm_emitf(6, "(if (i32.or (i32.lt_s (local.get $digit) (i32.const 0)) (i32.ge_u (local.get $digit) (local.get $base))) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $val (i64.add (i64.mul (local.get $val) (i64.extend_i32_u (local.get $base))) (i64.extend_i32_u (local.get $digit))))\n");
  wasm_emitf(6, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
  ...
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_wscan_ascii_lower (param $ch i32) (result i32)\n");
  wasm_emitf(4, "(if (result i32) (i32.and (i32.ge_u (local.get $ch) (i32.const 65)) (i32.le_u (local.get $ch) (i32.const 90))) (then (i32.add (local.get $ch) (i32.const 32))) (else (local.get $ch)))\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_wscan_hex_float (param $p i32) (param $dst i32) (param $bits64 i32) (param $width i32) (param $neg i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $digit i32)\n");
  wasm_emitf(4, "(local $digits i32)\n");
  wasm_emitf(4, "(local $value f64)\n");
  ...
  wasm_emitf(4, "(local $exp_neg i32)\n");
  wasm_emitf(4, "(local $exp_digits i32)\n");
  wasm_emitf(4, "(if (i32.or (i32.and (i32.ge_s (local.get $width) (i32.const 0)) (i32.lt_s (local.get $width) (i32.const 2))) (i32.ne (i32.load (local.get $p)) (i32.const 48))) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(if (i32.ne (call $__ag_wscan_ascii_lower (i32.load (i32.add (local.get $p) (i32.const 4)))) (i32.const 120)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(local.set $p (i32.add (local.get $p) (i32.const 8)))\n");
  wasm_emitf(4, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 2)))))\n");
  wasm_emitf(4, "(block $int_done (loop $int_loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $int_done)))\n");
  wasm_emitf(6, "(local.set $digit (call $__ag_wscan_digit_value (i32.load (local.get $p))))\n");
  wasm_emitf(6, "(if (i32.or (i32.lt_s (local.get $digit) (i32.const 0)) (i32.ge_s (local.get $digit) (i32.const 16))) (then (br $int_done)))\n");
  wasm_emitf(6, "(local.set $value (f64.add (f64.mul (local.get $value) (f64.const 16.0)) (f64.convert_i32_u (local.get $digit))))\n");
  wasm_emitf(6, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
  ...
  wasm_emitf(6, "(br $int_loop)\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.and (i32.ne (local.get $width) (i32.const 0)) (i32.eq (i32.load (local.get $p)) (i32.const 46))) (then\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(6, "(local.set $place (f64.const 0.0625))\n");
  wasm_emitf(6, "(block $frac_done (loop $frac_loop\n");
  wasm_emitf(8, "(if (i32.eqz (local.get $width)) (then (br $frac_done)))\n");
  wasm_emitf(8, "(local.set $digit (call $__ag_wscan_digit_value (i32.load (local.get $p))))\n");
  wasm_emitf(8, "(if (i32.or (i32.lt_s (local.get $digit) (i32.const 0)) (i32.ge_s (local.get $digit) (i32.const 16))) (then (br $frac_done)))\n");
  wasm_emitf(8, "(local.set $value (f64.add (local.get $value) (f64.mul (f64.convert_i32_u (local.get $digit)) (local.get $place))))\n");
  wasm_emitf(8, "(local.set $place (f64.div (local.get $place) (f64.const 16.0)))\n");
  wasm_emitf(8, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
  ...
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $digits)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(if (i32.or (i32.eqz (local.get $width)) (i32.ne (call $__ag_wscan_ascii_lower (i32.load (local.get $p))) (i32.const 112))) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
  wasm_emitf(4, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(4, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(4, "(if (i32.eq (local.get $ch) (i32.const 45)) (then (local.set $exp_neg (i32.const 1)) (local.set $p (i32.add (local.get $p) (i32.const 4))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(4, "(if (i32.eq (local.get $ch) (i32.const 43)) (then (local.set $p (i32.add (local.get $p) (i32.const 4))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(4, "(block $exp_done (loop $exp_loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $exp_done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.eqz (call $__ag_wscan_isdigit (local.get $ch))) (then (br $exp_done)))\n");
  wasm_emitf(6, "(local.set $exp_digits (i32.const 1))\n");
  wasm_emitf(6, "(if (i32.lt_u (local.get $exp_value) (i32.const 1200)) (then\n");
  wasm_emitf(8, "(local.set $exp_value (i32.add (i32.mul (local.get $exp_value) (i32.const 10)) (i32.sub (local.get $ch) (i32.const 48))))\n");
  wasm_emitf(8, "(if (i32.gt_u (local.get $exp_value) (i32.const 1200)) (then (local.set $exp_value (i32.const 1200))))\n");
  ...
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_wscan_float (param $p i32) (param $dst i32) (param $bits64 i32) (param $width i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $digits i32)\n");
  wasm_emitf(4, "(local $neg i32)\n");
  wasm_emitf(4, "(local $value f64)\n");
  ...
  wasm_emitf(4, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $ch)) (then (return (i32.const -1))))\n");
  wasm_emitf(4, "(if (i32.eq (local.get $ch) (i32.const 45)) (then (local.set $neg (i32.const 1)) (local.set $p (i32.add (local.get $p) (i32.const 4))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(4, "(if (i32.eq (local.get $ch) (i32.const 43)) (then (local.set $p (i32.add (local.get $p) (i32.const 4))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(4, "(if (i32.and (i32.or (i32.lt_s (local.get $width) (i32.const 0)) (i32.ge_s (local.get $width) (i32.const 3))) (i32.and (i32.eq (call $__ag_wscan_ascii_lower (i32.load (local.get $p))) (i32.const 105)) (i32.and (i32.eq (call $__ag_wscan_ascii_lower (i32.load (i32.add (local.get $p) (i32.const 4)))) (i32.const 110)) (i32.eq (call $__ag_wscan_ascii_lower (i32.load (i32.add (local.get $p) (i32.const 8)))) (i32.const 102))))) (then\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 12)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 3)))))\n");
  wasm_emitf(6, "(if (i32.and (i32.or (i32.lt_s (local.get $width) (i32.const 0)) (i32.ge_s (local.get $width) (i32.const 5))) (i32.and (i32.eq (call $__ag_wscan_ascii_lower (i32.load (local.get $p))) (i32.const 105)) (i32.and (i32.eq (call $__ag_wscan_ascii_lower (i32.load (i32.add (local.get $p) (i32.const 4)))) (i32.const 110)) (i32.and (i32.eq (call $__ag_wscan_ascii_lower (i32.load (i32.add (local.get $p) (i32.const 8)))) (i32.const 105)) (i32.and (i32.eq (call $__ag_wscan_ascii_lower (i32.load (i32.add (local.get $p) (i32.const 12)))) (i32.const 116)) (i32.eq (call $__ag_wscan_ascii_lower (i32.load (i32.add (local.get $p) (i32.const 16)))) (i32.const 121))))))) (then\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 20)))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 5)))))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(local.set $value (f64.const inf))\n");
  wasm_emitf(6, "(if (local.get $neg) (then (local.set $value (f64.neg (local.get $value)))))\n");
  ...
  wasm_emitf(6, "(return (local.get $p))\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.and (i32.or (i32.lt_s (local.get $width) (i32.const 0)) (i32.ge_s (local.get $width) (i32.const 3))) (i32.and (i32.eq (call $__ag_wscan_ascii_lower (i32.load (local.get $p))) (i32.const 110)) (i32.and (i32.eq (call $__ag_wscan_ascii_lower (i32.load (i32.add (local.get $p) (i32.const 4)))) (i32.const 97)) (i32.eq (call $__ag_wscan_ascii_lower (i32.load (i32.add (local.get $p) (i32.const 8)))) (i32.const 110))))) (then\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 12)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 3)))))\n");
  wasm_emitf(6, "(if (i32.and (i32.ne (local.get $width) (i32.const 0)) (i32.eq (i32.load (local.get $p)) (i32.const 40))) (then\n");
  wasm_emitf(8, "(local.set $payload_cursor (i32.add (local.get $p) (i32.const 4)))\n");
  wasm_emitf(8, "(local.set $payload_width (local.get $width))\n");
  wasm_emitf(8, "(if (i32.gt_s (local.get $payload_width) (i32.const 0)) (then (local.set $payload_width (i32.sub (local.get $payload_width) (i32.const 1)))))\n");
  wasm_emitf(8, "(block $payload_done (loop $payload_loop\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $payload_width)) (then (br $payload_done)))\n");
  wasm_emitf(10, "(local.set $ch (i32.load (local.get $payload_cursor)))\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $ch)) (then (br $payload_done)))\n");
  wasm_emitf(10, "(if (i32.eq (local.get $ch) (i32.const 41)) (then\n");
  wasm_emitf(12, "(local.set $p (i32.add (local.get $payload_cursor) (i32.const 4)))\n");
  wasm_emitf(12, "(local.set $width (local.get $payload_width))\n");
  wasm_emitf(12, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(12, "(br $payload_done)\n");
  wasm_emitf(10, "))\n");
  wasm_emitf(10, "(local.set $payload_cursor (i32.add (local.get $payload_cursor) (i32.const 4)))\n");
  wasm_emitf(10, "(if (i32.gt_s (local.get $payload_width) (i32.const 0)) (then (local.set $payload_width (i32.sub (local.get $payload_width) (i32.const 1)))))\n");
  wasm_emitf(10, "(br $payload_loop)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(6, "))\n");
  ...
  wasm_emitf(6, "(return (local.get $p))\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(local.set $hex_next (call $__ag_wscan_hex_float (local.get $p) (local.get $dst) (local.get $bits64) (local.get $width) (local.get $neg)))\n");
  wasm_emitf(4, "(if (local.get $hex_next) (then (return (local.get $hex_next))))\n");
  wasm_emitf(4, "(block $int_done (loop $int_loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $int_done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.eqz (call $__ag_wscan_isdigit (local.get $ch))) (then (br $int_done)))\n");
  wasm_emitf(6, "(local.set $value (f64.add (f64.mul (local.get $value) (f64.const 10.0)) (f64.convert_i32_u (i32.sub (local.get $ch) (i32.const 48)))))\n");
  wasm_emitf(6, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  ...
  wasm_emitf(8, "(if (i32.eqz (local.get $width)) (then (br $frac_done)))\n");
  wasm_emitf(8, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(8, "(if (i32.eqz (call $__ag_wscan_isdigit (local.get $ch))) (then (br $frac_done)))\n");
  wasm_emitf(8, "(local.set $value (f64.add (local.get $value) (f64.mul (f64.convert_i32_u (i32.sub (local.get $ch) (i32.const 48))) (local.get $place))))\n");
  wasm_emitf(8, "(local.set $place (f64.div (local.get $place) (f64.const 10.0)))\n");
  wasm_emitf(8, "(local.set $digits (i32.add (local.get $digits) (i32.const 1)))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
  ...
  wasm_emitf(6, "(if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))\n");
  wasm_emitf(6, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 45)) (then (local.set $exp_neg (i32.const 1)) (local.set $p (i32.add (local.get $p) (i32.const 4))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $ch) (i32.const 43)) (then (local.set $p (i32.add (local.get $p) (i32.const 4))) (if (i32.gt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.sub (local.get $width) (i32.const 1)))))))\n");
  wasm_emitf(6, "(block $exp_done (loop $exp_loop\n");
  wasm_emitf(8, "(if (i32.eqz (local.get $width)) (then (br $exp_done)))\n");
  wasm_emitf(8, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(8, "(if (i32.eqz (call $__ag_wscan_isdigit (local.get $ch))) (then (br $exp_done)))\n");
  wasm_emitf(8, "(local.set $exp_digits (i32.const 1))\n");
  wasm_emitf(8, "(if (i32.lt_u (local.get $exp_value) (i32.const 400)) (then\n");
  wasm_emitf(10, "(local.set $exp_value (i32.add (i32.mul (local.get $exp_value) (i32.const 10)) (i32.sub (local.get $ch) (i32.const 48))))\n");
  wasm_emitf(10, "(if (i32.gt_u (local.get $exp_value) (i32.const 400)) (then (local.set $exp_value (i32.const 400))))\n");
  ...
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_wscan_word (param $p i32) (param $dst i32) (param $wide i32) (param $width i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $out i32)\n");
  wasm_emitf(4, "(local $count i32)\n");
  wasm_emitf(4, "(local.set $p (call $__ag_wscan_skip_spaces (local.get $p)))\n");
  ...
  wasm_emitf(4, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(4, "(if (i32.eqz (local.get $ch)) (then (return (i32.const -1))))\n");
  wasm_emitf(4, "(if (call $__ag_wscan_isspace (local.get $ch)) (then (return (i32.const 0))))\n");
  wasm_emitf(4, "(block $done (loop $loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load (local.get $p)))\n");
  ...
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_wscan_char (param $p i32) (param $dst i32) (param $wide i32) (param $width i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $out i32)\n");
  wasm_emitf(4, "(local $count i32)\n");
  wasm_emitf(4, "(if (i32.lt_s (local.get $width) (i32.const 0)) (then (local.set $width (i32.const 1))))\n");
  wasm_emitf(4, "(local.set $out (local.get $dst))\n");
  wasm_emitf(4, "(if (i32.eqz (i32.load (local.get $p))) (then (return (i32.const -1))))\n");
  wasm_emitf(4, "(block $done (loop $loop\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.eqz (local.get $ch)) (then (br $done)))\n");
  ...
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_wscan_set_contains (param $set i32) (param $end i32) (param $invert i32) (param $ch i32) (result i32)\n");
  wasm_emitf(4, "(local $q i32)\n");
  wasm_emitf(4, "(local $first i32)\n");
  wasm_emitf(4, "(local $last i32)\n");
  wasm_emitf(4, "(local $found i32)\n");
  ...
  wasm_emitf(4, "(block $done (loop $loop\n");
  wasm_emitf(6, "(if (i32.ge_u (local.get $q) (local.get $end)) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $first (i32.load (local.get $q)))\n");
  wasm_emitf(6, "(if (i32.and (i32.lt_u (i32.add (local.get $q) (i32.const 8)) (local.get $end)) (i32.eq (i32.load (i32.add (local.get $q) (i32.const 4))) (i32.const 45)))\n");
  wasm_emitf(8, "(then\n");
  wasm_emitf(10, "(local.set $last (i32.load (i32.add (local.get $q) (i32.const 8))))\n");
  wasm_emitf(10, "(if (i32.or (i32.and (i32.le_u (local.get $first) (local.get $last)) (i32.and (i32.ge_u (local.get $ch) (local.get $first)) (i32.le_u (local.get $ch) (local.get $last)))) (i32.and (i32.gt_u (local.get $first) (local.get $last)) (i32.and (i32.le_u (local.get $ch) (local.get $first)) (i32.ge_u (local.get $ch) (local.get $last))))) (then (local.set $found (i32.const 1))))\n");
  wasm_emitf(10, "(local.set $q (i32.add (local.get $q) (i32.const 12)))\n");
  wasm_emitf(8, ")\n");
  wasm_emitf(8, "(else\n");
  wasm_emitf(10, "(if (i32.eq (local.get $ch) (local.get $first)) (then (local.set $found (i32.const 1))))\n");
  wasm_emitf(10, "(local.set $q (i32.add (local.get $q) (i32.const 4)))\n");
  wasm_emitf(8, ")\n");
  wasm_emitf(6, ")\n");
  wasm_emitf(6, "(br $loop)\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (result i32) (local.get $invert) (then (i32.eqz (local.get $found))) (else (local.get $found)))\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_wscan_set (param $p i32) (param $dst i32) (param $wide i32) (param $width i32) (param $set i32) (param $end i32) (param $invert i32) (result i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $out i32)\n");
  wasm_emitf(4, "(local $count i32)\n");
  wasm_emitf(4, "(local.set $out (local.get $dst))\n");
  ...
  wasm_emitf(6, "(if (i32.eqz (local.get $width)) (then (br $done)))\n");
  wasm_emitf(6, "(local.set $ch (i32.load (local.get $p)))\n");
  wasm_emitf(6, "(if (i32.or (i32.eqz (local.get $ch)) (i32.eqz (call $__ag_wscan_set_contains (local.get $set) (local.get $end) (local.get $invert) (local.get $ch)))) (then (br $done)))\n");
  wasm_emitf(6, "(if (local.get $out) (then\n");
  wasm_emitf(8, "(if (local.get $wide)\n");
  wasm_emitf(10, "(then (i32.store (local.get $out) (local.get $ch)) (local.set $out (i32.add (local.get $out) (i32.const 4))))\n");
  wasm_emitf(10, "(else (i32.store8 (local.get $out) (local.get $ch)) (local.set $out (i32.add (local.get $out) (i32.const 1))))\n");
  ...
  wasm_emitf(4, "(local.get $p)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_vswscanf_impl (param $s i32) (param $fmt i32) (param $ap i64) (result i32)\n");
  wasm_emitf(4, "(local $p i32)\n");
  wasm_emitf(4, "(local $f i32)\n");
  wasm_emitf(4, "(local $vap i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  ...
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.ne (local.get $ch) (i32.const 37)) (then\n");
  wasm_emitf(8, "(if (i32.ne (i32.load (local.get $p)) (local.get $ch)) (then\n");
  wasm_emitf(10, "(if (i32.and (i32.eqz (i32.load (local.get $p))) (i32.eqz (local.get $assigns))) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
  ...
  wasm_emitf(6, "(if (i32.eqz (local.get $spec)) (then (br $done)))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 37)) (then\n");
  wasm_emitf(8, "(if (i32.ne (i32.load (local.get $p)) (i32.const 37)) (then\n");
  wasm_emitf(10, "(if (i32.and (i32.eqz (i32.load (local.get $p))) (i32.eqz (local.get $assigns))) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
  ...
  wasm_emitf(8, "(local.set $suppress (i32.const 1))\n");
  wasm_emitf(8, "(local.set $f (i32.add (local.get $f) (i32.const 4)))\n");
  wasm_emitf(8, "(local.set $spec (i32.load (local.get $f)))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (call $__ag_wscan_isdigit (local.get $spec)) (then\n");
  wasm_emitf(8, "(local.set $width (i32.const 0))\n");
  wasm_emitf(8, "(block $width_done (loop $width_loop\n");
  wasm_emitf(10, "(if (i32.eqz (call $__ag_wscan_isdigit (local.get $spec))) (then (br $width_done)))\n");
  wasm_emitf(10, "(local.set $width (i32.add (i32.mul (local.get $width) (i32.const 10)) (i32.sub (local.get $spec) (i32.const 48))))\n");
  wasm_emitf(10, "(local.set $f (i32.add (local.get $f) (i32.const 4)))\n");
  wasm_emitf(10, "(local.set $spec (i32.load (local.get $f)))\n");
  wasm_emitf(10, "(br $width_loop)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 104)) (then\n");
  ...
  wasm_emitf(8, "(if (i32.or (i32.eq (local.get $spec) (i32.const 112)) (i32.or (i32.eq (local.get $spec) (i32.const 120)) (i32.eq (local.get $spec) (i32.const 88)))) (then (local.set $base (i32.const 16))))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $spec) (i32.const 111)) (then (local.set $base (i32.const 8))))\n");
  wasm_emitf(8, "(local.set $next (call $__ag_wscan_int (local.get $p) (local.get $dst) (i32.or (i32.eq (local.get $spec) (i32.const 100)) (i32.eq (local.get $spec) (i32.const 105))) (local.get $store_size) (local.get $width) (local.get $base)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $next) (i32.const -1)) (then\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $assigns)) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  ...
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.or (i32.or (i32.eq (local.get $spec) (i32.const 97)) (i32.eq (local.get $spec) (i32.const 65))) (i32.or (i32.or (i32.eq (local.get $spec) (i32.const 102)) (i32.eq (local.get $spec) (i32.const 70))) (i32.or (i32.or (i32.eq (local.get $spec) (i32.const 101)) (i32.eq (local.get $spec) (i32.const 69))) (i32.or (i32.eq (local.get $spec) (i32.const 103)) (i32.eq (local.get $spec) (i32.const 71)))))) (then\n");
  wasm_emitf(8, "(local.set $next (call $__ag_wscan_float (local.get $p) (local.get $dst) (i32.or (local.get $length_l) (local.get $length_L)) (local.get $width)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $next) (i32.const -1)) (then\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $assigns)) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  ...
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 115)) (then\n");
  wasm_emitf(8, "(local.set $next (call $__ag_wscan_word (local.get $p) (local.get $dst) (local.get $length_l) (local.get $width)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $next) (i32.const -1)) (then\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $assigns)) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  ...
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 99)) (then\n");
  wasm_emitf(8, "(local.set $next (call $__ag_wscan_char (local.get $p) (local.get $dst) (local.get $length_l) (local.get $width)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $next) (i32.const -1)) (then\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $assigns)) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  ...
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 91)) (then\n");
  wasm_emitf(8, "(local.set $set_cursor (i32.add (local.get $f) (i32.const 4)))\n");
  wasm_emitf(8, "(local.set $invert (i32.const 0))\n");
  wasm_emitf(8, "(if (i32.eq (i32.load (local.get $set_cursor)) (i32.const 94)) (then\n");
  wasm_emitf(10, "(local.set $invert (i32.const 1))\n");
  wasm_emitf(10, "(local.set $set_cursor (i32.add (local.get $set_cursor) (i32.const 4)))\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(local.set $set_start (local.get $set_cursor))\n");
  wasm_emitf(8, "(if (i32.eq (i32.load (local.get $set_cursor)) (i32.const 93)) (then (local.set $set_cursor (i32.add (local.get $set_cursor) (i32.const 4)))))\n");
  wasm_emitf(8, "(local.set $set_end (i32.const 0))\n");
  wasm_emitf(8, "(block $set_end_done (loop $set_end_loop\n");
  wasm_emitf(10, "(local.set $ch (i32.load (local.get $set_cursor)))\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $ch)) (then (br $set_end_done)))\n");
  wasm_emitf(10, "(if (i32.eq (local.get $ch) (i32.const 93)) (then (local.set $set_end (local.get $set_cursor)) (br $set_end_done)))\n");
  wasm_emitf(10, "(local.set $set_cursor (i32.add (local.get $set_cursor) (i32.const 4)))\n");
  wasm_emitf(10, "(br $set_end_loop)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(if (i32.eqz (local.get $set_end)) (then (br $done)))\n");
  wasm_emitf(8, "(local.set $next (call $__ag_wscan_set (local.get $p) (local.get $dst) (local.get $length_l) (local.get $width) (local.get $set_start) (local.get $set_end) (local.get $invert)))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $next) (i32.const -1)) (then\n");
  wasm_emitf(10, "(if (i32.eqz (local.get $assigns)) (then (return (i32.const -1))))\n");
  wasm_emitf(10, "(br $done)\n");
  wasm_emitf(8, "))\n");
  ...
  wasm_emitf(8, "(local.set $p (local.get $next))\n");
  wasm_emitf(8, "(if (i32.eqz (local.get $suppress)) (then (local.set $assigns (i32.add (local.get $assigns) (i32.const 1)))))\n");
  wasm_emitf(8, "(local.set $f (i32.add (local.get $set_end) (i32.const 4)))\n");
  wasm_emitf(8, "(br $loop)\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (local.get $spec) (i32.const 110)) (then\n");
  wasm_emitf(8, "(if (local.get $dst) (then\n");
  wasm_emitf(10, "(if (i32.eq (local.get $store_size) (i32.const 8))\n");
  wasm_emitf(12, "(then (i64.store (local.get $dst) (i64.extend_i32_s (i32.div_u (i32.sub (local.get $p) (local.get $s)) (i32.const 4)))))\n");
  wasm_emitf(12, "(else (if (i32.eq (local.get $store_size) (i32.const 2))\n");
  wasm_emitf(14, "(then (i32.store16 (local.get $dst) (i32.div_u (i32.sub (local.get $p) (local.get $s)) (i32.const 4))))\n");
  wasm_emitf(14, "(else (if (i32.eq (local.get $store_size) (i32.const 1))\n");
  wasm_emitf(16, "(then (i32.store8 (local.get $dst) (i32.div_u (i32.sub (local.get $p) (local.get $s)) (i32.const 4))))\n");
  wasm_emitf(16, "(else (i32.store (local.get $dst) (i32.div_u (i32.sub (local.get $p) (local.get $s)) (i32.const 4))))\n");
  wasm_emitf(14, "))\n");
  wasm_emitf(12, "))\n");
  wasm_emitf(10, ")\n");
  wasm_emitf(8, "))\n");
  ...
  wasm_emitf(4, "(local.get $assigns)\n");
  wasm_emitf(2, ")\n");
  if (has_undefined_function("vswscanf", 8)) {
    wasm_emitf(2, "(func $vswscanf (param $s i32) (param $fmt i32) (param $ap i64) (result i32)\n");
    wasm_emitf(4, "(call $__ag_vswscanf_impl (local.get $s) (local.get $fmt) (local.get $ap))\n");
    wasm_emitf(2, ")\n");
  }
...
static void emit_wasm_strtod_common(
    wasm32_ir_context_t *context, int errno_addr) {
  wasm_emitf(2, "(func $__ag_float_ch (param $p i32) (param $wide i32) (result i32)\n");
  wasm_emitf(4, "(if (result i32) (local.get $wide)\n");
  wasm_emitf(6, "(then (i32.load (local.get $p)))\n");
  wasm_emitf(6, "(else (i32.load8_u (local.get $p)))\n");
  wasm_emitf(4, ")\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_float_eq_ci (param $p i32) (param $index i32) (param $step i32) (param $wide i32) (param $expected i32) (result i32)\n");
  wasm_emitf(4, "(i32.eq\n");
  wasm_emitf(6, "(i32.or (call $__ag_float_ch (i32.add (local.get $p) (i32.mul (local.get $index) (local.get $step))) (local.get $wide)) (i32.const 32))\n");
  wasm_emitf(6, "(local.get $expected))\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_float_hex_digit (param $ch i32) (result i32)\n");
  wasm_emitf(4, "(if (i32.and (i32.ge_u (local.get $ch) (i32.const 48)) (i32.le_u (local.get $ch) (i32.const 57)))\n");
  wasm_emitf(6, "(then (return (i32.sub (local.get $ch) (i32.const 48)))))\n");
  wasm_emitf(4, "(if (i32.and (i32.ge_u (local.get $ch) (i32.const 97)) (i32.le_u (local.get $ch) (i32.const 102)))\n");
  wasm_emitf(6, "(then (return (i32.sub (local.get $ch) (i32.const 87)))))\n");
  wasm_emitf(4, "(if (i32.and (i32.ge_u (local.get $ch) (i32.const 65)) (i32.le_u (local.get $ch) (i32.const 70)))\n");
  wasm_emitf(6, "(then (return (i32.sub (local.get $ch) (i32.const 55)))))\n");
  wasm_emitf(4, "(i32.const -1)\n");
  wasm_emitf(2, ")\n");
  wasm_emitf(2, "(func $__ag_strtod_common (param $s i32) (param $endptr i32) (param $wide i32) (result f64)\n");
  wasm_emitf(4, "(local $p i32)\n");
  wasm_emitf(4, "(local $ch i32)\n");
  wasm_emitf(4, "(local $digit i32)\n");
  wasm_emitf(4, "(local $step i32)\n");
  ...
  wasm_emitf(4, "(local $nonzero i32)\n");
  wasm_emitf(4, "(local $is_hex i32)\n");
  wasm_emitf(4, "(local $hex_start i32)\n");
  wasm_emitf(4, "(local $payload_start i32)\n");
  wasm_emitf(4, "(local.set $step (if (result i32) (local.get $wide) (then (i32.const 4)) (else (i32.const 1))))\n");
  ...
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.eq (call $__ag_float_ch (local.get $p) (local.get $wide)) (i32.const 45)) (then\n");
  wasm_emitf(6, "(local.set $sign (f64.const -1.0))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(4, ") (else (if (i32.eq (call $__ag_float_ch (local.get $p) (local.get $wide)) (i32.const 43)) (then\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(4, "))))\n");

  /* Case-insensitive infinity and NaN subject sequences. */
  wasm_emitf(4, "(if (i32.and\n");
  wasm_emitf(6, "(call $__ag_float_eq_ci (local.get $p) (i32.const 0) (local.get $step) (local.get $wide) (i32.const 105))\n");
  wasm_emitf(6, "(i32.and (call $__ag_float_eq_ci (local.get $p) (i32.const 1) (local.get $step) (local.get $wide) (i32.const 110)) (call $__ag_float_eq_ci (local.get $p) (i32.const 2) (local.get $step) (local.get $wide) (i32.const 102)))) (then\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.mul (i32.const 3) (local.get $step))))\n");
  wasm_emitf(6, "(if (i32.and\n");
  wasm_emitf(8, "(call $__ag_float_eq_ci (local.get $p) (i32.const 0) (local.get $step) (local.get $wide) (i32.const 105))\n");
  wasm_emitf(8, "(i32.and (call $__ag_float_eq_ci (local.get $p) (i32.const 1) (local.get $step) (local.get $wide) (i32.const 110))\n");
  wasm_emitf(10, "(i32.and (call $__ag_float_eq_ci (local.get $p) (i32.const 2) (local.get $step) (local.get $wide) (i32.const 105))\n");
  wasm_emitf(12, "(i32.and (call $__ag_float_eq_ci (local.get $p) (i32.const 3) (local.get $step) (local.get $wide) (i32.const 116)) (call $__ag_float_eq_ci (local.get $p) (i32.const 4) (local.get $step) (local.get $wide) (i32.const 121)))))) (then\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (i32.mul (i32.const 5) (local.get $step))))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (local.get $endptr) (then (i64.store (local.get $endptr) (i64.extend_i32_u (local.get $p)))))\n");
  wasm_emitf(6, "(return (f64.mul (f64.const inf) (local.get $sign)))\n");
  wasm_emitf(4, "))\n");
  wasm_emitf(4, "(if (i32.and\n");
  wasm_emitf(6, "(call $__ag_float_eq_ci (local.get $p) (i32.const 0) (local.get $step) (local.get $wide) (i32.const 110))\n");
  wasm_emitf(6, "(i32.and (call $__ag_float_eq_ci (local.get $p) (i32.const 1) (local.get $step) (local.get $wide) (i32.const 97)) (call $__ag_float_eq_ci (local.get $p) (i32.const 2) (local.get $step) (local.get $wide) (i32.const 110)))) (then\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.mul (i32.const 3) (local.get $step))))\n");
  wasm_emitf(6, "(if (i32.eq (call $__ag_float_ch (local.get $p) (local.get $wide)) (i32.const 40)) (then\n");
  wasm_emitf(8, "(local.set $payload_start (local.get $p))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(8, "(block $payload_done (loop $payload_loop\n");
  wasm_emitf(10, "(local.set $ch (call $__ag_float_ch (local.get $p) (local.get $wide)))\n");
  wasm_emitf(10, "(if (i32.or (i32.eqz (local.get $ch)) (i32.eq (local.get $ch) (i32.const 41))) (then (br $payload_done)))\n");
  wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(10, "(br $payload_loop)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(if (i32.eq (local.get $ch) (i32.const 41))\n");
  wasm_emitf(10, "(then (local.set $p (i32.add (local.get $p) (local.get $step))))\n");
  wasm_emitf(10, "(else (local.set $p (local.get $payload_start))))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (local.get $endptr) (then (i64.store (local.get $endptr) (i64.extend_i32_u (local.get $p)))))\n");
  wasm_emitf(6, "(return (f64.const nan))\n");
  wasm_emitf(4, "))\n");

  /* Hexadecimal floating subject sequence. Invalid prefixes fall back to the
   * decimal parser, which consumes only the leading zero. */
  wasm_emitf(4, "(if (i32.and\n");
  wasm_emitf(6, "(i32.eq (call $__ag_float_ch (local.get $p) (local.get $wide)) (i32.const 48))\n");
  wasm_emitf(6, "(call $__ag_float_eq_ci (local.get $p) (i32.const 1) (local.get $step) (local.get $wide) (i32.const 120))) (then\n");
  wasm_emitf(6, "(local.set $hex_start (local.get $p))\n");
  wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.mul (i32.const 2) (local.get $step))))\n");
  wasm_emitf(6, "(block $hex_int_done (loop $hex_int_loop\n");
  wasm_emitf(8, "(local.set $digit (call $__ag_float_hex_digit (call $__ag_float_ch (local.get $p) (local.get $wide))))\n");
  wasm_emitf(8, "(if (i32.lt_s (local.get $digit) (i32.const 0)) (then (br $hex_int_done)))\n");
  wasm_emitf(8, "(local.set $any_digit (i32.const 1))\n");
  wasm_emitf(8, "(if (local.get $digit) (then (local.set $nonzero (i32.const 1))))\n");
  wasm_emitf(8, "(local.set $acc (f64.add (f64.mul (local.get $acc) (f64.const 16.0)) (f64.convert_i32_u (local.get $digit))))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(8, "(br $hex_int_loop)\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (call $__ag_float_ch (local.get $p) (local.get $wide)) (i32.const 46)) (then\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(8, "(local.set $place (f64.const 0.0625))\n");
  wasm_emitf(8, "(block $hex_frac_done (loop $hex_frac_loop\n");
  wasm_emitf(10, "(local.set $digit (call $__ag_float_hex_digit (call $__ag_float_ch (local.get $p) (local.get $wide))))\n");
  wasm_emitf(10, "(if (i32.lt_s (local.get $digit) (i32.const 0)) (then (br $hex_frac_done)))\n");
  wasm_emitf(10, "(local.set $any_digit (i32.const 1))\n");
  wasm_emitf(10, "(if (local.get $digit) (then (local.set $nonzero (i32.const 1))))\n");
  wasm_emitf(10, "(local.set $acc (f64.add (local.get $acc) (f64.mul (f64.convert_i32_u (local.get $digit)) (local.get $place))))\n");
  wasm_emitf(10, "(local.set $place (f64.div (local.get $place) (f64.const 16.0)))\n");
  wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(10, "(br $hex_frac_loop)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(local.set $ch (call $__ag_float_ch (local.get $p) (local.get $wide)))\n");
  ...
  wasm_emitf(10, "(then (local.set $exp_sign (i32.const -1)) (local.set $p (i32.add (local.get $p) (local.get $step))))\n");
  wasm_emitf(10, "(else (if (i32.eq (call $__ag_float_ch (local.get $p) (local.get $wide)) (i32.const 43)) (then (local.set $p (i32.add (local.get $p) (local.get $step)))))))\n");
  wasm_emitf(8, "(block $hex_exp_done (loop $hex_exp_loop\n");
  wasm_emitf(10, "(local.set $ch (call $__ag_float_ch (local.get $p) (local.get $wide)))\n");
  wasm_emitf(10, "(if (i32.or (i32.lt_u (local.get $ch) (i32.const 48)) (i32.gt_u (local.get $ch) (i32.const 57))) (then (br $hex_exp_done)))\n");
  wasm_emitf(10, "(local.set $have_exp (i32.const 1))\n");
  wasm_emitf(10, "(if (i64.lt_u (local.get $exp) (i64.const 4096)) (then\n");
  wasm_emitf(12, "(local.set $exp (i64.add (i64.mul (local.get $exp) (i64.const 10)) (i64.extend_i32_u (i32.sub (local.get $ch) (i32.const 48)))))\n");
  wasm_emitf(12, "(if (i64.gt_u (local.get $exp) (i64.const 4096)) (then (local.set $exp (i64.const 4096))))\n");
  wasm_emitf(10, "))\n");
  wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  ...
  wasm_emitf(14, "(then (local.set $acc (f64.div (local.get $acc) (f64.const 2.0))))\n");
  wasm_emitf(14, "(else (local.set $acc (f64.mul (local.get $acc) (f64.const 2.0))))\n");
  wasm_emitf(12, ")\n");
  ...
  wasm_emitf(8, "(local.set $acc (f64.const 0))\n");
  wasm_emitf(8, "(local.set $place (f64.const 0))\n");
  wasm_emitf(8, "(local.set $exp (i64.const 0))\n");
  wasm_emitf(8, "(local.set $exp_sign (i32.const 0))\n");
  wasm_emitf(8, "(local.set $have_exp (i32.const 0))\n");
  wasm_emitf(8, "(local.set $any_digit (i32.const 0))\n");
  wasm_emitf(8, "(local.set $nonzero (i32.const 0))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(4, "))\n");

  wasm_emitf(4, "(if (i32.eqz (local.get $is_hex)) (then\n");
  wasm_emitf(6, "(block $int_done (loop $int_loop\n");
  wasm_emitf(8, "(local.set $ch (call $__ag_float_ch (local.get $p) (local.get $wide)))\n");
  wasm_emitf(8, "(if (i32.or (i32.lt_u (local.get $ch) (i32.const 48)) (i32.gt_u (local.get $ch) (i32.const 57))) (then (br $int_done)))\n");
  wasm_emitf(8, "(local.set $any_digit (i32.const 1))\n");
  wasm_emitf(8, "(if (i32.ne (local.get $ch) (i32.const 48)) (then (local.set $nonzero (i32.const 1))))\n");
  wasm_emitf(8, "(local.set $acc (f64.add (f64.mul (local.get $acc) (f64.const 10.0)) (f64.convert_i32_u (i32.sub (local.get $ch) (i32.const 48)))))\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(8, "(br $int_loop)\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(if (i32.eq (call $__ag_float_ch (local.get $p) (local.get $wide)) (i32.const 46)) (then\n");
  wasm_emitf(8, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(8, "(local.set $place (f64.const 0.1))\n");
  wasm_emitf(8, "(block $frac_done (loop $frac_loop\n");
  wasm_emitf(10, "(local.set $ch (call $__ag_float_ch (local.get $p) (local.get $wide)))\n");
  wasm_emitf(10, "(if (i32.or (i32.lt_u (local.get $ch) (i32.const 48)) (i32.gt_u (local.get $ch) (i32.const 57))) (then (br $frac_done)))\n");
  wasm_emitf(10, "(local.set $any_digit (i32.const 1))\n");
  wasm_emitf(10, "(if (i32.ne (local.get $ch) (i32.const 48)) (then (local.set $nonzero (i32.const 1))))\n");
  wasm_emitf(10, "(local.set $acc (f64.add (local.get $acc) (f64.mul (f64.convert_i32_u (i32.sub (local.get $ch) (i32.const 48))) (local.get $place))))\n");
  wasm_emitf(10, "(local.set $place (f64.div (local.get $place) (f64.const 10.0)))\n");
  wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(10, "(br $frac_loop)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(6, "(local.set $ch (call $__ag_float_ch (local.get $p) (local.get $wide)))\n");
  wasm_emitf(6, "(if (i32.or (i32.eq (local.get $ch) (i32.const 101)) (i32.eq (local.get $ch) (i32.const 69))) (then\n");
  ...
  wasm_emitf(10, "(then (local.set $exp_sign (i32.const -1)) (local.set $p (i32.add (local.get $p) (local.get $step))))\n");
  wasm_emitf(10, "(else (if (i32.eq (call $__ag_float_ch (local.get $p) (local.get $wide)) (i32.const 43)) (then (local.set $p (i32.add (local.get $p) (local.get $step)))))))\n");
  wasm_emitf(8, "(block $exp_digits_done (loop $exp_digits_loop\n");
  wasm_emitf(10, "(local.set $ch (call $__ag_float_ch (local.get $p) (local.get $wide)))\n");
  wasm_emitf(10, "(if (i32.or (i32.lt_u (local.get $ch) (i32.const 48)) (i32.gt_u (local.get $ch) (i32.const 57))) (then (br $exp_digits_done)))\n");
  wasm_emitf(10, "(local.set $have_exp (i32.const 1))\n");
  wasm_emitf(10, "(if (i64.lt_u (local.get $exp) (i64.const 4096)) (then\n");
  wasm_emitf(12, "(local.set $exp (i64.add (i64.mul (local.get $exp) (i64.const 10)) (i64.extend_i32_u (i32.sub (local.get $ch) (i32.const 48)))))\n");
  wasm_emitf(12, "(if (i64.gt_u (local.get $exp) (i64.const 4096)) (then (local.set $exp (i64.const 4096))))\n");
  wasm_emitf(10, "))\n");
  wasm_emitf(10, "(local.set $p (i32.add (local.get $p) (local.get $step)))\n");
  wasm_emitf(10, "(br $exp_digits_loop)\n");
  wasm_emitf(8, "))\n");
  wasm_emitf(8, "(if (local.get $have_exp) (then\n");
  wasm_emitf(10, "(block $scale_done (loop $scale_loop\n");
  wasm_emitf(12, "(if (i64.eqz (local.get $exp)) (then (br $scale_done)))\n");
  wasm_emitf(12, "(if (i32.lt_s (local.get $exp_sign) (i32.const 0))\n");
  wasm_emitf(14, "(then (local.set $acc (f64.div (local.get $acc) (f64.const 10.0))))\n");
  wasm_emitf(14, "(else (local.set $acc (f64.mul (local.get $acc) (f64.const 10.0))))\n");
  wasm_emitf(12, ")\n");
  wasm_emitf(12, "(local.set $exp (i64.sub (local.get $exp) (i64.const 1)))\n");
  wasm_emitf(12, "(br $scale_loop)\n");
  wasm_emitf(10, "))\n");
  wasm_emitf(8, ") (else (local.set $p (local.get $exp_start))))\n");
  wasm_emitf(6, "))\n");
  wasm_emitf(4, "))\n");
  ...
  wasm_emitf(4, "(if (i32.or\n");
  wasm_emitf(6, "(f64.eq (f64.abs (local.get $acc)) (f64.const inf))\n");
  wasm_emitf(6, "(i32.and (local.get $nonzero) (f64.eq (local.get $acc) (f64.const 0)))) (then\n");
...
#define emit_wasm_strtod_common(...) \
  emit_wasm_strtod_common(context, __VA_ARGS__)
...
void wasm32_wat_emit_minimal_libc_stubs(
  ...
  int needs_narrow_formatter =
      has_undefined_function("snprintf", 8) || has_undefined_function("sprintf", 7) ||
      has_undefined_function("printf", 6) ||
      has_undefined_function("fprintf", 7) ||
  ...
  int needs_wide_formatter =
      has_undefined_function("swprintf", 8) ||
      has_undefined_function("vswprintf", 9) ||
      has_undefined_function("wprintf", 7) ||
      has_undefined_function("fwprintf", 8) ||
      has_undefined_function("vwprintf", 8) ||
      has_undefined_function("vfwprintf", 9);
  ...
  if (needs_narrow_formatter || needs_wide_formatter) {
  ...
  if (has_undefined_function("wscanf", 6)) {
    wasm_emitf(2, "(func $wscanf (param $fmt i32) (result i32)\n");
    wasm_emitf(4, "(if (result i32) (i32.eqz (i32.load (local.get $fmt))) (then (i32.const 0)) (else (i32.const -1)))\n");
    wasm_emitf(2, ")\n");
  }
  if (has_undefined_function("vwscanf", 7)) {
    wasm_emitf(2, "(func $vwscanf (param $fmt i32) (param $ap i64) (result i32)\n");
    wasm_emitf(4, "(if (result i32) (i32.eqz (i32.load (local.get $fmt))) (then (i32.const 0)) (else (i32.const -1)))\n");
    wasm_emitf(2, ")\n");
  }
  if (has_undefined_function("fwscanf", 7)) {
    wasm_emitf(2, "(func $fwscanf (param $stream i32) (param $fmt i32) (result i32)\n");
    wasm_emitf(4, "(if (result i32) (i32.eqz (i32.load (local.get $fmt))) (then (i32.const 0)) (else (i32.const -1)))\n");
    wasm_emitf(2, ")\n");
  }
  if (has_undefined_function("vfwscanf", 8)) {
    wasm_emitf(2, "(func $vfwscanf (param $stream i32) (param $fmt i32) (param $ap i64) (result i32)\n");
    wasm_emitf(4, "(if (result i32) (i32.eqz (i32.load (local.get $fmt))) (then (i32.const 0)) (else (i32.const -1)))\n");
    wasm_emitf(2, ")\n");
  }
  if (has_undefined_function("swscanf", 7) ||
      has_undefined_function("vswscanf", 8)) {
  ...
  if (has_undefined_function("strncat", 7)) {
    ...
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(block $copy_done (loop $copy_loop\n");
    wasm_emitf(6, "(if (i64.ge_u (local.get $count) (local.get $n)) (then (br $copy_done)))\n");
    wasm_emitf(6, "(local.set $ch (i32.load8_u (i32.add (local.get $src) (i32.wrap_i64 (local.get $count)))))\n");
    wasm_emitf(6, "(if (i32.eqz (local.get $ch)) (then (br $copy_done)))\n");
    wasm_emitf(6, "(i32.store8 (i32.add (i32.add (local.get $dst) (local.get $end)) (i32.wrap_i64 (local.get $count))) (local.get $ch))\n");
    wasm_emitf(6, "(local.set $count (i64.add (local.get $count) (i64.const 1)))\n");
    wasm_emitf(6, "(br $copy_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(i32.store8 (i32.add (i32.add (local.get $dst) (local.get $end)) (i32.wrap_i64 (local.get $count))) (i32.const 0))\n");
    wasm_emitf(4, "(local.get $dst)\n");
    wasm_emitf(2, ")\n");
  }
  ...
  if (has_undefined_function("strncmp", 7)) {
    ...
    wasm_emitf(6, "(local.set $ca (i32.load8_u (i32.add (local.get $a) (i32.wrap_i64 (local.get $i)))))\n");
    wasm_emitf(6, "(local.set $cb (i32.load8_u (i32.add (local.get $b) (i32.wrap_i64 (local.get $i)))))\n");
    wasm_emitf(6, "(if (i32.ne (local.get $ca) (local.get $cb)) (then (return (i32.sub (local.get $ca) (local.get $cb)))))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $ca) (i32.const 0)) (then (br $done)))\n");
  ...
  if (has_undefined_function("strchr", 6)) {
    ...
    wasm_emitf(6, "(if (i32.eq (local.get $c) (local.get $needle)) (then (return (local.get $p))))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $c) (i32.const 0)) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
  ...
  if (has_undefined_function("strrchr", 7)) {
    ...
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(local.set $c (i32.load8_u (local.get $p)))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $c) (local.get $needle)) (then (local.set $last (local.get $p))))\n");
    wasm_emitf(6, "(if (i32.eq (local.get $c) (i32.const 0)) (then (br $done)))\n");
    wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
  ...
  if (need_strto64_stub) {
    int strto64_errno_addr = intern_data_symbol("__ag_stub_errno", 15, 4, 4)->addr;
    wasm_emitf(2, "(func $__ag_strto64 (param $s i32) (param $endptr i32) (param $base i64) (param $unsigned i32) (result i64)\n");
    wasm_emitf(4, "(local $p i32)\n");
    wasm_emitf(4, "(local $ch i32)\n");
    wasm_emitf(4, "(local $digit i64)\n");
    wasm_emitf(4, "(local $n i64)\n");
    wasm_emitf(4, "(local $limit i64)\n");
    wasm_emitf(4, "(local $cutoff i64)\n");
    wasm_emitf(4, "(local $cutlim i64)\n");
    wasm_emitf(4, "(local $neg i32)\n");
    wasm_emitf(4, "(local $any_digit i32)\n");
    wasm_emitf(4, "(local $overflow i32)\n");
    wasm_emitf(4, "(local $prefix i32)\n");
    wasm_emitf(4, "(local $prefix_digit i32)\n");
    wasm_emitf(4, "(local $valid_prefix i32)\n");
    wasm_emitf(4, "(local.set $p (local.get $s))\n");
    wasm_emitf(4, "(block $space_done (loop $space_loop\n");
    wasm_emitf(6, "(local.set $ch (i32.load8_u (local.get $p)))\n");
    wasm_emitf(6, "(if (i32.or (i32.eq (local.get $ch) (i32.const 32)) (i32.or (i32.eq (local.get $ch) (i32.const 9)) (i32.or (i32.eq (local.get $ch) (i32.const 10)) (i32.or (i32.eq (local.get $ch) (i32.const 11)) (i32.or (i32.eq (local.get $ch) (i32.const 12)) (i32.eq (local.get $ch) (i32.const 13))))))) (then\n");
    ...
    wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
    wasm_emitf(4, "))))\n");
    wasm_emitf(4, "(local.set $prefix (i32.load8_u (i32.add (local.get $p) (i32.const 1))))\n");
    wasm_emitf(4, "(local.set $prefix_digit (i32.load8_u (i32.add (local.get $p) (i32.const 2))))\n");
    wasm_emitf(4, "(local.set $valid_prefix (i32.and\n");
    wasm_emitf(6, "(i32.or (i32.eq (local.get $prefix) (i32.const 120)) (i32.eq (local.get $prefix) (i32.const 88)))\n");
    wasm_emitf(6, "(i32.or\n");
    wasm_emitf(8, "(i32.and (i32.ge_u (local.get $prefix_digit) (i32.const 48)) (i32.le_u (local.get $prefix_digit) (i32.const 57)))\n");
    wasm_emitf(8, "(i32.or (i32.and (i32.ge_u (local.get $prefix_digit) (i32.const 97)) (i32.le_u (local.get $prefix_digit) (i32.const 102))) (i32.and (i32.ge_u (local.get $prefix_digit) (i32.const 65)) (i32.le_u (local.get $prefix_digit) (i32.const 70)))))))\n");
    wasm_emitf(4, "(if (i64.eqz (local.get $base))\n");
    wasm_emitf(6, "(then\n");
    wasm_emitf(8, "(if (i32.eq (i32.load8_u (local.get $p)) (i32.const 48))\n");
    wasm_emitf(10, "(then\n");
    wasm_emitf(12, "(if (local.get $valid_prefix)\n");
    wasm_emitf(14, "(then (local.set $base (i64.const 16)) (local.set $p (i32.add (local.get $p) (i32.const 2))))\n");
    wasm_emitf(14, "(else (local.set $base (i64.const 8))))\n");
    wasm_emitf(10, ")\n");
    wasm_emitf(10, "(else (local.set $base (i64.const 10))))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(6, "(else\n");
    wasm_emitf(8, "(if (i32.and (i64.eq (local.get $base) (i64.const 16)) (i32.and (i32.eq (i32.load8_u (local.get $p)) (i32.const 48)) (local.get $valid_prefix))) (then\n");
    wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 2)))\n");
    wasm_emitf(8, "))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(4, ")\n");
    wasm_emitf(4, "(if (local.get $unsigned)\n");
    wasm_emitf(6, "(then (local.set $limit (i64.const -1)))\n");
    wasm_emitf(6, "(else (if (local.get $neg)\n");
    wasm_emitf(8, "(then (local.set $limit (i64.const -9223372036854775808)))\n");
    wasm_emitf(8, "(else (local.set $limit (i64.const 9223372036854775807))))))\n");
    wasm_emitf(4, "(local.set $cutoff (i64.div_u (local.get $limit) (local.get $base)))\n");
    wasm_emitf(4, "(local.set $cutlim (i64.rem_u (local.get $limit) (local.get $base)))\n");
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(local.set $ch (i32.load8_u (local.get $p)))\n");
    ...
    wasm_emitf(6, "(if (i32.or\n");
    wasm_emitf(8, "(i64.gt_u (local.get $n) (local.get $cutoff))\n");
    wasm_emitf(8, "(i32.and (i64.eq (local.get $n) (local.get $cutoff)) (i64.gt_u (local.get $digit) (local.get $cutlim))))\n");
    wasm_emitf(6, "(then (local.set $overflow (i32.const 1)))\n");
    wasm_emitf(6, "(else (local.set $n (i64.add (i64.mul (local.get $n) (local.get $base)) (local.get $digit)))))\n");
    wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 1)))\n");
    wasm_emitf(6, "(br $loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(if (i32.eqz (local.get $any_digit)) (then\n");
    ...
    wasm_emitf(4, "(if (local.get $overflow) (then\n");
    wasm_emitf(6, "(i32.store (i32.const %d) (i32.const 34))\n", strto64_errno_addr);
    wasm_emitf(6, "(if (local.get $unsigned) (then (return (i64.const -1))))\n");
    wasm_emitf(6, "(if (local.get $neg) (then (return (i64.const -9223372036854775808))))\n");
    wasm_emitf(6, "(return (i64.const 9223372036854775807))\n");
    wasm_emitf(4, "))\n");
  ...
  if (has_undefined_function("strtol", 6)) {
    ...
    wasm_emitf(4, "(call $__ag_strto64 (local.get $s) (local.get $endptr) (i64.extend_i32_s (local.get $base)) (i32.const 0))\n");
    wasm_emitf(2, ")\n");
  }
  if (has_undefined_function("strtoul", 7)) {
    ...
    wasm_emitf(4, "(call $__ag_strto64 (local.get $s) (local.get $endptr) (i64.extend_i32_s (local.get $base)) (i32.const 1))\n");
    wasm_emitf(2, ")\n");
  }
  ...
  if (has_undefined_function("atol", 4) || has_undefined_function("atoi", 4)) {
    ...
    wasm_emitf(4, "(call $__ag_strto64 (local.get $s) (i32.const 0) (i64.const 10) (i32.const 0))\n");
    wasm_emitf(2, ")\n");
  }
  ...
  int needs_narrow_float_parser =
      has_undefined_function("strtod", 6) ||
      has_undefined_function("strtof", 6) ||
      has_undefined_function("strtold", 7) ||
      has_undefined_function("atof", 4);
  int needs_wide_float_parser =
      has_undefined_function("wcstod", 6) ||
      has_undefined_function("wcstof", 6) ||
      has_undefined_function("wcstold", 7);
  if (needs_narrow_float_parser || needs_wide_float_parser) {
    int float_errno_addr =
        intern_data_symbol("__ag_stub_errno", 15, 4, 4)->addr;
    emit_wasm_strtod_common(float_errno_addr);
  }
  if (needs_narrow_float_parser) {
    wasm_emitf(2, "(func $__ag_strtod (param $s i32) (param $endptr i32) (result f64)\n");
    wasm_emitf(4, "(call $__ag_strtod_common (local.get $s) (local.get $endptr) (i32.const 0))\n");
    wasm_emitf(2, ")\n");
  }
  ...
  int need_wcsto64_stub = has_undefined_function("wcstoimax", 9) ||
                          has_undefined_function("wcstol", 6) ||
                          has_undefined_function("wcstoul", 7) ||
                          has_undefined_function("wcstoll", 7) ||
                          has_undefined_function("wcstoull", 8) ||
                          has_undefined_function("wcstoumax", 9);
  if (need_wcsto64_stub) {
    int wcsto64_errno_addr = intern_data_symbol("__ag_stub_errno", 15, 4, 4)->addr;
    wasm_emitf(2, "(func $__ag_wcsto64 (param $s i32) (param $endptr i32) (param $base i64) (param $unsigned i32) (result i64)\n");
    wasm_emitf(4, "(local $p i32)\n");
    wasm_emitf(4, "(local $ch i32)\n");
    wasm_emitf(4, "(local $digit i64)\n");
    wasm_emitf(4, "(local $n i64)\n");
    ...
    wasm_emitf(6, "(local.set $p (i32.add (local.get $p) (i32.const 4)))\n");
    wasm_emitf(4, "))))\n");
    wasm_emitf(4, "(local.set $prefix (i32.load (i32.add (local.get $p) (i32.const 4))))\n");
    wasm_emitf(4, "(local.set $prefix_digit (i32.load (i32.add (local.get $p) (i32.const 8))))\n");
    wasm_emitf(4, "(local.set $valid_prefix (i32.and\n");
    wasm_emitf(6, "(i32.or (i32.eq (local.get $prefix) (i32.const 120)) (i32.eq (local.get $prefix) (i32.const 88)))\n");
    wasm_emitf(6, "(i32.or\n");
    wasm_emitf(8, "(i32.and (i32.ge_u (local.get $prefix_digit) (i32.const 48)) (i32.le_u (local.get $prefix_digit) (i32.const 57)))\n");
    ...
    wasm_emitf(4, "(if (i64.eqz (local.get $base))\n");
    wasm_emitf(6, "(then\n");
    wasm_emitf(8, "(if (i32.eq (i32.load (local.get $p)) (i32.const 48))\n");
    wasm_emitf(10, "(then\n");
    wasm_emitf(12, "(if (local.get $valid_prefix)\n");
    wasm_emitf(14, "(then (local.set $base (i64.const 16)) (local.set $p (i32.add (local.get $p) (i32.const 8))))\n");
    wasm_emitf(14, "(else (local.set $base (i64.const 8))))\n");
    wasm_emitf(10, ")\n");
    wasm_emitf(10, "(else (local.set $base (i64.const 10))))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(6, "(else\n");
    wasm_emitf(8, "(if (i32.and (i64.eq (local.get $base) (i64.const 16)) (i32.and (i32.eq (i32.load (local.get $p)) (i32.const 48)) (local.get $valid_prefix))) (then\n");
  ...
  if (has_undefined_function("wcstoimax", 9)) {
    wasm_emitf(2, "(func $wcstoimax (param $s i32) (param $endptr i32) (param $base %s) (result i64)\n",
               wasm_stub_param_type("wcstoimax", 9, 2, IR_TY_I32));
    wasm_emitf(4, "(call $__ag_wcsto64 (local.get $s) (local.get $endptr) (i64.extend_i32_s (local.get $base)) (i32.const 0))\n");
    wasm_emitf(2, ")\n");
  }
  ...
  if (has_undefined_function("wcstoul", 7)) {
    ...
    wasm_emitf(4, "(call $__ag_wcsto64 (local.get $s) (local.get $endptr) (i64.extend_i32_s (local.get $base)) (i32.const 1))\n");
    wasm_emitf(2, ")\n");
  }
  ...
  if (has_undefined_function("wcstoumax", 9)) {
    wasm_emitf(2, "(func $wcstoumax (param $s i32) (param $endptr i32) (param $base %s) (result i64)\n",
               wasm_stub_param_type("wcstoumax", 9, 2, IR_TY_I32));
    wasm_emitf(4, "(call $__ag_wcsto64 (local.get $s) (local.get $endptr) (i64.extend_i32_s (local.get $base)) (i32.const 1))\n");
    wasm_emitf(2, ")\n");
  }
  if (needs_wide_float_parser) {
    wasm_emitf(2, "(func $wcstod (param $s i32) (param $endptr i32) (result f64)\n");
    wasm_emitf(4, "(call $__ag_strtod_common (local.get $s) (local.get $endptr) (i32.const 1))\n");
    wasm_emitf(2, ")\n");
  }
  ...
  if (has_undefined_function("raise", 5)) {
    wasm32_wat_require_function_table();
  ...
  if (!has_defined_function("mbsrtowcs", 9) &&
    ...
    wasm_emitf(4, "(block $done (loop $loop\n");
    wasm_emitf(6, "(if (i32.and (i32.ne (local.get $dst) (i32.const 0)) (i64.ge_u (local.get $i) (local.get $len))) (then (br $done)))\n");
    ...
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(if (local.get $dst) (then\n");
    wasm_emitf(6, "(if (i32.and (i64.lt_u (local.get $i) (local.get $len)) (i32.eqz (i32.load8_u (i32.add (local.get $src) (i32.wrap_i64 (local.get $i))))))\n");
    wasm_emitf(8, "(then\n");
    wasm_emitf(10, "(i32.store (i32.add (local.get $dst) (i32.wrap_i64 (i64.mul (local.get $i) (i64.const 4)))) (i32.const 0))\n");
    wasm_emitf(10, "(i32.store (local.get $srcp) (i32.const 0))\n");
    wasm_emitf(8, ")\n");
    wasm_emitf(8, "(else (i32.store (local.get $srcp) (i32.add (local.get $src) (i32.wrap_i64 (local.get $i)))))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $i)\n");
    wasm_emitf(2, ")\n");
  ...
  if (!has_defined_function("wcsrtombs", 9) &&
    ...
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(if (local.get $dst) (then\n");
    wasm_emitf(6, "(if (i32.and (i64.lt_u (local.get $i) (local.get $len)) (i32.eqz (i32.load (i32.add (local.get $src) (i32.wrap_i64 (i64.mul (local.get $i) (i64.const 4)))))))\n");
    wasm_emitf(8, "(then\n");
    wasm_emitf(10, "(i32.store8 (i32.add (local.get $dst) (i32.wrap_i64 (local.get $i))) (i32.const 0))\n");
    wasm_emitf(10, "(i32.store (local.get $srcp) (i32.const 0))\n");
    wasm_emitf(8, ")\n");
    wasm_emitf(8, "(else (i32.store (local.get $srcp) (i32.add (local.get $src) (i32.wrap_i64 (i64.mul (local.get $i) (i64.const 4))))))\n");
    wasm_emitf(6, ")\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.get $i)\n");
    wasm_emitf(2, ")\n");
  ...
  if (has_undefined_function("remquo", 6) || has_undefined_function("remquol", 7)) {
    ...
    wasm_emitf(4, "(local.set $bits (i32.and (if (result i32) (i32.lt_s (local.get $q) (i32.const 0)) (then (i32.sub (i32.const 0) (local.get $q))) (else (local.get $q))) (i32.const 7)))\n");
    wasm_emitf(4, "(if (i32.lt_s (local.get $q) (i32.const 0)) (then (local.set $bits (i32.sub (i32.const 0) (local.get $bits)))))\n");
    wasm_emitf(4, "(i32.store (local.get $quo) (local.get $bits))\n");
