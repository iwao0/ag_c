...
static void emit_wasm_swprintf_stub(wasm32_ir_context_t *context) {
    ...
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $rounded (if (result f64) (f64.le (local.get $v) (f64.div (f64.const 9007199254740991) (local.get $scale))) (then (f64.div (f64.nearest (f64.mul (local.get $v) (local.get $scale))) (local.get $scale))) (else (local.get $v))))\n");
    ...
    wasm_emitf(6, "(br $scale_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(local.set $norm (f64.div (f64.nearest (f64.mul (local.get $norm) (local.get $scale))) (local.get $scale)))\n");
    ...
    wasm_emitf(6, "(br $scale_loop)\n");
    wasm_emitf(4, "))\n");
    wasm_emitf(4, "(if (f64.ge (f64.div (f64.nearest (f64.mul (local.get $norm) (local.get $scale))) (local.get $scale)) (f64.const 10)) (then\n");
    wasm_emitf(6, "(local.set $exp (i32.add (local.get $exp) (i32.const 1)))\n");
    wasm_emitf(4, "))\n");
