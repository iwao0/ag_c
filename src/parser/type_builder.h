...
psx_type_t *ps_type_new_integer(token_kind_t scalar_kind, int size,
                                int is_unsigned);
...
psx_type_t *ps_type_new_tag(token_kind_t tag_kind, char *tag_name,
                            int tag_len, int tag_scope_depth_p1, int size);
