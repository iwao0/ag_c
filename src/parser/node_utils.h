...
node_t *ps_node_new_lvar_for(struct lvar_t *var);
node_t *ps_node_new_lvar_typed_for(struct lvar_t *var, int type_size);
node_t *ps_node_new_lvar_object_ref_for(struct lvar_t *var);
node_t *ps_node_new_lvar_expr_ref_for(struct lvar_t *var, int is_pointer);
node_t *ps_node_new_lvar_identifier_ref_for(struct lvar_t *var);
node_t *ps_node_new_vla_decay_ref_for(struct lvar_t *var);
...
node_t *ps_node_new_gvar_array_base_for(struct global_var_t *gv);
node_t *ps_node_new_static_local_gvar_for(struct lvar_t *var, int type_size);
