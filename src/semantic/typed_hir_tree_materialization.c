...
#define MAP(source_kind, hir_kind) \
  ...
  switch (source) {
    ...
    MAP(ND_GT, PSX_HIR_GT);
    MAP(ND_GE, PSX_HIR_GE);
    ...
    MAP(ND_UNARY_PLUS, PSX_HIR_UNARY_PLUS);
  ...
  switch (psx_resolved_object_ref_node_kind(
    ...
    case ND_MEMBER_ACCESS: {
      ...
      const psx_record_layout_t *layout = psx_record_layout_table_lookup(
          ...
          state->record_id, ps_ctx_data_layout(builder->semantic_context));
