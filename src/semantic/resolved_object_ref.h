...
psx_resolved_object_ref_kind_t psx_resolved_object_ref_kind(
    const node_t *node);
lvar_t *psx_resolved_object_ref_local(const node_t *node);
global_var_t *psx_resolved_object_ref_global(const node_t *node);
int psx_resolved_object_ref_storage_offset(const node_t *node);
char *psx_resolved_object_ref_name(
    const node_t *node, int *name_len);
int psx_resolved_object_ref_is_thread_local(const node_t *node);
