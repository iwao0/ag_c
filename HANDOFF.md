...
最終更新: 2026-06-27（続き110: funcptr return pointer-to-array）

## 現状
- `make test` = **1121/1121 green** (E2E + unit + parser + preprocess + IR + fuzz)。
...
3. **`make test`** で 1121/1121 green を確認 (前回セッションの状態が引き継がれている)。
