...
最終更新: 2026-06-27（続き111: func return pointer-to-2d-array）

## 現状
- `make test` = **1122/1122 green** (E2E + unit + parser + preprocess + IR + fuzz)。
...
3. **`make test`** で 1122/1122 green を確認 (前回セッションの状態が引き継がれている)。
