...
PARSER_LIB_OBJS=$(OBJROOT)/parser/alignas_value.o $(OBJROOT)/parser/anon_tag.o $(OBJROOT)/parser/arena.o $(OBJROOT)/parser/array_suffixes.o $(OBJROOT)/parser/config_runtime.o $(OBJROOT)/parser/declarator_syntax.o $(OBJROOT)/parser/parser.o $(OBJROOT)/parser/decl.o $(OBJROOT)/parser/diag.o $(OBJROOT)/parser/enum_const.o $(OBJROOT)/parser/expr.o $(OBJROOT)/parser/global_registry.o $(OBJROOT)/parser/initializer_syntax.o $(OBJROOT)/parser/local_registry.o $(OBJROOT)/parser/semantic_ctx.o $(OBJROOT)/parser/node_utils.o $(OBJROOT)/parser/stmt.o $(OBJROOT)/parser/pragma_pack.o $(OBJROOT)/parser/runtime_context.o $(OBJROOT)/parser/type.o $(OBJROOT)/semantic/aggregate_member_resolution.o $(OBJROOT)/semantic/constant_expression.o $(OBJROOT)/semantic/declaration_application.o $(OBJROOT)/semantic/declaration_resolution.o $(OBJROOT)/semantic/enum_constant_resolution.o $(OBJROOT)/semantic/function_declaration_resolution.o $(OBJROOT)/semantic/global_declaration_resolution.o $(OBJROOT)/semantic/initializer_resolution.o $(OBJROOT)/semantic/local_declaration_plan.o $(OBJROOT)/semantic/local_declaration_resolution.o $(OBJROOT)/semantic/parameter_declaration_plan.o $(OBJROOT)/semantic/parameter_declaration_resolution.o $(OBJROOT)/semantic/semantic_pass.o $(OBJROOT)/semantic/tag_declaration_resolution.o $(OBJROOT)/semantic/typedef_declaration_resolution.o $(OBJROOT)/lowering/frame_layout.o $(OBJROOT)/lowering/runtime_context.o $(OBJROOT)/lowering/global_object_lowering.o $(OBJROOT)/lowering/local_storage.o $(OBJROOT)/lowering/local_object_lowering.o $(OBJROOT)/lowering/parameter_lowering.o $(OBJROOT)/lowering/static_data_initializer.o $(OBJROOT)/lowering/static_local_lowering.o $(OBJROOT)/lowering/vla_lowering.o $(OBJROOT)/lowering/expr_lowering.o $(OBJROOT)/lowering/generic_selection_lowering.o $(OBJROOT)/lowering/cast_lowering.o $(OBJROOT)/lowering/assignment_lowering.o $(OBJROOT)/lowering/initializer_lowering.o $(OBJROOT)/lowering/member_access_lowering.o $(OBJROOT)/lowering/subscript_lowering.o $(OBJROOT)/lowering/unary_deref_lowering.o $(OBJROOT)/lowering/unary_operator_lowering.o $(OBJROOT)/lowering/sizeof_lowering.o $(OBJROOT)/lowering/alignof_lowering.o $(OBJROOT)/lowering/semantic_lowering_pass.o
PARSER_LIB_OBJS+=$(OBJROOT)/declaration_pipeline.o $(OBJROOT)/semantic/declaration_registration.o $(OBJROOT)/frontend/function_definition.o $(OBJROOT)/frontend/local_declaration.o $(OBJROOT)/frontend/semantic_pipeline.o $(OBJROOT)/frontend/toplevel_declaration.o $(OBJROOT)/frontend/translation_unit.o $(OBJROOT)/frontend/translation_unit_compat.o $(OBJROOT)/lowering/compound_literal_lowering.o $(OBJROOT)/parser/aggregate_member_syntax.o $(OBJROOT)/parser/declaration_syntax.o $(OBJROOT)/parser/function_definition_syntax.o $(OBJROOT)/parser/function_parameter_syntax.o $(OBJROOT)/parser/local_declaration_syntax.o $(OBJROOT)/parser/static_assert_declaration.o $(OBJROOT)/parser/toplevel_declaration_syntax.o $(OBJROOT)/semantic/control_flow_validation.o $(OBJROOT)/semantic/expression_operand_resolution.o $(OBJROOT)/semantic/function_call_resolution.o $(OBJROOT)/semantic/function_parameter_resolution.o $(OBJROOT)/semantic/generic_selection_resolution.o $(OBJROOT)/semantic/identifier_binding.o $(OBJROOT)/semantic/identifier_resolution.o $(OBJROOT)/semantic/lvar_usage_analysis.o $(OBJROOT)/semantic/member_access_resolution.o $(OBJROOT)/semantic/semantic_diagnostics.o $(OBJROOT)/semantic/static_assert_resolution.o $(OBJROOT)/semantic/static_initializer_resolution.o $(OBJROOT)/semantic/type_name_resolution.o $(OBJROOT)/semantic/type_query_resolution.o
...
PARSER_LIB_OBJS+=$(OBJROOT)/compilation_session.o $(OBJROOT)/target_info.o $(OBJROOT)/preprocess/preprocess.o $(OBJROOT)/codegen_emit.o
