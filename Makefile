...
SRCS=$(wildcard src/*.c) $(wildcard src/config/*.c) $(ARCH_SRCS) $(wildcard src/tokenizer/*.c) $(wildcard src/parser/*.c) $(wildcard src/frontend/*.c) $(wildcard src/semantic/*.c) $(wildcard src/hir/*.c) $(wildcard src/preprocess/*.c) $(wildcard src/ir/*.c) $(TYPE_SYSTEM_SRCS) $(LOWERING_SRCS) $(DIAG_COMMON_SRCS) $(DIAG_MSG_SRCS)
...
PARSER_LIB_OBJS=$(OBJROOT)/parser/anon_tag.o $(OBJROOT)/parser/arena.o $(OBJROOT)/parser/declarator_syntax.o $(OBJROOT)/parser/parser.o $(OBJROOT)/parser/decl.o $(OBJROOT)/parser/diag.o $(OBJROOT)/parser/enum_const.o $(OBJROOT)/parser/expr.o $(OBJROOT)/parser/expression_syntax_adapter.o $(OBJROOT)/parser/global_registry.o $(OBJROOT)/parser/initializer_syntax.o $(OBJROOT)/parser/local_registry.o $(OBJROOT)/parser/semantic_ctx.o $(OBJROOT)/parser/node_utils.o $(OBJROOT)/parser/stmt.o $(OBJROOT)/parser/statement_syntax_adapter.o $(OBJROOT)/parser/pragma_pack.o $(OBJROOT)/parser/runtime_context.o $(OBJROOT)/semantic/aggregate_member_resolution.o $(OBJROOT)/semantic/integer_constant_evaluation.o $(OBJROOT)/semantic/expression_identity.o $(OBJROOT)/semantic/type_identity.o $(OBJROOT)/semantic/type_completeness.o $(OBJROOT)/semantic/declaration_application.o $(OBJROOT)/semantic/declaration_resolution.o $(OBJROOT)/semantic/enum_constant_resolution.o $(OBJROOT)/semantic/function_declaration_resolution.o $(OBJROOT)/semantic/global_declaration_resolution.o $(OBJROOT)/semantic/initializer_resolution.o $(OBJROOT)/semantic/local_declaration_plan.o $(OBJROOT)/semantic/local_declaration_resolution.o $(OBJROOT)/semantic/parameter_declaration_resolution.o $(OBJROOT)/semantic/tag_declaration_resolution.o $(OBJROOT)/semantic/typedef_declaration_resolution.o $(OBJROOT)/lowering/frame_layout.o $(OBJROOT)/lowering/runtime_context.o $(OBJROOT)/lowering/global_object_lowering.o $(OBJROOT)/lowering/local_storage.o $(OBJROOT)/lowering/local_object_lowering.o $(OBJROOT)/lowering/parameter_storage_plan.o $(OBJROOT)/lowering/parameter_lowering.o $(OBJROOT)/lowering/static_data_initializer.o $(OBJROOT)/lowering/static_local_lowering.o $(OBJROOT)/lowering/vla_lowering.o $(OBJROOT)/lowering/cast_lowering.o
PARSER_LIB_OBJS+=$(OBJROOT)/declaration_pipeline.o $(OBJROOT)/semantic/call_resolution.o $(OBJROOT)/semantic/declaration_registration.o $(OBJROOT)/semantic/declaration_specifier_resolution.o $(OBJROOT)/semantic/function_definition_resolution.o $(OBJROOT)/frontend/local_declaration.o $(OBJROOT)/frontend/semantic_pipeline.o $(OBJROOT)/frontend/toplevel_declaration.o $(OBJROOT)/frontend/translation_unit.o $(OBJROOT)/parser/aggregate_member_syntax.o $(OBJROOT)/parser/declaration_syntax.o $(OBJROOT)/parser/function_definition_syntax.o $(OBJROOT)/parser/function_parameter_syntax.o $(OBJROOT)/parser/local_declaration_syntax.o $(OBJROOT)/parser/static_assert_declaration.o $(OBJROOT)/parser/toplevel_declaration_syntax.o $(OBJROOT)/semantic/hir_control_flow_diagnostics.o $(OBJROOT)/semantic/expression_operand_resolution.o $(OBJROOT)/semantic/function_call_resolution.o $(OBJROOT)/semantic/function_parameter_resolution.o $(OBJROOT)/semantic/generic_selection_resolution.o $(OBJROOT)/semantic/hir_member_resolution.o $(OBJROOT)/semantic/identifier_resolution.o $(OBJROOT)/semantic/literal_resolution.o $(OBJROOT)/semantic/member_resolution.o $(OBJROOT)/semantic/static_assert_resolution.o $(OBJROOT)/semantic/static_initializer_resolution.o $(OBJROOT)/semantic/type_name_resolution.o
PARSER_LIB_OBJS+=$(OBJROOT)/semantic/declarator_bound_resolution.o $(OBJROOT)/semantic/hir_local_resolution.o $(OBJROOT)/semantic/hir_symbol_resolution.o $(OBJROOT)/semantic/semantic_node_builder.o $(OBJROOT)/semantic/semantic_tree_resolution.o $(OBJROOT)/semantic/static_initializer_materialization.o
PARSER_LIB_OBJS+=$(OBJROOT)/semantic/aggregate_cast_resolution.o $(OBJROOT)/semantic/assignment_resolution.o $(OBJROOT)/semantic/character_array_initializer.o $(OBJROOT)/semantic/compound_literal_semantics.o $(OBJROOT)/semantic/continuation_syntax_validation.o $(OBJROOT)/semantic/source_cast_type_resolution.o $(OBJROOT)/semantic/type_query_semantics.o
...
PARSER_LIB_OBJS+=$(OBJROOT)/semantic/record_decl.o $(OBJROOT)/semantic/record_decl_table.o $(OBJROOT)/semantic/record_layout.o
...
test-wasm-language-analysis-basic-documentation: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=basic-documentation node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-operand-hover: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=operand-hover node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-inline-tags: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=inline-tags node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-for-init: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=for-init node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-prototype-bounds: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=prototype-bounds node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-same-typedef-declarators: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=same-typedef-declarators node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-declarator-array-bounds: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=declarator-array-bounds node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
...
test-wasm-language-analysis-offsetof-types: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=offsetof-types node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-initializer-operands: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=initializer-operands node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-direct-operands: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=direct-operands node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-simple-call-arguments: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=simple-call-arguments node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-local-bitfield-widths: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=local-bitfield-widths node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-local-member-array-bounds: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=local-member-array-bounds node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)

test-wasm-language-analysis-local-record-static-asserts: check-runtime-symbol-manifest $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
	@AGC_LANGUAGE_ANALYSIS_FOCUS=local-record-static-asserts node tools/wasm_js_api/test_language_analysis.mjs $(WASM_SELFHOST_API) $(TEST_LANGUAGE_ANALYSIS)
...
.PHONY: test test-asan test-design-invariants test-e2e-sandbox generate-runtime-symbol-manifest check-runtime-symbol-manifest clean bench release check-tokenizer-perf-light log-tokenizer-hotpath-daily check-should-reject wasm32-object-fixture-scan wasm32-object-link-fixture-scan wasm32-object-link-all-fixture-scan wasm32-wat-fixture-scan wasm32-object-c-testsuite-scan wasm32-object-link-c-testsuite-scan wasm32-wat-c-testsuite-scan wasm32-scans test-wasm-obj-linker wasm-selfhost-api test-wasm-selfhost-source test-wasm-js-api test-wasm-language-analysis-macros test-wasm-language-analysis-basic-documentation test-wasm-language-analysis-operand-hover test-wasm-language-analysis-inline-tags test-wasm-language-analysis-for-init test-wasm-language-analysis-prototype-bounds test-wasm-language-analysis-same-typedef-declarators test-wasm-language-analysis-declarator-array-bounds test-wasm-language-analysis-static-assert test-wasm-language-analysis-do-body test-wasm-language-analysis-offsetof-types test-wasm-language-analysis-initializer-operands test-wasm-language-analysis-direct-operands test-wasm-language-analysis-simple-call-arguments test-wasm-language-analysis-local-bitfield-widths test-wasm-language-analysis-local-member-array-bounds test-wasm-language-analysis-local-record-static-asserts wasm-linker-selfhost test-wasm-linker-selfhost test-wasm-js-pipeline test-wasm-runtime-contracts test-wasm-js-e2e c-testsuite c-testsuite-verbose FORCE
