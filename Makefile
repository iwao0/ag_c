...
PARSER_LIB_OBJS=$(OBJROOT)/parser/aggregate_member_declaration.o $(OBJROOT)/parser/alignas_value.o $(OBJROOT)/parser/anon_tag.o $(OBJROOT)/parser/arena.o $(OBJROOT)/parser/array_suffixes.o $(OBJROOT)/parser/config_runtime.o $(OBJROOT)/parser/declarator_syntax.o $(OBJROOT)/parser/parser.o $(OBJROOT)/parser/decl.o $(OBJROOT)/parser/diag.o $(OBJROOT)/parser/enum_const.o $(OBJROOT)/parser/enum_constant_declaration.o $(OBJROOT)/parser/expr.o $(OBJROOT)/parser/global_registry.o $(OBJROOT)/parser/initializer_syntax.o $(OBJROOT)/parser/local_registry.o $(OBJROOT)/parser/semantic_ctx.o $(OBJROOT)/parser/semantic_pass.o $(OBJROOT)/parser/node_utils.o $(OBJROOT)/parser/stmt.o $(OBJROOT)/parser/struct_layout.o $(OBJROOT)/parser/tag_declaration.o $(OBJROOT)/parser/typedef_declaration.o $(OBJROOT)/parser/pragma_pack.o $(OBJROOT)/parser/type.o $(OBJROOT)/parser/type_name.o $(OBJROOT)/semantic/aggregate_member_resolution.o $(OBJROOT)/semantic/declaration_resolution.o $(OBJROOT)/semantic/constant_expression.o $(OBJROOT)/semantic/enum_constant_resolution.o $(OBJROOT)/semantic/function_declaration_plan.o $(OBJROOT)/semantic/function_declaration_resolution.o $(OBJROOT)/semantic/global_declaration_plan.o $(OBJROOT)/semantic/global_declaration_resolution.o $(OBJROOT)/semantic/initializer_resolution.o $(OBJROOT)/semantic/local_declaration_plan.o $(OBJROOT)/semantic/local_type_state.o $(OBJROOT)/semantic/parameter_declaration_plan.o $(OBJROOT)/semantic/parameter_declaration_resolution.o $(OBJROOT)/semantic/tag_declaration_resolution.o $(OBJROOT)/semantic/typedef_declaration_resolution.o $(OBJROOT)/lowering/frame_layout.o $(OBJROOT)/lowering/global_object_lowering.o $(OBJROOT)/lowering/local_storage.o $(OBJROOT)/lowering/local_object_lowering.o $(OBJROOT)/lowering/parameter_lowering.o $(OBJROOT)/lowering/static_data_initializer.o $(OBJROOT)/lowering/static_local_lowering.o $(OBJROOT)/lowering/vla_lowering.o $(OBJROOT)/lowering/expr_lowering.o $(OBJROOT)/lowering/cast_lowering.o $(OBJROOT)/lowering/assignment_lowering.o $(OBJROOT)/lowering/initializer_lowering.o
PARSER_LIB_OBJS+=$(OBJROOT)/parser/aggregate_member_syntax.o $(OBJROOT)/parser/declaration_application.o $(OBJROOT)/parser/declaration_syntax.o $(OBJROOT)/parser/function_parameter_syntax.o $(OBJROOT)/parser/static_assert_declaration.o $(OBJROOT)/semantic/function_parameter_resolution.o $(OBJROOT)/semantic/static_assert_resolution.o
