...
TEST_ONLY_SRCS=src/semantic/legacy_syntax_diagnostics.c
...
$(TEST_PARSER): test/test_parser.c test/support/parser_compatibility_test_hook.c test/support/tokenizer_test_hook.c src/semantic/legacy_syntax_diagnostics.c $(PARSER_LIB_OBJS) $(TOKENIZER_LIB_OBJS) $(DIAG_LIB_OBJS)
	@mkdir -p build
	$(CC) $(CFLAGS) -o $@ $^
