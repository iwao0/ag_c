...
PARSER_LIB_OBJS+=$(OBJROOT)/semantic/local_declaration_tree_resolution.o $(OBJROOT)/semantic/resolved_function.o $(OBJROOT)/semantic/resolved_lvalue.o $(OBJROOT)/semantic/resolved_node_kind.o $(OBJROOT)/semantic/resolved_node_type.o $(OBJROOT)/semantic/resolved_object_ref.o $(OBJROOT)/semantic/semantic_invariants.o $(OBJROOT)/semantic/semantic_node_builder.o $(OBJROOT)/semantic/semantic_tree_resolution.o $(OBJROOT)/semantic/static_initializer_materialization.o $(OBJROOT)/semantic/tree_walk.o $(OBJROOT)/semantic/type_identity_pass.o
PARSER_LIB_OBJS+=$(OBJROOT)/semantic/assignment_validation.o $(OBJROOT)/semantic/lowered_tree_validation.o
PARSER_LIB_OBJS+=$(OBJROOT)/hir/hir.o $(OBJROOT)/semantic/typed_hir_tree_materialization.o $(OBJROOT)/semantic/typed_hir_emission.o $(OBJROOT)/semantic/resolution_work_tree.o $(OBJROOT)/lowering/static_hir_initializer.o
