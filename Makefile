...
PARSER_LIB_OBJS+=$(OBJROOT)/semantic/semantic_invariants.o $(OBJROOT)/semantic/tree_walk.o $(OBJROOT)/semantic/type_identity_pass.o
PARSER_LIB_OBJS+=$(OBJROOT)/semantic/assignment_validation.o $(OBJROOT)/semantic/lowered_tree_validation.o
PARSER_LIB_OBJS+=$(OBJROOT)/hir/hir.o $(OBJROOT)/semantic/resolved_tree_hir.o $(OBJROOT)/semantic/resolved_tree_materialization.o $(OBJROOT)/semantic/resolution_work_tree.o
