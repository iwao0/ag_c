...
PARSER_LIB_OBJS+=$(OBJROOT)/lowering/translation_unit_data_lowering.o $(OBJROOT)/lowering/abi_lowering.o $(OBJROOT)/lowering/function_type_lowering.o $(OBJROOT)/lowering/hir_ir_builder.o $(OBJROOT)/lowering/runtime_initializer_plan.o $(OBJROOT)/ir/ir_alloc.o $(OBJROOT)/ir/ir_data.o
...
$(TEST_PARSER): test/test_parser.c test/support/parser_compatibility_test_hook.c $(PARSER_LIB_OBJS) $(TOKENIZER_LIB_OBJS) $(DIAG_LIB_OBJS)
	@mkdir -p build
	$(CC) $(CFLAGS) -o $@ $^
