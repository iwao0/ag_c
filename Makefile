...
PARSER_LIB_OBJS=build/parser/parser.o build/parser/parser_decl.o build/parser/parser_expr.o build/parser/parser_loop_ctx.o build/parser/parser_semantic_ctx.o build/parser/parser_node_utils.o build/parser/parser_switch_ctx.o
