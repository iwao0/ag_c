...
TEST_ONLY_SRCS+=src/lowering/semantic_lowering_pass.c src/lowering/initializer_lowering.c src/lowering/compound_literal_lowering.c
TEST_ONLY_SRCS+=src/semantic/lowered_tree_validation.c
...
TEST_ONLY_SRCS+=src/parser/parser_legacy.c src/parser/stmt_legacy.c src/parser/name_classifier_legacy.c
TEST_ONLY_SRCS+=src/parser/semantic_ctx_legacy.c src/parser/node_utils_legacy.c src/frontend/local_declaration_legacy.c
TEST_ONLY_SRCS+=src/semantic/parser_type_compatibility.c src/semantic/type_compatibility_view.c
TEST_ONLY_SRCS+=src/parser/type.c
