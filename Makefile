...
PARSER_LIB_OBJS+=$(OBJROOT)/hir/hir.o $(OBJROOT)/semantic/typed_hir_tree.o $(OBJROOT)/semantic/typed_hir_tree_materialization.o $(OBJROOT)/semantic/typed_hir_emission.o $(OBJROOT)/semantic/resolution_work_tree.o $(OBJROOT)/lowering/static_hir_initializer.o
