...
PARSER_LIB_OBJS=$(OBJROOT)/parser/alignas_value.o $(OBJROOT)/parser/anon_tag.o $(OBJROOT)/parser/arena.o $(OBJROOT)/parser/declarator_syntax.o $(OBJROOT)/parser/parser.o $(OBJROOT)/parser/decl.o $(OBJROOT)/parser/diag.o $(OBJROOT)/parser/enum_const.o $(OBJROOT)/parser/expr.o $(OBJROOT)/parser/expression_syntax_adapter.o $(OBJROOT)/parser/global_registry.o $(OBJROOT)/parser/initializer_syntax.o $(OBJROOT)/parser/local_registry.o $(OBJROOT)/parser/semantic_ctx.o $(OBJROOT)/parser/node_utils.o $(OBJROOT)/parser/stmt.o $(OBJROOT)/parser/statement_syntax_adapter.o $(OBJROOT)/parser/pragma_pack.o $(OBJROOT)/parser/runtime_context.o $(OBJROOT)/semantic/aggregate_member_resolution.o $(OBJROOT)/semantic/constant_expression.o $(OBJROOT)/semantic/integer_constant_evaluation.o $(OBJROOT)/semantic/expression_identity.o $(OBJROOT)/semantic/type_identity.o $(OBJROOT)/semantic/type_compatibility_cache.o $(OBJROOT)/semantic/declaration_application.o $(OBJROOT)/semantic/declaration_resolution.o $(OBJROOT)/semantic/enum_constant_resolution.o $(OBJROOT)/semantic/function_declaration_resolution.o $(OBJROOT)/semantic/global_declaration_resolution.o $(OBJROOT)/semantic/initializer_resolution.o $(OBJROOT)/semantic/local_declaration_plan.o $(OBJROOT)/semantic/local_declaration_resolution.o $(OBJROOT)/semantic/local_initializer_binding.o $(OBJROOT)/semantic/parameter_declaration_resolution.o $(OBJROOT)/semantic/tag_declaration_resolution.o $(OBJROOT)/semantic/typedef_declaration_resolution.o $(OBJROOT)/lowering/frame_layout.o $(OBJROOT)/lowering/runtime_context.o $(OBJROOT)/lowering/global_object_lowering.o $(OBJROOT)/lowering/local_storage.o $(OBJROOT)/lowering/local_object_lowering.o $(OBJROOT)/lowering/parameter_storage_plan.o $(OBJROOT)/lowering/parameter_lowering.o $(OBJROOT)/lowering/static_data_initializer.o $(OBJROOT)/lowering/static_local_lowering.o $(OBJROOT)/lowering/vla_lowering.o $(OBJROOT)/lowering/cast_lowering.o
PARSER_LIB_OBJS+=$(OBJROOT)/declaration_pipeline.o $(OBJROOT)/semantic/call_resolution.o $(OBJROOT)/semantic/declaration_registration.o $(OBJROOT)/semantic/declaration_specifier_resolution.o $(OBJROOT)/semantic/function_definition_resolution.o $(OBJROOT)/frontend/local_declaration.o $(OBJROOT)/frontend/semantic_pipeline.o $(OBJROOT)/frontend/toplevel_declaration.o $(OBJROOT)/frontend/translation_unit.o $(OBJROOT)/parser/aggregate_member_syntax.o $(OBJROOT)/parser/declaration_syntax.o $(OBJROOT)/parser/function_definition_syntax.o $(OBJROOT)/parser/function_parameter_syntax.o $(OBJROOT)/parser/local_declaration_syntax.o $(OBJROOT)/parser/static_assert_declaration.o $(OBJROOT)/parser/toplevel_declaration_syntax.o $(OBJROOT)/semantic/case_label_resolution.o $(OBJROOT)/semantic/hir_control_flow_diagnostics.o $(OBJROOT)/semantic/expression_operand_resolution.o $(OBJROOT)/semantic/function_call_resolution.o $(OBJROOT)/semantic/function_parameter_resolution.o $(OBJROOT)/semantic/generic_selection_resolution.o $(OBJROOT)/semantic/hir_member_resolution.o $(OBJROOT)/semantic/identifier_resolution.o $(OBJROOT)/semantic/literal_resolution.o $(OBJROOT)/semantic/member_access_resolution.o $(OBJROOT)/semantic/member_resolution.o $(OBJROOT)/semantic/static_assert_resolution.o $(OBJROOT)/semantic/static_initializer_resolution.o $(OBJROOT)/semantic/type_name_resolution.o $(OBJROOT)/semantic/type_query_resolution.o
PARSER_LIB_OBJS+=$(OBJROOT)/semantic/declarator_bound_resolution.o $(OBJROOT)/semantic/hir_local_resolution.o $(OBJROOT)/semantic/hir_symbol_resolution.o $(OBJROOT)/semantic/resolved_function.o $(OBJROOT)/semantic/resolved_lvalue.o $(OBJROOT)/semantic/resolved_node_kind.o $(OBJROOT)/semantic/resolved_node_type.o $(OBJROOT)/semantic/resolved_object_ref.o $(OBJROOT)/semantic/semantic_node_builder.o $(OBJROOT)/semantic/semantic_tree_resolution.o $(OBJROOT)/semantic/static_initializer_materialization.o
