...
PARSER_LIB_OBJS+=$(OBJROOT)/parser/aggregate_member_syntax.o $(OBJROOT)/parser/function_parameter_syntax.o $(OBJROOT)/parser/static_assert_declaration.o $(OBJROOT)/semantic/static_assert_resolution.o
