...
PARSER_LIB_OBJS+=$(OBJROOT)/semantic/resolved_function.o $(OBJROOT)/semantic/semantic_invariants.o $(OBJROOT)/semantic/tree_walk.o $(OBJROOT)/semantic/type_identity_pass.o
