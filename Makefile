...
PARSER_LIB_OBJS+=$(OBJROOT)/semantic/resolved_function.o $(OBJROOT)/semantic/resolved_node_type.o $(OBJROOT)/semantic/semantic_invariants.o $(OBJROOT)/semantic/semantic_tree.o $(OBJROOT)/semantic/semantic_tree_resolution.o $(OBJROOT)/semantic/tree_walk.o $(OBJROOT)/semantic/type_identity_pass.o
